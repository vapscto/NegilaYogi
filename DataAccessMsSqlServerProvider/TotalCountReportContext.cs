...
{
    public class TotalCountReportContext : DbContext
    {
        public TotalCountReportContext(DbContextOptions<TotalCountReportContext> options) :base(options)
        { }

        public TotalCountReportContext()
        {
        }
