...
{
    public class RegistrationReportContext : DbContext
    {
        public RegistrationReportContext(DbContextOptions<enquiryreportContext> options) :base(options)
        { }

        public RegistrationReportContext()
        {
        }
