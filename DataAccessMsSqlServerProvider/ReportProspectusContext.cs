...
{
    public class ReportProspectusContext : DbContext
    {
        public ReportProspectusContext(DbContextOptions<enquiryreportContext> options) :base(options)
        { }

        public ReportProspectusContext()
        {
        }
