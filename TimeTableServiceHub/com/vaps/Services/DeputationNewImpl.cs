...
{
    public class DeputationNewImpl : Interfaces.DeputationNewInterface
    {
        public TTContext _ttcontext;

        public DomainModelMsSqlServerContext _db;
        public DeputationNewImpl(TTContext ttcntx, DomainModelMsSqlServerContext _db1234)
        {
            _ttcontext = ttcntx;
        ...
        public TTDeputationDTO savedetails(TTDeputationDTO _category)
        {
             try
            {
                ...
                deputs = _ttcontext.TT_Staff_DeputationDMO.Where(x => x.MI_Id == _category.MI_Id).ToList();
                foreach (var x in _category.subarray)
                {
                    //for edit and add start here.............
                    var result = _ttcontext.TT_Staff_DeputationDMO.Where(t => t.ASMAY_Id == _category.ASMAY_Id && t.MI_Id == _category.MI_Id && t.TTSD_Date == _category.TTSD_Date && t.TTSD_AbsentStaff == _category.TTSD_AbsentStaff && t.TTMD_Id == x.TTMD_Id && t.TTMP_Id == x.TTMP_Id && t.TTSD_DeputedStaff==x.TTSD_DeputedStaff).Count();
                    if (result > 0)
                    {
                        var result1 = _ttcontext.TT_Staff_DeputationDMO.Single(t => t.ASMAY_Id == _category.ASMAY_Id && t.MI_Id == _category.MI_Id && t.TTSD_Date == _category.TTSD_Date && t.TTSD_AbsentStaff == _category.TTSD_AbsentStaff && t.TTMD_Id == x.TTMD_Id && t.TTMP_Id == x.TTMP_Id);
                        result1.ASMAY_Id = _category.ASMAY_Id;
                        result1.TTSD_Date = _category.TTSD_Date;
                        result1.TTSD_AbsentStaff = _category.TTSD_AbsentStaff;
                        result1.TTSD_DeputedStaff = x.TTSD_DeputedStaff;
                        result1.ASMCL_Id = x.ASMCL_Id;
                        result1.ASMS_Id = x.ASMS_Id;
                        result1.TTMD_Id = x.TTMD_Id;
                        result1.TTMP_Id = x.TTMP_Id;
                        result1.TTSD_Remarks = _category.TTSD_Remarks;
                        ...
                        if (contactExists == 1)
                        {
                            ...
                            if (_category.mailflag == true)
                            {
                                ...
                                mailId = _ttcontext.Emp_Email_Id.Where(h => h.HRME_Id.Equals(x.TTSD_DeputedStaff) && h.HRMEM_DeFaultFlag == "default").Select(h => h.HRMEM_EmailId).FirstOrDefault();
                                if(mailId  !="")
                                {
                            ...
                            {
                                var result123 = _ttcontext.TT_Staff_DeputationDMO.Single(t => t.ASMAY_Id == _category.ASMAY_Id && t.MI_Id == _category.MI_Id && t.TTSD_Date == _category.TTSD_Date && t.TTSD_AbsentStaff == _category.TTSD_AbsentStaff && t.TTMD_Id == x.TTMD_Id && t.TTMP_Id == x.TTMP_Id);
                                long contactno = 0;
                                //for (int z = 0; z <= 1; z++)
                                //{
                                ...
                                //}
                                Template = "TTTakingStaff";
                                contactno = _ttcontext.Emp_MobileNo.Where(h => h.HRME_Id.Equals(x.TTSD_DeputedStaff) && h.HRMEMNO_DeFaultFlag == "default").Select(h => h.HRMEMNO_MobileNo).FirstOrDefault();
                                if (contactno != 0)
                                {
                                    // SMS sms = new SMS(_db);
                            ...
                            if (_category.NOT_Flag == true)
                            {
                                ...
                                var keylist = _ttcontext.MobileApplAuthenticationDMO.Where(t => t.MI_Id == _category.MI_Id).Distinct().ToList();
                                ...
                                if (keylist.Count > 0)
                                {
                                    ...
                                    {
                                        long mobno = 0;
                                        var contactnolist = _ttcontext.Emp_MobileNo.Where(h => h.HRME_Id.Equals(x.TTSD_DeputedStaff) && h.HRMEMNO_DeFaultFlag == "default").ToList();
                                        if (contactnolist.Count > 0)
                                        {
                                            mobno = contactnolist[0].HRMEMNO_MobileNo;
                                        }
                                        var result123 = _ttcontext.TT_Staff_DeputationDMO.Single(t => t.ASMAY_Id == _category.ASMAY_Id && t.MI_Id == _category.MI_Id && t.TTSD_Date == _category.TTSD_Date && t.TTSD_DeputedStaff == x.TTSD_DeputedStaff && t.TTMD_Id == x.TTMD_Id && t.TTMP_Id == x.TTMP_Id);

                                        int e = callnotification(x.TTSD_DeputedStaff, _category.deviceid, mobno, _category.MI_Id, "", "", keylist[0].MAAN_AuthenticationKey, "Staff", result123.TTSD_Id, "P");
                                    }

                                    var empmobid = _ttcontext.HR_Master_Employee_DMO.Where(t => t.MI_Id == _category.MI_Id && t.HRME_Id == _category.TTSD_AbsentStaff).ToList();
                                    ...
                                    if (empmobid.Count > 0)
                                    {
                                        ...
                                        if (empmobid[0].HRME_AppDownloadedDeviceId != null && empmobid[0].HRME_AppDownloadedDeviceId != "")
                                        {
                                            ...
                                            int e = callnotification(_category.TTSD_AbsentStaff, empmobid[0].HRME_AppDownloadedDeviceId, mobno, _category.MI_Id, "", "", keylist[0].MAAN_AuthenticationKey, "Staff", result123.TTSD_Id, "A");
                    ...
                    {
                        TT_Staff_DeputationDMO obj1 = new TT_Staff_DeputationDMO();
                        obj1.MI_Id = _category.MI_Id;
                        obj1.ASMAY_Id = _category.ASMAY_Id;
                        obj1.TTSD_Date = _category.TTSD_Date;
                        obj1.TTSD_AbsentStaff = _category.TTSD_AbsentStaff;
                        obj1.TTSD_DeputedStaff = x.TTSD_DeputedStaff;
                        obj1.ASMCL_Id = x.ASMCL_Id;
                        obj1.ASMS_Id = x.ASMS_Id;
                        obj1.TTMD_Id = x.TTMD_Id;
                        obj1.TTMP_Id = x.TTMP_Id;
                        obj1.TTSD_Remarks = _category.TTSD_Remarks;
        ...
        public TTDeputationDTO get_free_stfdets(TTDeputationDTO _category)
        {
            ...
            try
            {
                ...
                using (var cmd = _ttcontext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "TT_SCHOOL_DAYWISE_STAFFWISEFREEPERIODS";
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add(new SqlParameter("@HRMENew_Id",
                                        SqlDbType.BigInt)
                    {
                        Value = objpge.HRME_Id
                    });
                    ...
                    try
                    {
                        ...
                        objpge.freeperioddaily = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
                ...
                using (var cmd = _ttcontext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "TT_SCHOOL_DAYWISE_STAFFWISEFREEPERIODSWeekly";
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    try
                    {
                        ...
                        objpge.freeperiodweekly = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
