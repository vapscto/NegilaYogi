...
{
    public class TTStaffReplacementInTheirTTImpl : Interfaces.StaffReplacementInTheirTTInterface
    {

        private static ConcurrentDictionary<string, TTStaffReplacementInTheirTTDTO> _login =
               new ConcurrentDictionary<string, TTStaffReplacementInTheirTTDTO>();


        public TTContext _ttcategorycontext;
        public TTStaffReplacementInTheirTTImpl(TTContext ttcategory)
        {
            _ttcategorycontext = ttcategory;
        }
        public TTStaffReplacementInTheirTTDTO getdetails(int id)
        {
            TTStaffReplacementInTheirTTDTO TTMC = new TTStaffReplacementInTheirTTDTO();
            try
            {
        ...
        public TTStaffReplacementInTheirTTDTO get_catg(TTStaffReplacementInTheirTTDTO data)
        {
            try
            {
                data.catelist = (from a in _ttcategorycontext.TTMasterCategoryDMO
                                 ...
                                 select new TTStaffReplacementInTheirTTDTO
                                 {
                                     TTMC_Id = a.TTMC_Id,
        ...
        public TTStaffReplacementInTheirTTDTO getreport(TTStaffReplacementInTheirTTDTO data)
        {
            try
            {
        ...
        public TTStaffReplacementInTheirTTDTO getpossiblePeriod(TTStaffReplacementInTheirTTDTO data)
        {
            ...
            List<TTStaffReplacementInTheirTTDTO> result = new List<TTStaffReplacementInTheirTTDTO>();
            ...
            using (var cmd = _ttcategorycontext.Database.GetDbConnection().CreateCommand())
            {
                ...
                try
                {
                    using (var dataReader = cmd.ExecuteReader())
                    {
                        ...
                        {
                            result.Add(new TTStaffReplacementInTheirTTDTO
                            {
        ...
        public TTStaffReplacementInTheirTTDTO savedetail(TTStaffReplacementInTheirTTDTO data)
        {
            try
            {
