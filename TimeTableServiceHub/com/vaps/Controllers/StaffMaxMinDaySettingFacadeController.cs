...
namespace TimeTableServiceHub.com.vaps.Controllers
{
    ...
    public class StaffMaxMinDaySettingFacadeController : Controller
    {
        public StaffMaxMinDaySettingInterface _inter;

        public StaffMaxMinDaySettingFacadeController(StaffMaxMinDaySettingInterface obj)
        {
            _inter = obj;
        }
        ...
        [Route("getdetails")]
        public StaffMaxMinDaySettingDTO Getdetails([FromBody] StaffMaxMinDaySettingDTO data)
        {
