...
{
    public class AcademicYearWiseCollectionImpl : interfaces.AcademicYearWiseCollectionInterface
    {
        public FeeGroupContext _FeeGroupContext;

        public AcademicYearWiseCollectionImpl(FeeGroupContext frgContext)
        {
        ...
        public async Task<CategoryWiseFeeCollectionDTO> radiobtndata([FromBody] CategoryWiseFeeCollectionDTO temp)
        {
            ...
            {
                cmd.CommandText = "yearwisetotalamount";
