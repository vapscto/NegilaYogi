...
{
    public class FeeOnlinePaymentImpl : interfaces.FeeOnlinePaymentInterface
    {
       ...
       new ConcurrentDictionary<string, FeeStudentTransactionDTO>();
        ...
        readonly ILogger<FeeOnlinePaymentImpl> _logger;

        public FeeOnlinePaymentImpl(FeeGroupContext frgContext, ILogger<FeeOnlinePaymentImpl> log, DomainModelMsSqlServerContext context)
        {
            _logger = log;
        ...
        public FeeStudentTransactionDTO getamountdet(FeeStudentTransactionDTO data)
        {
            try
            {
               ...
               SqlDbType.Int, 500)
                ...
                //    using (var cmd = _FeeGroupHeadContext.Database.GetDbConnection().CreateCommand())
                //    {
                //        cmd.CommandText = "MOBILE_PAYMENT_GATEWAY";
                //        cmd.CommandType = CommandType.StoredProcedure;
                ...
                //                }
                //            }
                //            data.fillpaymentgateway = retObject.ToArray();
                //        }
                //        catch (Exception ex)
                //        {
        ...
        public async Task<PaymentDetails.CCAvenue> initiateJuspayPayment(PaymentDetails.CCAvenue response)
        {
        ...
        //    CreateOrderSessionInput createOrderSessionInput = new CreateOrderSessionInput(new Dictionary<string, object> {
        //        { "amount", amount }, { "order_id", orderId },
        //        { "customer_id", customerId },
        //        { "payment_page_client_id", "hdfcmaster" },
        //        { "action", "paymentPage" },
        //        { "return_url", "http://localhost:5000/handleJuspayResponse" } });
        //    try
        //    {
        ...
        public FeeStudentTransactionDTO get_grp_reptno(FeeStudentTransactionDTO data)
        {
            ...
            SqlDbType.NVarChar, 500)
                        ...
                        {
                            for (var l = 0; l < groupwisefmaids.Count - 1; l++)
                            {
                                if (groupwisefmaids[l].FSS_ToBePaid < groupwisefmaids[l + 1].FSS_ToBePaid)
                                {
                                    var temp = groupwisefmaids[l];
                                    groupwisefmaids[l] = groupwisefmaids[l + 1];
                                    groupwisefmaids[l + 1] = temp;
                                }
                            }
                        }
                        ...
                        //                         var waivedofffine = (from a in _FeeGroupHeadContext.feeStudentWaivedOff
                        //                                              where (a.MI_Id == data.MI_Id && a.ASMAY_Id == data.ASMAY_Id && a.FMA_Id == groupwisefmaids[s].FMA_Id && a.AMST_Id == data.Amst_Id)
                        //                                              select new FeeStudentTransactionDTO
                        //                                              {
                        //                                                  FSS_WaivedAmount = a.FSWO_WaivedOffAmount,
                        //                                                  FSWO_FineFlg = a.FSWO_FineFlg,
            ...
            try
            {
                ...
                else if (data.onlinepaygteway == "EASEBUZZ")
                {
                    ...
                    else
                    {
                        ...
                        data = CCAvenueApi(data);
                    }
                }
                else if (data.onlinepaygteway == "CCAvenue")
                {
                    data = CCAvenueApi(data);
                }
            }
        ...
        public async Task<FeeStudentTransactionDTO> mobilepayuconnect(FeeStudentTransactionDTO data)
        {
            try
            {
             ...
             && config[0].FMC_FineEnableDisable == false && config[0].FMC_RebateAplicableFlg == false)
                    {
                        data = await paymentPartMobileEasebuzzPartial(data);
                    }
        ...
        //public FeeStudentTransactionDTO mobilepayuconnect(FeeStudentTransactionDTO data)
        //{
        //    try
        //    {
        //        data.ASMAY_Id = getacademicyearcongig(data);
        ...
        public Array mobilepaymentPart(FeeStudentTransactionDTO enq, long totamount)
        {
            ...
            try
            {
               ...
               SqlDbType.Int, 500)
                ...
                PaymentDetailsDto.udf5 = ((FeeStudentTransactionDTO)enq.fillstudent.GetValue(0)).ASMCL_ID.ToString();
                PaymentDetailsDto.transaction_response_url = "http://localhost:57606/api/FeeOnlinePayment/paymentresponse/";
        ...
        public Array paymentPartpaytmmobile(FeeStudentTransactionDTO enq, long totamount)
        {
            ...
            try
            {
               ...
               SqlDbType.Int, 500)
                ...
                //paymentdetails = _FeeGroupHeadContext.Fee_PaymentGateway_Details.Where(t => t.MI_Id == enq.MI_Id && t.FPGD_PGName== "PAYTM").Distinct().ToList();
                ...
                parameters.Add("CALLBACK_URL", "http://localhost:57606/api/FeeOnlinePayment/paymentresponsePAYTM/");
                ...
                aa.payu_URL = url;
                aa.CALLBACK_URL = "http://localhost:57606/api/FeeOnlinePayment/paymentresponsePAYTM/";
        ...
        public PaymentDetails RefundAPI(PaymentDetails response)
        {
            try
            {
                ...
                //Full Refund
                Razorpay.Api.Refund refund = payment.Refund();

                //Partial Refund
                Dictionary<string, object> data = new Dictionary<string, object>();
                data.Add("amount", "100");
                Razorpay.Api.Refund Partialrefund = payment.Refund(data);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public FeeStudentTransactionDTO Razorpaypaymentsettlementresponse(FeeStudentTransactionDTO response)
        {
            try
            {
                ...
                try
                {
                    ...
                    List<Razorpay.Api.Order> orders = client.Order.All(input);
                    string id = "";
        ...
        public FeeStudentTransactionDTO paymentPartEasyBuzz(FeeStudentTransactionDTO enq)
        {
            ...
            try
            {
               ...
               SqlDbType.Int, 500)
                ...
                string surl = "http://localhost:57606/api/FeeOnlinePayment/paymentresponseeasybuzz/";
                string furl = "http://localhost:57606/api/FeeOnlinePayment/paymentresponseeasybuzz/";
        ...
        public PaymentDetails.CCAvenue getpaymentresponseccavenue(PaymentDetails.CCAvenue response)
        {
            ...
            if (response.status == "CHARGED")
            {
                ...
                string txnid = response.order_id.ToString();
                //string key = paymentdetails.FirstOrDefault().FPGD_AuthorisationKey;
                //string secret = paymentdetails.FirstOrDefault().FPGD_SaltKey;

                var username = "EA8307340FE4E27B832F19B482E806";
                var password = "";
                ...
                var requestnew = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri("https://smartgatewayuat.hdfcbank.com/orders/" + txnid),
                };


                requestnew.Headers.Add("x-merchantid", "SG330");
                requestnew.Headers.Add("x-customerid", "hdfcmaster");
                //requestnew.Headers.Add("Content-Type", "application/json");
                requestnew.Headers.Authorization = new AuthenticationHeaderValue("Basic", authHeaderValue);
                using (var response123 = client.SendAsync(requestnew))
                {
                    response123.Result.EnsureSuccessStatusCode();
                    //response123.EnsureSuccessStatusCode();
                    //response123.EnsureSuccessStatusCode();
                    var body = response123.Result.Content.ReadAsStringAsync();

                    JObject joResponse1 = JObject.Parse(body.Result.ToString());

                    string ReCheck = joResponse1["status"].ToString();



                    string paymentref = joResponse1["payment_gateway_response"]["epg_txn_id"].ToString();
                    string udf1 = joResponse1["udf1"].ToString();
                    string udf2 = joResponse1["udf2"].ToString();
                    string udf3 = joResponse1["udf3"].ToString();
                    string udf4 = joResponse1["udf4"].ToString();
                    string udf5 = joResponse1["udf5"].ToString();
                    string udf6 = joResponse1["udf6"].ToString();
                    decimal amt = Convert.ToDecimal(joResponse1["amount"].ToString());

                    response.order_id = joResponse1["order_id"].ToString();
                    response.txn_id = paymentref;
                    response.amount = Convert.ToInt32(amt);

                    if (ReCheck == "CHARGED")
                    {
                        var groups = (from a in _FeeGroupHeadContext.FeePaymentDetailsDMO
                                      where (a.MI_Id == Convert.ToInt32(udf3) && a.ASMAY_ID == Convert.ToInt32(udf4)
                                      && a.fyp_transaction_id == response.order_id)
                                      select new FeeStudentTransactionDTO
                                      {
                                          FYP_Receipt_No = a.FYP_Receipt_No
                                      }
                        ...
                        if (groups.Count == 0)
                        {
                            var confirmstatus = insertdatainfeetables(udf3, udf5, udf1, udf6,
                                amt, response.order_id, paymentref, udf4, indianTime, "0");

                            if (Convert.ToInt32(confirmstatus) > 0)
                            {
                                pgmod.MI_Id = Convert.ToInt64(udf3);
                                pgmod.amst_mobile = Convert.ToInt64(joResponse1["customer_phone"].ToString());
                                pgmod.Amst_Id = Convert.ToInt64(udf3);
                                pgmod.amst_email_id = joResponse1["customer_email"].ToString();

                                //SMS sms = new SMS(_context);

                                //sms.sendSms(pgmod.MI_Id, pgmod.amst_mobile, "FEEONLINEPAYMENT", Convert.ToInt32(udf2));

                                //Email Email = new Email(_context);

                                //Email.sendmail(pgmod.MI_Id, pgmod.amst_email_id, "FEEONLINEPAYMENT", Convert.ToInt32(udf2));

                                //response.order_id = joResponse1["order_id"].ToString();
                                //response.txn_id = paymentref;
                                //response.amount = Convert.ToInt32(amt);

                                response.status = ReCheck;
                    ...
                    //JObject joResponse2 = joResponse1.GetValue("payment_gateway_response").ToString();
                }
        ...
        public FeeStudentTransactionDTO paymentPartEasyBuzzSplit(FeeStudentTransactionDTO enq)
        {
            ...
            try
            {
               ...
               SqlDbType.Int, 500)
                    ...
                    //var accountvalidation = (from a in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                    //                         where (a.MI_Id == enq.MI_Id && a.FPGD_PGName == "EASEBUZZ")
                    //                         select new FeeStudentTransactionDTO
                    //                         {
                    //                             FPGD_SubMerchantId = a.FPGD_SubMerchantId
                    //                         }).Distinct().ToArray();
            ...
            SqlDbType.BigInt)
                ...
                string UDF6 = (enq.ASMCL_ID).ToString();
                    ...
                    for (var j = 0; j < mulacc.Count; j++)
                    {
                        if (j == 0)
                        {
                            if (fineamt > 0)
                            {
                                ...
                                transfersnotescash.Add(mulacc[j].vendor_id.ToString(), Convert.ToDecimal((mulacc[j].amount + fineamt) - enq.FSS_RebateAmount));
                            }
                            else
                            {
                                split += "'" + mulacc[j].vendor_id.ToString() + "':" + mulacc[j].amount + ",";
        ...
        public FeeStudentTransactionDTO CCAvenueApi(FeeStudentTransactionDTO response)
        {
            long totconclist = 0;
            response.ASMAY_Id = response.ASMAY_Id;

            long clsid = response.ASMCL_ID;
            TimeZoneInfo INDIAN_ZONE = TimeZoneInfo.FindSystemTimeZoneById("India Standard Time");
            DateTime indianTime = TimeZoneInfo.ConvertTime(DateTime.UtcNow, INDIAN_ZONE);

            var fetchecs = (from a in _FeeGroupHeadContext.School_Adm_Y_StudentDMO
                            from b in _FeeGroupHeadContext.AdmissionStudentDMO
                            where (a.AMST_Id == b.AMST_Id && a.AMST_Id == response.Amst_Id && a.AMAY_ActiveFlag == 1)
                            select new FeeStudentTransactionDTO
                            {
                                AMST_ECSFlag = b.AMST_ECSFlag,
                                AMST_FirstName = ((b.AMST_FirstName == null || b.AMST_FirstName == "0" ? "" : b.AMST_FirstName) +
            ...
            try
            {
                ...
                response.FSS_FineAmount = 0;
                List<FeeStudentTransactionDTO> amount_list = new List<FeeStudentTransactionDTO>();

                for (int l = 0; l < response.selected_list.Length; l++)
                {
                    totalfine = 0;
                    string fpgdids = "";
                    List<long> trm_ids = new List<long>();
                    foreach (var x in response.selected_list[l].trm_list)
                    {
                        termids = termids + ',' + x.FMT_Id;
                        trm_ids.Add(x.FMT_Id);
                    }

                    response.ftiidss = termids;

                    var grp_ids = _FeeGroupHeadContext.feeGGG.Where(t => t.FMGG_Id == response.selected_list[l].grp.FMGG_Id).Select(t => t.FMG_Id);
                    var grp_ids1 = _FeeGroupHeadContext.feeGGG.Where(t => t.FMGG_Id == response.selected_list[l].grp.FMGG_Id).Select(t => t.FMG_Id).ToArray();
                    fineamt = 0;
                    for (int r = 0; r < grp_ids1.Count(); r++)
                    {
                        grpidss = grpidss + ',' + grp_ids1[r];
                    ...
                    response.grpidss = grpidss;

                    if (readterms.IVRMGC_Classwise_Payment != "1")
                    {
                        var fpgdids1 = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                        from b in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                        where (a.fpgd_id == b.FPGD_Id && grp_ids.Contains(a.fmg_id) && a.MI_Id == response.MI_Id && b.FPGD_PGName == response.onlinepaygteway)
                                        select new FeeStudentTransactionDTO
                                        {
                                            merchantid = b.FPGD_SubMerchantId
                                        }
                    ...
                    else
                    {
                        var fpgdids1 = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                        from b in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                        where (a.fpgd_id == b.FPGD_Id && grp_ids.Contains(a.fmg_id) && a.MI_Id == response.MI_Id && a.ASMCL_Id == response.ASMCL_ID && trm_ids.Contains(a.fmt_id) && b.FPGD_PGName == response.onlinepaygteway)
                                        select new FeeStudentTransactionDTO
                                        {
                                            merchantid = b.FPGD_SubMerchantId
                                        }
                    ...
                    if (readterms.IVRMGC_Classwise_Payment != "1")
                    {
                        fineheadfmaid = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                         ...
                                         from d in _FeeGroupHeadContext.FeeInstallmentsyearlyDMO
                                         from e in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                         where (a.fpgd_id == e.FPGD_Id && b.FMH_Id == a.FMH_Id && b.FTI_Id == a.fti_id && b.FMG_Id == a.fmg_id && c.FMH_Id == a.FMH_Id && d.FTI_Id == a.fti_id && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && b.AMST_Id == response.Amst_Id && c.FMH_Flag == "F" && grp_ids.Contains(a.fmg_id))
                                         select new feefinefmaDTO
                                         {
                                             FMA_Id = b.FMA_Id,
                                             FMH_FeeName = c.FMH_FeeName,
                    ...
                    else
                    {
                        fineheadfmaid = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                         ...
                                         from d in _FeeGroupHeadContext.FeeInstallmentsyearlyDMO
                                         from e in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                         where (a.fpgd_id == e.FPGD_Id && b.FMH_Id == a.FMH_Id && b.FTI_Id == a.fti_id && b.FMG_Id == a.fmg_id && c.FMH_Id == a.FMH_Id && d.FTI_Id == a.fti_id && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && b.AMST_Id == response.Amst_Id && c.FMH_Flag == "F" && grp_ids.Contains(a.fmg_id) && a.ASMCL_Id == response.ASMCL_ID)
                                         select new feefinefmaDTO
                                         {
                                             FMA_Id = b.FMA_Id,
                                             FMH_FeeName = c.FMH_FeeName,
                    ...
                    if (readterms.IVRMGC_Classwise_Payment != "1")
                    {
                        var list = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                    ...
                                    from h in _FeeGroupHeadContext.feeYCCC
                                    from i in _FeeGroupHeadContext.FeeStudentTransactionDMO
                                    where (g.ASMAY_Id == b.ASMAY_Id && b.FMCC_Id == g.FMCC_Id && g.FYCC_Id == h.FYCC_Id && b.FMH_Id == a.FMH_Id && b.FTI_Id == a.fti_id && b.FMG_Id == a.fmg_id && c.FMH_Id == a.FMH_Id && d.FTI_Id == a.fti_id && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && grp_ids.Contains(a.fmg_id) && b.FMG_Id == f.FMG_Id && h.ASMCL_Id == Convert.ToInt32(response.ASMCL_ID) && trm_ids.Contains(a.fmt_id) && ((b.FMA_Amount > 0 && (c.FMH_Flag != "F")) || (c.FMH_Flag == "F")) && i.FMA_Id == b.FMA_Id && a.fmg_id == i.FMG_Id && a.FMH_Id == i.FMH_Id && a.fti_id == i.FTI_Id && i.AMST_Id == response.Amst_Id && i.ASMAY_Id == response.ASMAY_Id && i.FSS_ToBePaid > 0)
                                    select new FeeStudentTransactionDTO
                                    {
                                        FMA_Id = b.FMA_Id,
                                        FSS_ToBePaid = i.FSS_ToBePaid,
                    ...
                    else
                    {
                        var list = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                    ...
                                    from h in _FeeGroupHeadContext.feeYCCC
                                    from i in _FeeGroupHeadContext.FeeStudentTransactionDMO
                                    where (a.ASMCL_Id == response.ASMCL_ID && g.ASMAY_Id == b.ASMAY_Id && b.FMCC_Id == g.FMCC_Id && g.FYCC_Id == h.FYCC_Id && b.FMH_Id == a.FMH_Id && b.FTI_Id == a.fti_id && b.FMG_Id == a.fmg_id && c.FMH_Id == a.FMH_Id && d.FTI_Id == a.fti_id && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && grp_ids.Contains(a.fmg_id) && b.FMG_Id == f.FMG_Id && h.ASMCL_Id == Convert.ToInt32(response.ASMCL_ID) && trm_ids.Contains(a.fmt_id) && ((b.FMA_Amount > 0 && (c.FMH_Flag != "F")) || (c.FMH_Flag == "F")) && i.FMA_Id == b.FMA_Id && a.fmg_id == i.FMG_Id && a.FMH_Id == i.FMH_Id && a.fti_id == i.FTI_Id && i.AMST_Id == response.Amst_Id && i.ASMAY_Id == response.ASMAY_Id && i.FSS_ToBePaid > 0)
                                    select new FeeStudentTransactionDTO
                                    {
                                        FMA_Id = b.FMA_Id,
                                        FSS_ToBePaid = i.FSS_ToBePaid,
               ...
               SqlDbType.Int, 500)
                            ...
                            var waivedofffine = (from a in _FeeGroupHeadContext.feeStudentWaivedOff
                                                 where (a.MI_Id == response.MI_Id && a.ASMAY_Id == response.ASMAY_Id && a.FMA_Id == x.FMA_Id && a.AMST_Id == response.Amst_Id)
                                                 select new FeeStudentTransactionDTO
                                                 {
                                                     FSS_WaivedAmount = a.FSWO_WaivedOffAmount,
                                                     FSWO_FineFlg = a.FSWO_FineFlg,
                    ...
                    if (readterms.IVRMGC_Classwise_Payment != "1")
                    {
                        response.pendingamount = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                                  from b in _FeeGroupHeadContext.FeeStudentTransactionDMO
                                                  from c in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                                  where (a.fmg_id == b.FMG_Id && a.FMH_Id == b.FMH_Id && a.fti_id == b.FTI_Id && a.fpgd_id == c.FPGD_Id && c.FPGD_PGName == response.onlinepaygteway && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && b.AMST_Id == response.Amst_Id && trm_ids.Contains(a.fmt_id) && b.FSS_ToBePaid > 0 && grp_ids.Contains(a.fmg_id))
                                                  select new FeeStudentTransactionDTO
                                                  {
                                                      FSS_ToBePaid = b.FSS_ToBePaid,
                                                  }
                    ...
                    else
                    {
                        response.pendingamount = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                                  from b in _FeeGroupHeadContext.FeeStudentTransactionDMO
                                                  from c in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                                  where (a.fmg_id == b.FMG_Id && a.FMH_Id == b.FMH_Id && a.fti_id == b.FTI_Id && a.fpgd_id == c.FPGD_Id && c.FPGD_PGName == response.onlinepaygteway && b.MI_Id == response.MI_Id && b.ASMAY_Id == response.ASMAY_Id && b.AMST_Id == response.Amst_Id && trm_ids.Contains(a.fmt_id) && b.FSS_ToBePaid > 0 && grp_ids.Contains(a.fmg_id) && a.ASMCL_Id == response.ASMCL_ID)
                                                  select new FeeStudentTransactionDTO
                                                  {
                                                      FSS_ToBePaid = b.FSS_ToBePaid,
                                                  }
                    ...
                    result.Add(new FeeSlplitOnlinePayment
                    {
                        name = "splitId" + autoinc.ToString(),
                        merchantId = fpgdids,
                        value = (Convert.ToInt32(response.pendingamount) + fineamt).ToString(),
                        commission = "0",
                        description = "Online Payment",
                    });

                    response.FSS_FineAmount = response.FSS_FineAmount + fineamt;
                }

                response.Totalconcession = totconclist;
                ...
                List<Fee_PaymentGateway_DetailsDMO> paymentdetails = new List<Fee_PaymentGateway_DetailsDMO>();
                paymentdetails = _FeeGroupHeadContext.Fee_PaymentGateway_Details.Where(t => t.MI_Id == response.MI_Id && t.FPGD_PGName == "CCAvenue").Distinct().ToList();
                PaymentDetailsDto.MARCHANT_ID = paymentdetails.FirstOrDefault().FPGD_AuthorisationKey.ToString();
                PaymentDetailsDto.IVRMOP_BASE_URL = paymentdetails.FirstOrDefault().FPGD_URL.ToString();
                ...
                response.trans_id = response.MI_Id + indianTime.ToString("yyyyMMddHHmmss") + string.Format("{0:d5}", (indianTime.Millisecond)).Trim();


                PaymentDetails.CCAvenue s = new PaymentDetails.CCAvenue();
                PaymentDetails response1 = new PaymentDetails();
                ...
                s.order_id = (response.trans_id).ToString();
                s.amount = totpayableamount;
                s.customer_id = paymentdetails.FirstOrDefault().FPGD_SubMerchantKey.ToString();
                s.customer_email = fetchecs[0].amst_email_id;
                s.customer_phone = (fetchecs[0].amst_mobile).ToString();
                s.payment_page_client_id = paymentdetails.FirstOrDefault().FPGD_SubMerchantId.ToString();
                s.action = "paymentPage";
                s.return_url = "http://localhost:57606/api/FeeOnlinePayment/paymentresponseccavenue/";
                s.description = "Online Payment";
                s.first_name = fetchecs[0].AMST_FirstName;
                s.last_name = fetchecs[0].AMST_LastName;
                s.udf1 = (response.Amst_Id).ToString();
                s.udf2 = (response.userid).ToString();
                s.udf3 = (response.MI_Id).ToString();
                s.udf4 = (response.ASMAY_Id).ToString();
                s.udf5 = (response.ftiidss).ToString();
                s.udf6 = (response.ASMCL_ID).ToString();
                s.udf7 = "";
                s.udf8 = "";
                s.udf9 = "";
                s.udf10 = "";

                var jsonContent = JsonConvert.SerializeObject(s);

                var username = paymentdetails.FirstOrDefault().FPGD_AuthorisationKey.ToString();
                var password = "";
                var authToken = Encoding.ASCII.GetBytes($"{username}:{password}");
                var authHeaderValue = Convert.ToBase64String(authToken);
                ...
                {
                    Method = System.Net.Http.HttpMethod.Post,
                    RequestUri = new Uri(PaymentDetailsDto.IVRMOP_BASE_URL),
                    Content = new StringContent(jsonContent, Encoding.UTF8, "application/json")
                };


                requestnew.Headers.Add("x-merchantid", paymentdetails.FirstOrDefault().FPGD_AccNo.ToString());
                requestnew.Headers.Add("x-customerid", paymentdetails.FirstOrDefault().FPGD_SubMerchantId.ToString());
                //requestnew.Headers.Add("Content-Type", "application/json");
                requestnew.Headers.Authorization = new AuthenticationHeaderValue("Basic", authHeaderValue);
                ...
                using (var response123 = client.SendAsync(requestnew))
                {
                    ...
                    string responseContent1 = joResponse1.GetValue("status").ToString();
                    JObject joResponse2 = JObject.Parse(joResponse1.GetValue("payment_links").ToString());

                    string responseContent2 = joResponse2.GetValue("web").ToString();

                    if (responseContent1 == "NEW")
                    {
                        redirectionURL = joResponse2.GetValue("web").ToString();

                        if (response.FYP_PayModeType == "Portal")
                        {
                            get_grp_reptno(response);
                        }
                        else if (response.FYP_PayModeType == "MOBILE")
                        {
                            get_grp_reptno_Mobile(response);
                        }
                    }
                    response.strdatanew = redirectionURL;
                }
        ...
        public async Task<string> RedriectURl(string redirectionURL)
        {
            string responseBody = "";
            //using (HttpClient client = new HttpClient())
            //{
            //    HttpResponseMessage response = await client.GetAsync(redirectionURL);
            ...
            //    else
            //    {
            //        Console.WriteLine($"Failed to get a successful response. Status code: {response.StatusCode}");
            //    }
            //}

            using (var httpClient = new HttpClient(new HttpClientHandler { AllowAutoRedirect = false }))
            {
                var response = await httpClient.GetAsync(redirectionURL);
                    ...
                    response.StatusCode == System.Net.HttpStatusCode.MovedPermanently)
                {
                    ...
                    Console.WriteLine($"Response from redirected URL: {content}");
                }
                else
                {
                    var content = await response.Content.ReadAsStringAsync();
                    Console.WriteLine($"Response from URL: {content}");
                }
            }
            //var Reresponse = new HttpResponseMessage(HttpStatusCode.Redirect);
            //Reresponse.Headers.Location = new Uri(redirectionURL);
            return responseBody;
        }
        ...
        //                string surl = "https://jnujaipur.vapssmartecampus.com/api/FeeOnlinePayment/paymentresponseeasybuzz/";
        //                string furl = "https://jnujaipur.vapssmartecampus.com/api/FeeOnlinePayment/paymentresponseeasybuzz/";
        ...
        //                enq.FMA_Amount = Convert.ToInt64(amount);
        //                string Txnid = (enq.trans_id).ToString();
        //                string UDF1 = (enq.Amst_Id).ToString();
        ...
        //                string url = "https://testpay.easebuzz.in/payment/initiateLink";
        //                split_payments = "";
        //                sub_merchant_id = "";
        ...
        //                paytmParams.Add("key", secret);
        //                paytmParams.Add("amount", amount);
        //                paytmParams.Add("firstname", firstname);
        //                paytmParams.Add("email", email);
        //                paytmParams.Add("phone", phone);

        //                paytmParams.Add("productinfo", productinfo);



        //                paytmParams.Add("surl", surl);

        //                paytmParams.Add("furl", furl);
        //                paytmParams.Add("txnid", Txnid);
        //                paytmParams.Add("udf1", UDF1);
        //                paytmParams.Add("udf2", UDF2);
        //                paytmParams.Add("udf3", UDF3);
        //                paytmParams.Add("udf4", UDF4);
        //                paytmParams.Add("udf5", UDF5);
        //                paytmParams.Add("udf6", UDF6);
        //                paytmParams.Add("udf7", UDF7);
        //                paytmParams.Add("hash", hash1);
        //                paytmParams.Add("address1", "");
        //                paytmParams.Add("address2", "");
        //                paytmParams.Add("city", "");
        //                paytmParams.Add("state", "");
        //                paytmParams.Add("country", "");
        //                paytmParams.Add("zipcode", "");


        //                HttpWebRequest connection = (HttpWebRequest)WebRequest.Create(url);
        //                var myContent1 = JsonConvert.SerializeObject(paytmParams);
        //                String postData1 = myContent1;


        //                connection.Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
        //                connection.ContentType = "application/ ";
        //                connection.Method = "POST";

        //                using (StreamWriter requestWriter = new StreamWriter(connection.GetRequestStream()))
        //                {
        //                    requestWriter.Write(postData1);
        //                }
        ...
        //                {
        //                    Method = System.Net.Http.HttpMethod.Post,
        //                    RequestUri = new Uri("https://testpay.easebuzz.in/payment/initiateLink"),
                ...
                if (mulacc.Count > 0)
                {
                    ...
                    for (var j = 0; j < mulacc.Count; j++)
                    {
                        if (j == 0)
                        {
                            ...
                            {
                                split += "'" + mulacc[j].vendor_id.ToString() + "':" + mulacc[j].amount + ",";
                                transfersnotescash.Add(mulacc[j].vendor_id.ToString(), (mulacc[j].amount + totalfineamt) - enq.FSS_RebateAmount);
                            }
                            else
                            {
                                split += "'" + mulacc[j].vendor_id.ToString() + "':" + mulacc[j].amount + ",";
                    ...
                    Content = new FormUrlEncodedContent(new Dictionary<string, string>
    {
        ...
        { "zipcode", "" },
         ...
         { "sub_merchant_id", sub_merchant_id }
                ...
                var readcondcheck = _FeeGroupHeadContext.FeeMasterConfiguration.Where(t => t.MI_Id == enq.MI_Id && t.FMC_ReadmitFineCalculationFlg == 1).ToList();

                if (enq.FYP_PayModeType == "Portal")
                {
                    if (readcondcheck.Count > 0)
                    {
                        get_grp_reptnoreadmission(enq);
        ...
        public async System.Threading.Tasks.Task<FeeStudentTransactionDTO> paymentPartMobileEasebuzzPartial(FeeStudentTransactionDTO enq)
        {
            long totconclist = 0;
            long yrid = getacademicyearcongig(enq);
            string termlst = "0";
            ...
            try
            {
                ...
                List<FeeStudentTransactionDTO> selected_listupdated = new List<FeeStudentTransactionDTO>();
                List<FeeStudentTransactionDTO> dd = new List<FeeStudentTransactionDTO>();
                ...
                foreach (var x in enq.selected_list)
                {
                    ...
                    foreach (var q in x.trm_list)
                    {
                        ...
                        if (x.grp.FMGG_Id == q.FMGG_Id)
                        {
                            termids = termids + ',' + q.FMT_Id;
                            termid.Add(q.FMT_Id);
                            termsum = termsum + q.FMT_Amount;
                        }
                    ...
                    List<FeeStudentTransactionDTO> insttalmentwiseamt = new List<FeeStudentTransactionDTO>();

                    if (readterms.IVRMGC_Classwise_Payment != "1")
                    {
                        var insttalmentwiseamount = (from a in _FeeGroupHeadContext.feeGGG
                                                     from b in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                                     from c in _FeeGroupHeadContext.FeeStudentTransactionDMO
                                                     from d in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                                     from e in _FeeGroupHeadContext.feeTr
                                                     from f in _FeeGroupHeadContext.FeeHeadDMO
                                                     from g in _FeeGroupHeadContext.FeeInstallmentsyearlyDMO
                                                     where (a.FMG_Id == b.fmg_id && b.fmg_id == c.FMG_Id && a.FMG_Id == c.FMG_Id && b.FMH_Id == c.FMH_Id && b.fti_id == c.FTI_Id && b.fpgd_id == d.FPGD_Id && d.MI_Id == c.MI_Id &&
                                                     e.FMT_Id == b.fmt_id && b.MI_Id == e.MI_Id && b.FMH_Id == f.FMH_Id && b.FMH_Id == f.FMH_Id && c.FTI_Id == g.FTI_Id && d.FPGD_PGName == enq.onlinepaygteway && b.MI_Id == enq.MI_Id && c.ASMAY_Id == enq.ASMAY_Id && c.AMST_Id == enq.Amst_Id && c.FSS_ToBePaid > 0 && x.grp.FMGG_Id == a.FMGG_Id && termid.Contains(b.fmt_id))
                                                     select new FeeStudentTransactionDTO
                                                     {
                        ...
                        insttalmentwiseamt = insttalmentwiseamount;
                    }
                    else
                    {
                        var insttalmentwiseamount = (from a in _FeeGroupHeadContext.feeGGG
                                                     ...
                                                     from f in _FeeGroupHeadContext.FeeHeadDMO
                                                     from g in _FeeGroupHeadContext.FeeInstallmentsyearlyDMO
                                                     where (a.FMG_Id == b.fmg_id && b.fmg_id == c.FMG_Id && b.FMH_Id == c.FMH_Id && b.fti_id == c.FTI_Id && b.fpgd_id == d.FPGD_Id && d.FPGD_PGName == enq.onlinepaygteway && b.MI_Id == enq.MI_Id && c.ASMAY_Id == enq.ASMAY_Id && c.AMST_Id == enq.Amst_Id && b.ASMCL_Id == enq.ASMCL_ID && c.FSS_ToBePaid > 0 && x.grp.FMGG_Id == a.FMGG_Id && termid.Contains(b.fmt_id) && b.FMH_Id == f.FMH_Id && c.FTI_Id == g.FTI_Id)
                                                     select new FeeStudentTransactionDTO
                                                     {
                                                         FSS_ToBePaid = c.FSS_ToBePaid,
                                                         FMH_Id = c.FMH_Id,
                    ...
                    if (insttalmentwiseamt.Count > 0)
                    {
                        if (termsum > 0)
                        {
                            for (var c = 0; c < insttalmentwiseamt.Count; c++)
                            {
                                ...
                                if (termsum >= insttalmentwiseamt[c].FSS_ToBePaid)
                                {
                                    selected_listupdated.Add(new FeeStudentTransactionDTO
                                    {

                                        FMG_Id = insttalmentwiseamt[c].FMG_Id,
                                        FMH_Id = insttalmentwiseamt[c].FMH_Id,
                                        FTI_Id = insttalmentwiseamt[c].FTI_Id,
                                        FMA_Id = insttalmentwiseamt[c].FMA_Id,
                                        FMA_Amount = insttalmentwiseamt[c].FSS_ToBePaid,
                                        FSS_ToBePaid = insttalmentwiseamt[c].FSS_ToBePaid,
                                    ...
                                    termsum = termsum - insttalmentwiseamt[c].FSS_ToBePaid;
                                }
                                else if (termsum == 0)
                                {
                                    selected_listupdated.Add(new FeeStudentTransactionDTO
                                ...
                                else if (termsum < insttalmentwiseamt[c].FSS_ToBePaid)
                                {
                ...
                if (readterms.IVRMGC_Classwise_Payment != "1")
                {
                    var fpgdids1 = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                    from b in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                    where (a.fpgd_id == b.FPGD_Id && grpids.Contains(a.fmg_id) && a.MI_Id == enq.MI_Id && b.FPGD_PGName == enq.onlinepaygteway)
                                    select new FeeStudentTransactionDTO
                                    {
                                        merchantid = b.FPGD_SubMerchantId
                                    }
                ...
                else
                {
                    var fpgdids1 = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                    from b in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                    where (a.fpgd_id == b.FPGD_Id && grpids.Contains(a.fmg_id) && a.MI_Id == enq.MI_Id && a.ASMCL_Id == enq.ASMCL_ID && termid.Contains(a.fmt_id) && b.FPGD_PGName == enq.onlinepaygteway)
                                    select new FeeStudentTransactionDTO
                                    {
                                        merchantid = b.FPGD_SubMerchantId
                                    }
                ...
                var termiddaata = "0";
                int i = 0;
                for (i = 0; i < termid.Count; i++)
                {
                    termiddaata = termiddaata + ',' + termid[i];
                }
            ...
            SqlDbType.BigInt)
                ...
                result.Add(new FeeSlplitOnlinePayment
                {
                    name = "splitId" + autoinc.ToString(),
                    merchantId = fpgdids,
                    value = (((Convert.ToInt32(totalamtnew)) + totalfineamt)).ToString(),
                    commission = "0",
                    description = "Online Payment",
                });
                ...
                if (mulacc.Count > 0)
                {
                    ...
                    foreach (var entry in accountdetails)
                    {
                        ...
                        else
                        {
                            ...
                            if (transfersnotescash.Count == 0 || transfersnotescash == null)
                            {
                                transfersnotescash.Add(entry.vendor_id, entry.amount);
                            ...
                            else
                            {
                                if (Accountdetailsfinal.ContainsKey(entry.vendor_id))
                                {
                                    transfersnotescash[entry.vendor_id] += entry.amount;
                                }
                                else
                                {
                    ...
                    Content = new FormUrlEncodedContent(new Dictionary<string, string>
    {
        ...
        public FeeStudentTransactionDTO get_grp_reptnopartialmobile(FeeStudentTransactionDTO data, List<FeeStudentTransactionDTO> selecteditem)
        {
            try
            {
                var dynamicrecgen = new List<dynamic>();
                ...
                for (int r = 0; r < grps.Count(); r++)
                {
                    ...
                    //praveen
                    //foreach (var item10 in data.selected_list[0].trm_list)
                    //{
                    //    termids.Add(item10.FMT_Id);
                    //}
                    //praveen
            ...
            SqlDbType.NVarChar, 500)
                        ...
                        {
                            for (var l = 0; l < selecteditem.Count - 1; l++)
                            {
                                if (selecteditem[l].FSS_ToBePaid < selecteditem[l + 1].FSS_ToBePaid)
                                {
                                    var temp = selecteditem[l];
                                    selecteditem[l] = selecteditem[l + 1];
                                    selecteditem[l + 1] = temp;
                                }
                            }
                        }
                        ...
                        for (var j = 0; j < selecteditem.Count; j++)
                        {
                            ...
                            if (j == 0)
                            {
                                ...
                                if (selecteditem[j].FMH_Flag == "F")
                                {
                                    fethchfmaidsfine = selecteditem[j].FMA_Id;
                                }
                                else
                                {
                                    Fee_T_Online_TransactionDMO onlinettrans = new Fee_T_Online_TransactionDMO();
                                    onlinettrans.FMOT_Id = onlinemtrans.FMOT_Id;
                                    onlinettrans.FMA_Id = selecteditem[j].FMA_Id;
                                    onlinettrans.FTOT_Amount = selecteditem[j].FSS_ToBePaid - data.FSS_RebateAmount;
                                    onlinettrans.FTOT_Created_date = indianTime;
                                    onlinettrans.FTOT_Updated_date = indianTime;
                                    onlinettrans.FTOT_Concession = 0;
                                    onlinettrans.FTOT_Fine = 0;
                           ...
                           SqlDbType.Int, 500)
                                        ...
                                        var waivedofffine = (from a in _FeeGroupHeadContext.feeStudentWaivedOff
                                                             where (a.MI_Id == data.MI_Id && a.ASMAY_Id == data.ASMAY_Id && a.FMA_Id == selecteditem[j].FMA_Id && a.AMST_Id == data.Amst_Id)
                                                             select new FeeStudentTransactionDTO
                                                             {
                                                                 FSS_WaivedAmount = a.FSWO_WaivedOffAmount,
                                                                 FSWO_FineFlg = a.FSWO_FineFlg,
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    onlinettrans.FMOT_Id = onlinemtrans.FMOT_Id;
                                    onlinettrans.FMA_Id = selecteditem[j].FMA_Id;
                                    onlinettrans.FTOT_Amount = selecteditem[j].FSS_ToBePaid;
                                    onlinettrans.FTOT_Created_date = indianTime;
                                    onlinettrans.FTOT_Updated_date = indianTime;
                                    onlinettrans.FTOT_Concession = 0;
                                    onlinettrans.FTOT_Fine = 0;
        ...
        public FeeStudentTransactionDTO get_grp_reptnoreadmission(FeeStudentTransactionDTO data)
        {
            try
            {
                var dynamicrecgen = new List<dynamic>();
        ...
        public async Task<FeeStudentTransactionDTO> EasebuzzPaymentPendingReceipts(FeeStudentTransactionDTO data)

        {
            try
            {
                ...
                var Transactionlog = _FeeGroupHeadContext.Fee_M_Online_TransactionDMO.Where(t => t.FMOT_Date.Date.ToString() == "2023-08-18" && t.MI_Id == data.MI_Id).ToList();

                if (Transactionlog.Count > 0)
                {
                    foreach (var i in Transactionlog)
                    {
                        var receiptdetails = _FeeGroupHeadContext.FeePaymentDetailsDMO.Where(t => t.MI_Id == data.MI_Id && t.FYP_Date.Date.ToString() == "2023-08-18" && t.FYP_Bank_Or_Cash == "O" && t.fyp_transaction_id == i.FMOT_Trans_Id).ToList();



                        if (receiptdetails.Count == 0 || receiptdetails == null)
                        {

                            var studentdet = _FeeGroupHeadContext.School_Adm_Y_StudentDMO.Where(t => t.AMST_Id == i.AMST_Id && t.ASMAY_Id == i.ASMAY_ID).ToList();
                            var studentdetails = _FeeGroupHeadContext.Adm_M_Student.Where(t => t.AMST_Id == i.AMST_Id).ToList();
                            List<Fee_PaymentGateway_DetailsDMO> paymentdetails = new List<Fee_PaymentGateway_DetailsDMO>();
                            if (studentdet.Count > 0)
                            {
                                ...
                                if (readterms.IVRMGC_Classwise_Payment != "1")
                                {
                                    paymentdetails = _FeeGroupHeadContext.Fee_PaymentGateway_Details.Where(t => t.MI_Id == data.MI_Id && t.FPGD_PGName == "EASEBUZZ").Distinct().ToList();
                                ...
                                else
                                {
                                    var onlinepayment = (from a in _FeeGroupHeadContext.Fee_OnlinePayment_Mapping
                                                         ...
                                                         from c in _FeeGroupHeadContext.Fee_PaymentGateway_Details
                                                         where (a.fpgd_id == c.FPGD_Id && c.FPGD_PGName == "EASEBUZZ" && a.MI_Id == data.MI_Id && a.ASMCL_Id == studentdet[0].ASMCL_Id)
                                                         select new FeeStudentTransactionDTO
                                                         {
                                                             FPGD_SubMerchantId = c.FPGD_SubMerchantId
                                                         }
                                    ...
                                    if (onlinepayment.Count > 0)
                                    {
                                        ...
                                        paymentdetails = _FeeGroupHeadContext.Fee_PaymentGateway_Details.Where(t => t.MI_Id == data.MI_Id && t.FPGD_PGName == "EASEBUZZ" && t.FPGD_SubMerchantId == onlinepayment[0].FPGD_SubMerchantId).Distinct().ToList();
                                ...
                                string strForm = secret + "|" + i.FMOT_Trans_Id + "|" + i.FMOT_Amount.ToString() + "|" + studentdetails[0].AMST_emailId + "|" + studentdetails[0].AMST_MobileNo.ToString() + "|" + key;
                                string hash = SHA512Alg(strForm);
                                ...
                                {
                                    Method = System.Net.Http.HttpMethod.Post,
                                    RequestUri = new Uri("https://dashboard.easebuzz.in/transaction/v1/retrieve"),
                                    Headers =
    {
        { "Accept", "application/json" },
                                    ...
                                    Content = new FormUrlEncodedContent(new Dictionary<string, string>
    {
        { "txnid",  i.FMOT_Trans_Id },
        { "key", key },
        { "amount", i.FMOT_Amount.ToString() },
        { "email",  studentdetails[0].AMST_emailId},
        { "phone",  studentdetails[0].AMST_MobileNo.ToString() },
        { "hash", hash1 },
    }),
                                };
