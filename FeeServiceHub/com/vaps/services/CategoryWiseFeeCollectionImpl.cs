...
{
    public class CategoryWiseFeeCollectionImpl : interfaces.CategoryWiseFeeCollectionInterface
    {
        public FeeGroupContext _FeeGroupContext;

        public CategoryWiseFeeCollectionImpl(FeeGroupContext frgContext)
        {
        ...
        public async Task<CategoryWiseFeeCollectionDTO> radiobtndata([FromBody] CategoryWiseFeeCollectionDTO temp)
        {
            ...
            {
                cmd.CommandText = "Classcategorywiseamtdetails";
