...
{
    public class ExamCalculation_SSSEDTO
    {
        ...
        public Array Feetermlist { get; set; }
        public Array Feegrouplist { get; set; }
        public string flag { get; set; }
        public int roleid { get; set; }
        public string rolename { get; set; }
        public int ESTMP_PublishToStudentFlg { get; set; }
        public int ESTMPP_PublishToStudentFlg { get; set; }
        public bool retuvrnvalflag { get; set; }
        public bool retuvrnvalpublishflag { get; set; }
        public long lastdateprocess { get; set; }
        public long publishmarksdate { get; set; }
        public bool publishbtn { get; set; }
        public bool markscalculatedflag { get; set; }
        public bool markslastdateflag { get; set; }
        ...
        public bool? feeinstallmentcheckbox { get; set; }
        public bool? Deactive_Flag { get; set; }
        public bool? Left_Flag { get; set; }
        public selectedstudentsmarks[] selectedstudentsmarks { get; set; }
        public long[] TempGroupList { get; set; }
    }

    public class selectedstudentsmarks
    {
        public long AMST_Id { get; set; }
        public int ESTMP_Id { get; set; }
        public string AMST_FirstName { get; set; }
