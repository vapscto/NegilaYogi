...
{
    public class CLGStudentRouteMappingReportDTO
    {
        ...
        public CLGStudentRouteMappingReportDTO[] semidlist { get; set; }
        public CLGStudentRouteMappingReportDTO[] secidlist { get; set; }
