...
{
    public class ClgLiveMeetingScheduleDTO
    {
        ...
        public courseiddto[] selectedcourse_list { get; set; }
        ...
        public branchiddto[] selectedbranch { get; set; }
        public seciddto1[] secids { get; set; }
        public semiddto[] selectedsem { get; set; }
    ...
    public class semiddto
    {
        public long AMSE_Id { get; set; }
        public string AMSE_SEMCode { get; set; }

    }
    public class seciddto1 {
        public long ACMS_Id { get; set; }
        public string ACMS_SectionCode { get; set; }
