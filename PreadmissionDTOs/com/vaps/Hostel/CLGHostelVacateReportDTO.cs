...
{
    public class CLGHostelVacateReportDTO
    {
        //student
        ...
        public SelectedHostellst_DTO[] SelectedHostellist { get; set; }
        public Studentlst_DTO[] SelectedStudentlist { get; set; }
        public stafflst_DTO[] Selectedstafflist { get; set; }
        public guestlst_DTO[] Selectedguestlist { get; set; }
    }
    public class SelectedHostellst_DTO
    {
        public long HLMH_Id { get; set; }
    }
    public class Studentlst_DTO
    {
        public long AMCST_Id { get; set; }
    }
    public class stafflst_DTO
    {
        public long HRME_Id { get; set; }
    }
    public class guestlst_DTO
    {
        public long HLHGSTALT_Id { get; set; }
    }
}
