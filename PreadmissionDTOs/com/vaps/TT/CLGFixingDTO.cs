...
namespace PreadmissionDTOs.com.vaps.TT
{
    public class CLGFixingDTO
    {
        ...
        public CLGFixingDTO[] all_fix_day_staff_list { get; set; }
        public CLGFixingDTO[] all_fix_day_subject_list { get; set; }
        
        public CLGFixingDTO[] all_fix_period_staff_list { get; set; }
        public CLGFixingDTO[] all_fix_period_subject_list { get; set; }

        public CLGFixingDTO[] TempararyArrayList { get; set; }
       // public CLGFixingDTO[] all_period_distri_list { get; set; }
        ...
        public CLGFixingDTO[] TempararyArray { get; set; }

        public CLGFixingDTO[] All_list { get; set; }
        public CLGFixingDTO[] Temp_class_Array { get; set; }
