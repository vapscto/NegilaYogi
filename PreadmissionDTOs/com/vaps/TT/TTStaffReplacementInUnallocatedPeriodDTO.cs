...
{
    public class TTStaffReplacementInUnallocatedPeriodDTO
    {

        public bool returnval_cls_notfree { get; set; }
        ...
        public TTStaffReplacementInUnallocatedPeriodDTO[] Time_Table { get; set; }
