...
{
    public class CLGRoomMappingDTO
    {
        ...
        public Array perioddetails { get; set; }
        public Array existingperioddetails { get; set; }
        ...
        public Array facilitylist { get; set; }
        ...
        public CLGManualperiodinsertionDTO[] periods { get; set; }
        public CLGRoomMappingDTO[] savedata { get; set; }
