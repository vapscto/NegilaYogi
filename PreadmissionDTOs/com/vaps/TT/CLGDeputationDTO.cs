...
namespace PreadmissionDTOs.com.vaps.TT
{
    public class CLGDeputationDTO
    {
        ...
        public Array absentdpcountall { get; set; }
        ...
        public CLGDeputationDTO[] staffarray { get; set; }
        public CLGDeputationDTO[] subarray { get; set; }

        public CLGDeputationDTO[] TT { get; set; }
