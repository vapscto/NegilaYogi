...
namespace ExamServiceHub.com.vaps.Controllers
{
    ...
    public class VikasaMinorPregressExamReportFacadeController : Controller
    {
        public VikasaMinorPregressExamReportInterface _PCReportContext;

        public VikasaMinorPregressExamReportFacadeController(VikasaMinorPregressExamReportInterface dt)
        {
            _PCReportContext = dt;
        }
