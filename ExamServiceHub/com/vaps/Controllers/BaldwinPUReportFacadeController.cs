...
namespace ExamServiceHub.com.vaps.Controllers
{
    ...
    public class BaldwinPUReportFacadeController : Controller
    {
        public BaldwinPUReportInterface _BaldwinAllReport;

        public BaldwinPUReportFacadeController(BaldwinPUReportInterface data)
        {
