...
namespace ExamServiceHub.com.vaps.Controllers
{
    ...
    public class VikasaSchoolTermWiseSubjectCumulativeReportFacadeController : Controller
    {
        public VikasaSchoolTermWiseSubjectCumulativeReportInterface _ReportContext;

        public VikasaSchoolTermWiseSubjectCumulativeReportFacadeController(VikasaSchoolTermWiseSubjectCumulativeReportInterface dt)
        {
            _ReportContext = dt;
        }
