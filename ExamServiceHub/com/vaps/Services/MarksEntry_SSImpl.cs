...
{
    public class MarksEntry_SSImpl : MarksEntry_SSInterface
    {
        public ExamContext _examcontext;
        public DomainModelMsSqlServerContext _db;
        ILogger<MarksEntryImpl> _acdimpl;
        public MarksEntry_SSImpl(ExamContext ttcategory, DomainModelMsSqlServerContext db)
        {
            _examcontext = ttcategory;
            _db = db;
        }
        public MarksEntry_SSDTO getdetails(MarksEntry_SSDTO data)
        {
            //MarksEntry_SSDTO data = new MarksEntry_SSDTO();
            try
            {
        ...
        public MarksEntry_SSDTO get_classes(MarksEntry_SSDTO data)
        {
            try
            {
        ...
        public MarksEntry_SSDTO get_sections(MarksEntry_SSDTO data)
        {
        ...
        public MarksEntry_SSDTO get_exams(MarksEntry_SSDTO data)
        {
            //ExamMarksDTO data = new ExamMarksDTO();
            try
            {
        ...
        public MarksEntry_SSDTO get_subjects(MarksEntry_SSDTO data)
        {
            //ExamMarksDTO data = new ExamMarksDTO();
            try
            {
        ...
        public MarksEntry_SSDTO onsearch(MarksEntry_SSDTO data)
        {
            try
            {
                ...
                studentList = (from e in _examcontext.Adm_M_Student
                               ...
                               select new temp_marks_DTO//MarksEntry_SSDTO
                               {
                                   AMST_Id = e.AMST_Id,
                ...
                data.studentList = studentList.Where(t => stu_list_mapped.Contains(t.AMST_Id)).Distinct().OrderBy(t => t.AMAY_RollNo).ToArray();
                 ...
                 if (alrdy_stu_count > 0 && data.EYCES_SubSubjectFlg)
                {
        ...
        public MarksEntry_SSDTO SaveMarks(MarksEntry_SSDTO data)
        {
            try
            {
