...
{
    public class MarksEntry_SImpl : MarksEntry_SInterface
    {
        public ExamContext _examcontext;
        public DomainModelMsSqlServerContext _db;
        ILogger<MarksEntryImpl> _acdimpl;
        public MarksEntry_SImpl(ExamContext ttcategory, DomainModelMsSqlServerContext db)
        {
        ...
        {
            //MarksEntry_SDTO data = new MarksEntry_SDTO();
            try
            {
        ...
        public MarksEntry_SDTO get_classes(MarksEntry_SDTO data)
        {
        ...
        public MarksEntry_SDTO get_sections(MarksEntry_SDTO data)
        {
        ...
        public MarksEntry_SDTO get_exams(MarksEntry_SDTO data)
        {
            //ExamMarksDTO data = new ExamMarksDTO();
            try
            {
        ...
        public MarksEntry_SDTO get_subjects(MarksEntry_SDTO data)
        {
            //ExamMarksDTO data = new ExamMarksDTO();
            try
            {
        ...
        public MarksEntry_SDTO onsearch(MarksEntry_SDTO data)
        {
            ...
            try
            {
                ...
                //data.marksdeleteflag = MarksCalcReset.MarksCalculationResetFlag(data.ASMAY_Id, data.ASMCL_Id, data.ASMS_Id, data.MI_Id, data.EME_Id);
                ...
                studentList = (from e in _examcontext.Adm_M_Student
                               ...
                               select new temp_marks_DTO//MarksEntry_SDTO
                               {
                                   AMST_Id = e.AMST_Id,
                ...
                if (alrdy_stu_count > 0 && !data.EYCES_SubSubjectFlg && !data.EYCES_SubExamFlg)
                {
                    ...
                    //data.saved_s_list = (from a in _examcontext.Exm_Student_Marks_SubSubjectDMO
                    //                        from b in stu_marks
                ...
                //{
                //    data.studentList = (from e in _examcontext.Adm_M_Student
                //                        from i in _examcontext.ExamMarksDMO
                //                        from f in _examcontext.School_Adm_Y_StudentDMO
                //                        from g in _examcontext.IVRM_School_Master_SubjectsDMO
                //                        from h in _examcontext.Exm_Yrly_Cat_Exams_SubwiseDMO
                //                        from j in subject_details
                //                        from k in _examcontext.StudentMappingDMO
                //                        where (e.AMST_Id == f.AMST_Id  && f.ASMCL_Id == data.ASMCL_Id && f.ASMS_Id == data.ASMS_Id && f.ASMAY_Id == data.ASMAY_Id && e.MI_Id == data.MI_Id && e.AMST_ActiveFlag == 1 && e.AMST_SOL == "S" && f.AMAY_ActiveFlag == 1 && g.ISMS_Id == h.ISMS_Id  && g.MI_Id == data.MI_Id && g.ISMS_ActiveFlag == 1 && g.ISMS_ExamFlag == 1 && g.ISMS_Id == data.ISMS_Id && g.ISMS_Id == data.ISMS_Id && h.EYCE_Id == j.EYCE_Id && i.MI_Id == data.MI_Id && i.ASMAY_Id == data.ASMAY_Id && i.ASMCL_Id == data.ASMCL_Id && i.ASMS_Id == data.ASMS_Id && i.ISMS_Id == data.ISMS_Id && i.EME_Id == data.EME_Id && i.AMST_Id == e.AMST_Id && k.MI_Id == data.MI_Id && k.ASMAY_Id == data.ASMAY_Id && k.ASMCL_Id == data.ASMCL_Id && k.ASMS_Id == data.ASMS_Id && k.ISMS_Id == data.ISMS_Id && k.AMST_Id == f.AMST_Id)
                //                        select new MarksEntry_SDTO
                //                        {
                //                            AMST_Id = e.AMST_Id,
                //                            AMST_FirstName = ((e.AMST_FirstName == null ? " " : e.AMST_FirstName) + " " + (e.AMST_MiddleName == null ? " " : e.AMST_MiddleName) + " " + (e.AMST_LastName == null ? " " : e.AMST_LastName)).Trim(),
        ...
        public MarksEntry_SDTO SaveMarks(MarksEntry_SDTO data)
        {
