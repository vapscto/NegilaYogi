...
namespace CollegePortals.com.Staff.Controllers
{
    ...
    public class ClgStudentAttendanceFacade : Controller
    {
        public ClgStudentAttendanceInterface _ads;

        public ClgStudentAttendanceFacade(ClgStudentAttendanceInterface adstu)
        {
            _ads = adstu;
        }
