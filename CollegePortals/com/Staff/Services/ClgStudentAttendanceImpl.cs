...
{
    public class ClgStudentAttendanceImpl : Interfaces.ClgStudentAttendanceInterface
    {
        ...
        public ClgStudentAttendanceImpl(CollegeportalContext ClgPortalContext)
        {
        ...
        public async Task<ClgPortalAttendanceDTO> getreport(ClgPortalAttendanceDTO data)
        {
            try
            {
                using (var cmd = _ClgPortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "CLG_PORTAL_STAFF_STUDENT_ATTENDANCE";
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    try
                    {
                        ...
                        data.attendancereport = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
