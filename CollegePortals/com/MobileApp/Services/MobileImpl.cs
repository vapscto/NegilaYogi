...
{
    public class MobileImpl : Interfaces.MobileInterface
    {
        ...
        ILogger<MobileImpl> _acdimpl;
        public DomainModelMsSqlServerContext _db;
        public CollegeportalContext _CLGPortalContext;
        public MobileImpl(PortalContext cpContext, CollegeportalContext CLGPortalContext, DomainModelMsSqlServerContext db)
        {
        ...
        public AdmissionDTO.ttGetStudent getStudentTT(AdmissionDTO.ttGetStudent data)
        {
            ...
            try
            {
                ...
                //data.getStudentTT = (from a in _PortalContext.TT_Master_DayDMO
                //                     from b in _PortalContext.TT_Master_PeriodDMO
                //                     from c in _PortalContext.School_M_Class
                //                     from d in _PortalContext.School_M_Section
                //                     from e in _PortalContext.TT_Master_Subject_AbbreviationDMO
                //                     from f in _PortalContext.TT_Master_Staff_AbbreviationDMO
                //                     from g in _PortalContext.TT_Final_GenerationDMO
                //                     from h in _PortalContext.TT_Final_Generation_DetailedDMO
                //                     from ii in _PortalContext.TTMasterCategoryDMO
        ...
        public AdmissionDTO.daywiseTimetable clgdaywiseTimetable(AdmissionDTO.daywiseTimetable data)
        {
            try
            {
                ...
                using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "CollegeDashboard_timetable_daywise";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.ClgdaywiseTimeTableList = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public async Task<AdmissionDTO.CollegeUserDashboardDetails> CollegeUserDashboardDetails(AdmissionDTO.CollegeUserDashboardDetails data)
        {
            try
            {
                if (data.RoleType == "Student")
                {
                    ...
                    data.yearlist = _PortalContext.AcademicYearDMO.Where(a => a.MI_Id == data.MI_Id && a.Is_Active == true).OrderByDescending(a => a.ASMAY_Order).ToArray();

                    #region Course Branch & Semester Id


                    var ids = (from a in _PortalContext.Adm_Master_College_StudentDMO
                               ...
                               select new AdmissionDTO.CollegeUserDashboardDetails
                               {
                                   AMCST_Id = a.AMCST_Id,
                                   AMCO_Id = b.AMCO_Id,
                                   AMB_Id = b.AMB_Id,
                    ...
                    using (var cmd1 = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                  ...
                  SqlDbType.BigInt)
                    ...
                    #region Student Birthday list
                    using (var cmd1 = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd1.CommandText = "StdCollegeDashboardBirthdayDetails";
                        cmd1.CommandType = CommandType.StoredProcedure;
                  ...
                  SqlDbType.BigInt)
                    ...
                    using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "CLG_Portal_ExamDetails";
                        cmd.CommandType = CommandType.StoredProcedure;
                  ...
                  SqlDbType.BigInt)
                    ...
                    #region TimeTable Details


                    using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "CLG_Portal_TimeTableDetails";
                        cmd.CommandType = CommandType.StoredProcedure;
                  ...
                  SqlDbType.BigInt)
                    ...
                    using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "COE_CollegeEvents_Details";
                        cmd.CommandType = CommandType.StoredProcedure;
                  ...
                  SqlDbType.BigInt)
                        ...
                        try
                        {
                            ...
                            data.libraryList = retObject.ToArray();
                        }
                        catch (Exception ex)
                        {
                            Console.WriteLine(ex.Message);
                    ...
                    if (Staffmobileappprivileges.Count() > 0)
                    {
                        ...
                        //                                 where (Mobilepage.IVRMMAP_AnalyticalFlag == true && Mobilepage.IVRMMAP_Id == MobileRolePrivileges.IVRMMAP_Id && MobileRolePrivileges.IVRMRT_Id == data.roleId && MobileRolePrivileges.MI_ID == data.MI_Id)
                ...
                else if (data.RoleType == "Manager" || data.RoleType == "Principal")
                {
        ...
        public AdmissionDTO.ExamLibararyDTO FineIsuuesRecipt(AdmissionDTO.ExamLibararyDTO data)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "CLG_Portal_LibraryDetails_MobileApp";
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        //LibraryDetails
        public AdmissionDTO.ExamLibararyDTO LibraryDetails(AdmissionDTO.ExamLibararyDTO data)
        {
            try
            {
           ...
           SqlDbType.VarChar)
            ...
            SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.MonthDetails = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public AdmissionDTO.CLGUserProfileDetailsDTO CollegeUserProfileDetails(AdmissionDTO.CLGUserProfileDetailsDTO data)
        {
            try
            {
                ...
                using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Collage_User_profileDetails";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
             SqlDbType.BigInt)
                    {
                ...
                {
                    var clssec1 = _PortalContext.Adm_College_Yearly_StudentDMO.Where(a => a.ASMAY_Id == data.ASMAY_Id && a.AMCST_Id == data.AMCST_Id && a.ACYST_ActiveFlag == 1).ToList();
                    ...
                    using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "Clg_Get_Teacherwise_Subject_Details";
                        cmd.CommandType = CommandType.StoredProcedure;
                 ...
                 SqlDbType.VarChar)
                    ...
                    SqlDbType.VarChar)
                        ...
                        try
                        {
                            ...
                            data.Subtechaer = retObject.ToArray();
                        }
                        catch (Exception ex)
                        {
                            Console.WriteLine(ex.Message);
        ...
        //NoticeBoadCollege
        public AdmissionDTO.NoticeBoadCollegeDto NoticeBoadCollege(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Student_Noticeboard_Details";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
                ...
                SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.NoticeBoardlist = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public AdmissionDTO.NoticeBoadCollegeDto StaffNoticeBoadCollege(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Staff_Noticeboard_Details";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
                ...
                SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.staffNoticeBoardlist = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public AdmissionDTO.NoticeBoadCollegeDto NoticeBoadCollegedatawise(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Student_Noticeboard_Datewise";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
              ...
              SqlDbType.DateTime)
                    ...
                    try
                    {
                        ...
                        data.NoticeBoardlistdatewsie = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public AdmissionDTO.NoticeBoadCollegeDto StaffNoticeBoadCollegedatawise(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Staff_Noticeboard_Detailsdatewise";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
              ...
              SqlDbType.DateTime)
                    ...
                    try
                    {
                        ...
                        data.StaffNoticeBoardlistdatewsie = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
        ...
        public AdmissionDTO.NoticeBoadCollegeDto NoticeBoadCollege_onclick(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Noticeboard_Onclick_Details";
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public AdmissionDTO.NoticeBoadCollegeDto StaffNoticeBoadCollege_onclick(AdmissionDTO.NoticeBoadCollegeDto data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "StaffClg_Noticeboard_Onclick_Details";
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<AdmissionDTO.ShortageOFAttandence> clg_shortageOfAttendanceAlert(AdmissionDTO.ShortageOFAttandence data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    ...
                    try
                    {
                        ...
                        data.clgstudentAttendanceList = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.Write(ex.Message);
        ...
        public AdmissionDTO.ClgTimeTable getdata(AdmissionDTO.ClgTimeTable dto)
        {
            try
            {
                var HRME_Id = _PortalContext.Staff_User_Login.Single(c => c.Id == dto.UserId && c.MI_Id == dto.MI_Id).Emp_Code;

                dto.TT_final_generation = (from a in _PortalContext.TT_Final_GenerationDMO
                                           from b in _PortalContext.CLGTT_Final_Generation_DetailedDMO
                                           from c in _PortalContext.MasterCourseDMO
                                           from d in _PortalContext.ClgMasterBranchDMO
                                           from e in _PortalContext.TT_Master_PeriodDMO
                                           from f in _PortalContext.TT_Master_DayDMO
                                           where (a.ASMAY_Id == dto.ASMAY_Id && a.TTFG_Id == b.TTFG_Id && a.MI_Id == dto.MI_Id && b.TTMP_Id == e.TTMP_Id && b.AMCO_Id == c.AMCO_Id && c.MI_Id == dto.MI_Id && d.AMB_ActiveFlag == true && d.AMB_Id == b.AMB_Id && b.TTMD_Id == f.TTMD_Id && b.HRME_Id == HRME_Id && a.ASMAY_Id == dto.ASMAY_Id)
                                           select new
                                           {
                                               DayName = f.TTMD_DayName,
                                               PeriodCount = e.TTMP_PeriodName.Count()
                                           }).Distinct().GroupBy(f => f.DayName).Select(g => new AdmissionDTO.ClgTimeTable { DayName = g.Key, PeriodCount = g.Count() }).ToArray();


                dto.allperiods = _PortalContext.TT_Master_DayDMO.Where(c => c.TTMD_ActiveFlag == true && c.MI_Id == dto.MI_Id).ToArray();

                dto.periods = _PortalContext.TT_Master_PeriodDMO.Where(c => c.TTMP_ActiveFlag.Equals(true) && c.MI_Id.Equals(dto.MI_Id)).ToArray();



                using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "CLG_TT_class_sections";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
               SqlDbType.VarChar)
                    {
        ...
        public AdmissionDTO.ClgTimeTable clggetdaily_data(AdmissionDTO.ClgTimeTable dto)
        {
            try
            {
               var HRME_Id = _PortalContext.Staff_User_Login.Single(c => c.Id == dto.UserId && c.MI_Id == dto.MI_Id).Emp_Code;
                ...
                dto.TT_final_generation = (from a in _PortalContext.TT_Final_GenerationDMO
                                           ...
                                           where (a.ASMAY_Id == dto.ASMAY_Id && a.TTFG_Id == b.TTFG_Id && a.MI_Id == dto.MI_Id && b.TTMP_Id == e.TTMP_Id && b.AMCO_Id == c.AMCO_Id && c.MI_Id == dto.MI_Id && d.AMB_ActiveFlag == true && d.AMB_Id == b.AMB_Id && b.TTMD_Id == f.TTMD_Id && b.HRME_Id == HRME_Id && a.ASMAY_Id == dto.ASMAY_Id && f.TTMD_Id == dto.TTMD_Id)
                                           select new
                                           {
                                               AMCO_CourseName = c.AMCO_CourseName,
                                               AMB_BranchName = d.AMB_BranchName,
                                               PeriodCount = e.TTMP_PeriodName.Count()
                                           }).Distinct().GroupBy(c => new { c.AMCO_CourseName, c.AMB_BranchName }).Select(g => new AdmissionDTO.ClgTimeTable { AMCO_CourseName = g.Key.AMCO_CourseName, AMB_BranchName = g.Key.AMB_BranchName, PeriodCount = g.Count() }).ToArray();


                using (var cmd = _CLGPortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "CLG_TTEmployee_class_sections";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
               SqlDbType.VarChar)
                    {
        ...
        //
        public AdmissionDTO.CLGgetstudent CLGstdFeeDue(AdmissionDTO.CLGgetstudent data)
        {
            try
            {
                using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "CLG_FEE_Balance_Amount_Show_in_portal";
                    cmd.CommandType = CommandType.StoredProcedure;
             ...
             SqlDbType.VarChar)
                ...
                if (data.getstudentdetails.Length > 0)
                {
                    ...
                    using (var cmd = _PortalContext.Database.GetDbConnection().CreateCommand())
                    {
                        ...
                        cmd.CommandText = "CLG_StudentportalFeeDue";
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public AdmissionDTO.clgfeedbackDetailsDTO clgfeedbackDetails(AdmissionDTO.clgfeedbackDetailsDTO data)
        {
            try
            {
                ...
                using (var cmd = _db.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Clg_Student_Feedback_Transaction";
                    cmd.CommandType = CommandType.StoredProcedure;
              ...
              SqlDbType.BigInt)
                    ...
                    try
                    {
                        ...
                        data.feedbackdetails = retObject.ToArray();
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.Message);
