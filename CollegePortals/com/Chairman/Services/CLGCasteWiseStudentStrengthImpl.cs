...
{
    public class CLGCasteWiseStudentStrengthImpl : Interfaces.CLGCasteWiseStudentStrengthInterface
    {
        ...
        public CLGCasteWiseStudentStrengthImpl(CollegeportalContext ClgPortalContext)
        {
        ...
        public async Task<CLGCHStudentStrengthDTO> Getdetails(CLGCHStudentStrengthDTO data)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "CLG_CHAIRMAN_CASTEWISE_STUDENT_STRENGTH";
