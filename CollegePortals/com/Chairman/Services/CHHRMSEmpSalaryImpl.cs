...
{
    public class CHHRMSEmpSalaryImpl : Interfaces.CHHRMSEmpSalaryInterface
    {
        ...
        public CHHRMSEmpSalaryImpl(CollegeportalContext ClgPortalContext)
        {
        ...
        public async Task<CHHRMSEmpSalaryDTO> Getdetails(CHHRMSEmpSalaryDTO data)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "CLG_CHAIRMAN_MONTHWISE_SALARY";
