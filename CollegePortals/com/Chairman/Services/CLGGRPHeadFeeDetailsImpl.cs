...
{
    public class CLGGRPHeadFeeDetailsImpl : Interfaces.CLGGRPHeadFeeDetailsInterface
    {
        ...
        public CLGGRPHeadFeeDetailsImpl(CollegeportalContext ClgPortalContext)
        {
        ...
        public async Task<CLGGRPHeadFeeDetailsDTO> Getdetails(CLGGRPHeadFeeDetailsDTO data)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "CLG_CHAIRMAN_GRP_HEAD_FEE_DETAILS";
