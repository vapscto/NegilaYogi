...
{
    public class Naac_MC_CR4_Impl:Interface.Naac_MC_CR4_Interface
    {

        public GeneralContext _context;
        public DocumentsContext _DocumentsContext;
        public Naac_MC_CR4_Impl(GeneralContext w, DocumentsContext o)
        {
            _context = w;
            _DocumentsContext = o;
        }
        ...
        public async Task<Naac_MC_CR4_DTO> Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                   // cmd.CommandText = "Naac_MED_Budget_414_report";
                    cmd.CommandText = "Naac_Medical_414_Report";
                   ...
                   SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.reportlist2 = (from a in _context.NAAC_AC_414_Budget_Files_DMO
        ...
        public async Task<Naac_MC_CR4_DTO> InOutPatientReport(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                   // cmd.CommandText = "Naac_MED_InOutPatient_422_report";
                    cmd.CommandText = "Naac_Medical_422_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
                   ...
                   SqlDbType.VarChar)
                    ...
                    try
                    {
                        ...
                        data.reportlist2 = (from a in _context.NAAC_MC_422_Clinical_Laboratory_files_DMO
                                            from b in _context.NAAC_MC_422_Clinical_Laboratory_DMO
                                            where (mid.Contains(b.MI_Id) && b.NCMC422CL_Id == a.NCMC422CL_Id)
                                            select a).Distinct().ToArray();
                    }
                    catch (Exception ex)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> Membership433Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                   // cmd.CommandText = "Naac_MED_Membership_433_report";
                    cmd.CommandText = "Naac_Medical_433_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> MedExpenditure434Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                   // cmd.CommandText = "Naac_MED_Expenditure_434_report";
                    cmd.CommandText = "Naac_Medical_434_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> Econtent436Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Naac_Medical_436_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> PhyAcaFacility451Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                  //  cmd.CommandText = "Naac_MED_PhyAcaFacility_451_report";
                    cmd.CommandText = "Naac_Medical_451_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> ClassSeminarhall441Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                  //  cmd.CommandText = "Naac_MED_ClassSeminarhall_451_report";
                    cmd.CommandText = "Naac_Medical_441_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> BandwidthRangeReport(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
        ...
        public async Task<Naac_MC_CR4_DTO> InfrastructureReport(Naac_MC_CR4_DTO data)
        {
            try
            {
                string mi_ids = "0";
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Naac_Medical_424_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
        ...
        public async Task<Naac_MC_CR4_DTO> MEDStudentExposed423Report(Naac_MC_CR4_DTO data)
        {
            try
            {
                List<long> mid = new List<long>();
                ...
                using (var cmd = _DocumentsContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "Naac_Medical_423_Report";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@MI_Id",
                    SqlDbType.VarChar)
                    {
