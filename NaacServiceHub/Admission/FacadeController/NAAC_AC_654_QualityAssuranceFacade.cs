...
namespace NaacServiceHub.Admission.FacadeController
{
    ...
    public class NAAC_AC_654_QualityAssuranceFacade : Controller
    {
        public NAAC_AC_654_QualityAssuranceInterface _Interface;
        public NAAC_AC_654_QualityAssuranceFacade(NAAC_AC_654_QualityAssuranceInterface q)
        {
            _Interface = q;
        }
