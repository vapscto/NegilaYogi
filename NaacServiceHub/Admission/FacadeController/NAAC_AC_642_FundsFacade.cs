...
namespace NaacServiceHub.Admission.FacadeController
{
    ...
    public class NAAC_AC_642_FundsFacade : Controller
    {
        public NAAC_AC_642_FundsInterface _Interface;
        public NAAC_AC_642_FundsFacade(NAAC_AC_642_FundsInterface q)
        {
            _Interface = q;
        }
