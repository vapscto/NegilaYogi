...
namespace NaacServiceHub.University.FacadeController
{
    ...
    public class NAAC_HSU_StudentComplaints252Facade : Controller
    {
        public NAAC_HSU_StudentComplaints252Interface inter;
        public NAAC_HSU_StudentComplaints252Facade(NAAC_HSU_StudentComplaints252Interface q)
        {
            inter = q;
        }

        [Route("loaddata")]
        public NAAC_HSU_StudentComplaints252_DTO loaddata([FromBody] NAAC_HSU_StudentComplaints252_DTO data)
        {
