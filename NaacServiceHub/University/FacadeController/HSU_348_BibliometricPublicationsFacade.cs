...
namespace NaacServiceHub.University.FacadeController
{
    ...
    public class HSU_348_BibliometricPublicationsFacade : Controller
    {
        public HSU_348_BibliometricPublicationsInterface _inter;
        public HSU_348_BibliometricPublicationsFacade(HSU_348_BibliometricPublicationsInterface i)
        {
            _inter = i;
        }
