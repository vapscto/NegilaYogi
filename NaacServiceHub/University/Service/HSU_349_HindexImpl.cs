...
{
    public class HSU_349_HindexImpl:Interface.HSU_349_HindexInterface
    {
        public GeneralContext _context;
        public HSU_349_HindexImpl(GeneralContext y)
        {
            _context = y;
        }
            ...
            try
            {
                ...
                data.alldata1 = (from a in _context.Academic
                                 ...
                                 select new HSU_346_EMPApprovedJournalList_DTO
                                 {
                                     ...
                                     NCHSU346EAJL_ISTHIndex = b.NCHSU346EAJL_ISTHIndex,
            ...
            try
            {
                if (data.NCHSU346EAJL_Id == 0)
                {
                    ...
                    else
                    {
                        ...
                        rrr.NCHSU346EAJL_ISTHIndex = data.NCHSU346EAJL_ISTHIndex;
                ...
                else if (data.NCHSU346EAJL_Id > 0)
                {
                    ...
                    else
                    {
                        ...
                        yy.NCHSU346EAJL_ISTHIndex = data.NCHSU346EAJL_ISTHIndex;                       
