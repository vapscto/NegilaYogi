...
namespace NaacServiceHub.HRMS.Facade
{
    ...
    public class naacHrmsDetailsFacadeController : Controller
    {

        public naacHrmsDetailsInterface _interface;

        public naacHrmsDetailsFacadeController(naacHrmsDetailsInterface inte)
        {
            _interface = inte;
        }
