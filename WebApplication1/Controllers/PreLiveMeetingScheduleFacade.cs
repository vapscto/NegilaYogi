...
namespace WebApplication1.Controllers
{
    ...
    public class PreLiveMeetingScheduleFacade : Controller
    {

        public PreLiveMeetingScheduleInterface _org;
        private readonly DomainModelMsSqlServerContext _db;
        private readonly ILogger<PreLiveMeetingScheduleInterface> _log;
        public PreLiveMeetingScheduleFacade(PreLiveMeetingScheduleInterface org, DomainModelMsSqlServerContext db, ILogger<PreLiveMeetingScheduleInterface> loggerFactor)
        {
            _org = org;
            _db = db;
            _log = loggerFactor;
        ...
        public JsonResult getdata([FromQuery]string meetingID,bool recordingmarks)
        {
            ...
            {
                var userid = meeting.FirstOrDefault().User_Id;
                ...
                var resss = _db.LMS_Live_Meeting_PAStudentDMO.Where(e => e.LMSLMEET_Id == meeting.FirstOrDefault().LMSLMEET_Id && (e.LMSLMEETPASTD_LoginTime!=null && e.LMSLMEETPASTD_LoginTime!="")).ToList();
                foreach (var item in resss)
                {
                    ...
                    item.LMSLMEETPASTD_UpdatedBy = userid;
        ...
        public LiveMeetingScheduleDTO onschedulecahnge([FromBody] LiveMeetingScheduleDTO data)
        {
        ...
        [Route("saveremarks")]
        public LiveMeetingScheduleDTO saveremarks([FromBody] LiveMeetingScheduleDTO data)
        {
