...
namespace WebApplication1.Controllers
{
    ...
    public class StudentDetailsFacadeController : Controller
    {
        public StudentDetailsInterface _report;
        public StudentDetailsFacadeController(StudentDetailsInterface _screport)
        {
            _report = _screport;
        }
        // GET: api/values
