...
namespace WebApplication1.Controllers
{
    ...
    public class MeritListReportFacadeController : Controller
    {
        public MeritListReportInterface _report;
        public MeritListReportFacadeController(MeritListReportInterface _screport)
        {
            _report = _screport;
        }
        // GET: api/values
