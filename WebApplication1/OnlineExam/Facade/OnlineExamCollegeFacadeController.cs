...
namespace WebApplication1.Controllers
{
    ...
    public class OnlineExamCollegeFacadeController : Controller
    {
        public OnlineExamCollegeInterface _oei;
        public OnlineExamCollegeFacadeController(OnlineExamCollegeInterface oei)
        {
            _oei = oei;
        }
        [HttpPost]
