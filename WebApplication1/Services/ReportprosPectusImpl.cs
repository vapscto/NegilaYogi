...
{
    public class ReportProspectusImpl : Interfaces.ReportProspectusInterface
    {
        private static ConcurrentDictionary<string, StudentDetailsDTO> _login =
         new ConcurrentDictionary<string, StudentDetailsDTO>();

        private readonly ReportProspectusContext _ReportProspectusContext;
        private readonly UserManager<ApplicationUser> _UserManager;

        public ReportProspectusImpl(ReportProspectusContext ReportProspectusContext, UserManager<ApplicationUser> UserManager)
        {
            _ReportProspectusContext = ReportProspectusContext;
