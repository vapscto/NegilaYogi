...
{
    public class CLGStudentRequestConfirmIMPL : Interface.CLGStudentRequestConfirmInterface
    {

        public HostelContext _HostelContext;
        public DomainModelMsSqlServerContext _dbcontext;
        public CLGStudentRequestConfirmIMPL(HostelContext para1, DomainModelMsSqlServerContext para2)
        {
