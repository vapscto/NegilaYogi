...
{
    public class ClgBirthdayImpl : Interfaces.ClgBirthdayInterface
    {
        int MI_ID = 0;
        ...
        public ClgBirthdayImpl(DomainModelMsSqlServerContext db, ClgBirthdayContext clgbdContext, ClgAdmissionContext ClgadmContext)
        {
            _db = db;
