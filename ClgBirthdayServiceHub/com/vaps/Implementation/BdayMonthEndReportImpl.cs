...
namespace ClgBirthdayServiceHub.com.vaps.Services
{
    public class BdayMonthEndReportImpl : Interfaces.BdayMonthEndReportInterface
    {
        ...
        public BdayMonthEndReportImpl(DomainModelMsSqlServerContext db, ClgBirthdayContext clgbdContext, ClgAdmissionContext abc)
        {
            _db = db;
