/*
 CanvasJS HTML5 & JavaScript Charts - v1.9.6 GA - https://canvasjs.com/ 
...
*/
(function () {
    function U(a, d) { a.prototype = Ra(d.prototype); a.prototype.constructor = a; a.base = d.prototype } function Ra(a) { function d() { } d.prototype = a; return new d } function Ia(a, d, b) {
        "millisecond" === b ? a.setMilliseconds(a.getMilliseconds() + 1 * d) : "second" === b ? a.setSeconds(a.getSeconds() + 1 * d) : "minute" === b ? a.setMinutes(a.getMinutes() + 1 * d) : "hour" === b ? a.setHours(a.getHours() + 1 * d) : "day" === b ? a.setDate(a.getDate() + 1 * d) : "week" === b ? a.setDate(a.getDate() + 7 * d) : "month" === b ? a.setMonth(a.getMonth() + 1 * d) : "year" === b && a.setFullYear(a.getFullYear() +
            1 * d); return a
    } function N(a, d) { var b = !1; 0 > a && (b = !0, a *= -1); a = "" + a; for (d = d ? d : 1; a.length < d;)a = "0" + a; return b ? "-" + a : a } function ma(a) { if (!a) return a; a = a.replace(/^\s\s*/, ""); for (var d = /\s/, b = a.length; d.test(a.charAt(--b));); return a.slice(0, b + 1) } function Sa(a) {
    ...
    } function Aa(a, d) { return a - d } function Ja(a, d) { return a.x - d.x } function D(a) { var d = ((a & 16711680) >> 16).toString(16), b = ((a & 65280) >> 8).toString(16); a = ((a & 255) >> 0).toString(16); d = 2 > d.length ? "0" + d : d; b = 2 > b.length ? "0" + b : b; a = 2 > a.length ? "0" + a : a; return "#" + d + b + a } function Ta(a, d) {
        var b = this.length >>> 0, c = Number(d) ||
            0, c = 0 > c ? Math.ceil(c) : Math.floor(c); for (0 > c && (c += b); c < b; c++)if (c in this && this[c] === a) return c; return -1
    } function x(a) { return null === a || "undefined" === typeof a } function sa(a) { a.indexOf || (a.indexOf = Ta); return a } function Ka(a, d, b) {
        b = b || "normal"; var c = a + "_" + d + "_" + b, f = La[c]; if (isNaN(f)) {
            try {
                a = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + a + "; font-size:" + d + "px; font-weight:" + b + ";"; if (!da) {
                    var g = document.body; da = document.createElement("span");
                    da.innerHTML = ""; var h = document.createTextNode("Mpgyi"); da.appendChild(h); g.appendChild(da)
                } da.style.display = ""; da.setAttribute("style", a); f = Math.round(da.offsetHeight); da.style.display = "none"
            } catch (l) { f = Math.ceil(1.1 * d) } f = Math.max(f, d); La[c] = f
        } return f
    } function F(a, d) {
    ...
    } function L(a, d, b, c) { if (a.addEventListener) a.addEventListener(d, b, c || !1); else if (a.attachEvent) a.attachEvent("on" + d, function (c) { c = c || window.event; c.preventDefault = c.preventDefault || function () { c.returnValue = !1 }; c.stopPropagation = c.stopPropagation || function () { c.cancelBubble = !0 }; b.call(a, c) }); else return !1 } function Ma(a, d, b) {
        a *= P; d *= P; a = b.getImageData(a, d, 2, 2).data; d = !0; for (b = 0; 4 > b; b++)if (a[b] !== a[b + 4] | a[b] !== a[b + 8] | a[b] !== a[b + 12]) { d = !1; break } return d ? a[0] <<
            16 | a[1] << 8 | a[2] : 0
    } function S(a, d, b) { return a in d ? d[a] : b[a] } function ta(a, d, b) { if (v && Na) { var c = a.getContext("2d"); ua = c.webkitBackingStorePixelRatio || c.mozBackingStorePixelRatio || c.msBackingStorePixelRatio || c.oBackingStorePixelRatio || c.backingStorePixelRatio || 1; P = Ba / ua; a.width = d * P; a.height = b * P; Ba !== ua && (a.style.width = d + "px", a.style.height = b + "px", c.scale(P, P)) } else a.width = d, a.height = b } function Ua(a) {
        if (!Oa) {
            var d = !1, b = !1; "undefined" === typeof ea.Chart.creditHref ? (a.creditHref = "/",
    ...
    } function va() { for (var a = null, d = 0; d < arguments.length; d++)a = arguments[d], a.style && (a.style.display = "inline") } function $() {
        for (var a = null, d = 0; d < arguments.length; d++)(a = arguments[d]) &&
            a.style && (a.style.display = "none")
    } function M(a, d, b, c) { this._defaultsKey = a; this.parent = c; this._eventListeners = []; c = {}; b && (ka[b] && ka[b][a]) && (c = ka[b][a]); this.options = d ? d : { _isPlaceholder: !0 }; this.setOptions(this.options, c) } function z(a, d) {
        ...
        theme1: {
            ...
            }, Na = !0, Ba = window.devicePixelRatio || 1, ua = 1, P = Na ? Ba / ua : 1, Oa = window && window.location && window.location.href && window.location.href.indexOf && -1 !== window.location.href.indexOf(""), Va = {
