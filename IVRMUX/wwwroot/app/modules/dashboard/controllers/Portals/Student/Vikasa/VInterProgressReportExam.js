...
(function () {
    ...
    angular
        .module('app')
        .controller('VikasaInterProgressReportExamController', VikasaInterProgressReportExamController)
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("VikasaProgressReportExam/savedetails", data).
                    then(function (promise) {
                        ...
                        //        if (promise.savelisttot.length > 0) {
                        //            $scope.datalist = promise.savelisttot;
                        ...
                        //                $scope.clastechname = "";
                        //            }
                        //            $scope.exam = promise.savelisttot[0].emE_ExamName;
