...
(function () {
    ...
    angular
        .module('app')
        .controller('ParentsSmartCardSTJMController', ParentsSmartCardSTJMController)

    ParentsSmartCardSTJMController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', '$window', 'superCache', '$compile']
    function ParentsSmartCardSTJMController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, $window, superCache, $compile) {
        ...
        $scope.onchange = function (studentlst) {
            ...
            apiService.create("ParentsSmartCard/getstudata", data).
                then(function (promise) {
                    ...
                    if ($scope.parent == 'S') {
                        $scope.DOb =new Date($scope.cardData[0].AMST_DOB);
                        $scope.words = $scope.cardData[0].AMST_DOB_Words;
                    ...
                    $scope.clsname = $scope.cardData[0].ASMCL_ClassName,
                        $scope.secname = $scope.cardData[0].ASMC_SectionName,
                        $scope.regno = $scope.cardData[0].AMST_RegistrationNo,
