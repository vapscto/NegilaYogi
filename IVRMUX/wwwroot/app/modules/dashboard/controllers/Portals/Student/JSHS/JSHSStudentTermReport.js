...
(function () {
    'use strict';
    angular.module('app').controller('JSHSStudentTermReportController', jSHSStudentTermReportController)
    jSHSStudentTermReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window']
    function jSHSStudentTermReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
        ...
        $scope.BindData = function () {
            var pageid = 2;
            apiService.getURI("JSHSStudentReports/Getdetails", pageid).then(function (promise) {
        ...
        $scope.onyearchange = function () {
            ...
            apiService.create("JSHSStudentReports/get_classes", data).then(function (promise) {
        ...
        $scope.onclasschange = function () {
            ...
            apiService.create("JSHSStudentReports/get_sections", data).then(function (promise) {
        ...
        $scope.onsectionchange = function () {
            ...
            apiService.create("JSHSStudentReports/get_students_category_grade", data).then(function (promise) {
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSStudentReports/get_reportdetails", data).then(function (promise) {
