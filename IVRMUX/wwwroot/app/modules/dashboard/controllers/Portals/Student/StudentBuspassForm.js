(function () {
    ...
    angular
        .module('app')
        .controller('StudentBuspassFormController', StudentBuspassFormController)

    StudentBuspassFormController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', '$compile']
    function StudentBuspassFormController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, $compile) {
        ...
        $scope.academicload = function () {
            apiService.getDATA("StudentBuspassForm/academicload").
        ...
        $scope.onloadmodal = function () {
            apiService.getURI("StudentBuspassForm/getloaddataintruction",$scope.ASMAY_Id).
                then(function (promise) {
                    debugger;
        ...
        $scope.loaddata = function () {
            ...
            apiService.getURI("StudentBuspassForm/getloaddata", $scope.ASMAY_Id).
                then(function (promise) {
                    if (promise.trnsportcutoffdate == 'True') {
                        $scope.paydisable = false;
                    }
                    ...
                    if ($scope.routeDetls.length > 0) {
                        $scope.amsT_Id = $scope.routeDetls[0].amsT_Id;

                        $scope.onchange($scope.amsT_Id);
                    }
        ...
        $scope.onchange = function (amsT_Id) {
            debugger;
            $scope.acc = true;
            ...
            apiService.create("StudentBuspassForm/getstudata", data).
                then(function (promise) {
        ...
        $scope.onformclick = function (astA_Id, amsT_Id) {
            ...
            apiService.create("StudentBuspassForm/getbuspassdata", data).
                then(function (promise) {
                    //
        ...
        $scope.onareachange = function (trmA_Id) {
            ...
            apiService.create("StudentBuspassForm/getroutedata", data).
                then(function (promise) {
        ...
        $scope.onroutechange = function (trmA_Id) {
            ...
            apiService.create("StudentBuspassForm/getlocationdata", data).
                then(function (promise) {
        ...
        $scope.onroutechangeload = function (trmA_Id) {
            ...
            apiService.create("StudentBuspassForm/getlocationdataonly", data).
                then(function (promise) {
        ...
        $scope.savedata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                //    },
                //}
                apiService.create("StudentBuspassForm/savedata", data).then(function (promise) {


                    if (promise.returnval == "true") {
                        swal("Record Saved Successfully, Please Pay the Application Fee");
                        $state.reload();
                    }
        ...
        $scope.onclickloaddata1 = function (paydd) {
            ...
            if ($scope.paymenttype =='RAZORPAY') {
                ...
                apiService.create("StudentBuspassForm/paynow2", data).then(function (promise) {
            ...
            apiService.create("StudentBuspassForm/paynow1", data).then(function (promise) {
