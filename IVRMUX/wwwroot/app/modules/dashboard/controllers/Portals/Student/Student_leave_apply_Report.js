(function () {
    ...
    angular
        .module('app')
        .controller('Student_leave_apply_ReportController', student_leave_apply_ReportController)
    student_leave_apply_ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache', '$filter']
    function student_leave_apply_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache, $filter) {
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("OnlineLeaveApp/get_leave_Report", data).
                    then(function (promise) {

                        if (promise.student_leave_list.length > 0) {
                            ...
                            $scope.student_leave_list = promise.student_leave_list;
                           
                            $scope.presentCountgrid = promise.student_leave_list.length;
        ...
        $scope.Print = function () {
            ...
            if ($scope.student_leave_list !== null && $scope.student_leave_list.length > 0) {
