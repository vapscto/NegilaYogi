...
(function () {
    ...
    function VProgressReportExamController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.get_Exam = function () {
            ...
            apiService.create("VProgressReportExam/get_exam", data)
                .then(function (promise) {
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                var temp_list = [];
                apiService.create("VProgressReportExam/savedetails", data).
                    then(function (promise) {
                        ...
                        if ($scope.temp.length > 0) {
                            ...
                            $scope.asmcL_ClassName = promise.savelist[0].asmcL_ClassName;
                            $scope.asmC_SectionName = promise.savelist[0].asmC_SectionName;
