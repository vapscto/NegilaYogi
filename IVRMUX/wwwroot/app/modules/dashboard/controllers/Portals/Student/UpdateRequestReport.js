...
(function () {
    ...
    angular
        .module('app')
        .controller('UpdateRequestReportController', UpdateRequestReportController)

    UpdateRequestReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', '$window', 'superCache', '$compile', '$timeout', 'Excel']
    function UpdateRequestReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, $window, superCache, $compile,$timeout, Excel) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.getDATA("UpdateRequest/getreploaddata").
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("UpdateRequest/getreport", data).
                    then(function (promise) {
