(function () {
    'use strict';
    angular.module('app')
        .controller('HWConsolidatedReportController', HWConsolidatedReportController)
    HWConsolidatedReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', 'Excel', '$timeout']
    function HWConsolidatedReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, Excel, $timeout) {
        ...
        $scope.showreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HomeworkUpload/getreport_home", data).
                    then(function (promise) {
                        if ((promise.classreportlist != null && promise.classreportlist.length > 0) || (promise.reportlist != null && promise.reportlist.length > 0)) {
