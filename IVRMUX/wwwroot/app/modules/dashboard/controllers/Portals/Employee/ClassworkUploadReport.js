(function () {
    'use strict';
    angular.module('app')
        .controller('classworkuploadController', classworkuploadController)
    classworkuploadController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', 'Excel', '$timeout']
    function classworkuploadController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, Excel, $timeout) {
        ...
        $scope.showreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HomeworkUpload/getreport_class", data).
                    then(function (promise) {
