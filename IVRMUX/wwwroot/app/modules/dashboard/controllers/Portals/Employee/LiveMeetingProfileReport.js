(function () {
    ...
    angular
        .module('app')
        .controller('LiveMeetingProfileReportController', LiveMeetingProfileReportController);

    LiveMeetingProfileReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', 'Excel','$timeout'];
    function LiveMeetingProfileReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, Excel, $timeout) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getDATA("LiveMeetingSchedule/getschrptdetailsprofile").then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            var data = {
                ...
                apiService.create("LiveMeetingSchedule/getstaffprofilereport", data).
