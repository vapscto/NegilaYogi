(function () {
    ...
    angular
        .module('app')
        .controller('LiveMeetingStudentReportController', LiveMeetingStudentReportController);

    LiveMeetingStudentReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', 'Excel','$timeout'];
    function LiveMeetingStudentReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, Excel, $timeout) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getDATA("LiveMeetingSchedule/getstudentprofiledata").then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            var data = {
                ...
                apiService.create("LiveMeetingSchedule/getstudentprofilereport", data).
                            ...
                            angular.forEach($scope.staffdata, function (ss) {
                                ...
                                angular.forEach($scope.meetingidlist, function (mm) {
                                    ...
                                    angular.forEach($scope.meetingliststaff, function (cc) {
                                        ...
                                        if (ss.amst_Id == cc.AMST_Id && mm.LMSLMEET_Id == cc.LMSLMEET_Id) {
                                            $scope.maindata.push({ LMSLMEET_Id: cc.LMSLMEET_Id, LMSLMEET_MeetingId: cc.LMSLMEET_MeetingId, LMSLMEET_PlannedDate: cc.LMSLMEET_PlannedDate, LMSLMEET_MeetingTopic: cc.LMSLMEET_MeetingTopic, LMSLMEET_PlannedStartTime: cc.LMSLMEET_PlannedStartTime, LMSLMEET_PlannedEndTime: cc.LMSLMEET_PlannedEndTime, LMSLMEET_MeetingDate: cc.LMSLMEET_MeetingDate, LMSLMEET_StartedTime: cc.LMSLMEET_StartedTime, LMSLMEET_EndTime: cc.LMSLMEET_EndTime, ATT: cc.EmpName, ASMCL_ClassName: cc.ASMCL_ClassName, ASMC_SectionName: cc.ASMC_SectionName, sname: ss.name, ISMS_SubjectName: cc.ISMS_SubjectName, LMSLMEETSTD_LoginTime: cc.LMSLMEETSTD_LoginTime, LMSLMEETSTD_LogoutTime: cc.LMSLMEETSTD_LogoutTime})
                                        }
