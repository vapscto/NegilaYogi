(function () {
    ...
    angular
.module('app')
        .controller('chairmanmsemailreportController', chairmanmsemailreportController)

    chairmanmsemailreportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache', '$filter']
    function chairmanmsemailreportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache, $filter) {
        ...
        $scope.templete = 'PRINCIPAL DASHBOARD';
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("SmsEmailDetails/Getreportdetails", data).
