     ...
     (function () {
         ...
         angular
     .module('app')
     .controller('FEESOverAllStatusSchoolController', FEESOverAllStatusSchoolController)

         FEESOverAllStatusSchoolController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'superCache', '$window']
         function FEESOverAllStatusSchoolController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, superCache, $window) {
    ...
    $scope.loadbasicdata = function () {
        ...
        apiService.getDATA("FEESOverAllStatusSchool/Getdetails").
    ...
    $scope.showsectionGrid = function (classid) {
        ...
        apiService.create("FEESOverAllStatusSchool/Getsectioncount", data).
      then(function (promise) {
          ...
          $scope.sectionarray = promise.sectionarray;
             ...
             $scope.showstudentGrid = function (classid,sectionid) {
                 ...
                 apiService.create("FEESOverAllStatusSchool/Getsectioncount", data).
                     then(function (promise) {
                         ...
                         $scope.studentarray = promise.fillstudentstrenth;
    ...
    $scope.OnAcdyear = function (asmaY_Id) {
      ...
      //  alert(asmaY_Id)
        ...
        apiService.getURI("FEESOverAllStatusSchool/getdata", asmaY_Id).
      then(function (promise) {
