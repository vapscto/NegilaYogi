...
(function () {
    ...
    angular
.module('app')
.controller('SportFitnessReportController', SportFitnessReportController)

    SportFitnessReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$filter', 'superCache']
    function SportFitnessReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $filter, superCache) {
        ...
        $scope.BindData = function () {
            ...
            apiService.getDATA("SportFitnessReport/Getdetails").
       then(function (promise) {
        ...
        $scope.get_class = function () {
            ...
            apiService.create("SportFitnessReport/get_class", data)
                .then(function (promise) {
        ...
        $scope.get_section = function () {
            ...
            apiService.create("SportFitnessReport/get_section", data)
                .then(function (promise) {
        ...
        $scope.showdetails = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("SportFitnessReport/showdetails", data).
                         then(function (promise) {
