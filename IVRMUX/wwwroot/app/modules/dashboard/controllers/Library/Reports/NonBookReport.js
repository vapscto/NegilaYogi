...
(function () {
    ...
    angular
        .module('app')
        .controller('NonBookReportController', NonBookReportController)

    NonBookReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$q', '$filter', 'Excel', '$timeout']
    function NonBookReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $q, $filter, Excel, $timeout) {
        ...
        $scope.loaddata = function () {
            ...
            debugger;
            var pageid = 2;
            apiService.getURI("NonBookReport/getdetails", pageid).then(function (promise) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NonBookReport/get_report", data).then(function (promise) {
