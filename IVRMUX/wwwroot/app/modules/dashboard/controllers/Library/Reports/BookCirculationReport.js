...
(function () {
    ...
    angular
        .module('app')
        .controller('BookCirculationReportController', BookCirculationReportController)
    ...
    function BookCirculationReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $q, $filter, Excel, $timeout) {
        ...
        $scope.ExportToExcel = function () {
            ...
            //    $timeout(function () { location.href = exportHref; }, 100);
                var excelnamemain = "Book Circulation Report ";
                var printSectionId = "#printtable1";
                excelnamemain = excelnamemain + '.xls';
                var exportHref = Excel.tableToExcel(printSectionId, 'Book Circulation Report');
                $timeout(function () {
                ...
                //$timeout(function () { location.href = exportHref; }, 100);
                var excelnamemain = "Book Circulation Report ";
                var printSectionId = "#printtable2";
                excelnamemain = excelnamemain + '.xls';
                var exportHref = Excel.tableToExcel(printSectionId, 'Book Circulation Report');
                $timeout(function () {
                    var a = document.createElement('a');
                ...
                //$timeout(function () { location.href = exportHref; }, 100);
                var excelnamemain = "Book Circulation Report ";
                var printSectionId = "#printtable3";
                excelnamemain = excelnamemain + '.xls';
                var exportHref = Excel.tableToExcel(printSectionId, 'Book Circulation Report');
                $timeout(function () {
                    var a = document.createElement('a');
                ...
                //$timeout(function () { location.href = exportHref; }, 100);
                var excelnamemain = "Book Circulation Report ";
                var printSectionId = "#printtable4";
                excelnamemain = excelnamemain + '.xls';
                var exportHref = Excel.tableToExcel(printSectionId, 'Book Circulation Report');
                $timeout(function () {
                    var a = document.createElement('a');
