(function () {
    ...
    angular
        .module('app')
        .controller('CLGNonBookTransactionController', CLGNonBookTransactionController)

    CLGNonBookTransactionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter']
    function CLGNonBookTransactionController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter) {
        ...
        $scope.Loaddata = function () {
            ...
            debugger;
            var pageid = 2;
            apiService.create("CLGNonBookTransaction/getdetails", data).then(function (promise) {
        ...
        $scope.Savedata = function () {
            ...
            if ($scope.myForm.$valid) {
                if ($scope.LMBANO_Id !== "" && $scope.LMBANO_Id != null) {
                    ...
                    apiService.create("CLGNonBookTransaction/Savedata", data)
        ...
        $scope.get_staff1 = function () {
            ...
            apiService.create("CLGNonBookTransaction/get_staff1", data).then(function (promise) {
        ...
        $scope.getdepchange = function () {
            ...
            apiService.create("CLGNonBookTransaction/getdepchange", data).then(function (promise) {
                $scope.filldesignation = promise.filldesignation;
                //  $scope.stafftlist = promise.stafftlist;
        ...
        $scope.get_Studentdetails = function () {
            ...
            apiService.create("CLGNonBookTransaction/studentdetails", data).then(function (promise) {
                if ($scope.issuertype1 == 'std') {
        ...
        $scope.barcodechange = function (dd) {
            ...
            if (dd.length >= '1') {
                ...
                apiService.create("CLGNonBookTransaction/searchfilterbarcode", data).
                    then(function (promise) {
                        $scope.booktitle = promise.booktitle;
        ...
        $scope.barcodechange1 = function (dd) {
            ...
            apiService.create("CLGNonBookTransaction/searchfilterbarcode1", data).
                then(function (promise) {
                    debugger;
                    $scope.getalldata = promise.getalldata;
        ...
        $scope.searchfilter = function (objj) {
            ...
            if (objj.search.length >= '1') {
                ...
                apiService.create("CLGNonBookTransaction/searchfilter", data).
                    then(function (promise) {
        ...
        $scope.get_bookdetails = function () {
            ...
            apiService.create("CLGNonBookTransaction/get_bookdetails", data).then(function (promise) {
        ...
        $scope.EditData = function (user) {
            ...
            apiService.create("CLGNonBookTransaction/Editdata", data)
                .then(function (promise) {
                    if ($scope.issuertype1 == 'std') {
                        $scope.booktitle = promise.booktitle;
        ...
        $scope.renewaldata = function () {
            ...
            if (issuedate != date3) {
                ...
                if ($scope.myForm.$valid) {
                    ...
                    apiService.create("CLGNonBookTransaction/renewaldata", data)
                        .then(function (promise) {
                            if (promise.returnval != null && promise.duplicate != null) {
        ...
        $scope.returndata = function () {
            ...
            if (returndate != null && returndate != "" && returndate != undefined) {
                ...
                if ($scope.Book_Trans_Status != 'Return') {
                    apiService.create("CLGNonBookTransaction/returndata", data)
                        .then(function (promise) {
        ...
        $scope.GetStudentDetails1 = function () {
            ...
            apiService.create("CLGNonBookTransaction/GetStudentDetails1/", data).
                then(function (promise) {
