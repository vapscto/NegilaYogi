(function () {
    ...
    angular
.module('app')
        .controller('AddELibraryLinksController', AddELibraryLinksController)

    AddELibraryLinksController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache','$q']
    function AddELibraryLinksController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $q) {
        ...
        $scope.Loaddata = function () {
            ...
            debugger;
            var pageid = 2;
            apiService.getURI("AddELibraryLinks/getdetails", pageid).then(function (promise) {
