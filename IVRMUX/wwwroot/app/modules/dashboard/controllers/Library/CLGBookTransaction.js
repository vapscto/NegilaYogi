(function () {
    ...
    angular
        .module('app')
        .controller('CLGBookTransactionController', CLGBookTransactionController)

    CLGBookTransactionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache','$filter']
    function CLGBookTransactionController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter) {
        ...
        $scope.showfine = function (dobj) {
            ...
            apiService.create("CLGBookTransaction/showfine", data).
                then(function (promise) {
                    debugger;
                    var finamt = promise.fine_Amount

                    $scope.finelist.push({ lmB_BookTitle: dobj.lmB_BookTitle, lmbanO_AccessionNo: dobj.lmbanO_AccessionNo, issue_Date: dobj.issue_Date, due_Date: dobj.due_Date, finamt: finamt });
        ...
        $scope.stdSearch_Grid = function () {
            ...
            apiService.create("CLGBookTransaction/stdSearch_Grid", data).
                then(function (promise) {
                    debugger;
        ...
        $scope.Loaddata = function () {
            ...
            var pageid = 2;
            apiService.create("CLGBookTransaction/getdetails", data).then(function (promise) {
                    ...
                    if ($scope.issuertype1 == 'std') {
                        ...
                        if (promise.clamsg!='NS') {
                            ...
                            if (promise.studentCount > 0) {
                                ...
                                swal("No records found for selected academicYear,Course,Branch,Sem And Section");
                                $scope.count = 0;
                            }
                        }
                        else {
        ...
        $scope.Savedata = function() {
           // alert($scope.maxitem)
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.issuertype1 == 'std') {
                    var sid = $scope.AMCST_Id.amcsT_Id
                    ...
                    apiService.create("CLGBookTransaction/Savedata", data)
                    .then(function(promise) {
        ...
        $scope.get_staff1 = function () {
            ...
            apiService.create("CLGBookTransaction/get_staff1", data).then(function (promise) {
        ...
        $scope.getdepchange = function () {
            ...
            apiService.create("CLGBookTransaction/getdepchange", data).then(function (promise) {
                $scope.filldesignation = promise.filldesignation;
              //  $scope.stafftlist = promise.stafftlist;
        ...
        $scope.get_Studentdetails = function () {
            ...
            apiService.create("CLGBookTransaction/studentdetails", data).then(function (promise) {
                if ($scope.issuertype1 == 'std') {
                    $scope.studentdata = promise.studentdata;
                    if ($scope.studentdata.length != 0 && $scope.studentdata != null) {

                        $scope.AMST_FirstName = promise.studentdata[0].amcsT_FirstName;
                      ...
                      //  $scope.AMAY_RollNo = promise.studentdata[0].amaY_RollNo;
                        ...
                        $scope.AMSE_SEMName = promise.studentdata[0].amsE_SEMName;
                        $scope.ACMS_SectionName = promise.studentdata[0].acmS_SectionName;
                      ...
                      //  $scope.amsT_FatherMobleNo = promise.studentdata[0].amsT_FatherMobleNo;
                        $scope.AMCO_Id = promise.studentdata[0].amcO_Id; 
                        $scope.AMB_Id = promise.studentdata[0].amB_Id;
                        $scope.AMSE_Id = promise.studentdata[0].amsE_Id;
                        $scope.ACMS_Id = promise.studentdata[0].acmS_Id;
                        $scope.AMCST_MobileNo = promise.studentdata[0].amcsT_MobileNo;
                        $scope.AMCST_emailId = promise.studentdata[0].amcsT_emailId;
                    ...
                    if ($scope.selctstaffdata.length != 0 && $scope.selctstaffdata != null) {
                        ...
                        $scope.HRME_EmailId = promise.selctstaffdata[0].hrmE_EmailId;
        ...
        $scope.barcodechange = function (dd) {
            ...
            if (dd.length >='1') {
                ...
                apiService.create("CLGBookTransaction/searchfilterbarcode", data).
                    then(function (promise) {
                        $scope.booktitle = promise.booktitle;
        ...
        $scope.barcodechange1 = function (dd) {
            ...
            apiService.create("CLGBookTransaction/searchfilterbarcode1", data).
                    then(function (promise) {
                        debugger;
                        $scope.getalldata = promise.getalldata;
        ...
        $scope.searchfilter = function (objj) {
            ...
            if (objj.search.length >= '1') {
                ...
                apiService.create("CLGBookTransaction/searchfilter", data).
                    then(function (promise) {
        ...
        $scope.get_bookdetails = function () {
          ...
          //  $scope.LMB_Id = studid;
            ...
            apiService.create("CLGBookTransaction/get_bookdetails", data).then(function (promise) {
        ...
        $scope.EditData = function (user) {
            ...
            apiService.create("CLGBookTransaction/Editdata", data)
                .then(function (promise) {
                    if ($scope.issuertype1 == 'std') {
                        $scope.booktitle = promise.booktitle;
                      ...
                      //  $scope.AMST_Id = promise.editlist[0].amsT_Id;
                        ...
                        if ($scope.LMBANO_Id.length != 0 && $scope.AMCST_Id.length != 0) {
                            $scope.get_bookdetails();
        ...
        $scope.renewaldata = function () {
            ...
            if (issuedate != date3) {
                ...
                if ($scope.myForm.$valid) {
                    ...
                    apiService.create("CLGBookTransaction/renewaldata", data)
                        .then(function (promise) {
                            if (promise.returnval != null && promise.duplicate != null) {
        ...
        $scope.returndata = function () {
            ...
            if (returndate != null && returndate != "" && returndate != undefined) {
                    ...
                    if ($scope.Book_Trans_Status != 'Return') {
                        apiService.create("CLGBookTransaction/returndata", data)
                            .then(function (promise) {
       ...
       // $scope.minDatemf = new Date();
        ...
        $scope.onSelectcourse = function (classId) {
            if ($scope.ASMAY_Id > 0 && $scope.AMCO_Id > 0) {
                $scope.AMSE_Id = 0;
                $scope.AMB_Id = 0;
                $scope.ACMS_Id = 0;
                $scope.GetStudentDetails1();
        ...
        $scope.onSelectyear = function () {
            if ($scope.ASMAY_Id > 0 && $scope.ACMS_Id > 0 && $scope.AMSE_Id > 0 && $scope.AMB_Id > 0 && $scope.AMCO_Id > 0) {
                $scope.GetStudentDetails1();
            }
        }
        $scope.onSelectbranch = function () {
            if ($scope.ASMAY_Id > 0 && $scope.AMB_Id > 0 && $scope.AMCO_Id > 0) {
                $scope.AMSE_Id = 0;
                $scope.ACMS_Id = 0;
                $scope.GetStudentDetails1();
            }
        ...
        $scope.onSelectsemm = function () {
            if ($scope.ASMAY_Id > 0 && $scope.AMSE_Id > 0 && $scope.AMB_Id > 0 && $scope.AMCO_Id > 0) {
                $scope.ACMS_Id = 0;
                $scope.GetStudentDetails1();
            }
        }
        ...
        $scope.GetStudentDetails1 = function () {
          ...
          //  $scope.studentlst.amst_Id = '';
            ...
            apiService.create("CLGBookTransaction/GetStudentDetails1/", data).
                then(function (promise) {
                    ...
                    if (promise.studentCount > 0) {
                        ...
                        swal("No student found for selected parameter");
                        $scope.studlist = [];
                        $scope.count = 0;
                    }
                });
