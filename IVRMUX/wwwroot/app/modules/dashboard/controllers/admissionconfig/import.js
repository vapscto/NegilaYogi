...
(function () {
    ...
    importController.$inject = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'dashboardService', 'Flash', 'superCache']
    function importController($rootScope, $scope, $state, $location, apiService, dashboardService, Flash, superCache) {
        ...
        $rootScope.validateForm = function () {
            ...
            apiService.create("AdmissionImport/checkvalidation", data1).then(function (promise) {
        ...
        $scope.savedata = function (gridOptions) {
            ...
            apiService.create("AdmissionImport/", data).then(function (promise) {
