(function () {
    'use strict';
    angular.module('app').controller('LunchAttendanceEntrycontroller', LunchAttendanceEntrycontroller);
    LunchAttendanceEntrycontroller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', 'superCache', '$stateParams'];

    function LunchAttendanceEntrycontroller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, superCache, $stateParams) {
        $scope.chckedIndexs = [];
