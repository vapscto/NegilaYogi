(function () {
    'use strict';
    angular.module('app').controller('LibraryAttendanceEntrycontroller', LibraryAttendanceEntrycontroller);
    LibraryAttendanceEntrycontroller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', 'superCache', '$stateParams'];

    function LibraryAttendanceEntrycontroller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, superCache, $stateParams) {
        $scope.chckedIndexs = [];
