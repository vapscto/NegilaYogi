...
(function () {
    ...
    angular
.module('app')
        .controller('EMAILSMSTemplateSettingController', EMAILSMSTemplateSettingController)

    EMAILSMSTemplateSettingController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache','$compile']
    function EMAILSMSTemplateSettingController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, $compile) {
        $scope.DeleteRecord = {};
        $scope.EditRecord = {};
        ...
        $scope.BindData = function () {
            apiService.getDATA("EMAILSMSTemplateSetting/Getdetails").
       then(function (promise) {

           debugger;
           $scope.modulellist = promise.modulellist;
           var e1 = angular.element(document.getElementById("test"));
           $compile(e1.html(promise.htmldata))(($scope));

           var e11 = angular.element(document.getElementById("test1"));
           $compile(e11.html(promise.htmldata))(($scope));
       })
        };
        ...
        $scope.DeleteMasterActivitydata = function (DeleteRecord, SweetAlert) {
            ...
            function (isConfirm) {
                if (isConfirm) {
                    apiService.DeleteURI("MasterActivity/MasterDeleteModulesDTO", MdeleteId).
                    then(function (promise) {
