(function () {
    'use strict';
    angular.module('app').controller('SchooltcNDSController', SchooltcNDSController)

    SchooltcNDSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function SchooltcNDSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
