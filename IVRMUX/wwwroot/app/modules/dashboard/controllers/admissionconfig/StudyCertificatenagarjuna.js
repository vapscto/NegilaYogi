(function () {
    'use strict';
    angular.module('app').controller('StudyCertificatenagarjunaChikkattiController', StudyCertificatenagarjunaController)

    StudyCertificatenagarjunaController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StudyCertificatenagarjunaController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
