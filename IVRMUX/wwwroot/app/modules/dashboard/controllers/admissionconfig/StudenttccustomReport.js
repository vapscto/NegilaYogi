(function () {
    'use strict';
    angular.module('app').controller('StudentTcReportcustomController', StudentTcReportcustomController)

    StudentTcReportcustomController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function StudentTcReportcustomController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
            ...
            if ($scope.myform.$valid) {
                ...
                apiService.create("StudenttcReportcustom/getTcdetails", data).then(function (promise) {
                    ...
                    if (promise.studentTCList !== null && promise.studentTCList.length > 0) {
                        ...
                        $scope.IsHiddendown = true;
                        $scope.report = true;
                        $scope.penno = promise.studentTCList[0].PenNo;
