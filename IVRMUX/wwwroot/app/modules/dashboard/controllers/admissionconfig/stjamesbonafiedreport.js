(function () {
    'use strict';
    angular.module('app').controller('stjamesbonafiedreport', stjamesbonafiedreport)

    stjamesbonafiedreport.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function stjamesbonafiedreport($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
