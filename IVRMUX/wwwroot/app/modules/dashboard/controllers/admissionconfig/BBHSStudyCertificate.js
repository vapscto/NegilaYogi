(function () {
    ...
    angular
        .module('app')
        .controller('BBHSStudyCertificateController', BBHSStudyCertificateController)

    BBHSStudyCertificateController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function BBHSStudyCertificateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
                ...
                if ($scope.Character == 0) {
                    ...
                    apiService.create("StudyCertificate/Studdetails", data).then(function (promise) {
                        ...
                        if (promise.studentlist.length > 0 && promise.studentlist != null) {
                            ...
                            else if (promise.masterCompany[0].mI_Id == 4) {
                                $scope.baldwinsboys = true;
                                $scope.baldwinscoeducation = false;
                                $scope.baldwinsgirls = false;
                                $scope.hide = false;
                            }
                            else if (promise.masterCompany[0].mI_Id == 6) {
                                $scope.baldwinsboys = true;
                                $scope.baldwinscoeducation = false;
                                $scope.baldwinsgirls = false;
                                $scope.hide = false;
                            ...
                            if (promise.masterCompany[0].mI_Id == 5) {
                                ...
                                // $scope.dob = $scope.datesuf + ' ' + $scope.frommonth123 + ' ' + years;

                                //  $scope.getdate = $scope.datesuf1 + ' ' + $scope.frommonth223 + ' ' + years1;
