...
.module('app')
    ...
    function HHSBonafiedCertificateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
        ...
        $scope.HHSStudyCert = function () {
            var innerContents = document.getElementById("VIKASASTUDYCERT").innerHTML;
            var popupWinindow = window.open('');
            popupWinindow.document.open();
            popupWinindow.document.write('<html><head>' +
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/PrintPdf_Bootstrap.css" />' +
                  '<link type="text/css" media="print" rel="stylesheet" href="css/print/Vikasa/Studycertificate/vikasastudyReportPdf.css" />' +
