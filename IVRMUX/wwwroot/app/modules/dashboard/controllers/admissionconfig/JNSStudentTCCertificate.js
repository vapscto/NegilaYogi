(function () {
    ...
    angular
        .module('app')
        .controller('JNSStudentTCCertificateController', JNSStudentTCCertificateController)

    JNSStudentTCCertificateController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function JNSStudentTCCertificateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
        //$scope.report = false;
                ...
                apiService.create("BBKVCustomReport/getTcdetailsJNS", data)
                    .then(function (promise) {
                        ...
                        if (promise.studentTCList.length > 0) {
                            $scope.report = true;
                            $scope.header = "images/clients/BBS/JNSPU.jpg";
