(function () {
    'use strict';
    angular.module('app').controller('StudyCertificateJNSBOYSController', StudyCertificateJNSBOYSController)

    StudyCertificateJNSBOYSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StudyCertificateJNSBOYSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
                ...
                if (parseInt($scope.Character) === 0) {
                    ...
                    apiService.create("StudyCertificate/Studdetails", data).then(function (promise) {
                        ...
                        if (promise.studentlist !== null && promise.studentlist.length > 0) {
                            ...
                            $scope.admindate = promise.studentlist[0].admdate;
        ...
        $scope.printToCart = function () {
            ...
            popupWinindow.document.write('<html><head>' +
                ...
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/baldwin/JNSStudyCertPdf.css" />' +
