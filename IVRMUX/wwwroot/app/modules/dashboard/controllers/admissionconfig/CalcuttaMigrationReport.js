(function () {
    'use strict';
    angular.module('app').controller('CalcuttaMigrationCertificate', CalcuttaMigrationCertificate)

    CalcuttaMigrationCertificate.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function CalcuttaMigrationCertificate($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
