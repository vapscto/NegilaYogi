...
(function () {
    'use strict';
    angular.module('app').controller('StudentAttendancePeriodwiseReportOverAllController', StudentAttendancePeriodwiseReportOverAllController)

    StudentAttendancePeriodwiseReportOverAllController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache']
    function StudentAttendancePeriodwiseReportOverAllController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache) {
        $scope.currentPage = 1;
        ...
        $scope.PeriodWiseReportOverAll = function () {
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StudentAttendanceReport/PeriodWiseReportOverAll", data).then(function (promise) {
        ...
        $scope.exportToExcel = function () {
            var exportHref = "";
            var excelname = "";
            exportHref = Excel.tableToExcel('#excelid', 'Subject Wise Attendance Report Over All');
            excelname = "Subject Wise Attendance Report Over All.xlsx";
