(function () {
    'use strict';
    angular.module('app').controller('SRKVSTCController', SRKVSTCController)
    SRKVSTCController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function SRKVSTCController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
        ...
        $scope.stdnamechange = function () {
            ...
            apiService.create("BBKVCustomReport/stdnamechange", data).then(function (promise) {
        ...
        $scope.savetmpldata = function () {
            ...
            if ($scope.myform.$valid) {
                ...
                apiService.create("BBKVCustomReport/get_JSHSTcdetails", data).then(function (promise) {                    
                    if (promise.studentTCList.length > 0) {
                        ...
                        $scope.lblsex = promise.studentTCList[0].amsT_Sex;
                        ...
                        $scope.lblMotherTongue = promise.studentTCList[0].amsT_MotherTongue;
                        $scope.lblTCissuedate = promise.studentTCList[0].astC_TCIssueDate
                        ...
                        if ($scope.astC_Scholarship !== null && astC_Scholarship !== "") {
                            $scope.scholarship = promise.studentTCList[0].astC_Scholarship;
                        }
                     
                        
                        $scope.medicalexam = promise.studentTCList[0].astC_MedicallyExam,

                        $scope.lblMediumOfINStruction = promise.studentTCList[0].astC_MediumOfINStruction;
                        ...
                        $scope.schedulecaste = promise.studentTCList[0].schedulecaste;
                    }
                    else {
                        swal("No Records Found");
                        $scope.Print_flag = false;
