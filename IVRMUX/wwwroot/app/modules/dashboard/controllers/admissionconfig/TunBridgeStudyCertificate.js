(function () {
    ...
    StudyCertificateController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StudyCertificateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
                ...
                if (parseInt($scope.Character) === 0) {
                    ...
                    apiService.create("StudyCertificate/Studdetails", data).then(function (promise) {
                        ...
                        if (promise.studentlist !== null && promise.studentlist.length > 0) {
                            ...
                            $scope.IVRMMCT_Name = promise.studentlist[0].IVRMMCT_Name; 
                            ...
                            $scope.admitedclass = promise.studentlist[0].admitedclass;
                            $scope.PresentClass = promise.studentlist[0].PresentClass;
                            $scope.admitedyear = promise.studentlist[0].admitedyear;
                            $scope.PresentYear = promise.studentlist[0].PresentYear;
                            $scope.TCNo = promise.studentlist[0].TCNo;
                            $scope.TBSC_ID = promise.studentlist[0].TBSC_ID;
                       
                           // $scope.countryname = promise.studentlist[0].addressd1;

                            // $scope.countryname = promise.studentlist[0].addressd1;

                          //  $scope.concountryname = promise.studentlist[0].addressd13;


                            if ($scope.ts.address_opt == 'address_per') {
                                $scope.countryname = promise.studentlist[0].addressd1;
                            }
                            else if ($scope.ts.address_opt == 'address_con') {
                                $scope.countryname = promise.studentlist[0].addressd13;
                            }
                            ...
                            if ($scope.ts.address_opt == 'address_per') {
                                ...
                                $scope.street = promise.studentlist[0].constreet;
                                $scope.area = promise.studentlist[0].conarea;
                                $scope.city = promise.studentlist[0].concity;
                            }
        ...
        $scope.printToCart = function () {
            ...
            if (parseInt($scope.Character) === 0) {
                ...
                else if (parseInt($scope.mi_idd) === 5) {
                ...
                else if (parseInt($scope.mi_idd) === 6) {
                    //boys school
