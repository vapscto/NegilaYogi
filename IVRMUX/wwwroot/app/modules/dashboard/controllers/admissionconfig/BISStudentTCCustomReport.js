(function () {
    'use strict';
    angular.module('app').controller('BISStudentTCCustomReportController', BISStudentTCCustomReportController)

    BISStudentTCCustomReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BISStudentTCCustomReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
        $scope.report = false;
            ...
            if ($scope.myform.$valid) {
                ...
                apiService.create("BBKVCustomReport/getTcdetails", data).then(function (promise) {
                    if (promise.studentTCList !== null && promise.studentTCList.length > 0) {
                        ...
                        $scope.AMST_AdmNo = promise.studentTCList[0].amsT_AdmNo;
                        ...
                        $scope.classjoinname = promise.studentTCList[0].classjoinname;
        ...
        $scope.printToCart = function () {
            ...
            popupWinindow.document.write('<html><head>' +
                ...
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/BBKV/BBKVTC/BISTCPdf.css" />' +
