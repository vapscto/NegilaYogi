(function () {
    'use strict';
    angular.module('app').controller('JSHSTCREPORTController', JSHSTCREPORTController)
    JSHSTCREPORTController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function JSHSTCREPORTController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
