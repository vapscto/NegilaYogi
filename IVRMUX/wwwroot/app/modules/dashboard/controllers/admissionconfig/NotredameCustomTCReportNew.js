(function () {
    'use strict';
    angular.module('app').controller('NotredameCustomTCReportNewController', NotredameCustomTCReportNewController)

    NotredameCustomTCReportNewController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function NotredameCustomTCReportNewController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
        $scope.report = false;
            ...
            if ($scope.myform.$valid) {
                ...
                apiService.create("BBKVCustomReport/getTcdetails", data).then(function (promise) {
                    if (promise.studentTCList !== null && promise.studentTCList.length > 0) {
                        ...
                        $scope.FirstName = promise.studentTCList[0].amsT_FirstName;
                        $scope.MiddleName = promise.studentTCList[0].amsT_MiddleName;
                        $scope.LastName = promise.studentTCList[0].amsT_LastName;
                        ...
                        $scope.languageStudied = promise.studentTCList[0].languageStudied;
                       ...
                       // $scope.subjectsstudied = promise.studentTCList[0].langustudies;
                        ...
                        $scope.lastexam = promise.studentTCList[0].lastexam;
                        $scope.nccdtails = promise.studentTCList[0].nccdtails;
                        $scope.applidate = promise.studentTCList[0].applidate;
                        $scope.astc_extraactivities = promise.studentTCList[0].astc_extraactivities;
                        $scope.promotionflag = promise.studentTCList[0].promotionflag;
                        $scope.ASMC_SectionName = promise.studentTCList[0].asmC_SectionName;
                        $scope.amsT_AadharNo = promise.studentTCList[0].amsT_AadharNo;
                        $scope.govtno = promise.studentTCList[0].govtno;
                        $scope.admittedclass = promise.studentTCList[0].admittedclass;
