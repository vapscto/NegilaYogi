(function () {
    'use strict';
    angular.module('app').controller('StudyCertificateCommonController', StudyCertificateCommonController)

    StudyCertificateCommonController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StudyCertificateCommonController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
