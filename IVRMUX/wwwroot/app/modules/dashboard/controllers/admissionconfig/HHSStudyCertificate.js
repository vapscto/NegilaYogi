(function () {
    ...
    function HHSBonafiedCertificateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HHSBonafiedCertificate/Studdetails", data).then(function (promise) {
                    if (promise.studentlist.length > 0 && promise.studentlist != null) {
                       ...
                       $scope.acadamicyear = $scope.frommonth1 + '-' + $scope.fromyear + ' to ' + $scope.tomonth1 + '-' + $scope.toyear;
                        //$scope.acadamicyear = "June" + '-' + $scope.fromyear + ' to ' + "May" + '-' + $scope.toyear;
                        ...
                        $scope.uppercase($scope.dobinwords);
        ...
        $scope.HHSStudyCert = function () {
            var innerContents = document.getElementById("HHSStudyCert").innerHTML;
            var popupWinindow = window.open('');
            popupWinindow.document.open();
            popupWinindow.document.write('<html><head>' +
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/PrintPdf_Bootstrap.css" />' +
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/hutchings/Bonafide_Cert/BonafideCertPDf.css" />' +
        ...
        $scope.uppercase = function (str) {
            ...
            $scope.dobinwords = newarray1;
            return $scope.dobinwords = newarray1.join(' ');
