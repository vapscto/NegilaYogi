(function () {
    'use strict';
    angular.module('app').controller('studentadmissionSSVNController', studentadmissionSSVNController)
    studentadmissionSSVNController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', 'superCache', '$stateParams']
    function studentadmissionSSVNController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, superCache, $stateParams) {
        ...
        function getSelectGetdistrict2(distidd, stateid) {
        ...
        function getSelectGetdistrict1(distidd, stateid) {
            var stateidd = stateid;
            //var data = {
            //    countryName: stateid
            //};
        ...
        $scope.address_copy = function () {
            if ($scope.obj.chkbox_address == 1) {
                ...
                $scope.obj.amsT_ConDistrict = $scope.obj.amsT_ConCountry;
        ...
        $scope.savefirsttab = function () {
            ...
            if ($scope.myForm1.$valid) {
                ...
                apiService.create("StudentAdmission/savefirsttabSSVN", data).then(function (promise) {
        ...
        $scope.savethirdtab = function () {
            if ($scope.myForm3.$valid) {
                ...
                var data = {
                    ...
                    "FatherMonthlyIncome": $scope.obj.amsT_FatherMonIncome,
                    "FatherAnnualIncome": $scope.obj.amsT_FatherAnnIncome,
                    "AMST_FatherMobleNo": $scope.obj.amsT_FatherMobleNo,
        ...
        $scope.Editdata = function (EditRecord, allRefrence, allSources, allActivity) {
            ...
            apiService.getURI("StudentAdmission/GetSelectedRowDetails/", MEditId).then(function (promise) {
                ...
                getSelectGetdistrict1(promise.adm_m_student[0].amsT_ConState, promise.adm_m_student[0].amsT_ConState);
                getSelectGetdistrict2(promise.adm_m_student[0].amsT_PerState, promise.adm_m_student[0].amsT_PerState);
