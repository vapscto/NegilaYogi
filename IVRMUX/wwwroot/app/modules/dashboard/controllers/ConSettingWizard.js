...
(function () {
    ...
    angular
.module('app')
.controller('ConSettingWizardController', ConSettingWizardController);

    ConSettingWizardController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$window','superCache'];
    function ConSettingWizardController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $window, superCache) {
