(function () {
    'use strict';
    angular.module('app').controller('SA_AbsentReportController', SA_AbsentReportController)

    SA_AbsentReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'uiCalendarConfig', 'superCache', '$window', '$http', 'Excel','$timeout']

    function SA_AbsentReportController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, uiCalendarConfig, superCache, $window, $http, Excel, $timeout) {
        ...
        $scope.GetAbsentStudentReport = function () {
            if ($scope.myForm.$valid) {
                ...
                apiService.create("SA_Report/GetAbsentStudentReport", data).then(function (promise) {
                    if (promise !== null) {
