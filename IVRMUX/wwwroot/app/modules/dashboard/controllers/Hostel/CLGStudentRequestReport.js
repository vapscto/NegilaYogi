(function () {
    ...
    angular
        .module('app')
        .controller('CLGStudentRequestReportController', CLGStudentRequestReportController)

    CLGStudentRequestReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', 'Excel', '$timeout']
    function CLGStudentRequestReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, Excel, $timeout) {
