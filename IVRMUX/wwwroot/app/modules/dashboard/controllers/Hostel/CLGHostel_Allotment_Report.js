(function () {
    ...
    angular
        .module('app')
        .controller('CLGHostel_Allotment_ReportController', CLGHostel_Allotment_ReportController)

    CLGHostel_Allotment_ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', 'Excel', '$timeout']
    function CLGHostel_Allotment_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, Excel, $timeout) {
        $scope.currentPage = 1;
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CLGStudentRequestReport/getreport", data)
