...
(function () {
    ...
    angular
        .module('app')
        .controller('HostelAllotAndConfermForCLGStudentController', HostelAllotAndConfermForCLGStudentController)
    HostelAllotAndConfermForCLGStudentController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$stateParams', '$filter', '$timeout']
    function HostelAllotAndConfermForCLGStudentController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $stateParams, $filter, $timeout) {
        ...
        $scope.savedata = function () {
            ...
            var data = {
                ...
                "HLHSALTC_EntireRoomReqdFlg": $scope.HLHSALTC_EntireRoomReqdFlg,
        ...
        $scope.get_studInfo = function (objtype) {
