(function () {
    ...
    angular
        .module('app')
        .controller('StudentFeeGroupMappingNextAcaYrController', StudentFeeGroupMappingNextAcaYrController)

    StudentFeeGroupMappingNextAcaYrController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StudentFeeGroupMappingNextAcaYrController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
        ...
        $scope.formload = function () {
            ...
            apiService.create("StudentFeeGroupMappingNextAcaYr/loaddata", data).
                then(function (promise) {
        ...
        $scope.DeletRecord = function (studentmappingid, studentid, groupid) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("StudentFeeGroupMappingNextAcaYr/Deletedetails", data).
                            then(function (promise) {
        ...
        $scope.fillstudents = function () {
            ...
            apiService.create("StudentFeeGroupMappingNextAcaYr/getgroupmappedheads", data).
                then(function (promise) {
        ...
        $scope.savedata = function (studentsdata, grouplst, headlst, installlst) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StudentFeeGroupMappingNextAcaYr/savedata", data).
                    then(function (promise) {
        ...
        $scope.ShowSearch_Report = function () {
            ...
            if ($scope.searchtxt != "" || $scope.searchnumbr != "" || $scope.searchdat != "") {
                ...
                apiService.create("StudentFeeGroupMappingNextAcaYr/searching", data).
                    then(function (promise) {
                        $scope.thirdgrid = promise.alldatathird;
