(function () {
    ...
    angular
        .module('app')
        .controller('HlMasterRoom_FeeGroupController', HlMasterRoom_FeeGroupController)

    HlMasterRoom_FeeGroupController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce'];
    function HlMasterRoom_FeeGroupController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce) {
