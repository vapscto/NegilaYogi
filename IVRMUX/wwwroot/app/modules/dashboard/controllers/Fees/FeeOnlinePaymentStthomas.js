(function () {
    ...
    angular
        .module('app')
        .controller('FeeOnlinePaymentStthomasController', FeeOnlinePaymentStthomasController)

    FeeOnlinePaymentStthomasController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$window', 'FormSubmitter', 'superCache', '$compile']
    function FeeOnlinePaymentStthomasController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $window, FormSubmitter, superCache, $compile) {
        ...
        var grouporterm, autoreceipt, automanualreceiptnotranum, FMC_ReadmitFineCalculationFlg;
        ...
        if (configsettings.length > 0) {
            ...
            FMC_ReadmitFineCalculationFlg = configsettings[0].fmC_ReadmitFineCalculationFlg;
        }
        ...
        $scope.onclickloaddataregular = function (paymenttype) {
            ...
            if (paymenttype == true) {
                ...
                apiService.create("FeeOnlinePaymentStthomas/getgrouportermdetails", data).
        ...
        $scope.getcustomgroups = function (termid, yearlst) {
            ...
            if ($scope.checkboxval != 'undefined') {
                ...
                apiService.create("FeeOnlinePaymentStthomas/getcustomgroups", data).
                    then(function (promise) {
        ...
        $scope.optionToggledtransport = function (insid, data1, yearlst) {
            ...
            if ($scope.checkboxval != 'undefined') {
                ...
                apiService.create("FeeOnlinePaymentStthomas/getamountdetails", data).
                    then(function (promise) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.create("FeeOnlinePaymentStthomas/getalldetails", data).
                then(function (promise) {
                    ...
                    if (promise.readterms.length > 0) {
                        ...
                        if (promise.customgrplist.length > 0) {
                            ...
                            if (FMC_ReadmitFineCalculationFlg == 1)
                                $scope.Readmissionfeeschecking = promise.readmissionfeeschecking;

                            if ($scope.Readmissionfeeschecking != null) {
                                if ($scope.Readmissionfeeschecking.length > 0) {

                                    angular.forEach($scope.Readmissionfeeschecking, function (obj4) {
                                        angular.forEach($scope.temp_grp_ins_list, function (obj1) {
                                            angular.forEach(obj1.trm_list, function (obj3) {

                                                if (obj3.fmT_Id == obj4.FMT_Id) {
                                                    obj1.grp.checkedgrplst = true;
                                                    obj3.checkedheadlst = true;
                                                    obj3.termdisablechk = true;
        ...
        $scope.pamentsave = function (totalamt, students, checkbx, yearlst, customfeegroup, qwe) {
            ...
            if ($scope.amst_mobile != 0 || $scope.amst_email_id != "") {
                ...
                apiService.create("FeeOnlinePaymentStthomas/generatehashsequence", data).
                    then(function (promise) {
                        ...
                        if (promise.fyP_Receipt_No != null) {
                            if (qwe.paygtw == "BILLDESK") {
                                ...
                                var params = {
                                    ...
                                    "CALLBACK_URL": "http://localhost:57606/api/FeeOnlinePaymentStthomas/paymentresponsePAYTM/",
                                }
                                ...
                                var params = {
                                    ...
                                    "surl": "http://localhost:57606/api/FeeOnlinePaymentStthomas/paymentresponse/",
                                    "furl": "http://localhost:57606/api/FeeOnlinePaymentStthomas/paymentresponse/"
                                }
                                FormSubmitter.submit(url, method, params);
                            }
                                ...
                                var params = {
                                    ...
                                    //  "backurl":"http://localhost:57606/api/FeeOnlinePaymentStthomas/AirpayPaymentResponse/"
