(function () {
    ...
    angular
        .module('app')
        .controller('FeeDefaulterReportStthomasController', FeeDefaulterReportStthomasController)

    FeeDefaulterReportStthomasController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout', '$compile']
    function FeeDefaulterReportStthomasController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout, $compile) {
        ...
        $scope.onselectclass = function () {
            ...
            if ($scope.clsdrp != 0 || $scope.clsdrp == 0) {
        ...
        $scope.ShowReportdata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("FeeDefaulterReportStthomas/getreport/", data).
                    then(function (promise) {

                        if (promise.getreportdata != null && promise.getreportdata != "") {
                            $scope.termwisedetails = promise.getreportdata;
