...
(function () {
    ...
    angular
        .module('app')
        .controller('INV_MasterSupplierController', INV_MasterSupplierController);
    INV_MasterSupplierController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function INV_MasterSupplierController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
