(function () {
    'use strict';
    angular.module('app').controller('AddVisitorsController', AddVisitorsController)

    AddVisitorsController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$filter', 'superCache', '$q', '$sce']
    function AddVisitorsController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $filter, superCache, $q, $sce) {
