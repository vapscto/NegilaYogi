...
(function () {
    ...
    angular
.module('app')
        .controller('CollegeOverallFeeStatusController', CollegeOverallFeeStatusController)

    CollegeOverallFeeStatusController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel','$timeout']
    function CollegeOverallFeeStatusController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.loaddata = function () {
            ...
            var pageid = 1;
            apiService.getURI("CollegeOverallFeeStatus/GetYearList", pageid).
        ...
        $scope.get_courses = function () {
            ...
            if ($scope.asmaY_Id != undefined && $scope.asmaY_Id != "") {
                ...
                apiService.create("CollegeOverallFeeStatus/get_courses", data).then(function (promise) {
        ...
        $scope.get_branches = function () {
            ...
            apiService.create("CollegeOverallFeeStatus/get_branches", data).then(function (promise) {
        ...
        $scope.get_semisters = function () {
            ...
            apiService.create("CollegeOverallFeeStatus/get_semisters", data).
                then(function (promise) {
        ...
        $scope.DeleteRecord = function (user) {
            ...
            function (isConfirm) {
                ...
                if (isConfirm) {
                    ...
                    apiService.create("CollegeOverallFeeStatus/DeleteRecord", data).
                        then(function (promise) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CollegeOverallFeeStatus/get_report", data).then(function (promise) {
        ...
        $scope.edit = function (role) {
            ...
            apiService.create("CollegeOverallFeeStatus/editdata", data).
                then(function (promise) {
                ...
                for (var u = 0; u < $scope.sectionlist.length; u++) {
                 ...
                 //   installlst = $scope.valsinstallment;
                    if ($scope.valsgroup.length > 0)
                    {
                        ...
                        apiService.create("CollegeOverallFeeStatus/savedata", data).
                        then(function (promise) {
                            ...
                            if ($scope.feedetails.length!= 0) {
                                ...
                                angular.forEach($scope.feedetails, function (ff) {
                                    $scope.lastyrtotal = $scope.lastyrtotal + ff.StudentDue; 
                                    $scope.curryrtotal = $scope.curryrtotal + ff.BFCSS_CurrentYrCharges;
                                    $scope.rectotal = $scope.rectotal + ff.Receivable;
                                    $scope.paidtotal = $scope.paidtotal + ff.Collection;
                                    $scope.finertotal = $scope.finertotal + ff.CollectionAnyTime;
                                    $scope.constotal = $scope.constotal + ff.BFCSS_ConcessionAmount;
                                })
