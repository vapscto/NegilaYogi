(function () {
    ...
    angular
        .module('app')
        .controller('StaffAndOtherAmountEntryController', StaffAndOtherAmountEntryController)
    StaffAndOtherAmountEntryController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function StaffAndOtherAmountEntryController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
        ...
        $scope.changeradio = function (abcc) {
            ...
            apiService.create("StaffAndOtherAmountEntry/getalldetailsOnselectiontype", data).
        ...
        $scope.formload = function () {
            ...
            var pageid = 1;
            apiService.getURI("StaffAndOtherAmountEntry/getalldetails", pageid).
                then(function (promise) {
        ...
        $scope.selectacademicyear = function () {
            ...
            apiService.create("StaffAndOtherAmountEntry/selectacademicyear", data).
                then(function (promise) {
                  //  $scope.categorycount = promise.fillcategory;
                    $scope.groupcount = promise.fillmastergroup;
                    $scope.thirdgrid = promise.alldata;
        ...
        $scope.onselectgroup = function (groupcount) {
            ...
            apiService.create("StaffAndOtherAmountEntry/getgroupmappedheads", data).
                then(function (promise) {
        ...
        $scope.DeletRecord = function (amountid, selectiontype) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("StaffAndOtherAmountEntry/Deletedetails/", data).
                            then(function (promise) {
        ...
        $scope.clicktypeofstudent = function (typeofstudentregular, typeofstudentecs) {
            ...
            apiService.create("StaffAndOtherAmountEntry/paymentdetails", data).
                then(function (promise) {
        ...
        $scope.EditMasterSectvalue = function (employee) {
            ...
            //orgid = 12;
            apiService.getURI("StaffAndOtherAmountEntry/Editdetails", orgid).
                then(function (promise) {
        ...
        $scope.filterby = function () {
            ...
            apiService.create("StaffAndOtherAmountEntry/1", data).
                then(function (promise) {
                    $scope.thirdgrid = promise.alldata;
        ...
        $scope.savedata = function (totalgrid, finslab1, finslab2) {
            ...
            if ($scope.myform.$valid) {
                ...
                apiService.create("StaffAndOtherAmountEntry/", data).
                    then(function (promise) {
