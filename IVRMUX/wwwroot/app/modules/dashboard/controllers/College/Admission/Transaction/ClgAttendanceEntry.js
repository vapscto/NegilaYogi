(function () {
    ...
    angular
        .module('app')
        .controller('ClgAttendanceEntryController', ClgAttendanceEntryController)
    ClgAttendanceEntryController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function ClgAttendanceEntryController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
        $scope.obj = {};
