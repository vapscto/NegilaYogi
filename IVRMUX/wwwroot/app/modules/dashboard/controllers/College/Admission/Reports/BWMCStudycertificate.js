(function () {
    ...
    angular
        .module('app')
        .controller('CollegeBWMCStudyCertificate', CollegeBWMCStudyCertificate)

    CollegeBWMCStudyCertificate.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache']
    function CollegeBWMCStudyCertificate($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache) {
