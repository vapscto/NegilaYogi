(function () {
    'use strict';
    angular.module('app').controller('StatewiseStudentAdmissionController', StatewiseStudentAdmissionController)

    StatewiseStudentAdmissionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function StatewiseStudentAdmissionController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.onreport = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.detail_state === true) {
                    ...
                    stateid = obj.ivrmmS_Id.ivrmmS_Id;
                }
