(function () {
    ...
    angular
        .module('app')
        .controller('StudentActiveInactiveReportController', StudentActiveInactiveReportController)
    StudentActiveInactiveReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function StudentActiveInactiveReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        $scope.pagesrecord = {};
        $scope.students = [];
        $scope.adtable = true;
        $scope.searchValue = '';
        ...
        $scope.getpagesname = function () {
            $scope.currentPage = 1;
            var pageid = 1;
            apiService.getURI("StudentActiveInactiveReport/getdata", pageid).
        ...
        $scope.onacademicyearchange = function () {    
            ...
            apiService.create("StudentActiveInactiveReport/onacademicyearchange", data).
                then(function (promise) {               
        ...
        $scope.oncoursechange = function () {            
            ...
            apiService.create("StudentActiveInactiveReport/oncoursechange", data).then(function (promise) {
        ...
        $scope.onbranchchange = function () {           
            ...
            apiService.create("StudentActiveInactiveReport/onbranchchange", data).then(function (promise) {
        ...
        $scope.onchangesemester = function () {           
            ...
            apiService.create("StudentActiveInactiveReport/onchangesemester", data).then(function (promise) {
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StudentActiveInactiveReport/getreport", data).then(function (promise) {
