(function () {
    'use strict';
    angular.module('app').controller('CollegeMultiHoursAttendanceEntryController', CollegeMultiHoursAttendanceEntryController)
    CollegeMultiHoursAttendanceEntryController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$stateParams', '$filter']
    function CollegeMultiHoursAttendanceEntryController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $stateParams, $filter) {
        $scope.obj = {};
        ...
        $scope.loaddata = function () {
            var pageid = 2;
            var dataf, datat;
            apiService.getURI("CollegeMultiHoursAttendanceEntry/balgetalldetails", pageid).then(function (promise) {
        ...
        $scope.onyearchange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getCoursedata", data).then(function (promise) {
        ...
        $scope.onCoursechange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getBranchdata", data).then(function (promise) {
        ...
        $scope.onBranchchange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getSemesterdata", data).then(function (promise) {
                if ($scope.multibranch == 1) {
        ...
        $scope.onSemchange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getSectiondata", data).then(function (promise) {
                $scope.getSection = promise.getSection;
            });
        };
        ...
        $scope.onSectionchange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getSubjdata", data).then(function (promise) {
                $scope.ismS_Id = "";
                $scope.acaB_Id = "";
        ...
        $scope.onSubjectchange = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getBatchdata", data).then(function (promise) {
        ...
        $scope.get_Studentdetails = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.acaB_Id !== undefined && $scope.acaB_Id !== "") {
                ...
                apiService.create("CollegeMultiHoursAttendanceEntry/getStudentdata", data).then(function (promise) {
                        ...
                        for (var x = 0; x < promise.getStudentdetails.length; x++) {
                            ...
                            angular.forEach(promise.getStudentdetails, function (opq) {
                                if (opq.amcsT_Id == stu_id) {
                                    stu_subj_list.push({
                                        ...
                                        acysT_RollNo: opq.acysT_RollNo, amcsT_RegistrationNo: opq.amcsT_RegistrationNo,
                                        ttmP_Id: opq.ttmP_Id, amcO_Id: opq.amcO_Id, amB_Id: opq.amB_Id, amsE_Id: opq.amsE_Id,
                            ...
                            if (temp_list.length === 0) {
                                temp_list.push({
                                    ...
                                    amcsT_RegistrationNo: promise.getStudentdetails[x].amcsT_RegistrationNo,
                                    amcO_Id: promise.getStudentdetails[x].amcO_Id, 
                                    amB_Id: promise.getStudentdetails[x].amB_Id, amsE_Id: promise.getStudentdetails[x].amsE_Id,
        ...
        $scope.saveatt = function (objas) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CollegeMultiHoursAttendanceEntry/saveatt", data).then(function (promise) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        apiService.create("CollegeMultiHoursAttendanceEntry/delete", data).then(function (promise) {
        ...
        $scope.getsaveddatepreview = function () {
            ...
            apiService.create("CollegeMultiHoursAttendanceEntry/getsaveddatepreview", data).then(function (promise) {
                if (promise !== null) {
