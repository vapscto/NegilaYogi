(function () {
    ...
    angular
        .module('app')
        .controller('CollegesubjectpercentageattendanceController', CollegesubjectpercentageattendanceController)

    CollegesubjectpercentageattendanceController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$filter']
    function CollegesubjectpercentageattendanceController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $filter) {
        ...
        //    var exportHref = Excel.tableToExcel(export_id, 'studentpercentageattendancereport');
        //    $timeout(function () {
        ...
        $scope.getsubject = function () {
            ...
            apiService.create("CollegeDailyAttendance/getsubject", data).then(function (promise) {
                ...
                if ($scope.seclist234.length > 0) {
                    ...
                    swal("No Subjects Is Found For Selected List");
                }
        ...
        $scope.onreport = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CollegeDailyAttendance/onreportpercentage", data).
                    then(function (promise) {
