(function () {
    'use strict';
    angular.module('app').controller('CollegeBWMCTCCertificate', CollegeBWMCTCCertificate)

    CollegeBWMCTCCertificate.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function CollegeBWMCTCCertificate($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        var data1;
        var frommonth;
        var tomonth;
        $scope.tcpdf = false;
