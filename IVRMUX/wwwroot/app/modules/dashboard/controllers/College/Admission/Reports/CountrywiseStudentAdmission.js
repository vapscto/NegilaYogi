(function () {
    ...
    angular
        .module('app')
        .controller('CountrywiseStudentAdmissionController', CountrywiseStudentAdmissionController)

    CountrywiseStudentAdmissionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function CountrywiseStudentAdmissionController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        if (ivrmcofigsettings.length !== null && ivrmcofigsettings.length !== 0  && ivrmcofigsettings.length !== undefined) {
        ...
        if (admfigsettings.length !== null && admfigsettings.length !== 0 && admfigsettings.length !== undefined) {
        ...
        $scope.onreport = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.detail_state === true) {
                    ...
                    stateid = obj.ivrmmC_Id.ivrmmC_Id;
                }
                ...
                apiService.create("StatewiseStudentAdmission/onreportcountry", data).
                    then(function (promise) {
