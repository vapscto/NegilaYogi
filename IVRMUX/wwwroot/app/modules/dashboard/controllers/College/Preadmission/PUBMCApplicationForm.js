(function () {
    ...
    angular
        .module('app')
        .controller('PUBMCApplicationFormController', PUBMCApplicationFormController);


    PUBMCApplicationFormController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', '$compile']
    function PUBMCApplicationFormController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, $compile) {
        ...
        $scope.BindData = function () {
            ...
            apiService.create("ApplicationForm/Getdetails/", data).
                then(function (promise) {
                    ...
                    angular.forEach($scope.subjectlistlag, function (ee) {

                        if (ee.ismS_SubjectName.toLowerCase() == 'english') {
                            ee.select = true;
                        }
            ...
            apiService.getURI("ApplicationForm/Edit/", MEditId).
                then(function (promise) {
                    ...
                    if (promise.studentList != null || promise.studentList.length > 0) {
                        ...
                        $scope.obj.PACA_VISANo = promise.studentList[0].pacA_VISANo;
                        ...
                        angular.forEach(promise.subjectlist, function (ee) {
                            ...
                            angular.forEach($scope.subjectlistlag, function (gg) {
                                ...
                                if (gg.ismS_SubjectName.toLowerCase() == 'english') {
                                    gg.select = true;
                                }
                            })
        ...
        $scope.showprintdata = function (studentid) {
            ...
            apiService.getURI("ApplicationForm/getprintdata/", studentid).then(function (promise) {
                ...
                if (promise.studentList != null || promise.studentList.length > 0) {
                    ...
                    if (promise.studentList[0].pacA_MedOfInstruction != null && promise.studentList[0].pacA_MedOfInstruction != '' && promise.studentList[0].pacA_MedOfInstruction != undefined) {
                        $scope.PACA_MedOfInstruction = promise.studentList[0].pacA_MedOfInstruction.toLowerCase();;
                    }
                    ...
                    $scope.PACA_VISANo = promise.studentList[0].pacA_VISANo;
                    $scope.PACA_VISAValidFrom = promise.studentList[0].pacA_VISAValidFrom;
                    $scope.PACA_VISAValidFrom1 = new Date(promise.studentList[0].pacA_VISAValidFrom);
        ...
        $scope.clear_fourth_tab = function () {
            ...
            for (var i = 0; i < $scope.prevSchoolDetails.length; i++) {
                ...
                $scope.prevSchoolDetails[i].pacstpS_PreviousGrade = "";
                $scope.prevSchoolDetails[i].pacstpS_PreviousRegNo = "";
        ...
        $scope.savefinaltab = function () {
            if ($scope.myForm5.$valid) {
                ...
                var data = {
                    ...
                    "PACA_VISANo": $scope.obj.PACA_VISANo,
