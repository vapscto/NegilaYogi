...
(function () {
    ...
    DocumentViewClgController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', 'Excel', '$timeout']
    function DocumentViewClgController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, Excel, $timeout) {
        ...
        $scope.loaddata = function () {
            apiService.get("DocumentViewClg/getdetails/2").
        ...
        $scope.ShowReport = function (enq) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("DocumentViewClg/Getregdata", data).
                    then(function (promise) {
