...
(function () {
    'use strict';
    angular.module('app').controller('clgManagerDashboardController', clgManagerDashboardController)
    clgManagerDashboardController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'superCache', '$window', 'uiCalendarConfig']
    function clgManagerDashboardController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, superCache, $window, uiCalendarConfig) {
        $scope.sms = 0;
        $scope.email = 0;
        $scope.hidecoe = false;
