...
(function () {
    ...
    angular
        .module('app')
        .controller('CLGCHStudentStrengthController', CLGCHStudentStrengthController)

    CLGCHStudentStrengthController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'superCache', '$window', 'uiGridGroupingConstants']
    function CLGCHStudentStrengthController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, superCache, $window, uiGridGroupingConstants) {
        ...
        $scope.Binddata = function () {
            ...
            apiService.getDATA("CLGCHStudentStrength/Getdetails").
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                { name: 'ACMS_SectionName', displayName: 'Section', grouping: { groupPriority: 3 }, sort: { priority: 2, direction: 'asc' }, width: '10%' },
                {
        ...
        $scope.OnAcdyear = function (asmaY_Id) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CLGCHStudentStrength/yrchange", data).
                    then(function (promise) {
                        $scope.studentstrenth = promise.fillstudentstrenth;
                        $scope.gridOptions.data = $scope.studentstrenth;
