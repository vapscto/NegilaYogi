(function () {
    ...
    angular
        .module('app')
        .controller('ClgStudentMeetingProfileController', ClgStudentMeetingProfileController);

    ClgStudentMeetingProfileController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache'];
    function ClgStudentMeetingProfileController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getDATA("ClgLiveMeetingSchedule/getstudentdetails").then(function (promise) {
        ...
        $scope.stopstreeming = function (user) {
            ...
            $scope.ttt = false;
            apiService.create("ClgLiveMeetingSchedule/endmainmeetingstudent", data).then(function (promise) {
        ...
        $scope.joinmeeting = function (user) {
            ...
            $scope.topic = user.lmslmeeT_MeetingTopic;
            $scope.meetid = user.lmslmeeT_Id
            apiService.create("ClgLiveMeetingSchedule/joinmeetingStudent", user).then(function (promise) {
                //$scope.meetinglist = promise.meetinglist;
        ...
        $scope.ondatechange = function () {
            ...
            apiService.create("ClgLiveMeetingSchedule/ondatechangestudent", data).then(function (promise) {
