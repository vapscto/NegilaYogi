     ...
     (function () {
         ...
         angular
     .module('app')
             .controller('Clg_HODCasteWiseStudentStrengthController', Clg_HODCasteWiseStudentStrengthController)

         Clg_HODCasteWiseStudentStrengthController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'superCache', '$window','uiGridGroupingConstants']
         function Clg_HODCasteWiseStudentStrengthController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, superCache, $window, uiGridGroupingConstants) {
        ...
        $scope.studentstrenthgr = false;
                 ...
                 apiService.getDATA("Clg_HODCasteWiseStudentStrength/Getdetails").
      then(function (promise) {
          ...
          if ($scope.studentstrenth.length > 0) {
             ...
             $scope.showsectionGrid = function (classid) {
                 ...
                 apiService.create("Clg_HODCasteWiseStudentStrength/Getsectioncount", data).
               then(function (promise) {
    ...
    $scope.OnAcdyear = function (asmaY_Id) {
       ...
       // alert(asmaY_Id)
        $scope.fields();
            ...
            apiService.getURI("Clg_HODCasteWiseStudentStrength/yrchange", asmaY_Id).
      then(function (promise) {
          $scope.studentstrenth = promise.fillstudentstrenth;
          $scope.gridOptions.data = $scope.studentstrenth;
