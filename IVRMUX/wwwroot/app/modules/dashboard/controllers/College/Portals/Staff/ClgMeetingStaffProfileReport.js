(function () {
    ...
    angular
        .module('app')
        .controller('ClgMeetingStaffProfileReportController', ClgMeetingStaffProfileReportController);

    ClgMeetingStaffProfileReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', 'Excel','$timeout'];
    function ClgMeetingStaffProfileReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, Excel, $timeout) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getDATA("ClgLiveMeetingSchedule/getschrptdetailsprofile").then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            var data = {
                ...
                apiService.create("ClgLiveMeetingSchedule/getstaffprofilereport", data).
