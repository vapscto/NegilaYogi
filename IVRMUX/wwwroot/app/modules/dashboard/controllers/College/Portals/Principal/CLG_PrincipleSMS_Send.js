...
(function () {
    ...
    angular
        .module('app')
        .controller('CLG_PrincipleSMS_SendController', CLG_PrincipleSMS_SendController)
    CLG_PrincipleSMS_SendController.$inject = ['$rootScope', '$scope', '$state', '$location', 'dashboardService', 'Flash', 'apiService', '$stateParams', '$filter', 'superCache']
    function CLG_PrincipleSMS_SendController($rootScope, $scope, $state, $location, dashboardService, Flash, apiService, $stateParams, $filter, superCache) {
        ...
        $scope.changeradio = function () {           
            ...
            if ($scope.radioval == 'Student') {
                ...
                $scope.studentList = [];
                apiService.create("CLG_PrincipleSMS_Send/Getdetails/", data).
            ...
            if ($scope.radioval == 'Staff') {
                ...
                $scope.employeelst = [];
                $scope.stfmsg = "";
                apiService.getURI("CLG_PrincipleSMS_Send/Getdepartment", id).
                    then(function (promise) {
        ...
        $scope.getCourse = function () {          
            ...
            apiService.create("CLG_PrincipleSMS_Send/getCourse", data).
                then(function (promise) {
        ...
        $scope.getBranch = function () {            
            ...
            apiService.create("CLG_PrincipleSMS_Send/getBranch", data).
                then(function (promise) {                  
        ...
        $scope.getSemister = function () {
            ...
            apiService.create("CLG_PrincipleSMS_Send/getSemister", data).
                then(function (promise) {
        ...
        $scope.get_designationnew = function () {
            ...
            if (groupidss != undefined) {
                ...
                apiService.create("CLG_PrincipleSMS_Send/get_designation", data).
                    then(function (promise) {
        ...
        $scope.get_employeenew = function () {
            ...
            if (groupidss != undefined) {
                ...
                apiService.create("CLG_PrincipleSMS_Send/get_employee", data).
                    then(function (promise) {
        ...
        $scope.GetStudentDetails = function () {
            ...
            apiService.create("CLG_PrincipleSMS_Send/GetStudentDetails/", data).
                then(function (promise) {
                    ...
                    if (promise.studentCount > 0) {
                        ...
                        swal("No records found for selected academicYear,course,branch and semister");
                        $scope.studentList = "";
                        $scope.count = 0;
                    }
                });
        ...
        $scope.SendData = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CLG_PrincipleSMS_Send/savedetail", Send).then(function (promise) {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            apiService.create("CLG_PrincipleSMS_Send/savedetail", data).then(function (promise) {
                                debugger;
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            ...
                            apiService.create("CLG_PrincipleSMS_Send/savedetail", data)
                                .then(function (promise) {
                                    if (promise.smsStatus == 'sent') {
                                        swal("SMS/EMAIL Sent Successfully.");
                                        $state.reload();
        ...
        $scope.optionToggled = function (SelectedStudentRecord, index) {
            $scope.all = $scope.employeelst.every(function (itm) { return itm.selected; });
