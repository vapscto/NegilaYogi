...
(function () {
    ...
    angular
        .module('app')
        .controller('ClgExamStandardController', ClgExamStandardController)

    ClgExamStandardController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function ClgExamStandardController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {


        $scope.BindData = function () {
            apiService.getDATA("ClgExamStandard/Getdetails").then(function (promise) {
                if (promise.exm_config.length === 0) {
                    ...
                    // $scope.ExmConfig_Recordsearchtype = 'Name';
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("ClgExamStandard/savedetails", data).then(function (promise) {
