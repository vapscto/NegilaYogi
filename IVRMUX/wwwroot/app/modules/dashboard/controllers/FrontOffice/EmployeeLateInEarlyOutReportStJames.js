(function () {
    ...
    angular
.module('app')
        .controller('EmployeeLateInEarlyOutReportStJamesController', EmployeeLateInEarlyOutReportStJamesController)

    EmployeeLateInEarlyOutReportStJamesController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$stateParams', '$filter']
    function EmployeeLateInEarlyOutReportStJamesController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $stateParams, $filter) {
                    ...
                    apiService.create("EmployeeLateInEarlyOutReport/getrpt", data).
                        then(function (promise) {
                            if (promise.filldata.length > 0) {
                                ...
                                $scope.newformatdata = promise.filldata;
                            }
                            else {
                                $scope.grid_view = false;
