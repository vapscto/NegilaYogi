(function () {
    ...
    angular
.module('app')
.controller('EmployeeYearlyReportController', EmployeeYearlyReportController)

    EmployeeYearlyReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', '$filter']
    function EmployeeYearlyReportController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, $filter) {
        $scope.maxDatemf = new Date();
        //loading start
        $scope.loadData = function () {
            var id = 2;
            
            apiService.getURI("EmployeeYearlyReport/getalldetails", id).
        ...
        $scope.get_departments = function () {
            ...
            if (groupidss != undefined) {
                ...
                apiService.create("EmployeeYearlyReport/get_departments", data).
                then(function (promise) {
        ...
        $scope.get_designationnew = function () {
            ...
            if (groupidss != undefined) {
                ...
                apiService.create("EmployeeYearlyReport/get_designation", data).
                then(function (promise) {
        ...
        $scope.get_employeenew = function () {
            ...
            if (groupidss != undefined) {
                ...
                apiService.create("EmployeeYearlyReport/get_employee", data).
                then(function (promise) {
            ...
            if ($scope.myForm.$valid) {
                ...
                if (groupidss != undefined) {
                    ...
                    data = {
                        ...
                        apiService.create("EmployeeYearlyReport/getrpt", data).
                        then(function (promise) {
