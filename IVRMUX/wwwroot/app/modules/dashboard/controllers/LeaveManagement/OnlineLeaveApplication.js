...
(function () {
    ...
    angular
.module('app')
.controller('OnlineLeaveApplicationController', OnlineLeaveApplicationController)
    OnlineLeaveApplicationController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$stateParams', '$filter', '$sce','$window']
    function OnlineLeaveApplicationController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $stateParams, $filter, $sce, $window) {
        $scope.hstep = 1;
        $scope.mstep = 1;
