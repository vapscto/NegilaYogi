(function () {
    ...
    angular
        .module('app')
        .controller('VBSC_Events_MappingController', VBSC_Events_MappingController)
    VBSC_Events_MappingController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$window', '$stateParams', '$filter', 'superCache', '$q']
    function VBSC_Events_MappingController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $window, $stateParams, $filter, superCache, $q) {
