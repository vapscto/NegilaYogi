...
(function () {
    ...
    angular
        .module('app')
        .controller('DisposeReportController', DisposeReportController);
    DisposeReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout', '$filter'];
    function DisposeReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout, $filter) {
        ...
        $scope.loaddata = function () {
            ...
            $scope.search = "";
            var pageid = 2;
            apiService.getURI("DisposeReport/getloaddata", pageid).
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("DisposeReport/getreport", data).then(function (promise) {
        ...
        $scope.exportToExcel = function (export_id) {
            ...
            var exportHref = Excel.tableToExcel(export_id, 'printdispose');
            $timeout(function () {
