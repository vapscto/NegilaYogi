(function () {
    ...
    angular
        .module('app')
        .controller('naacQualifyingExamController', naacQualifyingExamController);

    naacQualifyingExamController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', '$q', '$sce'];
    function naacQualifyingExamController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, $q, $sce) {
