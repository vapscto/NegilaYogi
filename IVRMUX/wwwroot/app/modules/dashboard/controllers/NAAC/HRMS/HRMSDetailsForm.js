(function () {
    ...
    naacHrmsDetailsController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', '$q', '$sce', '$window'];
    function naacHrmsDetailsController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, $q, $sce,$window) {
        ...
        $scope.selectFileforUploadzd = function (input, document) {
            ...
            if (input.files && input.files[0]) {
                ...
                else if (extention !== "JPEG" && extention !== "jpg" && extention !== "JPG" && extention !== "pdf" && extention !== "xls" && extention !== "xlsx" && extention !== "doc" & extention !== "docx") {
                    $('#' + document.id).removeAttr('src');
        ...
        $scope.selectFileforUploadzdStuActivity = function (input, document) {
            ...
            if (input.files && input.files[0]) {
                ...
                document.extention = nameArray[nameArray.length - 1];
               /* if ((extention === "JPEG" || extention === "jpg" || extention === "JPG" || extention === "pdf") && input.files[0].size <= 2097152)*/  // 2097152 bytes = 2MB 
                    if ((extention === "JPEG" || extention === "jpg" || extention === "JPG" || extention === "pdf" || extention === "xls" || extention === "xlsx" || extention === "doc" || extention === "docx")  && input.files[0].size <= 2097152) 
                {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        $('#' + document.id) //hrmedS_Id
                    ...
                    && extention !== "xls" && extention !== "xlsx" && extention !== "doc" & extention !== "docx") {
                    $('#' + document.id).removeAttr('src');
                    swal("Please Upload the valid file");
                    return;
                } else if (input.files[0].size > 2097152) {
        ...
        $scope.showmodaldetailsStuActivity = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
                //$('#preview').attr('src', data.hresacT_Document);
                $window.open(data.hresacT_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.selectFileforUploadzdProfActivity = function (input, document) {
            ...
            if (input.files && input.files[0]) {
                ...
                var extention = nameArray[nameArray.length - 1];
                document.extention = nameArray[nameArray.length - 1];
                if ((extention === "JPEG" || extention === "jpg" || extention === "JPG" || extention === "pdf" || extention === "xls" || extention === "xlsx" || extention === "doc" || extention === "docx") && input.files[0].size <= 2097152)  // 2097152 bytes = 2MB 
                {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        $('#' + document.id) //hrmedS_Id
        ...
        $scope.showmodaldetailsProfActivity = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').attr('src', data.hredacT_Document);
                $window.open(data.hredacT_Document);
            }
            else if (extention === "pdf") {
            ...
            if ($scope.myForm4.$valid) {
                ...
                if ($scope.HRME_IDSelected !== null && $scope.HRME_IDSelected > 0) {
                    if (duplicateda) {
                        ...
                        apiService.create("naacHrmsDetails/SaveData", data).then(function (promise) {
                            if (promise.retrunMsg !== "") {
                                if (promise.retrunMsg === "Duplicate") {
                                    swal("Record already exist..!!");
                                    return;
        ...
        $scope.showmodaldetailsResProject = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
               // $('#preview').attr('src', data.hrerepR_Document);
                $window.open(data.hrerepR_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsResGuidance = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
                //$('#preview').attr('src', data.hreregU_Document);
                $window.open(data.hreregU_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsBOSBOE = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
               // $('#preview').attr('src', data.hreboS_Document);
                $window.open(data.hreboS_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsConference = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
                //$('#preview').attr('src', data.hreconF_Document);
                $window.open(data.hreconF_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsBook = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
                //$('#preview').attr('src', data.hrebK_Document);
                $window.open(data.hrebK_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsBookChapter = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
                //$('#preview').attr('src', data.hrebkcP_Document);
                $window.open(data.hrebkcP_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsCommettee = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
               // $('#preview').attr('src', data.hrecoM_Document);
                $window.open(data.hrecoM_Document);
            }
            else if (extention === "pdf") {
        ...
        $scope.showmodaldetailsOtherDetail = function (data) {
            ...
            if (extention === "jpg" || extention === "jpeg") {
                ...
                //$('#preview').removeAttr('src');
               //$('#preview').attr('src', data.hreothdeT_Document);
                $window.open(data.hreothdeT_Document);
            }
            else if (extention === "pdf") {
