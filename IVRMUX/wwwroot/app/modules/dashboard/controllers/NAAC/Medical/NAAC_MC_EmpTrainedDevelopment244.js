(function () {
    ...
    angular
        .module('app')
        .controller('EmpTrainedDevelopment244', EmpTrainedDevelopment244)

    EmpTrainedDevelopment244.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];
    function EmpTrainedDevelopment244($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("NAAC_MC_EmpTrainedDevelopment244/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.save = function () {
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    "NCMCETD244_Id": $scope.NCMCETD244_Id,
                    "asmaY_Id": $scope.NCMCETD244_Year,
                    "NCMCETD244_NoOfTechersTrainedForDevOfEcontents": $scope.NCMCETD244_NoOfTechersTrainedForDevOfEcontents,
                    "NCMCETD244_TotalNoOfTeachers": $scope.NCMCETD244_TotalNoOfTeachers,
                  
                    filelist: $scope.materaldocuupload,
                    "MI_Id": $scope.mI_Id
                }

                apiService.create("NAAC_MC_EmpTrainedDevelopment244/save", data).then(function (promise) {
        ...
        $scope.deactivYTab1 = function (usersem, SweetAlert) {
            ...
            var dystring = "";
            if (usersem.ncmcetD244_ActiveFlag == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncmcetD244_ActiveFlag == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAAC_MC_EmpTrainedDevelopment244/deactive", usersem).
        ...
        $scope.edittab1 = function (user) {
            ...
            var data = {
                "NCMCETD244_Id": user.ncmcetD244_Id,
                "MI_Id": user.mI_Id
            }
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/EditData", data).then(function (promise) {
                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCMCETD244_Id = promise.editlist[0].ncmcetD244_Id;
                    $scope.NCMCETD244_Year = promise.editlist[0].ncmcetD244_Year;
                    $scope.NCMCETD244_NoOfTechersTrainedForDevOfEcontents = promise.editlist[0].ncmcetD244_NoOfTechersTrainedForDevOfEcontents;
                    $scope.NCMCETD244_TotalNoOfTeachers = promise.editlist[0].ncmcetD244_TotalNoOfTeachers;
        ...
        $scope.viewdocument = function (obj) {
            ...
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            var data = {
                "NCMCETD244F_Id": docfile.ncmcetD244F_Id,
                "NCMCETD244_Id": docfile.ncmcetD244_Id,
                "MI_Id": docfile.mI_Id
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAAC_MC_EmpTrainedDevelopment244/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.change_institution = function () {
            $scope.NCMCETD244_Year = '';
            $scope.NCMCETD244_NoOfTechersTrainedForDevOfEcontents = '';
            $scope.NCMCETD244_TotalNoOfTeachers = '';
        ...
        $scope.getorganizationdata = function (obj) {
            debugger;
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/getcomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.getorganizationdata1 = function (obj) {
            debugger;
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/getfilecomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/savemedicaldatawisecomments", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            apiService.create("NAAC_MC_EmpTrainedDevelopment244/savefilewisecomments", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
                        swal("Comments Saved Successfully");
                    } else {
