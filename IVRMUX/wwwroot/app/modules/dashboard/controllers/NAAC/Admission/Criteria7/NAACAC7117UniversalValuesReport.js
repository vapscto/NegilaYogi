(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC7117UniversalValuesReportController', NAACAC7117UniversalValuesReportController)

    NAACAC7117UniversalValuesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC7117UniversalValuesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
