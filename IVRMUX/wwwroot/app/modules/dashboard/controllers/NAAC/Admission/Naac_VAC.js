...
(function () {
    ...
    angular
        .module('app')
        .controller('Naac_VACController', Naac_VACController);

    Naac_VACController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function Naac_VACController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.getorganizationdata = function (obj) {
            apiService.create("Naac_VAC/getcommentmaster", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.getorganizationdata1 = function (obj) {
            apiService.create("Naac_VAC/getfilecommentmaster", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("Naac_VAC/savemedicaldatawisecommentsmaster", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            apiService.create("Naac_VAC/savefilewisecommentsmaster", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
                        swal("Comments Saved Successfully");
                    } else {
        ...
        $scope.savedataadavance = function (gridOptions) {
            ...
            $scope.headers = ["IntroductionYear", "CourseName", "CourseCode"];
            var data = {};
            ...
            if (excellvalidatecount == 3) {
                ...
                apiService.create("Naac_VAC/saveadvance", data).
                    then(function (promise) {
