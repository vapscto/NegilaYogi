(function () {
    ...
    angular
        .module('app')
        .controller('NAAC_811MC_NEET', NAAC_811MC_NEET);
    NAAC_811MC_NEET.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];
    function NAAC_811MC_NEET($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var id = 2;
            apiService.getURI("NAAC_811MC_NEET/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.savedata = function () {
            ...
            if ($scope.myForm.$valid) {
                    ...
                    var data = {
                        "NCMC811NEET_Id": $scope.NCMC811NEET_Id,
                        "ASMAY_Id": $scope.NCMC811NEET_Year,
                        "NCMC811NEET_NoOfStudentsEnrolled": $scope.NCMC811NEET_NoOfStudentsEnrolled,
                        "NCMC811NEET_Range": $scope.NCMC811NEET_Range,
                        "NCMC811NEET_Mean": $scope.NCMC811NEET_Mean,
                        "NCMC811NEET_StandardDeviation": $scope.NCMC811NEET_StandardDeviation,
                        "filelist": $scope.materaldocuupload,
                        "MI_Id": $scope.mI_Id
                    }
               
                apiService.create("NAAC_811MC_NEET/savedata", data).then(function (promise) {
        ...
        $scope.edit = function (user) {
            var data = {
                "NCMC811NEET_Id": user.ncmC811NEET_Id,
                "MI_Id": user.mI_Id

            }
            apiService.create("NAAC_811MC_NEET/editdata", data).then(function (promise) {
                if (promise.editlist.length > 0) {

                    $scope.instit = true;
                    $scope.editflag = true;
                    //  $scope.emplist = promise.emplist;
                    $scope.NCMC811NEET_Id = promise.editlist[0].ncmC811NEET_Id;
                    $scope.NCMC811NEET_Year = promise.editlist[0].ncmC811NEET_Year;
                    $scope.NCMC811NEET_NoOfStudentsEnrolled = promise.editlist[0].ncmC811NEET_NoOfStudentsEnrolled;
                    $scope.NCMC811NEET_Range = promise.editlist[0].ncmC811NEET_Range;
                    $scope.mI_Id = promise.editlist[0].mI_Id;
                    $scope.NCMC811NEET_Mean = promise.editlist[0].ncmC811NEET_Mean;
                    $scope.NCMC811NEET_StandardDeviation = promise.editlist[0].ncmC811NEET_StandardDeviation;
        ...
        $scope.deactiveY = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmC811NEET_ActiveFlg == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncmC811NEET_ActiveFlg == false) {
                dystring = "Activate";
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAAC_811MC_NEET/deactivY", usersem).
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("NAAC_811MC_NEET/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        //    var data = {
        //        "NCMC811NEETF_Id": docfile.ncmC811NEETF_Id,
        //        "NCMC811NEET_Id": docfile.ncmC811NEET_Id,
        //    }
        //    apiService.create("NAAC_811MC_NEET/deleteuploadfile", data).then(function (promise) {
        //        if (promise.returnval == true) {
        ...
        $scope.change_institution = function () {
            $scope.NCMC811NEET_Id = 0;
            $scope.NCMC811NEET_Year = '';
            $scope.NCMC811NEET_NoOfStudentsEnrolled = '';
            $scope.NCMC811NEET_Range = '';
            $scope.NCMC811NEET_Mean = '';
            $scope.NCMC811NEET_StandardDeviation = '';
        ...
        $scope.getlocationaldata = function (obj) {
            ...
            apiService.create("NAAC_811MC_NEET/getcomment", obj).then(function (promise) {
        ...
        $scope.getlocationaldata1 = function (obj) {
            apiService.create("NAAC_811MC_NEET/getfilecomment", obj).then(function (promise) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("NAAC_811MC_NEET/savecomments", data).then(function (promise) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            apiService.create("NAAC_811MC_NEET/savefilewisecomments", data).then(function (promise) {
        ...
        $scope.adddatawisecomments = function (dd) {
            ...
            console.log(dd);
            $scope.obj.filefkid = dd.ncmC811NEET_Id;
        ...
        $scope.viewdatawisecomments = function (obj) {
            ...
            var data = {
                ...
                "filefkid": obj.ncmC811NEET_Id
            };
            apiService.create("NAAC_811MC_NEET/viewmedicaldatawisecomments", data).then(function (promise) {
                if (promise !== null) {
