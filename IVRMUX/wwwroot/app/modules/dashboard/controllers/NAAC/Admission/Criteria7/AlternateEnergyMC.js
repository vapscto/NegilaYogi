...
(function () {
    'use strict';
    angular.module('app').controller('AlternateEnergyMCController', AlternateEnergyMCController);

    AlternateEnergyMCController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function AlternateEnergyMCController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.getDataMC = function (mI_Id) {
            $scope.equityid = 0;
            var id = mI_Id;
            apiService.getURI("AlternateEnergy/getDataMC", id).then(function (promise) {
        ...
        $scope.savedatatab1 = function () {
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    ...
                    "NCMC713ALTENE_Id": $scope.equityid,
                    "NCMC713ALTENE_Year": $scope.page.ncmC713ALTENE_Year,
                    "NCMC713ALTENE_SolarenergyFlag": $scope.page.ncmC713ALTENE_SolarenergyFlag,
                    "NCMC713ALTENE_WindenergyFlag": $scope.page.ncmC713ALTENE_WindenergyFlag,
                    "NCMC713ALTENE_SensorbasedEnergyFlag": $scope.page.ncmC713ALTENE_SensorbasedEnergyFlag,
                    "NCMC713ALTENE_BiogasPlantFlag": $scope.page.ncmC713ALTENE_BiogasPlantFlag,
                    "NCMC713ALTENE_LEDbulbsORPowerefficEquipFlag": $scope.page.ncmC713ALTENE_LEDbulbsORPowerefficEquipFlag,
                };
                apiService.create("AlternateEnergy/saveMC", data).then(function (promise) {
        ...
        $scope.edittab1 = function (data) {
            apiService.create("AlternateEnergy/EditDataMC", data).then(function (promise) {
                $scope.equityid = data.ncmC713ALTENE_Id;
        ...
        $scope.deactivYTab1 = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmC713ALTENE_ActiveFlg == true) {
                dystring = "Deactivated";
            }
            else if (usersem.ncmC713ALTENE_ActiveFlg == false) {
                dystring = "Activated";
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("AlternateEnergy/deactivateMC", usersem).
