(function () {
    ...
    angular
        .module('app')
        .controller('DifferentlyAbledMCReportController', DifferentlyAbledMCReportController)

    DifferentlyAbledMCReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function DifferentlyAbledMCReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
