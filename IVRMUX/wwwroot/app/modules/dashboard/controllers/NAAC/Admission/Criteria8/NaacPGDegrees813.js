...
(function () {
    ...
    angular
        .module('app')
        .controller('NaacPGDegrees813', NaacPGDegrees813);

    NaacPGDegrees813.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function NaacPGDegrees813($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("NaacPGDegrees813/loaddata", $scope.mI_Id).
                then(function (promise) {
               
                    $scope.institutionlist = promise.institutionlist;
                    $scope.mI_Id = promise.mI_Id;
                    $scope.allacademicyear = promise.allacademicyear;
                   // $scope.compacademicyear = promise.compacademicyear;
        ...
        $scope.deactive = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmC813PGDE_ActiveFlg == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncmC813PGDE_ActiveFlg == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NaacPGDegrees813/deactive", usersem).
                            then(function (promise) {
        ...
        $scope.edittab1 = function (user) {
            var data = {
                "NCMC813PGDE_Id": user.ncmC813PGDE_Id,
                "MI_Id": user.mI_Id
            }

            apiService.create("NaacPGDegrees813/EditData", data).then(function (promise) {
           
                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCMC813PGDE_Id = promise.editlist[0].ncmC813PGDE_Id;
                    $scope.NCMC813PGDE_JoinYear = promise.editlist[0].ncmC813PGDE_JoinYear;
                    $scope.NCMC813PGDE_NoOfTeachers = promise.editlist[0].ncmC813PGDE_NoOfTeachers;
                    $scope.NCMC813PGDE_CompletedYear = promise.editlist[0].ncmC813PGDE_CompletedYear;
                    $scope.NCMC813PGDE_DegreeFromInst = promise.editlist[0].ncmC813PGDE_DegreeFromInst;
        ...
        $scope.save = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    "NCMC813PGDE_Id": $scope.NCMC813PGDE_Id,
                    "NCMC813PGDE_JoinYear": $scope.NCMC813PGDE_JoinYear,
                    "NCMC813PGDE_NoOfTeachers": $scope.NCMC813PGDE_NoOfTeachers,
                    "NCMC813PGDE_CompletedYear": $scope.NCMC813PGDE_CompletedYear,
                    "NCMC813PGDE_DegreeFromInst": $scope.NCMC813PGDE_DegreeFromInst,
                    "MI_Id": $scope.mI_Id,
                    filelist: $scope.materaldocuupload,
                }
               
                apiService.create("NaacPGDegrees813/save", data).then(function (promise) {
                    debugger;
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("NaacPGDegrees813/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            var data = {
                "NCMC813PGDEF_Id": docfile.ncmC813PGDEF_Id,
                "NCMC813PGDE_Id": docfile.ncmC813PGDE_Id,
                "MI_Id": docfile.mI_Id
            };
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NaacPGDegrees813/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.change_institution = function () {
            $scope.NCMC813PGDE_Id = 0;
            $scope.NCMC813PGDE_JoinYear = '';
            $scope.NCMC813PGDE_NoOfTeachers = '';
            $scope.NCMC813PGDE_CompletedYear = '';
            $scope.NCMC813PGDE_DegreeFromInst = '';
        ...
        $scope.getlocationaldata = function (obj) {
            ...
            apiService.create("NaacPGDegrees813/getcomment", obj).then(function (promise) {
        ...
        $scope.getlocationaldata1 = function (obj) {
            apiService.create("NaacPGDegrees813/getfilecomment", obj).then(function (promise) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("NaacPGDegrees813/savecomments", data).then(function (promise) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            apiService.create("NaacPGDegrees813/savefilewisecomments", data).then(function (promise) {
        ...
        $scope.viewdatawisecomments = function (obj) {
            ...
            apiService.create("NaacPGDegrees813/viewmedicaldatawisecomments", data).then(function (promise) {
                if (promise !== null) {
