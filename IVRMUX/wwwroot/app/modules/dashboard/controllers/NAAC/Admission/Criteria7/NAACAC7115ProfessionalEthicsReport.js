(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC7115ProfessionalEthicsReportController', NAACAC7115ProfessionalEthicsReportController)

    NAACAC7115ProfessionalEthicsReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC7115ProfessionalEthicsReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
