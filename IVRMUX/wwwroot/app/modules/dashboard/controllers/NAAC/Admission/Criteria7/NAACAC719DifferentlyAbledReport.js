(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC719DifferentlyAbledReportController', NAACAC719DifferentlyAbledReportController)

    NAACAC719DifferentlyAbledReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC719DifferentlyAbledReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
