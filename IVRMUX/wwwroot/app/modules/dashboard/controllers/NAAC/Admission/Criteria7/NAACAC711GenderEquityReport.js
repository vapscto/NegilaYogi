(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC711GenderEquityReportController', NAACAC711GenderEquityReportController)

    NAACAC711GenderEquityReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC711GenderEquityReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
