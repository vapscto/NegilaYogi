...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACInstShcrshipController', NAACInstShcrshipController);

    NAACInstShcrshipController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function NAACInstShcrshipController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
