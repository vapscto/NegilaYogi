...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACGovtShcrShipController', NAACGovtShcrShipController);
    ...
    function NAACGovtShcrShipController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.getURI("NAACGovtShcrShip/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.savedatatab1 = function () {
            ...
            if ($scope.myForm.$valid) {
                    var data = {
                        "MI_Id": $scope.mI_Id,
                        "NCAC511GSCH_Id": $scope.NCAC511GSCH_Id,
                        "NCAC511GSCH_Year": $scope.ASMAY_Id,
                        "NCAC511GSCH_SchemeName": $scope.NCAC511GSCH_SchemeName,
                        "NCAC511GSCH_NoOfStudents": $scope.NCAC511GSCH_NoOfStudents,
                        filelist: $scope.materaldocuupload,
                      
                    }
                apiService.create("NAACGovtShcrShip/save", data).then(function (promise) {
        ...
        $scope.getorganizationdata = function (obj) {
            apiService.create("NAACGovtShcrShip/getcomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.getorganizationdata1 = function (obj) {
            debugger;
            obj.ncaC511GSCHF_Id = obj.cfileid;
            apiService.create("NAACGovtShcrShip/getfilecomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            if ($scope.myFormc.$valid) {
                ...
                apiService.create("NAACGovtShcrShip/savemedicaldatawisecomments", data).then(function (promise) {
                    if (promise !== null) {
                        if (promise.returnval === true) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            if ($scope.myFormc1.$valid) {
                ...
                apiService.create("NAACGovtShcrShip/savefilewisecomments", data).then(function (promise) {
                    if (promise !== null) {
                        if (promise.returnval === true) {
                            swal("Comments Saved Successfully");
                        } else {
        ...
        $scope.edittab1 = function (data) {
            debugger;
            apiService.create("NAACGovtShcrShip/EditData", data).then(function (promise) {

                $scope.materaldocuupload = [{ id: 'Materal1' }];
                $scope.editlist = promise.editlist;
                $scope.NCAC511GSCH_Id = promise.editlist[0].ncaC511GSCH_Id;
                $scope.NCAC511GSCH_SchemeName = promise.editlist[0].ncaC511GSCH_SchemeName;
                $scope.ASMAY_Id = promise.editlist[0].ncaC511GSCH_Year;
                $scope.NCAC511GSCH_NoOfStudents = promise.editlist[0].ncaC511GSCH_NoOfStudents;
        ...
        $scope.deactivYTab1 = function (usersem, SweetAlert) {
            ...
            var dystring = "";
            if (usersem.ncaC511GSCH_ActiveFlg == true) {
                dystring = "Deactivated";
            }
            else if (usersem.ncaC511GSCH_ActiveFlg == false) {
                dystring = "Activated";
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAACGovtShcrShip/deactiveStudent", usersem).
        ...
        $scope.clrr = function () {
            ...
            $scope.NCAC511GSCH_SchemeName = '';
            $scope.NCAC511GSCH_Id = 0;
        ...
        $scope.viewdocument = function (obj) {
            ...
            apiService.create("NAACGovtShcrShip/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
                    debugger;
        ...
        $scope.deleteuploadfile = function (obj) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAACGovtShcrShip/deleteuploadfile", data).then(function (promise) {
