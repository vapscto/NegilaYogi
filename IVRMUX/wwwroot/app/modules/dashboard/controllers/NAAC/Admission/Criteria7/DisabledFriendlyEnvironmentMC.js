...
(function () {
    'use strict';
    angular.module('app').controller('DisabledFriendlyEnvironmentMCController', DisabledFriendlyEnvironmentMCController);

    DisabledFriendlyEnvironmentMCController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function DisabledFriendlyEnvironmentMCController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.getDataMC = function (mI_Id) {
            $scope.equityid = 0;
            var id = mI_Id;
            apiService.getURI("LEDBulbs/getDataMCdisable", id).then(function (promise) {
        ...
        $scope.savedatatab1 = function () {
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    ...
                    "NCMC717DFE_Id": $scope.equityid,
                    "NCMC717DFE_Year": $scope.page.ncmC717DFE_Year,
                    "NCMC717DFE_BuiltEnvwithRampsORLiftsFlag": $scope.page.ncmC717DFE_BuiltEnvwithRampsORLiftsFlag,
                    "NCMC717DFE_DisabledFriendlyWashroomsFlag": $scope.page.ncmC717DFE_DisabledFriendlyWashroomsFlag,
                    "NCMC717DFE_SignageIncTactilePathssignpostsFlag": $scope.page.ncmC717DFE_SignageIncTactilePathssignpostsFlag,
                    "NCMC717DFE_AssistiveTechnologyFacfacMEFlag": $scope.page.ncmC717DFE_AssistiveTechnologyFacfacMEFlag,
                    "NCMC717DFE_ProvisionForEnquiryScreenReadingFlag": $scope.page.ncmC717DFE_ProvisionForEnquiryScreenReadingFlag
                };
                apiService.create("LEDBulbs/saveMCdisable", data).then(function (promise) {
        ...
        $scope.edittab1 = function (data) {
            apiService.create("LEDBulbs/EditDataMCdisable", data).then(function (promise) {
                $scope.equityid = data.ncmC717DFE_Id;
        ...
        $scope.deactivYTab1 = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmC717DFE_ActiveFlg == true) {
                dystring = "Deactivated";
            }
            else if (usersem.ncmC717DFE_ActiveFlg == false) {
                dystring = "Activated";
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("LEDBulbs/deactivateMCdisable", usersem).
