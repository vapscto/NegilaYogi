(function () {
    ...
    angular
        .module('app')
        .controller('NAACMC716GreenCampusInitiativesReportController', NAACMC716GreenCampusInitiativesReportController)

    NAACMC716GreenCampusInitiativesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACMC716GreenCampusInitiativesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    ...
                    Type: "716GreenCampusInitiatives"
                };
