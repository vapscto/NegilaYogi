...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACQualifyMedController', NAACQualifyMedController);

    NAACQualifyMedController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function NAACQualifyMedController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.heading = "5.2.1 – Qualify (Master)";
        ...
        $scope.tabchange1 = function () {
            ...
            $scope.heading = "  5.2.1. Average percentage of students qualifying in state/ national/ international level examinations (eg: GATE/GMAT/GPAT /CAT/NEET / GRE / TOEFL / PLAB / USMLE / AYUSH / CivilServices / Defence / UPSC / State Government examinations / AIIMSPGET, JIPMER Entrance Test, PGIMER Entrance Test etc.,) ";
        ...
        $scope.clrr = function () {
            ...
            $scope.NCAC523QE_NoOfStudentsappearing = '';
            $scope.EXM_Id = '';
        ...
        $scope.savedatatab1 = function () {
            ...
            if ($scope.myForm.$valid) {
                if (parseInt($scope.NCAC523QE_NoOfStudents) <= parseInt($scope.NCAC523QE_NoOfStudentsappearing)) {
                ...
                var data = {
                    ...
                    "NCAC523QE_NoOfStudentsappearing": $scope.NCAC523QE_NoOfStudentsappearing,
                ...
                swal('NUMBER OF STUDENTS APPEARING SHOULD BE GREATER THAN NUMBER OF STUDENTS QUALIFYING!!!!!!')
            }
            }
            else {
        ...
        $scope.edittab1 = function (data) {
            ...
            apiService.create("NAACQualify/EditData", data).then(function (promise) {
                ...
                $scope.NCAC523QE_NoOfStudentsappearing = promise.editlist[0].ncaC523QE_NoOfStudentsappearing;
