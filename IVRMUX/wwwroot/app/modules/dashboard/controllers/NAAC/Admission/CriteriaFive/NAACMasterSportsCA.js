...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACMasterSportsCAController', NAACMasterSportsCAController);

    NAACMasterSportsCAController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function NAACMasterSportsCAController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
