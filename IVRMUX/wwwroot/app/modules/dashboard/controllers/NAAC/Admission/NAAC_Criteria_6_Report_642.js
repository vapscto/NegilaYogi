(function () {
    ...
    function NAAC_Criteria_6_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function () {
            ...
            var excelname = 'Criteria 6.4.2.xls';
            var exportHref = Excel.tableToExcel(printSection_642, '1.2.1');
            $timeout(function () {
        ...
        $scope.printData = function () {
            var innerContents = document.getElementById("printSection_642").innerHTML;
