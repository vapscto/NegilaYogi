...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACGRIController', NAACGRIController);

    NAACGRIController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce','myFactorynaac'];

    function NAACGRIController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.getURI("NAACGRI/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.edittab1 = function (data) {
            ...
            apiService.create("NAACGRI/EditData", data).then(function (promise) {
                ...
                $scope.NCAC516GRI_GRIAPP = promise.editlist[0].ncaC516GRI_GRIAPP;
                $scope.NCAC516GRI_GRIRED = promise.editlist[0].ncaC516GRI_GRIRED;
                $scope.NCAC516GRI_AvgTime = promise.editlist[0].ncaC516GRI_AvgTime;
