(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC718WasteManagementReportController', NAACAC718WasteManagementReportController)

    NAACAC718WasteManagementReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC718WasteManagementReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
