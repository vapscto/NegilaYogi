(function () {
    ...
    angular
        .module('app')
        .controller('NAAC_EContent_434', NAAC_EContent_434)

    NAAC_EContent_434.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$q', '$sce','myFactorynaac']
    function NAAC_EContent_434($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $q, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("NaacEContent434/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.savedata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    "NCAC434ECT_Id": $scope.ncaC434ECT_Id,
                    "NCAC434ECT_DevFacilityName": $scope.ncaC434ECT_DevFacilityName,
                    "NCAC434ECT_LinkName": $scope.ncaC434ECT_LinkName,
                    filelist: $scope.materaldocuupload,
                    "MI_Id": $scope.mI_Id,
                }

                apiService.create("NaacEContent434/savedata", data).then(function (promise) {
                   
                    
                        if (promise.duplicate === false) {
                            if (promise.returnval === true) {
                                if ($scope.ncaC434ECT_Id > 0) {
        ...
        $scope.deactiveStudent = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncaC434ECT_ActiveFlg == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncaC434ECT_ActiveFlg == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NaacEContent434/deactiveStudent", usersem).
        ...
        $scope.editdata = function (obj) {
            var data = {
                "NCAC434ECT_Id": obj.ncaC434ECT_Id,
                "MI_Id": obj.mI_Id,
            }
            apiService.create("NaacEContent434/editdata", data).then(function (promise) {

                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.ncaC434ECT_Id = promise.editlist[0].ncaC434ECT_Id;
                    $scope.ncaC434ECT_DevFacilityName = promise.editlist[0].ncaC434ECT_DevFacilityName;
                    $scope.ncaC434ECT_LinkName = promise.editlist[0].ncaC434ECT_LinkName;
        ...
        $scope.viewdocument = function (obj) {
            ...
            apiService.create("NaacEContent434/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            var data = {
                "NCAC434ECTF_Id": docfile.ncaC434ECTF_Id,
                "NCAC434ECT_Id": docfile.ncaC434ECT_Id,
            }
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NaacEContent434/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.getorganizationdata = function (obj) {
            apiService.create("NaacEContent434/getcomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.getorganizationdata1 = function (obj) {
            apiService.create("NaacEContent434/getfilecomment", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("NaacEContent434/savemedicaldatawisecomments", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
        ...
        $scope.savedatawisecomments1 = function (obj) {
            ...
            apiService.create("NaacEContent434/savefilewisecomments", data).then(function (promise) {
                if (promise !== null) {
                    if (promise.returnval === true) {
                        swal("Comments Saved Successfully");
                    } else {
