...
(function () {
    ...
    angular
        .module('app')
        .controller('NAACAlumniContributionHSUController', NAACAlumniContributionHSUController);

    NAACAlumniContributionHSUController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function NAACAlumniContributionHSUController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.getURI("NAACAlumniContribution/loaddatahsu", $scope.mI_Id).then(function (promise) {
        ...
        $scope.savedatatab1 = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAACAlumniContribution/savehsu", data).then(function (promise) {
