(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC7113CoreValuesReportController', NAACAC7113CoreValuesReportController)

    NAACAC7113CoreValuesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC7113CoreValuesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
