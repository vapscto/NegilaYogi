(function () {
    ...
    angular
        .module('app')
        .controller('NAACMC715WaterConservFacilitiesReportController', NAACMC715WaterConservFacilitiesReportController)

    NAACMC715WaterConservFacilitiesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACMC715WaterConservFacilitiesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    ...
                    Type: "715WaterConservFacilities"
                };
