(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC713AlternateEnergyReportController', NAACAC713AlternateEnergyReportController)

    NAACAC713AlternateEnergyReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC713AlternateEnergyReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
