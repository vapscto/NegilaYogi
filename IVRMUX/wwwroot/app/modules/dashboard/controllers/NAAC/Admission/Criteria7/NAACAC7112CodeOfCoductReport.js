(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC7112CodeOfCoductReportController', NAACAC7112CodeOfCoductReportController)

    NAACAC7112CodeOfCoductReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC7112CodeOfCoductReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
