(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC7114HumanValuesReportController', NAACAC7114HumanValuesReportController)

    NAACAC7114HumanValuesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC7114HumanValuesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
                    ...
                    if (promise.alldata.length > 0) {
                        angular.forEach($scope.alldata6, function (tt) {
                            ...
                            angular.forEach($scope.alldata62, function (ss) {
                                if (tt.ncaC7114HUVAL_Id == ss.ncaC7114HUVAL_Id) {
