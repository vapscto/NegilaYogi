(function () {
    ...
    angular
        .module('app')
        .controller('NAACAC714LEDBulbsReportController', NAACAC714LEDBulbsReportController)

    NAACAC714LEDBulbsReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACAC714LEDBulbsReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
