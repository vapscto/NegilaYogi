(function () {
    ...
    function NAAC_Criteria_6_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Criteria 6.3.4.xls';
            var exportHref = Excel.tableToExcel(printSection_634, '1.2.1');
            $timeout(function () {
        ...
        $scope.printData = function () {
            var innerContents = document.getElementById("printSection_634").innerHTML;
