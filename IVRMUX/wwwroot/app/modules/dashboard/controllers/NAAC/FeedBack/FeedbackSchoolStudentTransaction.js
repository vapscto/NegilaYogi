(function () {
    ...
    angular
        .module('app')
        .controller('FeedbackSchoolStudentTransactionController', FeedbackSchoolStudentTransactionController)

    FeedbackSchoolStudentTransactionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$filter']
    function FeedbackSchoolStudentTransactionController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $filter) {
        ...
        $scope.BindData = function () {
            ...
            apiService.create("FeedbackSchoolGeneralTransaction/getstudentstaffdetails", data).then(function (promise) {
                if (promise.getstudentdetails !== null && promise.getstudentdetails.length > 0) {
                    if (promise.getsubjectlist !== null && promise.getsubjectlist.length > 0) {
                        ...
                        swal("Subjects Are Not Found For This Student");
                    }
                } else {
        ...
        $scope.getstaffname = function () {
            ...
            apiService.create("FeedbackSchoolGeneralTransaction/getstaffname", data).then(function (promise) {
                ...
                if (promise !== null) {
                    ...
                    $scope.typelistload = promise.typelist;
        ...
        $scope.getfeedbacksubject = function () {
            ...
            apiService.create("FeedbackSchoolGeneralTransaction/getfeedbacksubject", data).then(function (promise) {
                ...
                if (promise !== null) {
                    ...
                    if ((promise.typelist !== null || promise.typelist.length > 0) && (promise.mappedquestiondeetails !== null || promise.mappedquestiondeetails.length > 0) && (promise.mappedoptiondeetails !== null || promise.mappedoptiondeetails.length > 0)) {
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.count > 0) {
                    ...
                    swal({
                        ...
                        function (isConfirm) {
                            if (isConfirm) {
                                apiService.create("FeedbackSchoolGeneralTransaction/studentstaffsavedata", data).
