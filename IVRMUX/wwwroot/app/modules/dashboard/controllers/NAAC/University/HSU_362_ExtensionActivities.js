...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_362_ExtensionActivitiesController', HSU_362_ExtensionActivitiesController);

    HSU_362_ExtensionActivitiesController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function HSU_362_ExtensionActivitiesController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("HSU_362_ExtensionActivities/loaddata", $scope.mI_Id).
        ...
        $scope.deactive = function (usersem, SweetAlert) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_362_ExtensionActivities/deactive", usersem).
                            then(function (promise) {
        ...
        $scope.edittab1 = function (user) {
            ...
            apiService.create("HSU_362_ExtensionActivities/EditData", data).then(function (promise) {

                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCACSA343_Id = promise.editlist[0].ncacsA343_Id;
                    $scope.NCACSA343_Year = promise.editlist[0].ncacsA343_Year;
        ...
        $scope.save = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_362_ExtensionActivities/save", data).then(function (promise) {
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("HSU_362_ExtensionActivities/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_362_ExtensionActivities/deleteuploadfile", data).then(function (promise) {
