...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_352_RevenueGeneratedController', HSU_352_RevenueGeneratedController);

    HSU_352_RevenueGeneratedController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function HSU_352_RevenueGeneratedController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("HSU_352_RevenueGenerated/loaddata", $scope.mI_Id).
        ...
        $scope.deactive = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmcrG352_ActiveFlag == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncmcrG352_ActiveFlag == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_352_RevenueGenerated/deactive", usersem).
                            then(function (promise) {
        ...
        $scope.edittab1 = function (user) {
            var data = {
                "NCMCRG352_Id": user.ncmcrG352_Id,
                "MI_Id": user.mI_Id
            }

            apiService.create("HSU_352_RevenueGenerated/EditData", data).then(function (promise) {

                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCMCRG352_Id = promise.editlist[0].ncmcrG352_Id;
                    $scope.NCMCRG352_Year = promise.editlist[0].ncmcrG352_Year;
                    $scope.NCMCRG352_ConsultantName = promise.editlist[0].ncmcrG352_ConsultantName;
                    $scope.NCMCRG352_AdvisoryName = promise.editlist[0].ncmcrG352_AdvisoryName;
                    $scope.NCMCRG352_ConsultingORSpnAgencyCD = promise.editlist[0].ncmcrG352_ConsultingORSpnAgencyCD;
                    $scope.NCMCRG352_RevenueGeneratedAmount = promise.editlist[0].ncmcrG352_RevenueGeneratedAmount;
        ...
        $scope.save = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    "NCMCRG352_Id": $scope.NCMCRG352_Id,
                    "asmaY_Id": $scope.NCMCRG352_Year,
                    "NCMCRG352_ConsultantName": $scope.NCMCRG352_ConsultantName,
                    "NCMCRG352_AdvisoryName": $scope.NCMCRG352_AdvisoryName,
                    "NCMCRG352_ConsultingORSpnAgencyCD": $scope.NCMCRG352_ConsultingORSpnAgencyCD,
                    "NCMCRG352_RevenueGeneratedAmount": $scope.NCMCRG352_RevenueGeneratedAmount,
                    "MI_Id": $scope.mI_Id,
                    filelist: $scope.materaldocuupload,
                }

                apiService.create("HSU_352_RevenueGenerated/save", data).then(function (promise) {
                 debugger;
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("HSU_352_RevenueGenerated/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            var data = {
                "NCMCRG352F_Id": docfile.ncmcrG352F_Id,
                "NCMCRG352_Id": docfile.ncmcrG352_Id,
                "MI_Id": docfile.mI_Id
            };
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_352_RevenueGenerated/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.change_institution = function () {
            $scope.NCMCRG352_Id = 0;
            $scope.asmaY_Id = '';
            $scope.NCMCRG352_ConsultantName = '';
            $scope.NCMCRG352_AdvisoryName = '';
            $scope.NCMCRG352_ConsultingORSpnAgencyCD = '';
            $scope.NCMCRG352_RevenueGeneratedAmount = '';
