...
(function () {
    ...
    angular
        .module('app')
        .controller('MC_314_ResearchAssociatesController', MC_314_ResearchAssociatesController);

    MC_314_ResearchAssociatesController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function MC_314_ResearchAssociatesController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("MC_314_ResearchAssociates/loaddata", $scope.mI_Id).
        ...
        $scope.deactive = function (usersem, SweetAlert) {
            var dystring = "";
            if (usersem.ncmcrA314_ActiveFlag == true) {
                dystring = "Deactivate";
            }
            else if (usersem.ncmcrA314_ActiveFlag == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("MC_314_ResearchAssociates/deactive", usersem).
                            then(function (promise) {
        ...
        $scope.edittab1 = function (user) {
            var data = {
                "NCMCRA314_Id": user.ncmcrA314_Id,
                "MI_Id": user.mI_Id
            }

            apiService.create("MC_314_ResearchAssociates/EditData", data).then(function (promise) {

                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCMCRA314_Id = promise.editlist[0].ncmcrA314_Id;
                    $scope.NCMCRA314_Year = promise.editlist[0].ncmcrA314_Year;
                    $scope.NCMCRA314_NameOfResearch = promise.editlist[0].ncmcrA314_NameOfResearch;
                    $scope.NCMCRA314_Type = promise.editlist[0].ncmcrA314_Type;
                    $scope.NCMCRA314_GrantingAgency = promise.editlist[0].ncmcrA314_GrantingAgency;
                    $scope.NCMCRA314_QualExamName = promise.editlist[0].ncmcrA314_QualExamName;
                    $scope.NCMCRA314_Duration = promise.editlist[0].ncmcrA314_Duration;
        ...
        $scope.save = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    "NCMCRA314_Id": $scope.NCMCRA314_Id,
                    "asmaY_Id": $scope.NCMCRA314_Year,
                    "NCMCRA314_NameOfResearch": $scope.NCMCRA314_NameOfResearch,
                    "NCMCRA314_Type": $scope.NCMCRA314_Type,
                    "NCMCRA314_GrantingAgency": $scope.NCMCRA314_GrantingAgency,
                    "NCMCRA314_QualExamName": $scope.NCMCRA314_QualExamName,
                    "NCMCRA314_Duration": $scope.NCMCRA314_Duration,
                    "MI_Id": $scope.mI_Id,
                    filelist: $scope.materaldocuupload,
                }

                apiService.create("MC_314_ResearchAssociates/save", data).then(function (promise) {
                    debugger;
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("MC_314_ResearchAssociates/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            var data = {
                "NCMCRA313F_Id": docfile.ncmcrA313F_Id,
                "NCMCRA313_Id": docfile.ncmcrA313_Id,
                "MI_Id": docfile.mI_Id
            };
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("MC_314_ResearchAssociates/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.change_institution = function () {
            ...
            $scope.HRME_Id = 0;
            $scope.asmaY_Id = '';
            $scope.NCMCRA314_NameOfResearch = '';
            $scope.NCMCRA314_Type = '';
            $scope.NCMCRA314_GrantingAgency = '';
            $scope.NCMCRA314_QualExamName = '';
            $scope.NCMCRA314_Duration = '';
