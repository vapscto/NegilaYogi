(function () {
    ...
    angular
        .module('app')
        .controller('NAAC_HSU_InterdisciplinaryProgrammes_123', NAAC_HSU_InterdisciplinaryProgrammes_123)

    NAAC_HSU_InterdisciplinaryProgrammes_123.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];
    function NAAC_HSU_InterdisciplinaryProgrammes_123($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("NAAC_HSU_InterdisciplinaryProgrammes_123/loaddata", $scope.mI_Id).then(function (promise) {
        ...
        $scope.save = function () {
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    "NCHSUIP123_Id": $scope.NCHSUIP123_Id,
                    "asmaY_Id": $scope.NCHSUIP123_Year,
                    "NCHSUIP123_TotalNoOfProg": $scope.NCHSUIP123_TotalNoOfProg,
                    "NCHSUIP123_TotalNoOfCoursesAcrossProgs": $scope.NCHSUIP123_TotalNoOfCoursesAcrossProgs,
                    "NCHSUIP123_NoOfInterdisciplinaryCoursesAcsProg": $scope.NCHSUIP123_NoOfInterdisciplinaryCoursesAcsProg,

                    filelist: $scope.materaldocuupload,
                    "MI_Id": $scope.mI_Id
                }

                apiService.create("NAAC_HSU_InterdisciplinaryProgrammes_123/save", data).then(function (promise) {
        ...
        $scope.deactivYTab1 = function (usersem, SweetAlert) {
            debugger;
            var dystring = "";
            if (usersem.nchsuiP123_ActiveFlag == true) {
                dystring = "Deactivate";
            }
            else if (usersem.nchsuiP123_ActiveFlag == false) {
                dystring = "Activate"
            }
            swal({
                title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAAC_HSU_InterdisciplinaryProgrammes_123/deactive", usersem).
        ...
        $scope.edittab1 = function (user) {
            ...
            var data = {
                "NCHSUIP123_Id": user.nchsuiP123_Id,
                "MI_Id": user.mI_Id
            }
            apiService.create("NAAC_HSU_InterdisciplinaryProgrammes_123/EditData", data).then(function (promise) {
                if (promise.editlist.length > 0) {
                    $scope.instit = true;
                    $scope.NCHSUIP123_Id = promise.editlist[0].nchsuiP123_Id;
                    $scope.NCHSUIP123_Year = promise.editlist[0].nchsuiP123_Year;
                    $scope.NCHSUIP123_TotalNoOfProg = promise.editlist[0].nchsuiP123_TotalNoOfProg;
                    $scope.NCHSUIP123_TotalNoOfCoursesAcrossProgs = promise.editlist[0].nchsuiP123_TotalNoOfCoursesAcrossProgs;
                    $scope.NCHSUIP123_NoOfInterdisciplinaryCoursesAcsProg = promise.editlist[0].nchsuiP123_NoOfInterdisciplinaryCoursesAcsProg;
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("NAAC_HSU_InterdisciplinaryProgrammes_123/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            var data = {
                "NCHSUIP123F_Id": docfile.nchsuiP123F_Id,
                "NCHSUIP123_Id": docfile.nchsuiP123_Id,
                "MI_Id": docfile.mI_Id
            };
            swal({
                title: "Are You Sure",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("NAAC_HSU_InterdisciplinaryProgrammes_123/deleteuploadfile", data).then(function (promise) {
        ...
        $scope.change_institution = function () {
            $scope.NCHSUIP123_Year = '';
            $scope.NCHSUIP123_TotalNoOfProg = '';
            $scope.NCHSUIP123_TotalNoOfCoursesAcrossProgs = '';
            $scope.NCHSUIP123_NoOfInterdisciplinaryCoursesAcsProg = '';
