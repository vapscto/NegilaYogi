...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_349_HindexController', HSU_349_HindexController);

    HSU_349_HindexController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce', 'myFactorynaac'];

    function HSU_349_HindexController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce, myFactorynaac) {
        ...
        $scope.loaddata = function () {
            ...
            //var pageid = 2;
            apiService.getURI("HSU_349_Hindex/loaddata", $scope.mI_Id).
        ...
        $scope.deactive = function (usersem, SweetAlert) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_349_Hindex/deactive", usersem).
                            then(function (promise) {
        ...
        $scope.edittab1 = function (user) {
            ...
            apiService.create("HSU_349_Hindex/EditData", data).then(function (promise) {
                ...
                if (promise.editlist.length > 0) {
                    ...
                    $scope.NCHSU346EAJL_ISTHIndex = promise.editlist[0].NCHSU346EAJL_ISTHIndex;
        ...
        $scope.save = function () {
            ...
            if ($scope.myForm.$valid) {
                var data = {
                    ...
                    "NCHSU346EAJL_ISTHIndex": $scope.NCHSU346EAJL_ISTHIndex,
                ...
                apiService.create("HSU_349_Hindex/save", data).then(function (promise) {
                    debugger;
        ...
        $scope.viewdocument = function (obj) {
            ...
            $scope.objdata = obj;
            apiService.create("HSU_349_Hindex/viewuploadflies", obj).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.deleteuploadfile = function (docfile) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("HSU_349_Hindex/deleteuploadfile", data).then(function (promise) {
