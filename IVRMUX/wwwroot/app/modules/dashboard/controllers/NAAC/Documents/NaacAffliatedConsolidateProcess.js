(function () {
    'use strict';
    angular.module('app').controller('NaacAffliatedConsolidateProcessController', NaacAffliatedConsolidateProcessController)

    NaacAffliatedConsolidateProcessController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$q', '$filter', '$timeout', 'Excel', '$compile', '$window', 'myFactorynaac', '$sce']
    function NaacAffliatedConsolidateProcessController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $q, $filter, $timeout, Excel, $compile, $window, myFactorynaac, $sce) {
        ...
        $scope.getorganizationdata = function (ddd) {
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NaacConsolidatProcess/getaffliateddata", ddd).then(function (promise) {
                    if (promise !== null) {
        ...
        $scope.getapproved = function (ddd) {
            ...
            if ($scope.myForm.$valid) {
                ...
                $scope.approvedornotflag = "";
                $scope.viewdetailsname = ddd.naacsL_SLNo;
                apiService.create("NaacConsolidatProcess/getapproved", ddd).then(function (promise) {
                    if (promise !== null) {
        ...
        $scope.savedatawisecomments = function (obj) {
            ...
            apiService.create("NaacConsolidatProcess/savedatawisecomments", data).then(function (promise) {
        ...
        $scope.viewdatawisecomments = function (obj) {
            ...
            apiService.create("NaacConsolidatProcess/viewdatawisecomments", data).then(function (promise) {
                if (promise !== null) {
        ...
        $scope.approvedata = function () {
            ...
            if ($scope.approvedlist.length > 0) {
                ...
                apiService.create("NaacConsolidatProcess/approvedata", data).then(function (promise) {
                    if (promise !== null) {
                        if (promise.returnval === true) {
        ...
        $scope.savefilewisecomments = function (objfile) {
            ...
            apiService.create("NaacConsolidatProcess/savefilewisecomments", data).then(function (promise) {
        ...
        $scope.viewfilewisecomments = function (objfile) {
            ...
            apiService.create("NaacConsolidatProcess/viewfilewisecomments", data).then(function (promise) {
                if (promise !== null) {
                    $scope.viewcomments = promise.datawisecomments;
                    $('#mymodalviewcommentslist').modal('show');
                }
        ...
        $scope.approvedocuments = function () {
            ...
            if ($scope.approvedfilelist.length > 0) {
                ...
                apiService.create("NaacConsolidatProcess/approvedocuments", data).then(function (promise) {
                    if (promise !== null) {
                        if (promise.returnval === true) {
                            swal("Record Approved");
                        } else {
