(function () {
    ...
    angular
        .module('app')
        .controller('CollegeStaffperiodtransactiondevationreportcontroller', CollegeStaffperiodtransactiondevationreportcontroller)

    CollegeStaffperiodtransactiondevationreportcontroller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function CollegeStaffperiodtransactiondevationreportcontroller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.getreportdetails = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CollegeStaffperiodtransactionreport/getdevationreport", data).then(function (promise) {
                    if (promise !== null) {

                        $scope.getreport1 = promise.getdevationreport;

                        if ($scope.getreport1 !== null) {

                            if ($scope.getreport1.length > 0) {

                                $scope.getreport = promise.getdevationreport;
                                $scope.getreportemployee = promise.getdevationreportemployee;
                                ...
                                angular.forEach($scope.getreportemployee, function (dd) {
                                    ...
                                    angular.forEach($scope.getreport, function (d) {
                                        ...
                                        if (dd.isms_id === d.isms_id) {
                                            $scope.tempdata1.push({ topicname: d.topicname, allocateddate: d.allocateddate, staffname: d.staffname, takendate: d.takendate, datediffcount: d.datediffcount });
                                        }
                                    });
