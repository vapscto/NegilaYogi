(function () {
    ...
    angular
        .module('app')
        .controller('SchoolStaffperiodtransactiondevationreportcontroller', SchoolStaffperiodtransactiondevationreportcontroller)

    SchoolStaffperiodtransactiondevationreportcontroller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function SchoolStaffperiodtransactiondevationreportcontroller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.getreportdetails = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("SchoolStaffperiodtransactionreport/getdevationreport", data).then(function (promise) {
                    if (promise !== null) {
