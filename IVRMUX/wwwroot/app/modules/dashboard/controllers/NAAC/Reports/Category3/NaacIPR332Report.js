(function () {
    ...
    angular
        .module('app')
        .controller('NAACIPR_322_Report', NAACIPR_322_Report)

    NAACIPR_322_Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAACIPR_322_Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAACCriteria3Report/reportIPR", data).then(function (promise) {
