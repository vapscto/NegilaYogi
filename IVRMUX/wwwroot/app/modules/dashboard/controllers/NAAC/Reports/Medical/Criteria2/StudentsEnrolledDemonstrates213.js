(function () {
    ...
    angular
        .module('app')
        .controller('StudentsEnrolledDemonstrates213', StudentsEnrolledDemonstrates213)

    StudentsEnrolledDemonstrates213.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function StudentsEnrolledDemonstrates213($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_213_report", data).then(function (promise) {                  
                    debugger;
