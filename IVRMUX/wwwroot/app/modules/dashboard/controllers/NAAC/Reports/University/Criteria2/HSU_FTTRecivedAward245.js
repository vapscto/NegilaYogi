(function () {
    'use strict';
    angular.module('app').controller('HSU_FTTRecivedAward245', HSU_FTTRecivedAward245)

    HSU_FTTRecivedAward245.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_FTTRecivedAward245($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_245_Report", data).then(function (promise) {
