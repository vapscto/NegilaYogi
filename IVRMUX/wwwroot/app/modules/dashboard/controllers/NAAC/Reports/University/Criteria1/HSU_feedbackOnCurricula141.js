(function () {
    'use strict';
    angular.module('app').controller('HSU_feedbackOnCurricula141', HSU_feedbackOnCurricula141)

    HSU_feedbackOnCurricula141.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_feedbackOnCurricula141($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR1_Report/HSU_141_Report", data).then(function (promise) {
