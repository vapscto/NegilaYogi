(function () {
    ...
    angular
        .module('app')
        .controller('MC_BooksPublished334', MC_BooksPublished334)

    MC_BooksPublished334.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_BooksPublished334($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_334_Report", data).then(function (promise) {
