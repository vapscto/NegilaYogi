...
(function () {
    ...
    angular
        .module('app')
        .controller('PhyAcaFacility451', PhyAcaFacility451)

    PhyAcaFacility451.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function PhyAcaFacility451($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_MC_CR4/PhyAcaFacility451Report", data).then(function (promise) {
