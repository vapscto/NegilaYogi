(function () {
    ...
    angular
        .module('app')
        .controller('MC_Activity342', MC_Activity342)

    MC_Activity342.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function MC_Activity342($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        $scope.currentPage = 1;
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.4.2.xls';
            var exportHref = Excel.tableToExcel(table, '3.4.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_342_Report", data).then(function (promise) {
