(function () {
    'use strict';
    angular.module('app').controller('MC_SeatAllotmentPolicy_211', MC_SeatAllotmentPolicy_211)

    MC_SeatAllotmentPolicy_211.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function MC_SeatAllotmentPolicy_211($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (export_id) {
            ...
            var excelname = 'Cat 2.1.1.xls';
            var exportHref = Excel.tableToExcel(export_id, '2.1.1');
            $timeout(function () {
