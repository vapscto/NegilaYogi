(function () {
    'use strict';
    angular.module('app').controller('HSU_FulltimeTeacher222', HSU_FulltimeTeacher222)

    HSU_FulltimeTeacher222.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_FulltimeTeacher222($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_222_Report", data).then(function (promise) {
