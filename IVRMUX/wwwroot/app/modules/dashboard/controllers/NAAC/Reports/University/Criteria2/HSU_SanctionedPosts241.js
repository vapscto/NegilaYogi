(function () {
    ...
    angular
        .module('app')
        .controller('HSU_SanctionedPosts241', HSU_SanctionedPosts241)

    HSU_SanctionedPosts241.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_SanctionedPosts241($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_241_Report", data).then(function (promise) {
