(function () {
    ...
    function NAAC_MC_312_TeachersResearchController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 3.1.2.xls';
            var exportHref = Excel.tableToExcel(table, '3.1.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_MC_312_TeachersResearch/get_312U_report", data).then(function (promise) {
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            angular.forEach($scope.reportlist2, function (ff) {
                                if (gg.NCMCTR312_Id === ff.ncmctR312_Id) {                                
                                    govtfiles.push({ ncmctR312F_FileName: ff.ncmctR312F_FileName, ncmctR312F_Filedesc: ff.ncmctR312F_Filedesc, ncmctR312F_FilePath: ff.ncmctR312F_FilePath })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCMCTR312_Id: gg.NCMCTR312_Id, NCMCTR312_Year: gg.NCMCTR312_Year, NCMCTR312_ProjectName: gg.NCMCTR312_ProjectName, NCMCTR312_Duration: gg.NCMCTR312_Duration, NCMCTR312_ProjReceivingSeedMoney: gg.NCMCTR312_ProjReceivingSeedMoney, NCMCTR312_amountOfSeedMoneyProvided: gg.NCMCTR312_amountOfSeedMoneyProvided, FILES: govtfiles })
                        })
