(function () {
    ...
    function NAAC_HSU_323_ResearchProjectsRatioController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 3.3.3.xls';
            var exportHref = Excel.tableToExcel(table, '3.3.3');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_HSU_323_ResearchProjectsRatio/get_333U_report", data).then(function (promise) {
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            angular.forEach($scope.reportlist2, function (ff) {
                                if (gg.NCACAW342_Id === ff.ncacaW342_Id) {                               
                                    govtfiles.push({ ncacaW342F_FileName: ff.ncacaW342F_FileName, ncacaW342F_FilePath: ff.ncacaW342F_FilePath, ncacaW342F_Filedesc: ff.ncacaW342F_Filedesc })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCACAW342_Id: gg.NCACAW342_Id, NCACAW342_AwardYear: gg.NCACAW342_AwardYear, NCACAW342_ActivityName: gg.NCACAW342_ActivityName, NCACAW342_AwardName: gg.NCACAW342_AwardName, NCACAW342_AgencyName: gg.NCACAW342_AgencyName, NCACAW342_CategoryName: gg.NCACAW342_CategoryName, FILES: govtfiles })
                        })
