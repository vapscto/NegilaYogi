(function () {
    ...
    angular
        .module('app')
        .controller('M511Controller', M511Controller)

    M511Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function M511Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = '5.1.1.xls';
            var exportHref = Excel.tableToExcel(table, '5.1.1');
            $timeout(function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAACCriteriaFiveReport/get_report", data).then(function (promise) {
                    ...
                    if ($scope.govtsclist.length > 0 || $scope.instsclist.length > 0) {
                        ...
                        $scope.finalarray = $scope.tfinalarray;
