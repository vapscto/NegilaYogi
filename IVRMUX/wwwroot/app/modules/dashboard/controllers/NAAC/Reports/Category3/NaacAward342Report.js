(function () {
    ...
    angular
        .module('app')
        .controller('NaacAward342Report', NaacAward342Report)

    NaacAward342Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function NaacAward342Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.loaddata = function () {
            ...
            var pageid = 2;
            apiService.getURI("NaacAward342Report/getdata", pageid).then(function (promise) {
        ...
        $scope.exportToExcel = function (printSectionId) {
            ...
            var exportHref = Excel.tableToExcel(printSectionId, '3.6.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NaacAward342Report/get_report", data).then(function (promise) {
                    debugger;
