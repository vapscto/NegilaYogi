(function () {
    ...
    angular
        .module('app')
        .controller('MC_EthicsForResearch331', MC_EthicsForResearch331)

    MC_EthicsForResearch331.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_EthicsForResearch331($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.3.1.xls';
            var exportHref = Excel.tableToExcel(table, '3.3.1');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_331_Report", data).then(function (promise) {
