(function () {
    ...
    angular
        .module('app')
        .controller('M522Controller', M522Controller)

    M522Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function M522Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
            ...
            if ($scope.myForm.$valid) {
                ...
                $scope.govtsclistfiles = promise.govtsclistfiles;
                    ...
                    angular.forEach($scope.govtsclist, function (gg) {
                        ...
                        $scope.finalarray.push({ YEAR: gg.asmaY_Year, APCNT: gg.noofstd, NAME: gg.ncaC521PLA_EmployerName, COURSE: gg.amcO_CourseName, PACK: gg.amount, BRANCH: gg.amB_BranchName, FILES: govtfiles, selfcnr: gg.noofstdself})
                    })
