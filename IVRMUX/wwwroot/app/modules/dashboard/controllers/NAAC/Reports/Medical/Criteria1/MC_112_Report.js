(function () {
    ...
    angular
        .module('app')
        .controller('MC_112_Report', MC_112_Report)

    MC_112_Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_112_Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria1Reports/get_report_MC_112", data).then(function (promise) {
