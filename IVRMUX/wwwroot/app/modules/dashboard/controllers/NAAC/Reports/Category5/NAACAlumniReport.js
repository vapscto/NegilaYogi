(function () {
    ...
    angular
        .module('app')
        .controller('NAACAlumniReportController', NAACAlumniReportController)

    NAACAlumniReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function NAACAlumniReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
            ...
            if ($scope.myForm.$valid) {
                ...
                $scope.govtsclist = promise.govtsclist;
                    ...
                    angular.forEach($scope.govtsclist, function (gg) {
                        ...
                        $scope.finalarray.push({ YEAR: gg.asmaY_Year, STDNAME: gg.awardname, GYEAR: gg.asmaY_Year1, amt: gg.amount, adhar: gg.aadharpan, FILES: govtfiles})
                    })
