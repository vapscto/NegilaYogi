(function () {
    'use strict';
    angular.module('app').controller('HSU_VAC131', HSU_VAC131)

    HSU_VAC131.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_VAC131($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            apiService.create("HSU_CR1_Report/HSU_132_133_Report", data).then(function (promise) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 1.3.1.xls';
            var exportHref = Excel.tableToExcel(table, '1.3.1');
            $timeout(function () {
