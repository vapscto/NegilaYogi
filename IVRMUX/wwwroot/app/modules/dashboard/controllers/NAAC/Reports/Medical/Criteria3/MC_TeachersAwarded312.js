(function () {
    ...
    angular
        .module('app')
        .controller('MC_TeachersAwarded312', MC_TeachersAwarded312)

    MC_TeachersAwarded312.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function MC_TeachersAwarded312($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_312_Report", data).then(function (promise) {
