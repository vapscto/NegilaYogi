(function () {
    ...
    angular
        .module('app')
        .controller('M533Controller', M533Controller)

    M533Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function M533Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
            ...
            if ($scope.myForm.$valid) {
                ...
                $scope.govtsclistfiles = promise.govtsclistfiles;
                    ...
                    angular.forEach($scope.govtsclist, function (gg) {
                        ...
                        $scope.finalarray.push({ YEAR: gg.asmaY_Year, STDNAME: gg.program, FILES: govtfiles, flag2: gg.ncaC533SPCAA_ActType})
                        })
