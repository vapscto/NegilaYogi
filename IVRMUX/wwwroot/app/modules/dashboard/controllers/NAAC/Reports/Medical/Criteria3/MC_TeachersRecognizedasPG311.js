(function () {
    ...
    angular
        .module('app')
        .controller('MC_TeachersRecognizedasPG311', MC_TeachersRecognizedasPG311)

    MC_TeachersRecognizedasPG311.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_TeachersRecognizedasPG311($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var exportHref = Excel.tableToExcel(table, '3.1.1');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_311_Report", data).then(function (promise) {
                    debugger;
