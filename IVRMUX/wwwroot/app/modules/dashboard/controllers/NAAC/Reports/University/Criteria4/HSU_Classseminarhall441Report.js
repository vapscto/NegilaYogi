...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_Classseminarhall441Report', HSU_Classseminarhall441Report)

    HSU_Classseminarhall441Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function HSU_Classseminarhall441Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_HSU_CR4Report/HSUClassSeminarhall441Report", data).then(function (promise) {
