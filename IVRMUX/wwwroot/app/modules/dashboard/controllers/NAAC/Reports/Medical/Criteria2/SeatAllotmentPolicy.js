(function () {
    'use strict';
    angular.module('app').controller('SeatAllotmentPolicyController', SeatAllotmentPolicyController)

    SeatAllotmentPolicyController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function SeatAllotmentPolicyController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
