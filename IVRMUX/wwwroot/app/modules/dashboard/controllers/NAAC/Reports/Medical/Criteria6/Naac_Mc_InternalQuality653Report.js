...
(function () {
    ...
    angular
        .module('app')
        .controller('InternalQuality653', InternalQuality653)

    InternalQuality653.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function InternalQuality653($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_MC_CR6/MEDInternalQuality653", data).then(function (promise) {
                    ...
                    if (promise.reportlist.length > 0) {
                        angular.forEach($scope.alldata4, function (tt) {
                            ...
                            angular.forEach($scope.alldata42, function (ss) {
                                ...
                                if (tt.NCAC654QUAS_Id == ss.ncaC654QUAS_Id) {
                                    $scope.mainArray.push(ss);
                                }
                                //if (tt.NCAC654QUAS_AAAFlg =='Yes') {
                                //    $scope.aa = "Yes";
                                //}
                                //else {
                                //    $scope.bb = "No";
                                //}
                                //if (tt.NCAC654QUAS_FkStsCollectedAnlreportFlag=='Yes') {
                                //    $scope.cc = "Yes";
                                //}
                                //else {
                                //    $scope.dd = "No";
                                //}
                                //if (tt.NCAC654QUAS_OrgWsSsPrgAdmStaffFlag== 'Yes') {
                                //    $scope.ee = "Yes";
                                //}
                                //else {
                                //    $scope.ff = "No";
                                //}
                                //if (tt.NCAC654QUAS_ISOFlg =='Yes') {
                                //    $scope.gg = "Yes";
                                //}
                                //else {
                                //    $scope.hh = "No";
