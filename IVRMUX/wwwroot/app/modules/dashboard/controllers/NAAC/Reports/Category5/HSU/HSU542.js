(function () {
    ...
    angular
        .module('app')
        .controller('HSU542Controller', HSU542Controller)

    HSU542Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU542Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.showdetails = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAACCriteriaFiveReport/get_report542HSU", data).then(function (promise) {
                ...
                $scope.govtsclist = promise.govtsclist;
                    ...
                    angular.forEach($scope.govtsclist, function (gg) {
                        ...
                        $scope.finalarray.push({ YEAR: gg.asmaY_Year, NCAC531SPCAS_DonationOfBooksFlag: gg.ncaC531SPCAS_DonationOfBooksFlag, NCAC531SPCAS_FinancialORKindFlag: gg.ncaC531SPCAS_FinancialORKindFlag, NCAC531SPCAS_InstendowmentsFlag: gg.ncaC531SPCAS_InstendowmentsFlag, NCAC531SPCAS_StudentexchangesFlag: gg.ncaC531SPCAS_StudentexchangesFlag, NCAC531SPCAS_StudentsplacementFlag: gg.ncaC531SPCAS_StudentsplacementFlag, FILES: govtfiles})
                    })
