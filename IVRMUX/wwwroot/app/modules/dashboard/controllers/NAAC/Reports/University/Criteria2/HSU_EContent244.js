(function () {
    ...
    angular
        .module('app')
        .controller('HSU_EContent244', HSU_EContent244)

    HSU_EContent244.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_EContent244($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_244_Report", data).then(function (promise) {
                            ...
                            angular.forEach($scope.reportlist, function (y2) {
                                if (y1.asmaY_Year == y2.ASMAY_Year) {
                                    ...
                                    angular.forEach($scope.reportlist2, function (ss) {
                                        if (y2.NCMCETD244_Id == ss.ncmcetD244_Id) {
