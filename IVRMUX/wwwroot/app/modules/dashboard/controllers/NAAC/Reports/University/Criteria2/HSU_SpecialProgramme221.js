(function () {
    'use strict';
    angular.module('app').controller('HSU_SpecialProgramme221', HSU_SpecialProgramme221)

    HSU_SpecialProgramme221.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_SpecialProgramme221($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_221_Report", data).then(function (promise) {
