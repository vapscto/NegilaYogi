(function () {
    ...
    angular
        .module('app')
        .controller('HSU_MentorRatio234', HSU_MentorRatio234)

    HSU_MentorRatio234.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_MentorRatio234($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_234_Report", data).then(function (promise) {
