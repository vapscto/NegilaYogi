(function () {
    ...
    angular
        .module('app')
        .controller('MC_254_CourseImprovement_ReportController', MC_254_CourseImprovement_ReportController)

    MC_254_CourseImprovement_ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_254_CourseImprovement_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_254_Report", data).then(function (promise) {
                    debugger;
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 2.5.4.xls';
            var exportHref = Excel.tableToExcel(table, '2.5.4');
            $timeout(function () {
