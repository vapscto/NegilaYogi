(function () {
    ...
    function NAAC_HSU_323_ResearchProjectsRatioController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 3.4.9.xls';
            var exportHref = Excel.tableToExcel(table, '3.4.9');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_HSU_323_ResearchProjectsRatio/get_349U_report", data).then(function (promise) {
                    ...
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCHSU346EAJL_Id: gg.NCHSU346EAJL_Id, NCHSU346EAJL_year: gg.NCHSU346EAJL_year, NCHSU346EAJL_PaperTitle: gg.NCHSU346EAJL_PaperTitle, NCHSU346EAJL_EmpName: gg.NCHSU346EAJL_EmpName, NCHSU346EAJL_JournalTitle: gg.NCHSU346EAJL_JournalTitle, NCHSU346EAJL_NoOfCitationsExcludeCitations: gg.NCHSU346EAJL_NoOfCitationsExcludeCitations, NCHSU346EAJL_InstAffMenPub: gg.NCHSU346EAJL_InstAffMenPub, NCHSU346EAJL_ISTHIndex: gg.NCHSU346EAJL_ISTHIndex, FILES: govtfiles })
                        })
