(function () {
    'use strict';
    angular.module('app').controller('HSU_StudentSaSu271', HSU_StudentSaSu271)

    HSU_StudentSaSu271.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_StudentSaSu271($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_271_Report", data).then(function (promise) {
