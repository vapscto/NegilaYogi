(function () {
    ...
    angular
        .module('app')
        .controller('MC_MoUsWithInstitutions352', MC_MoUsWithInstitutions352)

    MC_MoUsWithInstitutions352.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_MoUsWithInstitutions352($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_352_Report", data).then(function (promise) {
