(function () {
    ...
    angular
        .module('app')
        .controller('MC_FTTW_PHD_242', MC_FTTW_PHD_242)

    MC_FTTW_PHD_242.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_FTTW_PHD_242($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_242_Report", data).then(function (promise) {
