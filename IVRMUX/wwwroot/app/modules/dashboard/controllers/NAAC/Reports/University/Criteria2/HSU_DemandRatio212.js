(function () {
    'use strict';
    angular.module('app').controller('HSU_DemandRatio212', HSU_DemandRatio212)

    HSU_DemandRatio212.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_DemandRatio212($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_212_Report", data).then(function (promise) {
