(function () {
    ...
    function NAAC_MC_312_TeachersResearchController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.4.3.xls';
            var exportHref = Excel.tableToExcel(table, '3.4.3');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_MC_312_TeachersResearch/get_343U_report", data).then(function (promise) {
                    ...
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            angular.forEach($scope.reportlist2, function (ff) {
                                if (gg.NCMCTT343_Id === ff.ncmctT343_Id) {                                
                                    govtfiles.push({ ncmctT343F_FileName: ff.ncmctT343F_FileName, ncmctT343F_FilePath: ff.ncmctT343F_FilePath, ncmctT343F_Filedesc: ff.ncmctT343F_Filedesc })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCMCTT343_Id: gg.NCMCTT343_Id, NCMCTT343_Year: gg.NCMCTT343_Year, NCMCTT343_PatenterName: gg.NCMCTT343_PatenterName, NCMCTT343_Patent: gg.NCMCTT343_Patent, NCMCTT343_Title: gg.NCMCTT343_Title, FILES: govtfiles })
                        })
