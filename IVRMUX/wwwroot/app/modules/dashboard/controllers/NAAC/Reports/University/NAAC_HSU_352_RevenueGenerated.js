(function () {
    ...
    function NAAC_MC_312_TeachersResearchController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 3.5.2.xls';
            var exportHref = Excel.tableToExcel(table, '3.5.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_MC_312_TeachersResearch/get_352U_report", data).then(function (promise) {
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            angular.forEach($scope.reportlist2, function (ff) {
                                if (gg.NCMCRG352_Id === ff.ncmcrG352_Id) {                           
                                    govtfiles.push({ ncmcrG352F_FileName: ff.ncmcrG352F_FileName, ncmcrG352F_Filedesc: ff.ncmcrG352F_Filedesc, ncmcrG352F_FilePath: ff.ncmcrG352F_FilePath })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCMCRG352_Id: gg.NCMCRG352_Id, NCMCRG352_Year: gg.NCMCRG352_Year, NCMCRG352_ConsultantName: gg.NCMCRG352_ConsultantName, NCMCRG352_AdvisoryName: gg.NCMCRG352_AdvisoryName, NCMCRG352_ConsultingORSpnAgencyCD: gg.NCMCRG352_ConsultingORSpnAgencyCD, NCMCRG352_RevenueGeneratedAmount: gg.NCMCRG352_RevenueGeneratedAmount, FILES: govtfiles })
                        })
