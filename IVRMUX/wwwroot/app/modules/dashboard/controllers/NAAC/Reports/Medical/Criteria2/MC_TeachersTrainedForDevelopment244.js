(function () {
    ...
    angular
        .module('app')
        .controller('MC_TeachersTrainedForDevelopment244', MC_TeachersTrainedForDevelopment244)

    MC_TeachersTrainedForDevelopment244.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_TeachersTrainedForDevelopment244($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_244_report", data).then(function (promise) {                  
                    debugger;
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 2.4.4.xls';
            var exportHref = Excel.tableToExcel(table, '2.4.4');
            $timeout(function () {
