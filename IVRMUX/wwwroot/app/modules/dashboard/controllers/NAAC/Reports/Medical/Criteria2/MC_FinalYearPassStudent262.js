(function () {
    ...
    angular
        .module('app')
        .controller('MC_FinalYearPassStudent262', MC_FinalYearPassStudent262)
    MC_FinalYearPassStudent262.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_FinalYearPassStudent262($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_262_Report", data).then(function (promise) {
