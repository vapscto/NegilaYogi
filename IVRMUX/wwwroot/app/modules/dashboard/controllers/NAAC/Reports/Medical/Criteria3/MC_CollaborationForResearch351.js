(function () {
    ...
    angular
        .module('app')
        .controller('MC_CollaborationForResearch351', MC_CollaborationForResearch351)

    MC_CollaborationForResearch351.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_CollaborationForResearch351($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.5.1.xls';
            var exportHref = Excel.tableToExcel(table, '3.5.1');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_351_Report", data).then(function (promise) {
