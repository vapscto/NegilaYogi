...
(function () {
    ...
    angular
        .module('app')
        .controller('Naac_Mc_Membership433', Naac_Mc_Membership433)

    Naac_Mc_Membership433.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function Naac_Mc_Membership433($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_MC_CR4/Membership433Report", data).then(function (promise) {
