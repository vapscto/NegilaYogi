(function () {
    ...
    angular
        .module('app')
        .controller('NAACQualifyReportController', NAACQualifyReportController)

    NAACQualifyReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function NAACQualifyReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
                    ...
                    $scope.finalarray = [];
                        ...
                        angular.forEach($scope.yearlist, function (yy) {
                            ...
                            if ($scope.mainarray.length>0) {
                                $scope.finalarray.push({ YEAR: yy.asmaY_Year, TT: totalcnt, list: $scope.mainarray })
                            }  
