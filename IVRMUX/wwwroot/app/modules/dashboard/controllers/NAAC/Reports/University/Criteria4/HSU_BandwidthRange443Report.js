...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_BandwidthRange443Report', HSU_BandwidthRange443Report)

    HSU_BandwidthRange443Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function HSU_BandwidthRange443Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_HSU_CR4Report/HSUBandwidthRangeReport", data).then(function (promise) {
