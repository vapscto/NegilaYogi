...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_ClinicalInfrastructure423Report', HSU_ClinicalInfrastructure423Report)

    HSU_ClinicalInfrastructure423Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function HSU_ClinicalInfrastructure423Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_HSU_CR4Report/HSUclinicalinfra423Report", data).then(function (promise) {
