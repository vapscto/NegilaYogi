(function () {
    ...
    angular
        .module('app')
        .controller('MC_ProgrammesAgainstTheApproved_212', MC_ProgrammesAgainstTheApproved_212)

    MC_ProgrammesAgainstTheApproved_212.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_ProgrammesAgainstTheApproved_212($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 2.1.2.xls';
            var exportHref = Excel.tableToExcel(table, '2.1.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_212_Report", data).then(function (promise) {
