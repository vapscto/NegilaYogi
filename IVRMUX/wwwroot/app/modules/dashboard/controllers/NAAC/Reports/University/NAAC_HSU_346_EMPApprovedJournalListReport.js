...
(function () {
    ...
    angular
        .module('app')
        .controller('NAAC_HSU_346_EMPApprovedJournalListReport', NAAC_HSU_346_EMPApprovedJournalListReport)

    NAAC_HSU_346_EMPApprovedJournalListReport.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NAAC_HSU_346_EMPApprovedJournalListReport($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_MC_312_TeachersResearch/NAAC_MC_346_TeachersResearchReport", data).then(function (promise) {
                        ...
                        angular.forEach($scope.govtsclist, function (gg) {
                            ...
                            angular.forEach($scope.govtsclistfiles, function (ff) {
                                if (gg.NCHSU346EAJL_Id == ff.nchsU346EAJL_Id) {
                                    govtfiles.push({ filename: ff.nchsU346EAJLF_FileName, filepath: ff.nchsU346EAJLF_FilePath, filedesc: ff.nchsU346EAJLF_FileDesc })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NCHSU346EAJL_EmpName: gg.NCHSU346EAJL_EmpName, NCHSU346EAJL_BookTitle: gg.NCHSU346EAJL_BookTitle, NCHSU346EAJL_PaperTitle: gg.NCHSU346EAJL_PaperTitle, NCHSU346EAJL_TitleOfProcConference: gg.NCHSU346EAJL_TitleOfProcConference, NCHSU346EAJL_NameOfConference: gg.NCHSU346EAJL_NameOfConference, NCHSU346EAJL_NationalORInternational: gg.NCHSU346EAJL_NationalORInternational, NCHSU346EAJL_ISBNNo: gg.NCHSU346EAJL_ISBNNo, NCHSU346EAJL_AffiliatingInsttimeOfPublication: gg.NCHSU346EAJL_AffiliatingInsttimeOfPublication, NCHSU346EAJL_PublisherName: gg.NCHSU346EAJL_PublisherName, FILES: govtfiles })
                        })
