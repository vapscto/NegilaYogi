(function () {
    'use strict';
    angular.module('app').controller('HSU_ClinicalSkillsLaboratory232', HSU_ClinicalSkillsLaboratory232)

    HSU_ClinicalSkillsLaboratory232.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_ClinicalSkillsLaboratory232($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_232_Report", data).then(function (promise) {
