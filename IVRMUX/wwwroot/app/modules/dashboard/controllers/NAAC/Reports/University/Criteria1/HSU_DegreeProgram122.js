(function () {
    'use strict';
    angular.module('app').controller('HSU_DegreeProgram122', HSU_DegreeProgram122)

    HSU_DegreeProgram122.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_DegreeProgram122($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            apiService.create("HSU_CR1_Report/HSU_122_Report", data).then(function (promise) {
                        ...
                        angular.forEach($scope.reportlist, function (y2) {
                            if (y1.asmaY_Year == y2.ASMAY_Year) {
                                ...
                                angular.forEach($scope.reportlist2, function (ss) {
                                    if (y2.NCHSUSM122_Id == ss.nchsusM122_Id) {
