(function () {
    ...
    function NAAC_HSU_323_ResearchProjectsRatioController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 3.4.4.xls';
            var exportHref = Excel.tableToExcel(table, '3.4.4');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_HSU_323_ResearchProjectsRatio/get_344U_report", data).then(function (promise) {
                    ...
                    if (promise.reportlist.length > 0) {
                        angular.forEach($scope.reportlist, function (tt) {
                            ...
                            //    if (tt.HREREGU_Id === ss.hreregU_Id) {
