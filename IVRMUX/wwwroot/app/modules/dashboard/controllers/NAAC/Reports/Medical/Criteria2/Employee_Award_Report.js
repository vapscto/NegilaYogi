    ...
    (function () {
        ...
        angular
            .module('app')
            .controller('Employee_Award_ReportController', Employee_Award_ReportController)

        Employee_Award_ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
        function Employee_Award_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {            
            ...
            $scope.get_report = function () {
                ...
                if ($scope.myForm.$valid) {
                    ...
                    apiService.create("DisabilityStudent/EMPLOYEE_AWARD_REPORT244", data).then(function (promise) {
