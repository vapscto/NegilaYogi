(function () {
    ...
    angular
        .module('app')
        .controller('HSU_FTTW_PHD242', HSU_FTTW_PHD242)

    HSU_FTTW_PHD242.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_FTTW_PHD242($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_242_Report", data).then(function (promise) {
