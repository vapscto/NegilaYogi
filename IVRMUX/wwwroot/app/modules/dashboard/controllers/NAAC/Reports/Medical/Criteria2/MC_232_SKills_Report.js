(function () {
    ...
    angular
        .module('app')
        .controller('MC_232_SKills_ReportController', MC_232_SKills_ReportController)

    MC_232_SKills_ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_232_SKills_ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_232_Report", data).then(function (promise) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 2.3.2.xls';
            var exportHref = Excel.tableToExcel(table, '2.3.2');
            $timeout(function () {
