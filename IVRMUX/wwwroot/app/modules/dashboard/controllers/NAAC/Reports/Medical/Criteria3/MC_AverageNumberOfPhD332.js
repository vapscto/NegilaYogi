(function () {
    ...
    angular
        .module('app')
        .controller('MC_AverageNumberOfPhD332', MC_AverageNumberOfPhD332)

    MC_AverageNumberOfPhD332.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function MC_AverageNumberOfPhD332($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.3.2.xls';
            var exportHref = Excel.tableToExcel(table, '3.3.2');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_332_Report", data).then(function (promise) {
