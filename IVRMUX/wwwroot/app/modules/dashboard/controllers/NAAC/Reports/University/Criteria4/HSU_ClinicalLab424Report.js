...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_ClinicalLab424Report', HSU_ClinicalLab424Report)

    HSU_ClinicalLab424Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function HSU_ClinicalLab424Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_HSU_CR4Report/ClinicalLabReport", data).then(function (promise) {
