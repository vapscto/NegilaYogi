(function () {
    ...
    angular
        .module('app')
        .controller('PofStudentsUndertakingFieldVisits134', PofStudentsUndertakingFieldVisits134)

    PofStudentsUndertakingFieldVisits134.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function PofStudentsUndertakingFieldVisits134($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria1Reports/MC_StudentUTFV_134_Report", data).then(function (promise) {
                    debugger;
                    if (promise.reportlist.length > 0) {
                        ...
                        angular.forEach($scope.reportlist, function (tt) {
                            ...
                            angular.forEach($scope.reportlist2, function (ss) {
                                if (tt.filefkid == ss.ncmcsP134_Id) {
