(function () {
    ...
    angular
        .module('app')
        .controller('MC_PapersPublishedPerTeacher333', MC_PapersPublishedPerTeacher333)

    MC_PapersPublishedPerTeacher333.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_PapersPublishedPerTeacher333($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria3Reports/MC_333_Report", data).then(function (promise) {
