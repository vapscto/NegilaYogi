(function () {
    ...
    angular
        .module('app')
        .controller('CUMNAACScholarshipsReportController', CUMNAACScholarshipsReportController)

    CUMNAACScholarshipsReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function CUMNAACScholarshipsReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
