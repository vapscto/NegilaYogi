(function () {
    ...
    angular
        .module('app')
        .controller('sanctionedpostsController', sanctionedpostsController)
    sanctionedpostsController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function sanctionedpostsController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("DisabilityStudent/sanctioned_posts_Report245", data).then(function (promise) {
                    debugger;
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 2.4.1.xls';
            var exportHref = Excel.tableToExcel(table, '2.4.1');
            $timeout(function () {
