(function () {    
    ...
    angular
        .module('app')
        .controller('MC_StudentSatisfactionSurvey271', MC_StudentSatisfactionSurvey271)
    MC_StudentSatisfactionSurvey271.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function MC_StudentSatisfactionSurvey271($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria2Reports/MC_271_Report", data).then(function (promise) {
        ...
        $scope.exportToExcel = function (table) {
            var excelname = 'Cat 2.7.1.xls';
            var exportHref = Excel.tableToExcel(table, '2.7.1');
            $timeout(function () {
