...
(function () {
    ...
    angular
        .module('app')
        .controller('HSU_QualityAssurance652Report', HSU_QualityAssurance652Report)

    HSU_QualityAssurance652Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function HSU_QualityAssurance652Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Naac_HSU_CR6Report/HSUQualityAssurance652Report", data).then(function (promise) {
                    ...
                    if (promise.govtsclist.length > 0 && promise.govtsclist != null) {
                        ...
                        angular.forEach($scope.govtsclist, function (gg) {
                            ...
                            angular.forEach($scope.govtsclistfiles, function (ff) {
                                if (gg.NCAC654QUAS_Id == ff.ncaC654QUAS_Id) {
                                    govtfiles.push({ filename: ff.ncaC654QUASF_FileName, filepath: ff.ncaC654QUASF_FilePath, filedesc: ff.ncaC654QUASF_Filedesc })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.asmay_year, NCAC654QUAS_AQARFlg: gg.NCAC654QUAS_AQARFlg, NCAC654QUAS_AAAFlg: gg.NCAC654QUAS_AAAFlg, NCAC654QUAS_NIRFFlg: gg.NCAC654QUAS_NIRFFlg, NCAC654QUAS_ISOFlg: gg.NCAC654QUAS_ISOFlg, NCAC654QUAS_NBAFlg: gg.NCAC654QUAS_NBAFlg, FILES: govtfiles })
                        })
