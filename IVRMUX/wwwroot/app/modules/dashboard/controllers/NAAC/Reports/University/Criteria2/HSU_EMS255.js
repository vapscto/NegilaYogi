(function () {
    'use strict';
    angular.module('app').controller('HSU_EMS255', HSU_EMS255)

    HSU_EMS255.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function HSU_EMS255($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 2.5.5.xls';
            var exportHref = Excel.tableToExcel(table, '2.5.5');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_255_Report", data).then(function (promise) {
