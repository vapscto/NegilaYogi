(function () {
    ...
    angular
        .module('app')
        .controller('HSU_CBCS121', HSU_CBCS121)

    HSU_CBCS121.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_CBCS121($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR1_Report/HSU_121_Report", data).then(function (promise) {
