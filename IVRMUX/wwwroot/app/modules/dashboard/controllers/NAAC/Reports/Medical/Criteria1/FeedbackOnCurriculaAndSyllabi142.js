(function () {
    ...
    angular
        .module('app')
        .controller('FeedbackOnCurriculaAndSyllabi142', FeedbackOnCurriculaAndSyllabi142)

    FeedbackOnCurriculaAndSyllabi142.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function FeedbackOnCurriculaAndSyllabi142($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Medical_Criteria1Reports/report_MC_142", data).then(function (promise) { 
