(function () {
    ...
    function NAAC_HSU_323_ResearchProjectsRatioController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.exportToExcel = function (table) {
            ...
            var excelname = 'Cat 3.2.3.xls';
            var exportHref = Excel.tableToExcel(table, '3.2.3');
            $timeout(function () {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NAAC_HSU_323_ResearchProjectsRatio/get_323U_report", data).then(function (promise) {
                    ...
                    if (promise.reportlist.length > 0 && promise.reportlist != null) {
                        ...
                        angular.forEach($scope.reportlist, function (gg) {
                            ...
                            angular.forEach($scope.reportlist2, function (ff) {
                                if (gg.NC323RPR_Id === ff.nC323RPR_Id) {                                
                                    govtfiles.push({ nC323RPRF_FileName: ff.nC323RPRF_FileName, nC323RPRF_Filedesc: ff.nC323RPRF_Filedesc, nC323RPRF_FilePath: ff.nC323RPRF_FilePath })
                                }
                            })
                            $scope.finalarray.push({ YEAR: gg.ASMAY_Year, NC323RPR_Id: gg.NC323RPR_Id, NC323RPR_Year: gg.NC323RPR_Year, NC323RPR_ProjName: gg.NC323RPR_ProjName, NC323RPR_PricipalName: gg.NC323RPR_PricipalName, NC323RPR_AgencyName: gg.NC323RPR_AgencyName, NC323RPR_Type: gg.NC323RPR_Type, NC323RPR_DeptName: gg.NC323RPR_DeptName, NC323RPR_FundProvided: gg.NC323RPR_FundProvided, NC323RPR_ProjDuration: gg.NC323RPR_ProjDuration, FILES: govtfiles })
                        })
