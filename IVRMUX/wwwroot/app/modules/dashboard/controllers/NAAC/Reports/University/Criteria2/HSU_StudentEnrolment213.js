(function () {
    ...
    angular
        .module('app')
        .controller('HSU_StudentEnrolment213', HSU_StudentEnrolment213)

    HSU_StudentEnrolment213.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function HSU_StudentEnrolment213($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HSU_CR2_Report/HSU_213_Report", data).then(function (promise) {  
                    ...
                    //        $scope.mainresult.push({ ASMAY_Id: y1.asmaY_Id, yearname: y1.asmaY_Year, result: $scope.resultlist, });
                    //    }
