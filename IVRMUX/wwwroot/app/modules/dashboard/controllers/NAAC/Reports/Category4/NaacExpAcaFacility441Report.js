...
(function () {
    ...
    angular
        .module('app')
        .controller('NaacExpAcaFacility441Report', NaacExpAcaFacility441Report)

    NaacExpAcaFacility441Report.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', '$filter', '$q', 'Excel', '$timeout']
    function NaacExpAcaFacility441Report($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, $filter, $q, Excel, $timeout) {
        ...
        $scope.Report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("NaacCriteria4Report/ExpAcaReport", data).then(function (promise) {
                    $scope.alldata6 = promise.reportlist;
                    $scope.alldata62 = promise.reportlist2;
