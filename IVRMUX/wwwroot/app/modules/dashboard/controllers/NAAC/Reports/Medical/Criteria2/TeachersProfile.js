(function () {
    ...
    angular
        .module('app')
        .controller('TeachersProfileController', TeachersProfileController)

    TeachersProfileController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function TeachersProfileController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        ...
        $scope.get_report = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("DisabilityStudent/T_ProfileAndQuality_Report24", data).then(function (promise) {
