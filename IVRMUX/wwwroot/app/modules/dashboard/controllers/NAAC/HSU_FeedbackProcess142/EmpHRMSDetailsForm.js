(function () {
    ...
    EmpnaacHrmsDetailsController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', '$q'];
    function EmpnaacHrmsDetailsController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, $q) {
        ...
        $scope.showmodaldetailsResProject = function (data) {
            ...
            var extention = nameArray[nameArray.length - 1];
            if (extention === "jpg" || extention === "jpeg") {
                // $('#preview').attr('src', 'https://bdcampusstrg.blob.core.windows.net/files/' + $scope.mi_id + "/" + "EmployeeDocuments" + "/" + data.hrerepR_Document);
