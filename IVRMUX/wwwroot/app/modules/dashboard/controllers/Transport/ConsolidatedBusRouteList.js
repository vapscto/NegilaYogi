(function () {
    ...
    angular
.module('app')
.controller('ConsolidatedBusRouteListController', ConsolidatedBusRouteListController)

    ConsolidatedBusRouteListController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache', '$filter']
    function ConsolidatedBusRouteListController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache, $filter) {
        ...
        $scope.BindData = function () {
            apiService.getDATA("ConsolidatedBusRouteList/getdata").then(function (promise) {
                if (promise != null) {
        ...
        $scope.getreport = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("ConsolidatedBusRouteList/Getreportdetails", data).
