(function () {
    ...
    angular
.module('app')
        .controller('KMNotupReportController', KMNotupReportController)

    KMNotupReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache', '$filter']
    function KMNotupReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache, $filter) {
        ...
        $scope.BindData = function () {
            apiService.getDATA("KMNotupReport/getdata").then(function (promise) {
                if (promise != null) {
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("KMNotupReport/Getreportdetails", data).
