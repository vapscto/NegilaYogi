(function () {
    ...
    angular
.module('app')
        .controller('CLGStdRouteUpdateController', CLGStdRouteUpdateController)

    CLGStdRouteUpdateController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', '$compile']
    function CLGStdRouteUpdateController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, $compile) {
        ...
        $scope.onloadmodal = function () {
            ...
            apiService.getDATA("CLGStdRouteUpdate/getloaddataintruction").
        ...
        $scope.loaddata = function () {
            ...
            apiService.getDATA("CLGStdRouteUpdate/getloaddata").
                then(function (promise) {
        ...
        $scope.onchange = function (studentlst) {
            ...
            apiService.create("CLGStdRouteUpdate/getstudata", data).
               then(function (promise) {
                   ...
                   $scope.ASTACO_Id = $scope.studentDetails[0].ASTACO_Id;
        ...
        $scope.onformclick = function (astA_Id, amsT_Id) {
            ...
            apiService.create("CLGStdRouteUpdate/getbuspassdata", data).
               then(function (promise) {
        ...
        $scope.onchangeacc = function () {
            
            var data = {
                "ASMAY_Id": $scope.ASMAY_Id
            }
            apiService.create("CLGStdRouteUpdate/getbuspassdataupdate", data).
              then(function (promise) {
        ...
        $scope.onareachange = function (trmA_Id) {
            ...
            apiService.create("CLGStdRouteUpdate/getroutedata", data).
               then(function (promise) {
        ...
        $scope.onroutechange = function (trmA_Id) {
            ...
            apiService.create("CLGStdRouteUpdate/getlocationdata", data).
               then(function (promise) {
        ...
        $scope.onroutechangeload = function (trmA_Id) {
            ...
            apiService.create("CLGStdRouteUpdate/getlocationdataonly", data).
               then(function (promise) {
        ...
        $scope.savedata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    ...
                    "studentid": $scope.AMCST_Id.amcsT_Id,
                ...
                //    },
                //}
                apiService.create("CLGStdRouteUpdate/savedata", data).then(function (promise) {
        ...
        $scope.pamentsave = function () {
            ...
            var params = {
                ...
                "hash": $scope.hash,
                "surl": "http://localhost:57606/api/CLGStdRouteUpdate/paymentresponse/",
                "furl": "http://localhost:57606/api/CLGStdRouteUpdate/paymentresponse/"
        ...
        $scope.paynow = function (pasR_Id, asta_id) {
            ...
            apiService.create("CLGStdRouteUpdate/paynow", data).then(function (promise) {
        ...
        $scope.searchfilter = function (objj) {
                ...
                if (objj.search.length >= '2') {
                    ...
                    apiService.create("CLGStdRouteUpdate/searchfilter", data).
                then(function (promise) {
