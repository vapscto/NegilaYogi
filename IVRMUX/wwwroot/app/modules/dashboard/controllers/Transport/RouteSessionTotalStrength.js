(function () {
    ...
    angular
.module('app')
.controller('RouteSessionTotalStrengthController', RouteSessionTotalStrengthController)

    RouteSessionTotalStrengthController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', 'Excel', '$timeout', 'superCache', '$filter']
    function RouteSessionTotalStrengthController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, Excel, $timeout, superCache, $filter) {
        ...
        $scope.BindData = function () {
            apiService.getDATA("RouteSessionTotalStrength/getdata").then(function (promise) {
                if (promise != null) {
        ...
        $scope.getreport = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("RouteSessionTotalStrength/Getreportdetails", data).
