...
(function () {
    ...
    angular
        .module('app')
        .controller('LanguagegraphReportController', LanguagegraphReportController)

    LanguagegraphReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$q', '$cookieStore', '$stateParams', '$filter', 'FormSubmitter', '$window', 'superCache', '$compile']
    function LanguagegraphReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $q, $cookieStore, $stateParams, $filter, FormSubmitter, $window, superCache, $compile) {
        $("#chart123").kendoChart({
            title: {
                text: "MOTHER TONGUE WISE STUDENT ADMISSION COUNT"
            },
            legend: {
                position: "top"
            },
        ...
        function createChart1() {
            $("#chart1").kendoChart({
                title: {
                    text: "MOTHER TONGUE STUDENT ADMISSION COUNT"
                },
                legend: {
                    position: "bottom"
                },
        ...
        function createChart2() {
            $("#chart2").kendoChart({
                title: {
                    position: "bottom",
                    text: "SourceWise Overall Student Count Percentage"
                },
                legend: {
                    visible: false
                },
