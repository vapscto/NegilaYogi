(function () {
    ...
    angular
        .module('app')
        .controller('SourcewiseStudentAdmCountController', SourcewiseStudentAdmCountController)
    SourcewiseStudentAdmCountController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'superCache', 'Excel', '$timeout']
    function SourcewiseStudentAdmCountController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, superCache, Excel, $timeout) {
        $scope.route = false;
        $scope.print = false;
        ...
        $scope.loaddata = function () {
            ...
            apiService.create("StudentTC/getallsourcedetails", pageid).
        ...
        $scope.onselectyear = function () {
            ...
            apiService.create("TotalCountReport/getheadisbygrpid", data).
                then(function (promise) {
        ...
        $scope.ShowReport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StudentTC/languagecntdata", data).
                    then(function (promise) {
                        $scope.yearmodel = true;
                        if (promise.studentDetails != null && promise.studentDetails.length) {
                        ...
                        if ($scope.studetails != null) {
                            ...
                            $scope.reference = [];
                            for (var i = 0; i < $scope.studetails.length; i++) {
                                $scope.reference.push($scope.studetails[i].Studentcount);
                            }
                        ...
                        //        $scope.class.push($scope.stutabledetails[i].PAMR_ReferenceName);
                        //    }
...

        {
            ...
            if ($scope.bulkdownload == true) {
                if ($scope.myForm.$valid) {
                    ...
                    apiService.create("TotalCountReport/radiobtndata", data).
                        then(function (promise) {
