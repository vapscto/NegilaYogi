...
(function () {
    ...
    angular
.module('app')
        .controller('CLGStaffRplInTheirTTController', CLGStaffRplInTheirTTController)

    CLGStaffRplInTheirTTController = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', 'superCache']
    function CLGStaffRplInTheirTTController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, superCache) {
        ...
        $scope.GetReport = function () {
            ...
            if ($scope.myForm.$valid) {
                if ($scope.HRME_Id.hrmE_Id == undefined || $scope.HRME_Id.hrmE_Id == '') {
                ...
                apiService.create("CLGStaffRplInTheirTT/getrpt", data).
        ...
        $scope.BindData = function () {
            apiService.getDATA("CLGStaffRplInTheirTT/getalldetails").
       then(function (promise) {
        ...
        $scope.cell_click = function (dayid, periodid,day,period) {
            ...
            if ($scope.from != null && $scope.from != "") {
                ...
                apiService.create("CLGStaffRplInTheirTT/getpossiblePeriod", data).
                then(function (promise) {
                    $scope.table_list = [];
                    $scope.table_list123 = [];
                    $scope.table_list = $scope.temp_grid;
        ...
        $scope.get_category = function () {
            ...
            if ($scope.asmaY_Id === "") {
                ...
                apiService.create("CLGStaffRplInTheirTT/get_catg", data).
         then(function (promise) {
        ...
        $scope.replacement_to_save = function () {
            ...
            if ($scope.from != null && $scope.from != "" && $scope.to != null && $scope.to != "") {
                ...
                apiService.create("CLGStaffRplInTheirTT/savedetail", data).
                  then(function (promise) {
