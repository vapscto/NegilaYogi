...
(function () {
    ...
    angular
.module('app')
        .controller('CLGStaffRplInUnallocatedPeriodController', CLGStaffRplInUnallocatedPeriodController)

    CLGStaffRplInUnallocatedPeriodController = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', 'superCache']
    function CLGStaffRplInUnallocatedPeriodController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, superCache) {
        ...
        $scope.GetReport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("CLGStaffRplInUnallocatedPeriod/getrpt", data).
        ...
        $scope.BindData = function () {
            apiService.getDATA("CLGStaffRplInUnallocatedPeriod/getalldetails").
       then(function (promise) {
        ...
        $scope.get_category = function () {
            ...
            if ($scope.asmaY_Id === "") {
                ...
                apiService.create("CLGStaffRplInUnallocatedPeriod/get_catg", data).
         then(function (promise) {
        ...
        $scope.replacement_to_save = function () {
            ...
            if ($scope.from != null && $scope.from != "" && $scope.to != null && $scope.to != "") {
                ...
                apiService.create("CLGStaffRplInUnallocatedPeriod/savedetail", data).
                  then(function (promise) {
