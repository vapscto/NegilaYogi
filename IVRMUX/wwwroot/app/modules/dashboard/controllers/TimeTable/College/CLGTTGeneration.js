...
(function () {
    ...
    angular
        .module('app')
        .controller('CLGTTGenerationController', CLGTTGenerationController)

    CLGTTGenerationController.$inject = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', 'superCache', 'Excel', '$timeout']
    function CLGTTGenerationController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, superCache, Excel, $timeout) {
                ...
                if ($scope.albumNameArray.length > 0) {
                    if ($scope.myForm.$valid) {
                        debugger;
                            ...
                            apiService.create("CLGTTGeneration/generate", data).
        ...
        $scope.BindData = function () {
            apiService.getDATA("CLGTTGeneration/getalldetails").
                then(function (promise) {
        ...
        $scope.get_category = function () {
            ...
            if ($scope.asmaY_Id === "") {
                ...
                apiService.create("CLGTTGeneration/get_catg", data).
                    then(function (promise) {
        ...
        $scope.get_count = function () {
            ...
            if ($scope.albumNameArray.length > 0) {
                ...
                apiService.create("CLGTTGeneration/get_count", data).
                    then(function (promise) {
        ...
        $scope.viewtemprecords = function () {
            ...
            apiService.create("CLGTTGeneration/Get_temp_data", data).
                then(function (promise) {
        ...
        $scope.viewrecordspopup = function (employee) {
            ...
            apiService.create("CLGTTGeneration/getalldetailsviewrecords", data).
                then(function (promise) {
        ...
        $scope.SaveTempTTdata = function (tempTTdata_list) {
            ...
            if ($scope.albumNameArray.length > 0) {
                ...
                apiService.create("CLGTTGeneration/saveTemptomain", data).
                    then(function (promise) {
        ...
        $scope.Replacementfunction = function (employee) {
            ...
            apiService.create("CLGTTGeneration/getreplacemntdetailsviewrecords", data).
                then(function (promise) {
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        if ($scope.ttmC_Id === 'all') {
                            ...
                            apiService.create("CLGTTGeneration/resetTT", data).
                                then(function (promise) {
                                    if (promise.returnval === true) {
                                        $scope.get_count();
        ...
        $scope.deactive = function (employee, SweetAlert) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.create("CLGTTGeneration/deactivate", employee).
                            then(function (promise) {
                                if (promise.returnval == true) {
