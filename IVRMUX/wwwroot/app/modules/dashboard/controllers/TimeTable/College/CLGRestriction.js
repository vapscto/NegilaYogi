...
(function () {
    ...
    angular
.module('app')
        .controller('CLGRestrictionController', CLGRestrictionController)

    CLGRestrictionController.$inject = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams']
    function CLGRestrictionController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams) {
        $scope.editEmployee = {};
        ...
        $scope.gridOptions1 = {
            ...
            columnDefs: [
...

               {
                ...
                '<a ng-if="row.entity.TTRDPC_ActiveFlag === false" href="javascript:void(0)" style="color:green;" ng-click="grid.appScope.switch1(row.entity);"> <md-tooltip md-direction="down">Activate Now</md-tooltip> <i class="fa fa-toggle-off text-red" aria-hidden="true"></i></a>' +
              '<span ng-if="row.entity.TTRDPC_ActiveFlag === true"><a href="javascript:void(0)"  style="color:red;" ng-click="grid.appScope.switch1(row.entity);">  <md-tooltip md-direction="down">Deactivate Now</md-tooltip> <i class="fa fa-toggle-on text-green"  aria-hidden="true"></i></a><span>' +
        ...
        $scope.gridOptions2 = {
            ...
            columnDefs: [
             ...
             { name: 'ttrdS_SUbSelcFlag', displayName: 'Semester-Section Wise' },
        ...
        $scope.gridOptions3 = {
            ...
            columnDefs: [
             ...
             { name: 'ttmD_DayName', displayName: 'Day Name' },
                { name: 'ttrdsU_SUbSelcFlag', displayName: 'Semester-Section Wise' },
        ...
        $scope.gridOptions4 = {
            ...
            columnDefs: [
             ...
             { name: 'ttmP_PeriodName', displayName: 'Period Name' },
                { name: 'ttrpS_SUbSelcFlag', displayName: 'Semester-Section Wise' },
        ...
        $scope.gridOptions5 = {
            ...
            columnDefs: [
             ...
             { name: 'ttmP_PeriodName', displayName: 'Period Name' },
                { name: 'ttrpsU_SUbSelcFlag', displayName: 'Semester-Section Wise' },
        ...
        $scope.savetab1 = function () {
            ...
            if ($scope.myForm1.$valid) {
                ...
                apiService.create("CLGRestriction/savetab1", data).
        ...
        $scope.savetab2 = function () {
            ...
            if ($scope.myForm2.$valid) {
                ...
                apiService.create("CLGRestriction/savetab2", data).
                    then(function (promise) {
                        if (promise.returnfixstatus === 'Fixed') {
                            swal('Selected Staff And Subject Is Fixed For Selected Details !');
                        }
        ...
        $scope.savetab3 = function () {
            ...
            if ($scope.myForm3.$valid) {
                ...
                apiService.create("CLGRestriction/savetab3", data).
                    then(function (promise) {
                        if (promise.returnfixstatus === 'Fixed') {
                            swal('Selected subject And Subject Is Fixed For Selected Details !');
                        }
                        else if (promise.returnval === true) {
                            swal('Data successfully Saved');
        ...
        $scope.savetab4 = function () {
            ...
            if ($scope.myForm4.$valid) {
                ...
                apiService.create("CLGRestriction/savetab4", data).
                    then(function (promise) {
                        if (promise.returnfixstatus === 'Fixed') {
                            swal('Selected Staff And Subject Is Fixed For Selected Details !');
                        }
        ...
        $scope.savetab5 = function () {
            ...
            if ($scope.myForm5.$valid) {
                ...
                apiService.create("CLGRestriction/savetab5", data).
                    then(function (promise) {
                        if (promise.returnfixstatus === 'Fixed') {
                            swal('Selected Staff And Subject Is Fixed For Selected Details !');
                        }
        ...
        $scope.getorgvalue1 = function (employee) {
            apiService.create("CLGRestriction/edittab1", employee).
                then(function (promise) {
                    ...
                    $scope.TTRDPC_Id = promise.restrict_day_period_edit[0].ttrdpC_Id;
                ...
                $scope.AMCO_Id1 = promise.restrict_day_period_edit[0].amcO_Id;
                $scope.AMB_Id1 = promise.restrict_day_period_edit[0].amB_Id;
                $scope.AMSE_Id1 = promise.restrict_day_period_edit[0].amsE_Id;
                $scope.ACMS_Id1 = promise.restrict_day_period_edit[0].acmS_Id;
                $scope.TTMP_Id1 = promise.restrict_day_period_edit[0].ttmP_Id;
                $scope.HRME_Id1 = promise.restrict_day_period_edit[0].hrmE_Id;
                $scope.ISMS_Id1 = promise.restrict_day_period_edit[0].ismS_Id;
        ...
        $scope.getorgvalue2 = function (employee) {
            ...
            $scope.albumNameArray2 = [];
            $scope.albumNameArraysaveDB2 = [];
            apiService.create("CLGRestriction/gettab2editdata", employee).
            then(function (promise) {
                ...
                if ($scope.temp_check2 == true) {
                    ...
                    $scope.temp_check2 = promise.restrict_day_staff_edit[0].TTRDS_SUbSelcFlag;
                    angular.forEach(promise.restrict_day_staff_edit, function (ww) {

                        $scope.albumNameArray2.push({ corDisplay: ww.AMCO_CourseName, brDisplay: ww.AMB_BranchName, semDisplay: ww.AMSE_SEMName, secDisplay: ww.ACMS_SectionName, subDisplay: ww.ISMS_SubjectName, pedDisplay: ww.TTRPSCB_Periods, AMCO_Id: ww.AMCO_Id, AMB_Id: ww.AMB_Id, AMSE_Id: ww.AMSE_Id, ACMS_Id: ww.ACMS_Id, ISMS_Id: ww.ISMS_Id });

                        $scope.albumNameArraysaveDB2.push({ AMCO_Id: ww.AMCO_Id, AMB_Id: ww.AMB_Id, AMSE_Id: ww.AMSE_Id, ACMS_Id: ww.ACMS_Id, ISMS_Id: ww.ISMS_Id, NOP: parseInt(ww.TTRPSCB_Periods) });
                    })
                    if ($scope.ASMAY_Id2 != "") {
                    ...
                    if ($scope.ASMAY_Id2 != "" && $scope.HRME_Id2 != "") {
                        ...
                        //$scope.AMCO_Id2 = promise.restrict_day_staff_edit[0].AMCO_Id;
                    }
        ...
        $scope.getorgvalue3 = function (employee) {
            apiService.create("CLGRestriction/edittab3", employee).
            then(function (promise) {
                $scope.clear3();
                ...
                if ($scope.temp_check3 == true) {
                    ...
                    angular.forEach(promise.restrict_day_subject_edit, function (ff) {
                        $scope.albumNameArray3.push({ corDisplay: ff.AMCO_CourseName, brDisplay: ff.AMB_BranchName, semDisplay: ff.AMSE_SEMName, secDisplay: ff.ACMS_SectionName, stfDisplay: ff.ENAME, pedDisplay: parseInt(ff.TTRDSUCB_Periods), AMCO_Id: ff.AMCO_Id, AMB_Id: ff.AMB_Id, AMSE_Id: ff.AMSE_Id, ACMS_Id: ff.ACMS_Id, HRME_Id: ff.HRME_Id });
                        $scope.albumNameArraysaveDB3.push({ AMCO_Id: ff.AMCO_Id, AMB_Id: ff.AMB_Id, AMSE_Id: ff.AMSE_Id, ACMS_Id: ff.ACMS_Id, HRME_Id: ff.HRME_Id, NOP: parseInt(ff.TTRDSUCB_Periods) });
        ...
        $scope.getorgvalue4 = function (employee) {
            apiService.create("CLGRestriction/edittab4", employee).
            then(function (promise) {
                $scope.clear4();
                ...
                if ($scope.temp_check4 == true) {
                    ...
                    angular.forEach(promise.restrict_period_staff_edit, function (rr) {

                        $scope.albumNameArray4.push({ corDisplay: rr.AMCO_CourseName, brDisplay: rr.AMB_BranchName, semDisplay: rr.AMSE_SEMName, secDisplay: rr.ACMS_SectionName, subDisplay: rr.ISMS_SubjectName, dayDisplay: parseInt(rr.TTRPSCB_Days), AMCO_Id: rr.AMCO_Id, AMB_Id: rr.AMB_Id, AMSE_Id: rr.AMSE_Id, ACMS_Id: rr.ACMS_Id, ISMS_Id: rr.ISMS_Id });
                        $scope.albumNameArraysaveDB4.push({ AMCO_Id: rr.AMCO_Id, AMB_Id: rr.AMB_Id, AMSE_Id: rr.AMSE_Id, ACMS_Id: rr.ACMS_Id, ISMS_Id: rr.ISMS_Id , NOD: parseInt(rr.TTRPSCB_Days) });
        ...
        $scope.getorgvalue5 = function (employee) {
            apiService.create("CLGRestriction/edittab5", employee).
            then(function (promise) {
                $scope.clear5();
                ...
                if ($scope.temp_check5 == true) {
                    ...
                    angular.forEach(promise.restrict_period_subject_edit, function (gg) {
                        $scope.albumNameArray5.push({ corDisplay: gg.AMCO_CourseName, brDisplay: gg.AMB_BranchName, semDisplay: gg.AMSE_SEMName, secDisplay: gg.ACMS_SectionName, stfDisplay: gg.ENAME, dayDisplay: parseInt(gg.TTRPSUCB_Days), AMCO_Id: gg.AMCO_Id, AMB_Id: gg.AMB_Id, AMSE_Id: gg.AMSE_Id, ACMS_Id: gg.ACMS_Id, HRME_Id: gg.HRME_Id });
                        $scope.albumNameArraysaveDB5.push({ AMCO_Id: gg.AMCO_Id, AMB_Id: gg.AMB_Id, AMSE_Id: gg.AMSE_Id, ACMS_Id: gg.ACMS_Id, HRME_Id: gg.HRME_Id, NOD: parseInt(gg.TTRPSUCB_Days) });
        ...
        $scope.viewrecordspopup2 = function (employee, SweetAlert) {
            ...
            apiService.create("CLGRestriction/viewtab2grid", employee).
                    then(function (promise) {
        ...
        $scope.viewrecordspopup3 = function (employee, SweetAlert) {
            ...
            $scope.day_Name = employee.ttmD_DayName;
            apiService.create("CLGRestriction/viewtab3grid", employee).
                    then(function (promise) {
        ...
        $scope.viewrecordspopup4 = function (employee, SweetAlert) {
            ...
            apiService.create("CLGRestriction/viewtab4", employee).
                    then(function (promise) {
        ...
        $scope.viewrecordspopup5 = function (employee, SweetAlert) {
            $scope.subject_Name = employee.ismS_SubjectName;
            $scope.period_Name = employee.ttmP_PeriodName;
            apiService.create("CLGRestriction/viewtab5", employee).
                    then(function (promise) {
        ...
        $scope.switch1 = function (employee, SweetAlert) {
            ...
            if (employee.TTRDPC_ActiveFlag === true) {
                mgs = "Deactive";
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                apiService.create("CLGRestriction/deactivatetab1", employee).
                then(function (promise) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                apiService.create("CLGRestriction/deactivatetab2", employee).
                then(function (promise) {
                    if (promise.returnval == true) {
                        swal(confirmmgs + " " + "successfully.");
                    }
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                apiService.create("CLGRestriction/deactivatetab3", employee).
                then(function (promise) {
                    if (promise.returnval == true) {
                        swal(confirmmgs + " " + "successfully.");
                    }
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                apiService.create("CLGRestriction/deactivatetab4", employee).
                then(function (promise) {
                    if (promise.returnval == true) {
                        swal(confirmmgs + " " + "successfully.");
                    }
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                apiService.create("CLGRestriction/deactivatetab5", employee).
                then(function (promise) {
                    if (promise.returnval == true) {
                        swal(confirmmgs + " " + "successfully.");
                    }
        ...
        $scope.BindData = function () {
            var pageid = 1;
            apiService.getURI("CLGRestriction/getalldetails", pageid).
       then(function (promise) {
           $scope.currentPage = 1;
