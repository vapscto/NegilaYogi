...
(function () {
    ...
    angular
.module('app')
.controller('StaffReplacementInTheirTTController', StaffReplacementInTheirTTController)

    StaffReplacementInTheirTTController = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', 'superCache']
    function StaffReplacementInTheirTTController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, superCache) {
        ...
        $scope.GetReport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StaffReplacementInTheirTT/getrpt", data).
        ...
        $scope.BindData = function () {
            apiService.getDATA("StaffReplacementInTheirTT/getalldetails").
       then(function (promise) {
        ...
        $scope.cell_click = function (dayid, periodid,day,period) {
            ...
            if ($scope.from != null && $scope.from != "") {
                ...
                apiService.create("StaffReplacementInTheirTT/getpossiblePeriod", data).
                then(function (promise) {
                    $scope.table_list = [];
                    $scope.table_list123 = [];
                    $scope.table_list = $scope.temp_grid;
        ...
        $scope.get_category = function () {
            ...
            if ($scope.asmaY_Id === "") {
                ...
                apiService.create("StaffReplacementInTheirTT/get_catg", data).
         then(function (promise) {
        ...
        $scope.replacement_to_save = function () {
            ...
            if ($scope.from != null && $scope.from != "" && $scope.to != null && $scope.to != "") {
                ...
                apiService.create("StaffReplacementInTheirTT/savedetail", data).
                  then(function (promise) {
