...
(function () {
    'use strict';
    angular.module('app').controller('TrainingAuthorizationController', TrainingAuthorizationController);
    TrainingAuthorizationController.$inject = ['$rootScope', '$scope', '$state', '$location', 'apiService', 'Flash', '$http', '$q', '$stateParams', '$window', 'superCache']
    function TrainingAuthorizationController($rootScope, $scope, $state, $location, apiService, Flash, $http, $q, $stateParams, $window, superCache) {
        $scope.editEmployee = {};
        $scope.selected = {};
        ...
        $scope.AddToCart = function () {
            if ($scope.myForm.$valid) {
                ...
                angular.forEach($scope.get_emp, function (dd) {
                    if (dd.hrmE_Id === Number($scope.ivrmuL_Id)) {
                        $scope.empname = dd.hrmE_EmployeeFirstName;
                        $scope.empid = dd.hrmE_Id;
                    }
                });
        ...
        $scope.getorgvalue = function (employee) {
            $scope.editEmployee = employee.hrlA_Id;
