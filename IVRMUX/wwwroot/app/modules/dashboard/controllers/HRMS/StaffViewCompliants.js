(function () {
    'use strict';
    angular.module('app').controller('StaffViewCompliantsController', StaffViewCompliantsController)

    StaffViewCompliantsController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce'];
    function StaffViewCompliantsController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce) {
