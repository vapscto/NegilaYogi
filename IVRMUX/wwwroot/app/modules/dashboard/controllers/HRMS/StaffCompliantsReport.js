(function () {
    'use strict';
    angular.module('app').controller('StaffCompliantsReportController', StaffCompliantsReportController)

    StaffCompliantsReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout', '$q', '$filter', '$sce'];
    function StaffCompliantsReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout, $q, $filter, $sce) {
        ...
        $scope.loaddata = function () {
            ...
            apiService.create("StaffCompliants/GetViewStaffLoaddata", data).then(function (promise) {

                $scope.getreport = promise.getreportdetails;
                console.log($scope.getreport);

                $scope.obj.FromDate = new Date(promise.fromDate);
                $scope.obj.ToDate = new Date(promise.toDate);
        ...
        $scope.report = function (dd) {
            if ($scope.myForm.$valid) {
                ...
                apiService.create("StaffCompliants/GetReport", data).then(function (promise) {
        ...
        $scope.exportToExcel = function (tableId) {
            ...
            var excelname = "Staff Compliants List Report.xls";
            $timeout(function () {
