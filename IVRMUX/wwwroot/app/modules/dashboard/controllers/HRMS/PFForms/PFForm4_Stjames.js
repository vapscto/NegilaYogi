(function () {
    ...
    angular
.module('app')
        .controller('PFForm4StjController', PFForm4StjController)

    PFForm4StjController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function PFForm4StjController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getURI("PFForm5/getalldetails", pageid).then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("PFForm5/getEmployeedetailsBySelection", data).
