(function () {
    ...
    angular
.module('app')
        .controller('PFForm5StjController', PFForm5StjController)

    PFForm5StjController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function PFForm5StjController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.SearchEmployee = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("PFForm10/getEmployeedetailsBySelectionStjames", data).
