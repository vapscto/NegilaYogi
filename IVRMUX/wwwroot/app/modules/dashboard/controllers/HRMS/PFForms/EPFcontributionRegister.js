(function () {
    ...
    angular
.module('app')
.controller('EPFcontributionRegisterController', EPFcontributionRegisterController)

    EPFcontributionRegisterController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function EPFcontributionRegisterController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
