(function () {
    ...
    angular
.module('app')
.controller('EmployeeGrauityController', EmployeeGrauityController)

    EmployeeGrauityController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function EmployeeGrauityController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getURI("EmployeeGrauity/getalldetails", pageid).then(function (promise) {
        ...
        $scope.GetEmployeeList = function () {
            ...
            if ($scope.Employee.hreS_Year != "" && $scope.Employee.hreS_Year != undefined && $scope.Employee.hreS_Month != "" && $scope.Employee.hreS_Month != undefined) {
                ...
                apiService.create("EmployeeGrauity/GetEmployeeDetailsByLeaveYearAndMonth", data).
        ...
        $scope.GenerateSalarySlip = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("EmployeeGrauity/GenerateEmployeeSalarySlip", data).
                            then(function (promise) {
                                $scope.EmployeeDis = true;
                                ...
                                if (promise.currentemployeeDetails !== null) {
                                    ...
                                    $scope.empdetails.hrmE_DOL = new Date($scope.empdetails.hrmE_DOL);
                                    $scope.totprdsrv = ($scope.empdetails.hrmE_DOL - $scope.empdetails.hrmE_DOJ ) / 1000 / 60 / 60 / 24;
