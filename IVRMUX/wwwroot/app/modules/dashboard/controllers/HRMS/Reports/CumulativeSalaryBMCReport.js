(function () {
    ...
    angular
.module('app')
        .controller('CumulativeSalaryReportBMCController', CumulativeSalaryReportBMCController)

    CumulativeSalaryReportBMCController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function CumulativeSalaryReportBMCController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
