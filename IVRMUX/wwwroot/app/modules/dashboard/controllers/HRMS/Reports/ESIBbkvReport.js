(function () {
    ...
    angular
        .module('app')
        .controller('ESIReportController', ESIReportController)

    ESIReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function ESIReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
                    ...
                    then(function (promise) {
                        ...
                        if (promise.employeeDetails !== null && promise.employeeDetails.length > 0) {
                            ...
                            angular.forEach($scope.employeeDetails, function (cls) {
                                ...
                                if (cls != null) {
                                    var intrr = Math.round(cls.employeeContibution);
                                    $scope.totalgrp = intrr;
                                    cls.employeeContibution = $scope.totalgrp;
                                    cls.employerContibution = Math.round(cls.employerContibution);
                                    cls.totalAmount = Math.round(cls.totalAmount);
