(function () {
    ...
    angular
        .module('app')
        .controller('employeesalaryNDSController', employeesalaryNDSController)

    employeesalaryNDSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function employeesalaryNDSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        ...
        $scope.onLoadGetData = function () {
            ...
            apiService.getURI("EmployeeSalarySlipGeneration/getalldetails", pageid).then(function (promise) {
                ...
                if (promise.employeetype !== null && promise.employeetype.length > 0) {
                    $scope.employeetype = promise.employeetype;
                }
