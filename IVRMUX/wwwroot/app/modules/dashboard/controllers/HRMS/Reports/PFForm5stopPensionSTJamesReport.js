(function () {
    ...
    angular
        .module('app')
        .controller('PFForm5stopPensionSTJamesReportController', PFForm5stopPensionSTJamesReportController)

    PFForm5stopPensionSTJamesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function PFForm5stopPensionSTJamesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getURI("PFForm5stopPensionSTJamesReport/getalldetails", pageid).then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                $scope.pfreport = [];
                $scope.pfreportrevised = [];
                var data = $scope.Employee;

                apiService.create("PFForm5stopPensionSTJamesReport/getEmployeedetailsBySelectionStjames", data).
