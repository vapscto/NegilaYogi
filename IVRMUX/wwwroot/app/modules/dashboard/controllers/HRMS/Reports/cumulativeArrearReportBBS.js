(function () {
    ...
    angular
.module('app')
        .controller('cumulativeArrearReportBBSController', cumulativeArrearReportBBSController)

    cumulativeArrearReportBBSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function cumulativeArrearReportBBSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
