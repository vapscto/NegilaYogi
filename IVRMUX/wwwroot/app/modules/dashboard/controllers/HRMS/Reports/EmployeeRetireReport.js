(function () {
    ...
    angular
        .module('app')
        .controller('EmployeeRetireReportController', EmployeeRetireReportController)

    EmployeeRetireReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function EmployeeRetireReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
        //object
        ...
        $scope.Employee.Working = false;
        $scope.Employee.Left = false;
        ...
        //{ id: 'CasteId', selected: true, value: 'Caste' },
            { id: 'HRME_Photo', selected: true, value: 'Photo' },
        { id: 'HRME_DOJ', selected: true, value: 'Date Of Join' },
            { id: 'HRME_DOL', selected: true, value: 'Date Of Left' },
            { id: 'HRME_DOC', selected: true, value: 'Date Of Confirmation' },
