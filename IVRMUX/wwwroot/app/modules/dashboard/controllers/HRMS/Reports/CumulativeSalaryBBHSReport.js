(function () {
    ...
    angular
        .module('app')
        .controller('CumulativeSalaryReportBBHSController', CumulativeSalaryReportBBHSController)

    CumulativeSalaryReportBBHSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', 'Excel', '$timeout']
    function CumulativeSalaryReportBBHSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, Excel, $timeout) {
