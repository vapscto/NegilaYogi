(function () {
    ...
    angular
.module('app')
        .controller('cumulativemasterrollReportController', cumulativemasterrollReportController)

    cumulativemasterrollReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function cumulativemasterrollReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
       //object
