(function () {
    ...
    angular
.module('app')
        .controller('cumulativeArrearSalaryReportController', cumulativeArrearSalaryReportController)

    cumulativeArrearSalaryReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function cumulativeArrearSalaryReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
       //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getURI("ArrearSalaryReport/getalldetails", pageid).then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("ArrearSalaryReport/getEmployeedetailsBySelection", data).
        ...
        $scope.get_depts = function () {
            ...
            apiService.create("ArrearSalaryReport/get_depts", data).
                        then(function (promise) {
        ...
        $scope.get_desig = function () {
            ...
            apiService.create("ArrearSalaryReport/get_desig", data).
                        then(function (promise) {
                            if (promise.designationdropdown !== null && promise.designationdropdown.length > 0) {
                                $scope.designationdropdown = promise.designationdropdown;
                                $scope.designationselectedAll = true;
