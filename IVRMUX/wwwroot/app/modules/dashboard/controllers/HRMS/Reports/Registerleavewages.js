(function () {
    ...
    angular
.module('app')
        .controller('RegisterleavewagesReportController', RegisterleavewagesReportController)

    RegisterleavewagesReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function RegisterleavewagesReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
       //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getURI("RegisterwagesReport/getalldetails", pageid).then(function (promise) {
        ...
        $scope.SearchEmployee = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("RegisterwagesReport/getEmployeedetailsBySelection", data).
        ...
        $scope.get_depts = function () {
            ...
            apiService.create("RegisterwagesReport/get_depts", data).
                        then(function (promise) {
        ...
        $scope.get_desig = function () {
            ...
            apiService.create("RegisterwagesReport/get_desig", data).
                        then(function (promise) {
                            if (promise.designationdropdown !== null && promise.designationdropdown.length > 0) {
                                $scope.designationdropdown = promise.designationdropdown;
                                $scope.designationselectedAll = true;
