(function () {
    ...
    angular
.module('app')
        .controller('CumulativeSalaryGrossReportController', CumulativeSalaryGrossReportController)

    CumulativeSalaryGrossReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'Excel', '$timeout', 'superCache']
    function CumulativeSalaryGrossReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, Excel, $timeout, superCache) {
       //object
                            ...
                            then(function (promise) {
                                ...
                                if (promise.employeeSalaryslipDetails !== null && promise.employeeSalaryslipDetails.length > 0) {
                                    ...
                                    $scope.getVolumeSumgirls = function (items) {
                                        return items
                                            .map(function (x) { return x.grosspayhead; })
