(function () {
    ...
    angular
        .module('app')
        .controller('employeeSalarySlipJSHSController', employeeSalarySlipJSHSController)

    employeeSalarySlipJSHSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function employeeSalarySlipJSHSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
                        ...
                        if (promise.main_list.length > 0 && promise.main_list != null) {
                            ...
                            for (var i = 0; i < promise.main_list.length; i++) {
                                if (promise.main_list[i].employeeSalaryslipDetails != null && promise.main_list[i].employeeSalaryslipDetails.length != 0) {
                                    ...
                                    promise.main_list[i].totalEarn = [es.sum];
                                    promise.main_list[i].totalDedu = [ds.sum];
                                    ...
                                    promise.main_list[i].NetSalary = Math.round((parseFloat(promise.main_list[i].totalEarn) - parseFloat(promise.main_list[i].totalDedu)) - parseFloat(LopAmount), 2);
                                    ...
                                    if (promise.main_list[i].currentemployeeDetails != null) {
                                        ...
                                        promise.main_list[i].GenderName = promise.main_list[i].GenderName;
                                    }
