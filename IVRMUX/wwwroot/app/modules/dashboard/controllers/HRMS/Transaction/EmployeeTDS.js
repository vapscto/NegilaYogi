(function () {
    ...
    angular
        .module('app')
        .controller('EmployeeTDSController', EmployeeTDSController)
    EmployeeTDSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function EmployeeTDSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                { name: 'hretdS_TaxDeposited', displayName: 'Tax Deposited', enableHiding: false },
        ...
        $scope.onLoadGetData = function () {
            ...
            apiService.getURI("HREmpTDS/getalldetails", pageid).then(function (promise) {
        ...
        $scope.saveData = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                var data = {
                    ...
                    "HRETDS_DepositedDate": new Date($scope.loan.hreL_AppliedDate).toDateString(),
                    "HRETDS_BSRCode": $scope.loan.hreL_LoanAmount,
                    "HRETDS_ChallanNo": $scope.loan.hreL_ReferenceNo,
                    "HRETDS_TaxDeposited": $scope.loan.hretdS_TaxDeposited,
                    "HRETDS_Id": $scope.select
                ...
                //}
                apiService.create("HREmpTDS/", data).
        ...
        $scope.EditData = function (record) {
         ...
         //   var data = {
            ...
            //    "HRETDS_ChallanNo": $scope.loan.hreL_ReferenceNo,
            //}
            apiService.getURI("HREmpTDS/editRecord", id).
                then(function (promise) {
                    if (promise.emploanList != null && promise.emploanList.length > 0) {
        ...
        $scope.GetDetailsByEmployee = function () {
            ...
            if ($scope.loan.hrmE_Id != "") {
                ...
                apiService.getURI("HREmpTDS/getDetailsByEmployee", id).
                    then(function (promise) {
        ...
        $scope.DeletRecord = function (data, SweetAlert) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        apiService.DeleteURI("HREmpTDS/ActiveDeactiveRecord", data.hretdS_Id).
                            then(function (promise) {
                                if (promise.retrunMsg !== "") {
