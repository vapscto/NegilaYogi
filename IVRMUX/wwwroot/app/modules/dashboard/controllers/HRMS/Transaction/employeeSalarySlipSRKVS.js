(function () {
    ...
    angular
        .module('app')
        .controller('employeeSalarySlipController', employeeSalarySlipController)

    employeeSalarySlipController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function employeeSalarySlipController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
