(function () {
    ...
    angular
        .module('app')
        .controller('employeeInterSalarySlipvikasaController', employeeInterSalarySlipvikasaController)

    employeeInterSalarySlipvikasaController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function employeeInterSalarySlipvikasaController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
