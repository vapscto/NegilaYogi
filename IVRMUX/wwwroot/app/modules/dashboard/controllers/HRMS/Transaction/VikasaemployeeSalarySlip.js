(function () {
    ...
    angular
        .module('app')
        .controller('employeeSalarySlipvikasaController', employeeSalarySlipvikasaController)

    employeeSalarySlipvikasaController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache']
    function employeeSalarySlipvikasaController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache) {
        //object
