...
(function () {
    ...
    angular
.module('app')
.controller('generalSettingWizardController', generalSettingWizardController);

    generalSettingWizardController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http','$window','superCache'];
    function generalSettingWizardController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $window, superCache) {
