(function () {
    'use strict';
    angular.module('app').controller('FinalPromReportChinmayController', FinalPromReportSRKVSController)
    FinalPromReportSRKVSController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window']
    function FinalPromReportSRKVSController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/nds_6_8_report", data).then(function (promise) {
                    ...
                    //        Groupname: dd.empG_GroupName,
                    //        columnid: dd.empsG_Order, columname: "Paper"
                    //    });
                    //    $scope.tempexamdetails.push({
                    //        Groupname: dd.empG_GroupName,
                    //        columnid: dd.empsG_Order,
                    //        columname: "Subject"
                    //    });
                    //});
                    ...
                    //});
                    //$scope.totalgrade = [];
                    //angular.forEach(promise.getstudentdetails, function (st) {
                    //    $scope.totalgrade = [];
                  ...
                  //  $scope.gettermexamdetails = promise.gettermexamdetails;
                    ...
                    angular.forEach($scope.studentdetails, function (student) {
                        ...
                        angular.forEach($scope.getstudentmarksdetails, function (marks) {
                            if (student.AMST_Id === marks.AMST_Id && marks.examname !== 'Grade' && marks.subjectname !== 'GRAND TOTAL') {
