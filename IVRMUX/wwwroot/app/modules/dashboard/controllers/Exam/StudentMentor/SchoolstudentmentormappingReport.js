(function () {
    ...
    angular
        .module('app')
        .controller('SchoolstudentmentormappingReportcontroller', SchoolstudentmentormappingReportcontroller)

    SchoolstudentmentormappingReportcontroller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function SchoolstudentmentormappingReportcontroller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.getreport = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("Schoolstudentmentormapping/onreport", data).then(function (promise) {
                    ...
                    if (promise !== null) {
                        ...
                        if ($scope.getreportdata !== null) {
                            if ($scope.getreportdata.length > 0) {
                                ...
                                $scope.coursename = $scope.getreportdata[0].classname;                            
