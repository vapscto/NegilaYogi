(function () {
    'use strict';
    angular.module('app').controller('FinalPromReportChinmayI-IXController', FinalPromReportSRKVSController)
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/nds_6_8_report", data).then(function (promise) {
                    ...
                    // $scope.studentwisemarks = promise.examwiseremarks;
                    ...
                    angular.forEach($scope.getgroupdetails, function (dd) {
                        $scope.groupwiseexamlist_temp = [];
                        if ($scope.empG_DistplayNametemp != "") {
                            $scope.empG_DistplayNametemp = $scope.empG_DistplayNametemp + dd.empG_DistplayName + "(50)";
                        }
                        else {
                            $scope.empG_DistplayNametemp = dd.empG_DistplayName + "(50) +";
                        }
