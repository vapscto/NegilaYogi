(function () {
    ...
    angular
        .module('app')
        .controller('MarksEntry_SSSEController', MarksEntry_SSSEController);

    MarksEntry_SSSEController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$window'];

    function MarksEntry_SSSEController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http,$window) {
        /* jshint validthis:true */
        //var vm = this;
        //vm.title = 'MarksEntry_SSSEController';
        // $scope.all = {};
        //activate();
        // $scope.all_s = {};
        //function activate() { }
        ...
        $scope.BindData = function () {
            apiService.getDATA("MarksEntry_SSSE/Getdetails").
       then(function (promise) {
        ...
        $scope.get_classes = function (ASMAY_Id) {
            ...
            apiService.create("MarksEntry_SSSE/get_classes", data).
       then(function (promise) {
        ...
        $scope.get_sections = function (ASMCL_Id, ASMAY_Id) {
            ...
            apiService.create("MarksEntry_SSSE/get_sections", data).
       then(function (promise) {
        ...
        $scope.get_exams = function (ASMS_Id, ASMCL_Id, ASMAY_Id) {
            ...
            apiService.create("MarksEntry_SSSE/get_exams", data).
       then(function (promise) {
        ...
        $scope.get_subjects = function (ASMS_Id, ASMCL_Id, ASMAY_Id, EME_Id) {
            ...
            apiService.create("MarksEntry_SSSE/get_subjects", data).
       then(function (promise) {
        ...
        $scope.onsearch = function (ASMS_Id, ASMCL_Id, ASMAY_Id, EME_Id, ISMS_Id) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("MarksEntry_SSSE/onsearch", data).
               then(function (promise) {
                   if (promise.studentList != null && promise.studentList.length > 0)
                   {
                       if (promise.eyceS_SubSubjectFlg && promise.eyceS_SubExamFlg && promise.subject_subsubjects != null && promise.subject_subsubjects.length > 0 && promise.subject_subexams != null && promise.subject_subexams.length > 0)
                       {
                           ...
                           if (promise.saved_studentList != null && promise.saved_studentList.length > 0 && promise.saved_ssse_list != null && promise.saved_ssse_list.length > 0) {
                               $scope.map_marks(promise.saved_studentList, promise.saved_ssse_list);
                           }
                       }
                       else {
        ...
        $scope.map_marks = function (saved_studentList, saved_ssse_list) {
                                                ...
                                                if (ssse_s.emsS_Id == y.sub_subject.emsS_Id && ssse_s.emsE_Id == y.sub_exam.emsE_Id) {
                                                    if (ssse_s.estM_Id == stu_s.estM_Id) {
                                                       // if (ssse_s.estM_Id == stu_s.estM_Id) {
                                                            ...
                                                            $scope.valid_marks(y, y.sub_subject.emsS_Id, y.sub_exam.emsE_Id, stu_m.ESTMSS_Marks, stu_m.amsT_Id, stu_m);
                                                      //  }
        ...
        $scope.optionToggled = function () {
            ...
            $scope.all_s = $scope.temp_student_list_SSSE.every(function (itm)
        ...
        $scope.valid_marks = function (obj_ssse, s_subj_id, s_exm_id, values, stu_id, obj_student) {//, totalMarks, obtainmarks, row
        ...
        $scope.save = function (ASMS_Id, ASMCL_Id, ASMAY_Id, EME_Id, ISMS_Id) {
            ...
            if ($scope.myForm.$valid) {
                ...
                if (main_save_list.length > 0)
                {
                    ...
                    apiService.create("MarksEntry_SSSE/SaveMarks", data).
               then(function (promise) {
        ...
        //                            })
        //                            //  var ratio_s_exm = (sum_s_exm_max_marks / S_subs_max_marks);
        //                            var ratio_s_exm =$scope.subject_subexams_details.length;
        //                            var S_subj_marks = sum_s_exm_obt_marks / ratio_s_exm;
        //                            sum_s_sub_obt_marks += S_subj_marks;
        //                        }
        //                    })
