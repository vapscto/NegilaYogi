...
(function () {
    'use strict';
    angular.module('app').controller('BBIReportController', BBIReportController)
    BBIReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BBIReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
