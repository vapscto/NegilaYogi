...
(function () {
    ...
    angular
.module('app')
.controller('BGIIReportController', BGIIReportController)

    BGIIReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BGIIReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
