...
(function () {
    'use strict';
    angular.module('app').controller('BBIVReportController', BBIVReportController)

    BBIVReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BBIVReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
                            ...
                            angular.forEach(promise.savelist, function (opq) {
                                if (opq.amsT_Id == stu_id) {
                                    ...
                                    stu_subj_list.push({
                                        ...
                                        estmP_TotalMaxMarks: opq.estmP_TotalMaxMarks, EYCES_MarksDisplayFlg: opq.eyceS_MarksDisplayFlg,
