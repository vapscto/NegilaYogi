...
(function () {
    'use strict';
    angular.module('app').controller('BCOEDIIReportController', BCOEDIIReportController)
    BCOEDIIReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BCOEDIIReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        $scope.DeleteRecord = {};
        $scope.EditRecord = {};
        $scope.obj = {};
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("BaldwinAllReport/savedetails", data).then(function (promise) {
                    if (promise.savelist.length > 0) {
                        ...
                        $scope.edclasslist = [];
                        $scope.edclasslist = promise.edclasslist;
