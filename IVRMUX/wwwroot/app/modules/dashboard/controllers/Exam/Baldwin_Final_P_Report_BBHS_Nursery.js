(function () {
    ...
    angular
        .module('app')
        .controller('Baldwin_Final_P_Report_BBHS_NurseryController', Baldwin_Final_P_Report_BBHS_NurseryController);

    Baldwin_Final_P_Report_BBHS_NurseryController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter'];

    function Baldwin_Final_P_Report_BBHS_NurseryController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter) {
        ...
        $scope.printToCart = function () {
            ...
            popupWinindow.document.write('<html><head>' +
                ...
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/baldwin/ProgressReport/BBNurseryFinalReportPdf.css" />' +
