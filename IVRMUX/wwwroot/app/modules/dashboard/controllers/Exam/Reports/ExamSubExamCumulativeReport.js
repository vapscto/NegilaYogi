(function () {
    'use strict';
    angular.module('app').controller('ExamSubExamCumulativeReportNew', ExamSubExamCumulativeReportNew)
    ExamSubExamCumulativeReportNew.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function ExamSubExamCumulativeReportNew($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HHSMIDFINALCumReport/ExamSubExamCumulativeReport", data).then(function (promise) {
                    ...
                    if (promise.savelist !== null && promise.savelist.length > 0) {
                        ...
                        $scope.reportname = $scope.yr + "-" + $scope.cla + "-" + $scope.sec + "-" + $scope.exmmid;
                        ...
                        angular.forEach($scope.headersub, function (obj1) {
                            if (obj1.eyceS_AplResultFlg === true) {
                                $scope.colarraytmp.push({
                                    ...
                                    marksflg: obj1.eyceS_MarksDisplayFlg, grdflag: obj1.eyceS_GradeDisplayFlg
                                });
                            }
                        });

                        console.log("JSHS");
                        console.log($scope.colarraytmp);
                        ...
                        angular.forEach($scope.colarraytmp, function (qwe) {
                            ...
                            angular.forEach($scope.subwithsubexm, function (obj2) {
                                if (obj2.eyceS_AplResultFlg === true && qwe.title === obj2.ismS_SubjectName) {
                                    ...
                                    subexamname = subexamname.replace(" ", "");
                                    $scope.nwtmpary.push({
                                        title: obj2.emsE_SubExamName, field: "unique" + qwe.idd + subexamname, width: 200,
                        ...
                        angular.forEach($scope.headersub, function (obj1) {
                            if (obj1.eyceS_AplResultFlg === false) {
                                $scope.colarraytmpapplyresult.push({ title: obj1.ismS_SubjectName, field: obj1.ismS_SubjectName, idd: obj1.ismS_Id, marksflg: obj1.eyceS_MarksDisplayFlg, grdflag: obj1.eyceS_GradeDisplayFlg });
                            }
                        });
                        ...
                        angular.forEach($scope.details, function (qqq) {
                            angular.forEach(qqq.stmrklist, function (qqq1) {
                                ...
                                var s = "unique" + qqq1.ismS_Id + subexamname1;
                                var s1 = "unique" + qqq1.ismS_Id + subexamname2;
