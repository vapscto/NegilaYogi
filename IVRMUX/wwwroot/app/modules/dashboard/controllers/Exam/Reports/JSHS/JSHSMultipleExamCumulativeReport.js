(function () {
    'use strict';
    angular.module('app').controller('JSHSMultipleExamCumulativeReportController', JSHSMultipleExamCumulativeReportController)
                                ...
                                angular.forEach($scope.getstudentmarksdetails, function (marks) {
                                    if (stu.AMST_Id === marks.AMST_Id && exm.EME_Id === marks.examid) {
                                        if (marks.examid !== 50001) {
                                            $scope.temp_markslist.push({ EME_Id: marks.examid, marksobtained: marks.marksobtained, maxmarks: marks.maxmiummarks });
                                        } else {
