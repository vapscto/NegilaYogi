(function () {
    'use strict';
    angular.module('app').controller('PromotionReportStdIIV_20_21Controller', PromotionReportStdIIV_20_21Controller)
    PromotionReportStdIIV_20_21Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function PromotionReportStdIIV_20_21Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
        ...
        $scope.BGHS_IIV_20202021 = function (obj) {
            $scope.JSHSReport = false;
            $scope.getstudentmarksdetails_temp = [];
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/BGHS_IIV_20202021", data).then(function (promise) {
