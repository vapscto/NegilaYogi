(function () {
    'use strict';
    angular.module('app').controller('PromotionReportIXController', PromotionReportIXController)
    PromotionReportIXController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter']
    function PromotionReportIXController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter) {
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/bcehspromotionreportix", data).then(function (promise) {
