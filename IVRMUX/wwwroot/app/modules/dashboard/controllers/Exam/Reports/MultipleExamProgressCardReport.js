(function () {
    'use strict';
    angular.module('app').controller('MultipleExamProgressCardReportController', MultipleExamProgressCardReportController)
    MultipleExamProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function MultipleExamProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
