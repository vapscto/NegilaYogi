(function () {
    'use strict';
    angular.module('app').controller('StjamesTransitionProgressCardController', StjamesTransitionProgressCardController)
    StjamesTransitionProgressCardController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function StjamesTransitionProgressCardController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
        $scope.readmit = false;
