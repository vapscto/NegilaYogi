(function () {
    'use strict';
    angular.module('app').controller('JSHSIndividualTermReportController', JSHSIndividualTermReportController)
    JSHSIndividualTermReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter']
    function JSHSIndividualTermReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter) {
        ...
        $scope.onsectionchange = function () {
            ...
            apiService.create("JSHSExamReports/get_students_category_grade", data).then(function (promise) {              
                $scope.grade_list = promise.getgradetermlist;
