(function () {
    'use strict';
    angular.module('app').controller('NDS68ProgressCardReportController', NDS68ProgressCardReportController)
    NDS68ProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window']
    function NDS68ProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
