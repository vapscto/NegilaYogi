(function () {
    'use strict';
    angular.module('app').controller('AggreagtiveProcesscardReportController', AggreagtiveProcesscardReportController)

    AggreagtiveProcesscardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function AggreagtiveProcesscardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        $scope.DeleteRecord = {};
        $scope.EditRecord = {};
        $scope.obj = {};
