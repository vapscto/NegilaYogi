(function () {
    'use strict';
    angular.module('app').controller('HHSReport_5to7Controller', HHSReport_5to7Controller)

    HHSReport_5to7Controller.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter']
    function HHSReport_5to7Controller($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter) {
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("HHSReport_5to7/savedetails", data).then(function (promise) {
                    ...
                    if ($scope.exm_sub_mrks_list !== null && $scope.exm_sub_mrks_list.length > 0) {
                        ...
                        if ($scope.personality_status !== null && $scope.personality_status.length > 0) {
