...
(function () {
    'use strict';
    angular.module('app').controller('SRKVSProgressCardReportController', SRKVSProgressCardReportController)

    SRKVSProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function SRKVSProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
