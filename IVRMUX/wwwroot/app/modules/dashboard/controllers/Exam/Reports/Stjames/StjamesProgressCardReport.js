(function () {
    'use strict';
    angular.module('app').controller('progresscardstjamesController', progresscardstjamesController)
    progresscardstjamesController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function progresscardstjamesController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
                        ...
                        if (promise.getstudentmarksdetails !== null && promise.getstudentmarksdetails.length > 0) {
                            ...
                            if ($scope.reporttype === "indi") {
                                ...
                                angular.forEach($scope.getexamdetails, function (dd) {
                                    ...
                                    $scope.tempexamdetails.push({ Groupname: dd.empG_GroupName, columnid: dd.empsG_Order, columname: "Subject" });
                                });
