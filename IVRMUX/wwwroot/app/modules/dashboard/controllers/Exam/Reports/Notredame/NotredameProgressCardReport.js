...
(function () {
    'use strict';
    angular.module('app').controller('NotredameProgressCardReportController', NotredameProgressCardReportController)
    NotredameProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window']
    function NotredameProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
