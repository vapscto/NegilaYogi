(function () {
    'use strict';
    angular.module('app').controller('HHSReport_10thNewController', HHSReport_10thNewController)

    HHSReport_10thNewController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function HHSReport_10thNewController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
                            ...
                            angular.forEach($scope.exm_sub_mrks_list, function (st) {
                                if ($scope.subject_list.length == 0) {
                                    ...
                                    $scope.subject_list.push({
                                        ISMS_Id: st.subid, subjectname: st.subjectname,
                                        subsubjects: ssubj_list, flag: st.flag
                                    });
                                }
