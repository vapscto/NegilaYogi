(function () {
    'use strict';
    angular.module('app').controller('IXXprogresscardstjamesController', IXXprogresscardstjamesController)
    IXXprogresscardstjamesController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function IXXprogresscardstjamesController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
                            ...
                            if ($scope.reporttype === "indi") {
                                angular.forEach($scope.getexamdetails, function (dd) {
                                    $scope.tempexamdetails.push({
                                        EME_Id: dd.emE_Id,
                                        columnid: dd.emE_Id, columname: "Marks",
                                        emE_ExamCode: dd.emE_ExamCode,
                                        emE_ExamDescription: dd.emE_ExamDescription
                                    });
                                   // if (dd.emE_ExamDescription != 'UAT') {
                                        $scope.tempexamdetails.push({
                                            EME_Id: dd.emE_Id,
                                            columnid: dd.emE_Id, columname: "Point",
                                            emE_ExamCode: dd.emE_ExamCode,
                                            emE_ExamDescription: dd.emE_ExamDescription
                                        });
                                   // }
                                ...
                                angular.forEach($scope.getexamdetails, function (dd) {
                                    $scope.tempexamdetails.push({ Groupname: dd.empG_GroupName, columnid: dd.empsG_Order, columname: "Paper" });
        ...
        $scope.printToCart = function () {
            ...
            if ($scope.reporttype === "indi") {
                ...
                popupWinindow.document.write('<html><head>' +
                    ...
                    //'<link type="text/css" media="print" rel="stylesheet" href="/css/print/StJames/progresscardpdfstjmaes.css" />' +
