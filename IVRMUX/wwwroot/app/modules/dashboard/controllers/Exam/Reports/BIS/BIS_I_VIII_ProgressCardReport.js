(function () {
    'use strict';
    angular.module('app').controller('BIS_I_VIII_ProgressCardReportController', BIS_I_VIII_ProgressCardReportController)
    BIS_I_VIII_ProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window']
    function BIS_I_VIII_ProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
