...
(function () {
    'use strict';
    angular.module('app').controller('BBSNurseryProgressReportExamController', BBSNurseryProgressReportExamController)

    BBSNurseryProgressReportExamController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BBSNurseryProgressReportExamController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
                        ...
                        angular.forEach($scope.temp, function (stude) {
                            ...
                            if (temp_list.length === 0) {
                                ...
                                temp_list.push({
                                    ...
                                    classheld: stude.classheld, classatt: stude.classatt,
                                    estmP_TotalGrade: stude.estmP_TotalGrade,
                                    //estmP_TotalObtMarks: stude.estmP_TotalObtMarks, estmP_Percentage: stude.estmP_Percentage,
                                    // estmP_TotalGrade: stude.estmP_TotalGrade, estmP_TotalMaxMarks: stude.estmP_TotalMaxMarks,
                                ...
                                if (already_cnt === 0) {
                                    temp_list.push({
                                        ...
                                        classatt: stude.classatt, estmP_TotalGrade: stude.estmP_TotalGrade,
                                        // estmP_TotalObtMarks: stude.estmP_TotalObtMarks, estmP_Percentage: stude.estmP_Percentage,
                                        // estmP_TotalGrade: stude.estmP_TotalGrade, estmP_TotalMaxMarks: stude.estmP_TotalMaxMarks,
                                        estmP_ClassRank: stude.estmP_ClassRank, estmP_SectionRank: stude.estmP_SectionRank,
                                        estmP_TotalGradeRemark: stude.estmP_TotalGradeRemark, sub_list: stu_subj_list
        ...
        $scope.VIKASAProgressCardReport = function () {
            var innerContents = document.getElementById("BBSProgressCard").innerHTML;
            var popupWinindow = window.open('');
            popupWinindow.document.open();
            popupWinindow.document.write('<html><head>' +
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/PrintPdf_Bootstrap.css" />' +
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/BBKV/Progresscard/BBSProgresCardPdf.css" />' +
