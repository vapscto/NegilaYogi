...
(function () {
    ...
    angular
.module('app')
.controller('VikasaAssessment2ReportController', VikasaAssessment2ReportController)

    VikasaAssessment2ReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function VikasaAssessment2ReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
       ...
       then(function (promise) {
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("VikasaAssessment2Report/savedetails", data).
                         then(function (promise) {
                             ...
                             if (promise.studentlist.length > 0) {
                                 ...
                                 if (promise.subjlist.length > 0) {
                                     ...
                                     if (promise.savelist.length > 0) {
                                         ...
                                         $scope.issuedate = new Date().toDateString();
                                         $scope.yearname = promise.basicListYear[0].asmaY_Year;
