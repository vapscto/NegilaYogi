(function () {
    'use strict';
    angular.module('app').controller('JSHSProgressCardReportController', JSHSProgressCardReportController)
    JSHSProgressCardReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', 'Excel', '$timeout']
    function JSHSProgressCardReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, Excel, $timeout) {
