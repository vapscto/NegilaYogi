(function () {
    'use strict';
    angular.module('app').controller('progresscardstjamesNewController', progresscardstjamesNewController)
    progresscardstjamesNewController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function progresscardstjamesNewController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
                        ...
                        if (promise.getstudentmarksdetails !== null && promise.getstudentmarksdetails.length > 0) {
                            ...
                            if ($scope.reporttype === "indi") {
                                angular.forEach($scope.getexamdetails, function (dd) {
                                    $scope.tempexamdetails.push({
                                        EME_Id: dd.emE_Id, columnid: dd.emE_Id,
                                        columname: "Paper",
                                        emE_ExamDescription: dd.emE_ExamDescription
                                    });
                                    $scope.tempexamdetails.push({
                                        EME_Id: dd.emE_Id,
                                        columnid: dd.emE_Id,
                                ...
                                angular.forEach($scope.getexamdetails, function (dd) {
                                    $scope.tempexamdetails.push({ Groupname: dd.empG_GroupName, columnid: dd.empsG_Order, columname: "Paper", empG_DistplayName: dd.empG_DistplayName});
                                    $scope.tempexamdetails.push({ Groupname: dd.empG_GroupName, columnid: dd.empsG_Order, columname: "Subject", empG_DistplayName: dd.empG_DistplayName });
                                });
                                ...
                                //st.markstotal[2].TOTALOBTAINEDMARKS
