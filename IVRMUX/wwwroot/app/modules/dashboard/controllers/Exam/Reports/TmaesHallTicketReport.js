(function () {
    'use strict';
    angular.module('app').controller('TmaesHallTicketReportController', TmaesHallTicketReportController)

    TmaesHallTicketReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$compile']
    function TmaesHallTicketReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $compile) {
