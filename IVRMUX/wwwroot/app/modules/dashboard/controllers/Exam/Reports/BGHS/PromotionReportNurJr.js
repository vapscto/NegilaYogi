(function () {
    'use strict';
    angular.module('app').controller('PromotionReportNurJrController', PromotionReportNurJrController)
    PromotionReportNurJrController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function PromotionReportNurJrController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/promotionreportnurjr", data).then(function (promise) {
