(function () {
    'use strict';
    angular.module('app').controller('ExamProgressCard_Report_UKG_LKGController', ExamProgressCard_Report_UKG_LKGController)
    ExamProgressCard_Report_UKG_LKGController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$filter', '$window', 'Excel', '$timeout']
    function ExamProgressCard_Report_UKG_LKGController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window, Excel, $timeout) {
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                angular.forEach($scope.getexamlist, function (term) {
                    if ((Number(term.emE_Id)) === (Number($scope.emE_Id))) {
