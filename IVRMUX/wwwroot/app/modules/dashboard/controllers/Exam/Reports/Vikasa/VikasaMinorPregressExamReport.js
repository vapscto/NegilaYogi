...
(function () {
    ...
    angular
        .module('app')
        .controller('VikasaMinorPregressExamReportController', VikasaMinorPregressExamReportController)

    VikasaMinorPregressExamReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function VikasaMinorPregressExamReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.BindData = function () {
            apiService.getDATA("VikasaMinorPregressExamReport/Getdetails").then(function (promise) {
        ...
        $scope.get_class = function () {
            ...
            apiService.create("VikasaMinorPregressExamReport/get_class", data).then(function (promise) {
        ...
        $scope.get_section = function () {
            ...
            apiService.create("VikasaMinorPregressExamReport/get_section", data).then(function (promise) {
        ...
        $scope.get_Exam = function () {
            ...
            apiService.create("VikasaMinorPregressExamReport/get_exam", data).then(function (promise) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("VikasaProgressReportExam/savedetails", data).then(function (promise) {
                    ...
                    if ($scope.temp.length > 0) {
                        ...
                        $scope.sports = promise.getsubjectavg;
                    }
                    else {
