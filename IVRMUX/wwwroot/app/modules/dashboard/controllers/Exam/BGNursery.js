...
(function () {
    ...
    angular
        .module('app')
        .controller('BGNurseryReportController', BGNurseryReportController)

    BGNurseryReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BGNurseryReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.printToCart = function () {
            ...
            popupWinindow.document.write('<html><head>' +
                ...
                '<link type="text/css" media="print"  rel="stylesheet" href="css/print/baldwin/ProgressReport/BGNurseryPdf.css" />' +
