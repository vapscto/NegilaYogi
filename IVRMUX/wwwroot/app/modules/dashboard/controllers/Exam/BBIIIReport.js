...
(function () {
    ...
    angular
        .module('app')
        .controller('BBIIIReportController', BBIIIReportController)

    BBIIIReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function BBIIIReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
        ...
        $scope.printToCart = function () {
            ...
            popupWinindow.document.write('<html><head>' +
                ...
                '<link type="text/css" media="print" rel="stylesheet" href="css/print/baldwin/ProgressReport/BBIIIProgressReportPdf.css" />' +
