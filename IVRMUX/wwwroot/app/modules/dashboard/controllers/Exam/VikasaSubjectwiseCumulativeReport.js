...
.controller('VikasaSubjectwiseCumulativeReportController', VikasaSubjectwiseCumulativeReportController)
    ...
    VikasaSubjectwiseCumulativeReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http']
    function VikasaSubjectwiseCumulativeReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http) {
