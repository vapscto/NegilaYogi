...
(function () {
    ...
    CumulativeReportController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', 'Excel', '$timeout']
    function CumulativeReportController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, Excel, $timeout) {

        $scope.applicable = false;
        $scope.nonapplicable = false;
        ...
        $scope.searchchkbx = "";
        $scope.grdaeDisply = true;
        $scope.marksdisplay = true;
        $scope.fonts = [
        ...
        $scope.saveddata = function () {
            ...
            if ($scope.myForm.$valid) {
                ...
                if ($scope.applicable === false && $scope.nonapplicable === false) {
                    $scope.applicable = true;
                    $scope.nonapplicable = true;
                }
                ...
                apiService.create("CumulativeReport/savedetails", data).then(function (promise) {
                    ...
                    if ($scope.masterinst.length !== null && $scope.masterinst.length > 0) {
