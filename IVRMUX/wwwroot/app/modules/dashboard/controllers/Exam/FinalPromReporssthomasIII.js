(function () {
    'use strict';
    angular.module('app').controller('FinalPromReporssthomasIIIController', FinalPromReporssthomasIIIController)
    ...
    function FinalPromReporssthomasIIIController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $filter, $window) {
        ...
        $scope.saveddata = function (obj) {
            ...
            if ($scope.myForm.$valid) {
                ...
                apiService.create("JSHSExamReports/Stthomos_III_V_Report", data).then(function (promise) {
                    ...
                    if ($scope.St_ThomosTotal != null && $scope.St_ThomosTotal.length > 0) {
                        angular.forEach($scope.St_ThomosTotal, function (rt) {
