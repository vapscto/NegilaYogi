(function () {
    ...
    angular
        .module('app')
        .controller('PreStudentMeetingProfileController', PreStudentMeetingProfileController);

    PreStudentMeetingProfileController.$inject = ['$rootScope', '$scope', '$state', '$location', 'Flash', 'appSettings', 'apiService', '$http', '$stateParams', '$filter', 'superCache', '$window', '$timeout'];
    function PreStudentMeetingProfileController($rootScope, $scope, $state, $location, Flash, appSettings, apiService, $http, $stateParams, $filter, superCache, $window, $timeout) {
        //object
        ...
        $scope.onLoadGetData = function () {
            var pageid = 2;
            apiService.getDATA("PreLiveMeetingSchedule/getstudentdetails").then(function (promise) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $scope.ttt = false;
                        apiService.create("PreLiveMeetingSchedule/endmainmeetingstudent", data).then(function (promise) {
        ...
        $scope.joinmeeting = function (user) {
            ...
            apiService.create("PreLiveMeetingSchedule/joinmeetingStudent", user).then(function (promise) {
        ...
        $scope.ondatechange = function () {
            ...
            apiService.create("PreLiveMeetingSchedule/ondatechangestudent", data).then(function (promise) {
