...
namespace corewebapi18072016.Controllers.com.vapstech.Exam
{
    ...
    public class MarksEntry_SSSEController : Controller
    {
        // GET: api/values
        //[HttpGet]
        ...
        //{
        //}
         MarksEntry_SSSEDelegates del_ssse =new MarksEntry_SSSEDelegates();
        ...
        [HttpPost]
        [Route("get_classes")]
        public MarksEntry_SSSEDTO onselectAcdYear([FromBody] MarksEntry_SSSEDTO dto)
        {
        ...
        [Route("get_sections")]
        public MarksEntry_SSSEDTO get_sections([FromBody] MarksEntry_SSSEDTO dto)
        {
            dto.UserId = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        [Route("get_exams")]
        public MarksEntry_SSSEDTO get_exams([FromBody] MarksEntry_SSSEDTO dto)
        {
            dto.UserId = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        [Route("get_subjects")]
        public MarksEntry_SSSEDTO get_subjects([FromBody] MarksEntry_SSSEDTO dto)
        {
            dto.UserId = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        [Route("onsearch")]
        public MarksEntry_SSSEDTO onsearch([FromBody] MarksEntry_SSSEDTO dto)
        {
            dto.UserId = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        [Route("SaveMarks")]
        public MarksEntry_SSSEDTO SaveMarks([FromBody] MarksEntry_SSSEDTO dto)
        {
            dto.UserId = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
