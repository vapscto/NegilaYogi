...
namespace corewebapi18072016.Controllers.com.vapstech.Exam
{
    ...
    public class MasterExamSlabController : Controller
    {
        MasterExamSlabDelegates objdelegate = new MasterExamSlabDelegates();
        ...
        [HttpGet]
        [Route("getalldetails")]
        public MasterExamSlabDTO Get([FromQuery] int id)
        {
        ...
        [HttpPost]
        [Route("savedetail")]
        public MasterExamSlabDTO savedetail([FromBody] MasterExamSlabDTO categorypage)
        {
        ...
        [HttpPost]
        [Route("deactivate")]
        public MasterExamSlabDTO deactivate([FromBody] MasterExamSlabDTO categorypage)
        {
        ...
        public MasterExamSlabDTO getalldetailsviewrecords(int id)
        {
        ...
        public MasterExamSlabDTO getdetail(int id)
        {
        ...
        public MasterExamSlabDTO deletepages(int id)
        {
