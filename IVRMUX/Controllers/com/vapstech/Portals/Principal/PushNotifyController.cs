...
namespace corewebapi18072016.Controllers
{
    ...
    public class PushNotifyController : Controller
    {
        PushNotifyDelegates SendStr = new PushNotifyDelegates();
        ...
        [Route("Getdetails")]
        public PushNotifyDTO Getdetails([FromBody]PushNotifyDTO data)
        {
        ...
        public PushNotifyDTO Getdepartment(int id)
        {
            PushNotifyDTO data = new PushNotifyDTO();
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));          
        ...
        [Route("savedetail")]
        public PushNotifyDTO savedetail([FromBody] PushNotifyDTO message)
        {
        ...
        public PushNotifyDTO GetStudentDetails([FromBody] PushNotifyDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
