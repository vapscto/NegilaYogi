...
namespace corewebapi18072016.Controllers
{
    ...
    public class ADMCasteStrengthController : Controller
    {


        ADMCasteStrengthDelegates crStr = new ADMCasteStrengthDelegates();
        ...
        [Route("getclass/{id}")]
        public ADMCasteStrengthDTO getclass(int id)
        {
            ADMCasteStrengthDTO data = new ADMCasteStrengthDTO();
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            data.ASMAY_Id = id;
