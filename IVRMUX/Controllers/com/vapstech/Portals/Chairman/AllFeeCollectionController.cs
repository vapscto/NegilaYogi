...
namespace corewebapi18072016.Controllers
{
    ...
    public class AllFeeCollectionController : Controller
    {


        AllFeeCollectionDelegates crStr = new AllFeeCollectionDelegates();
        ...
        [Route("getdata/{id}")]
        public AllFeeCollectionDTO getdata(int id)
        {
            AllFeeCollectionDTO data = new AllFeeCollectionDTO();
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            data.user_id = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
            data.ASMAY_Id = id;
            return crStr.Getdetails(data);
