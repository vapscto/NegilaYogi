...
namespace corewebapi18072016.Controllers
{
    ...
    public class FEESGroupHeadWiseDetailsSchoolController : Controller
    {


        FEESGroupHeadWiseDetailsSchoolDelegates crStr = new FEESGroupHeadWiseDetailsSchoolDelegates();
        ...
        [Route("getdata/{id}")]
        public FEESGroupHeadWiseDetailsSchoolDTO getdata(int id)
        {
            FEESGroupHeadWiseDetailsSchoolDTO data = new FEESGroupHeadWiseDetailsSchoolDTO();
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            data.ASMAY_Id = id;
            return crStr.Getdetails(data);
        }
        ...
        public FEESGroupHeadWiseDetailsSchoolDTO Getgroupclasscount([FromBody] FEESGroupHeadWiseDetailsSchoolDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            // data.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            return crStr.Getgroupclasscount(data);
        }
