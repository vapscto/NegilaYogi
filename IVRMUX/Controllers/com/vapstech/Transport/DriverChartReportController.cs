...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class DriverChartReportController : Controller
    {
        DriverChartReportDelegate _driver = new DriverChartReportDelegate();
        // GET: api/values
        [HttpGet]
        ...
        public DriverChartReportDTO Getreportdetails([FromBody] DriverChartReportDTO data)
        {
            ...
            return _driver.Getreportdetails(data);
        }
