...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class ConsolidatedBusRouteListController : Controller
    {

        ConsolidatedBusRouteListDelegate cwsd = new ConsolidatedBusRouteListDelegate();
        // GET: api/values
        [HttpGet]
        ...
        [Route("getdata")]
        public ConsolidatedBusRouteDTO getdata([FromQuery] int id)
        {
