...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    {
        MasterLocationDelegate _location = new MasterLocationDelegate();
        // GET: api/values
        [HttpGet]
        ...
        public MasterLocationDTO savedata([FromBody] MasterLocationDTO data)
        {
            ...
            return _location.savedata(data);
        }
        ...
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            return _location.activedeactive(data);
        }
        [Route("edit")]
        public MasterLocationDTO edit([FromBody] MasterLocationDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            return _location.edit(data);
        }
