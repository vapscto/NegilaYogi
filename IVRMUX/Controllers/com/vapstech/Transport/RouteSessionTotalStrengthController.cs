...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class RouteSessionTotalStrengthController : Controller
    {
        RouteSessionTotalStrengthDelegate rtfd = new RouteSessionTotalStrengthDelegate();
        // GET: api/values
        [HttpGet]
        ...
        [Route("getdata")]
        public RouteSessionTotalStrengthDTO getdata([FromQuery] int id)
        {
