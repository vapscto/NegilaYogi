...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class CLGRouteStatusReportController : Controller
    {
        CLGRouteStatusReportDelgate cwsd = new CLGRouteStatusReportDelgate();
        // GET: api/values
        [HttpGet]
        ...
        [Route("getdata")]
        public RouteStatusReportDTO getdata([FromQuery] int id)
        {
