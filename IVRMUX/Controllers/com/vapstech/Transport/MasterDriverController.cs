...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class MasterDriverController : Controller
    {
        MasterDriverDelegate _driver = new MasterDriverDelegate();
        // GET: api/values
        [HttpGet]
        ...
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            return _driver.activedeactive(data);
        }
