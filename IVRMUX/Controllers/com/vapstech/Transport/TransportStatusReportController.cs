...
namespace corewebapi18072016.Controllers.com.vapstech.Transport
{
    ...
    public class TransportStatusReportController : Controller
    {

        TransportStatusReportDelegate cwsd = new TransportStatusReportDelegate();
        // GET: api/values
        [HttpGet]
        ...
        [Route("getdata")]
        public TransportStatusReportDTO getdata([FromQuery] int id)
        {
