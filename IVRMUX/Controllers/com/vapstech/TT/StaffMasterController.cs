...
namespace corewebapi18072016.Controllers.com.vapstech.TT
{
    ...
    {
        StaffMasterDelegate objdelegate = new StaffMasterDelegate();
        ...
        [HttpGet]
        [Route("getalldetails")]
        public TTStaffMasterDTO Get([FromQuery] int id)
        {
        ...
        [HttpPost]
        [Route("savedetail")]
        public TTStaffMasterDTO savedetail([FromBody] TTStaffMasterDTO categorypage)
        {
        ...
        [HttpPost]
        [Route("deactivate")]
        public TTStaffMasterDTO deactivate([FromBody] TTStaffMasterDTO categorypage)
        {
            //  categorypage.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            categorypage.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public TTStaffMasterDTO deletepages(int id)
        {
            return objdelegate.deleterec(id);
        }
        [Route("getdetails/{id:int}")]
        public TTStaffMasterDTO getdetail(int id)
        {
