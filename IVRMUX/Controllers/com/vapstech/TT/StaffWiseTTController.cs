...
namespace corewebapi18072016.Controllers.com.vapstech.TT
{
    ...
    public class StaffWiseTTController : Controller
    {
        StaffWiseTTDelegate objdelegate = new StaffWiseTTDelegate();
        ...
        [HttpGet]
        [Route("getdetails")]
        public TTStaffWiseTTDTO Get([FromQuery] int id)
        {
        ...
        [HttpPost]
        [Route("getrpt")]
        public TTStaffWiseTTDTO getrpt([FromBody] TTStaffWiseTTDTO categorypage)
        {
