...
namespace corewebapi18072016.Controllers.com.vapstech.TT
{
    ...
    public class TTMasterRoomController : Controller
    {
        TTMasterRoomDelegate objdelegate = new TTMasterRoomDelegate();
        ...
        [HttpGet]
        [Route("getalldetails")]
        public TTMasterRoomDTO Get([FromQuery] int id)
        {
        ...
        [HttpPost]
        [Route("savedetail")]
        public TTMasterRoomDTO savedetail([FromBody] TTMasterRoomDTO data)
        {
        ...
        public TTMasterRoomDTO getdetail(int id)
        {
        ...
        {
            return objdelegate.Viewfacility(id);
        ...
        [HttpPost]
        [Route("deactivate")]
        public TTMasterRoomDTO deactvate([FromBody] TTMasterRoomDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            data.User_Id = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
