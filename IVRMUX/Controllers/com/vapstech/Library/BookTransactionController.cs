...
namespace IVRMUX.Controllers.com.vapstech.Library
{
    ...
    {
        BookTransactionDelegate _delobj = new BookTransactionDelegate();
        ...
        public BookTransactionDTO getdetails([FromBody] BookTransactionDTO data)
        {
            ...
            data.AMCTST_IP = Request.HttpContext.Connection.RemoteIpAddress.ToString();
        ...
        public BookTransactionDTO getdetailsReturn([FromBody] BookTransactionDTO data)
        {
            ...
            data.IVRMUL_Id = Convert.ToInt64(HttpContext.Session.GetInt32("UserId"));
            data.AMCTST_IP = Request.HttpContext.Connection.RemoteIpAddress.ToString();
            return _delobj.getdetailsReturn(data);
        }
        ...
        public BookTransactionDTO GettransctionDetails([FromBody] BookTransactionDTO data)
        {
            ...
            data.AMCTST_IP = Request.HttpContext.Connection.RemoteIpAddress.ToString();
            return _delobj.GettransctionDetails(data);
        }
        [Route("loadbookavail")]
        ...
        public BookTransactionDTO ShowDiffrentDays([FromBody] BookTransactionDTO data)
        {
            data.AMCTST_IP = Request.HttpContext.Connection.RemoteIpAddress.ToString();
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            return _delobj.ShowDiffrentDays(data);
        }
    }
}
