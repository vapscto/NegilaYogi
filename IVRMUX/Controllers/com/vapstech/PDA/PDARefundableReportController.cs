...
{
    public class PDARefundableReportController:Controller
    {
        PDATransactionDTO data = new PDATransactionDTO();

        PDARefundableReportDelegate pda = new PDARefundableReportDelegate();
        ...
        [Route("radiobtndata")]
        public PDATransactionDTO radiobtndata(int id)
        {
            data.MI_ID = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            data.user_id = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
