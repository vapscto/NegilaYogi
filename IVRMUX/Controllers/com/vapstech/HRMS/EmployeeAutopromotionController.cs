...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class EmployeeAutopromotionController : Controller
    {
        // GET: api/values
        EmployeeAutopromotionDelegate del = new EmployeeAutopromotionDelegate();

        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Emp_AutopromotionDTO getalldetails(int id)
        {
        ...
        public HR_Emp_AutopromotionDTO editRecord(int id)
        {
            HR_Emp_AutopromotionDTO dto = new HR_Emp_AutopromotionDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public HR_Emp_AutopromotionDTO ActiveDeactiveRecord(int id)
        {
            HR_Emp_AutopromotionDTO dto = new HR_Emp_AutopromotionDTO();
        ...
        public HR_Emp_AutopromotionDTO getDetailsByEmployee(int id)
        {
            HR_Emp_AutopromotionDTO dto = new HR_Emp_AutopromotionDTO();
            dto.HRME_Id = id;
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
