...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class FORMNO15GController : Controller
    {
    FORMNO15GDelegate del = new FORMNO15GDelegate();
    // GET: api/values
    [HttpGet]
    [Route("getalldetails/{id:int}")]
    public FORMNO15GDTO getalldetails(int id)
    {
      FORMNO15GDTO dto = new FORMNO15GDTO();
