...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
  ...
  public class HREmpAllowanceController : Controller
  {
        // GET: api/values
        HREmpAllowanceDelegate del = new HREmpAllowanceDelegate();

      // GET: api/values
      [HttpGet]
      [Route("getalldetails/{id:int}")]
      public HR_Emp_AllowanceDTO getalldetails(int id)
      {
      ...
      public HR_Emp_AllowanceDTO editRecord(int id)
      {
            HR_Emp_AllowanceDTO dto = new HR_Emp_AllowanceDTO();
        dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
      ...
      public HR_Emp_AllowanceDTO ActiveDeactiveRecord(int id)
      {
            HR_Emp_AllowanceDTO dto = new HR_Emp_AllowanceDTO();
            dto.HREAL_Id= id;
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public HR_Emp_AllowanceDTO getDetailsByEmployee(int id)
            {
            HR_Emp_AllowanceDTO dto = new HR_Emp_AllowanceDTO();
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
