...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class MasterIncomeTaxController : Controller
    {
        MasterIncomeTaxDelegate del = new MasterIncomeTaxDelegate();
        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Master_IncomeTaxDTO getalldetails(int id)
        {
        ...
        public HR_Master_IncomeTaxDTO editRecord(int id)
        {
            HR_Master_IncomeTaxDTO dto = new HR_Master_IncomeTaxDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public HR_Master_IncomeTaxDTO ActiveDeactiveRecord(int id)
        {
            HR_Master_IncomeTaxDTO dto = new HR_Master_IncomeTaxDTO();
            dto.HRMIT_Id = id;
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
