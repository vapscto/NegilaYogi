...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    {
        MasterBankDelegate del = new MasterBankDelegate();

        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Master_BankDeatilsDTO getalldetails(int id)
        {
        ...
        public HR_Master_BankDeatilsDTO editRecord(int id)
        {
            HR_Master_BankDeatilsDTO dto = new HR_Master_BankDeatilsDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public HR_Master_BankDeatilsDTO ActiveDeactiveRecord(int id)
        {
            HR_Master_BankDeatilsDTO dto = new HR_Master_BankDeatilsDTO();
            dto.HRMBD_Id = id;
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
