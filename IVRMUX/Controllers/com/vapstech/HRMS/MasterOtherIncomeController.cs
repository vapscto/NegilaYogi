...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class MasterOtherIncomeController : Controller
    {
        MasterotherIncomeDelegate del = new MasterotherIncomeDelegate();

        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_master_otherIncomeDTO getalldetails(int id)
        {
        ...
        public HR_master_otherIncomeDTO editRecord(int id)
        {
            HR_master_otherIncomeDTO dto = new HR_master_otherIncomeDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public HR_master_otherIncomeDTO ActiveDeactiveRecord(int id)
        {
            HR_master_otherIncomeDTO dto = new HR_master_otherIncomeDTO();
            dto.HRMOI_Id
 = id;
