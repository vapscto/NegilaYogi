...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class Master80CController : Controller
    {
        Master80CDelegate del = new Master80CDelegate();

        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Master_80CDTO getalldetails(int id)
        {
        ...
        public HR_Master_80CDTO editRecord(int id)
        {
            HR_Master_80CDTO dto = new HR_Master_80CDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public HR_Master_80CDTO ActiveDeactiveRecord(int id)
        {
            HR_Master_80CDTO dto = new HR_Master_80CDTO();
            dto.HRMMM_Id = id;
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
