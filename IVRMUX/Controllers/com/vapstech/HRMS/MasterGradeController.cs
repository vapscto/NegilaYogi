...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    {
    MasterGradeDelegate del = new MasterGradeDelegate();  
    // GET: api/values
    [HttpGet]
    [Route("getalldetails/{id:int}")]
    public HR_Master_GradeDTO getalldetails(int id)
    {
    ...
    public HR_Master_GradeDTO validateordernumber([FromBody]HR_Master_GradeDTO dto)
    {
    ...
    public HR_Master_GradeDTO editRecord(int id)
    {
      HR_Master_GradeDTO dto = new HR_Master_GradeDTO();
      dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
    ...
    public HR_Master_GradeDTO ActiveDeactiveRecord(int id)
    {
      HR_Master_GradeDTO dto = new HR_Master_GradeDTO();
      dto.HRMG_Id = id;
      dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
