...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class PFForm5stopPensionSTJamesReportController : Controller
    {
        PFForm5stopPensionSTJamesReportDelegate del = new PFForm5stopPensionSTJamesReportDelegate();
        // GET: api/values
        [HttpGet]
