...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class MasterQuarterController : Controller
    {
        MasterQuarterDelegate del = new MasterQuarterDelegate();

        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Master_QuarterDTO getalldetails(int id)
        {
        ...
        public HR_Master_QuarterDTO editRecord(int id)
        {
            HR_Master_QuarterDTO dto = new HR_Master_QuarterDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            dto.LogInUserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public HR_Master_QuarterDTO ActiveDeactiveRecord(int id)
        {
            HR_Master_QuarterDTO dto = new HR_Master_QuarterDTO();
            dto.HRMQ_Id = id;
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
