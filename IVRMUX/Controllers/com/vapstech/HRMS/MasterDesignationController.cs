...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    {
        MasterDesignationDelegate del = new MasterDesignationDelegate();
        // GET: api/values
        [HttpGet]
        [Route("getalldetails/{id:int}")]
        public HR_Master_DesignationDTO getalldetails(int id)
        {
        ...
        [Route("validateordernumber")]
         public HR_Master_DesignationDTO validateordernumber([FromBody]HR_Master_DesignationDTO dto)
         {
    ...
    [HttpGet("{id}")]
        ...
        public HR_Master_DesignationDTO editRecord(int id)
        {
            HR_Master_DesignationDTO dto = new HR_Master_DesignationDTO();
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        public HR_Master_DesignationDTO ActiveDeactiveRecord(int id)
        {
            HR_Master_DesignationDTO dto = new HR_Master_DesignationDTO();
            dto.HRMDES_Id = id;
            dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
