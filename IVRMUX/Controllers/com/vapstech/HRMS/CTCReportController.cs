...
namespace corewebapi18072016.Controllers.com.vapstech.HRMS
{
    ...
    public class CTCReportController : Controller
    {
    CTCReportDelegate del = new CTCReportDelegate();
    // GET: api/values
    [HttpGet]
    [Route("getalldetails/{id:int}")]
    public CTCReportDTO getalldetails(int id)
    {
      CTCReportDTO dto = new CTCReportDTO();
