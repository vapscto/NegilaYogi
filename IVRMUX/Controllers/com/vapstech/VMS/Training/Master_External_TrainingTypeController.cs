...
namespace IVRMUX.Controllers.com.vapstech.VMS.Training
{
    ...
    public class Master_External_TrainingTypeController : Controller
    {
        Master_External_TrainingTypeDelegate _del = new Master_External_TrainingTypeDelegate();
        // GET: api/<controller>
        [HttpGet]
        ...
        public Master_External_TrainingTypeDTO onloaddata(int id)
        {
            Master_External_TrainingTypeDTO data = new Master_External_TrainingTypeDTO();
