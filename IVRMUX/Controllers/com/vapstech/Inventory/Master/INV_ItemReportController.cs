...
namespace IVRMUX.Controllers.com.vapstech.Inventory
{
    ...
    public class INV_ItemReportController : Controller
    {
        INV_ItemReportDelegate _delegate = new INV_ItemReportDelegate();
        ...
        [Route("onreport")]
        public INV_Master_ItemDTO onreport([FromBody] INV_Master_ItemDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
