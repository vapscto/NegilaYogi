...
namespace IVRMUX.Controllers.com.vapstech.Inventory
{
    ...
    public class PhyStock_UpdationController : Controller
    {
        PhyStock_UpdationDelegate _delegate = new PhyStock_UpdationDelegate();
        ...
        [Route("getitemDetail")]
        public INV_PhyStock_UpdationDTO getitemDetail([FromBody] INV_PhyStock_UpdationDTO data)
        {
            data.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
