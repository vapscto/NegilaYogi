...
namespace corewebapi18072016.Controllers.com.vapstech.Fees
{
    ...
    public class FeeOnlinePaymentStthomasController : Controller
    {
        FeeOnlinePaymentStthomasDelegate clsdel = new FeeOnlinePaymentStthomasDelegate();
        private readonly IHostingEnvironment _hostingEnvironment;
        PaymentDetails od1 = new PaymentDetails();
        public FeeOnlinePaymentStthomasController(IHostingEnvironment hostingEnvironment)
        {
        ...
        public ActionResult paymentresponse(PaymentDetails response)
        {
            ...
            try
            {
                ...
                {
                    querystring = "http://localhost:57606/#/app/FeeOnlinePaymentStthomas/13?status=" + dto.status;
                }
                else
                {
                    querystring = "http://localhost:57606/#/app/FeeOnlinePaymentStthomas/13?status=Networkfailure";
                }
            }
            catch (Exception e)
            {
        ...
        public ActionResult BillDeskpaymentresponse(string msg)
        {
            ...
            try
            {
                ...
                {
                    querystring = "http://localhost:57606/#/app/FeeOnlinePaymentStthomas/13?status=" + returnmsg;
                }
                else if (returnmsg.Equals("Cancel Transaction"))
                {
                    querystring = "http://localhost:57606/#/app/FeeOnlinePaymentStthomas/13?status=cancelled";
                }
                else
                {
                    querystring = "http://localhost:57606/#/app/FeeOnlinePaymentStthomas/13?status=Networkfailure";
