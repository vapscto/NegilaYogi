...
namespace corewebapi18072016.Controllers
{
    ...
    public class StudentFeeGroupMappingController : Controller
    {
        StudentFeeGroupMappingDelegate od = new StudentFeeGroupMappingDelegate();
        // GET: api/values
        [HttpGet]
        ...
        public FeeStudentGroupMappingDTO fillstudentsroute([FromBody] FeeStudentGroupMappingDTO pgmodu)
        {
            pgmodu.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
        ...
        [Route("searching_s")]
        public FeeStudentGroupMappingDTO searching_s([FromBody] FeeStudentGroupMappingDTO categorypage)
        {
           // categorypage.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            categorypage.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            int UserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        [Route("searching_o")]
        public FeeStudentGroupMappingDTO searching_o([FromBody] FeeStudentGroupMappingDTO categorypage)
        {
            //categorypage.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            categorypage.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            int UserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public FeeStudentGroupMappingDTO searchingstaff([FromBody] FeeStudentGroupMappingDTO categorypage)
        {
            //categorypage.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            categorypage.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            int UserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public FeeStudentGroupMappingDTO searchingothers([FromBody] FeeStudentGroupMappingDTO categorypage)
        {
            //categorypage.ASMAY_Id = Convert.ToInt64(HttpContext.Session.GetInt32("ASMAY_Id"));
            categorypage.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            int UserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public FeeStudentGroupMappingDTO getacademicye([FromBody] FeeStudentGroupMappingDTO pgmodu)
        {
            pgmodu.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            pgmodu.user_id = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
            //pgmodu.ASMAY_Id = Convert.ToInt32(HttpContext.Session.GetInt32("ASMAY_Id"));
        ...
        public FeeStudentGroupMappingDTO geteditdatastaffothers([FromBody] FeeStudentGroupMappingDTO pgmodu)
        {
            pgmodu.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            //pgmodu.ASMAY_Id = Convert.ToInt32(HttpContext.Session.GetInt32("ASMAY_Id"));
        ...
        public FeeStudentGroupMappingDTO saveeditdatastaff([FromBody] FeeStudentGroupMappingDTO pgmodu)
        {
            pgmodu.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            pgmodu.user_id = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
        ...
        public FeeStudentGroupMappingDTO saveeditdataothers([FromBody] FeeStudentGroupMappingDTO pgmodu)
        {
            pgmodu.MI_Id = Convert.ToInt64(HttpContext.Session.GetInt32("Session_MI_Id"));
            pgmodu.user_id = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
