...
namespace IVRMUX.Controllers.NAAC.University
{
    ...
    public class NAAC_HSU_InterdisciplinaryProgrammes_123Controller : Controller
    {
        NAAC_HSU_InterdisciplinaryProgrammes_123Delegate del = new NAAC_HSU_InterdisciplinaryProgrammes_123Delegate();
        [Route("loaddata/{id:int}")]
        public NAAC_HSU_InterdisciplinaryProgrammes_123_DTO loaddata(int id)
        {
            NAAC_HSU_InterdisciplinaryProgrammes_123_DTO data = new NAAC_HSU_InterdisciplinaryProgrammes_123_DTO();
