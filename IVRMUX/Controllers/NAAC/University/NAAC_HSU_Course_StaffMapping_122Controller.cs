...
namespace IVRMUX.Controllers.NAAC.University
{
    ...
    public class NAAC_HSU_Course_StaffMapping_122Controller : Controller
    {
        NAAC_HSU_Course_StaffMapping_122Delegate del = new NAAC_HSU_Course_StaffMapping_122Delegate();
        [Route("loaddata/{id:int}")]
        public NAAC_HSU_Course_StaffMapping_122DTO loaddata(int id)
        {
            NAAC_HSU_Course_StaffMapping_122DTO data = new NAAC_HSU_Course_StaffMapping_122DTO();
        ...
        [Route("get_course")]
        public NAAC_HSU_Course_StaffMapping_122DTO get_course([FromBody] NAAC_HSU_Course_StaffMapping_122DTO dto)
        {
            //dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            return del.get_course(dto);
        }
        [Route("get_designation")]
        public NAAC_HSU_Course_StaffMapping_122DTO get_designation([FromBody] NAAC_HSU_Course_StaffMapping_122DTO dto)
        {
            //dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
            return del.get_designation(dto);
        }
        [Route("get_employee")]
        public NAAC_HSU_Course_StaffMapping_122DTO get_employee([FromBody] NAAC_HSU_Course_StaffMapping_122DTO dto)
        {
            //dto.MI_Id = Convert.ToInt32(HttpContext.Session.GetInt32("Session_MI_Id"));
