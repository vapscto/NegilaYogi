...
namespace IVRMUX.Controllers.NAAC.University
{
    ...
    public class HSU_348_BibliometricPublicationsController : Controller
    {
        HSU_348_BibliometricPublicationsDelegate del = new HSU_348_BibliometricPublicationsDelegate();
