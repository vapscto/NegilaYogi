...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class NAACAC7115ProfessionalEthicsReportController : Controller
    {
        NAACAC7115ProfessionalEthicsReportDelegate del = new NAACAC7115ProfessionalEthicsReportDelegate();
