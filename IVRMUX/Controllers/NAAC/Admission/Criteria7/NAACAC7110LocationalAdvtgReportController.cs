...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class NAACAC7110LocationalAdvtgReportController : Controller
    {
        NAACAC7110LocationalAdvtgReportDelegate del = new NAACAC7110LocationalAdvtgReportDelegate();
