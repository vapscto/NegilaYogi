...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class ProfessionalEthicsController : Controller
    {
        public ProfessionalEthicsDelegate _objdel = new ProfessionalEthicsDelegate();

        [Route("loaddata/{id:int}")]
        public NAAC_AC_7115_ProfessionalEthics_DTO loaddata(int id)
        {
            NAAC_AC_7115_ProfessionalEthics_DTO data = new NAAC_AC_7115_ProfessionalEthics_DTO();
        ...
        public NAAC_AC_7115_ProfessionalEthics_DTO getData(int id)
        {
            NAAC_AC_7115_ProfessionalEthics_DTO data = new NAAC_AC_7115_ProfessionalEthics_DTO();
            data.MI_Id = id;
            data.UserId = Convert.ToInt32(HttpContext.Session.GetInt32("UserId"));
