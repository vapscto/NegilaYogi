...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class NAACAC7116StatutoryBodiesReportController : Controller
    {
        NAACAC7116StatutoryBodiesReportDelegate del = new NAACAC7116StatutoryBodiesReportDelegate();
