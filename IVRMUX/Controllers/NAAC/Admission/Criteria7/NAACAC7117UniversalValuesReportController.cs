...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class NAACAC7117UniversalValuesReportController : Controller
    {
        NAACAC7117UniversalValuesReportDelegate del = new NAACAC7117UniversalValuesReportDelegate();
