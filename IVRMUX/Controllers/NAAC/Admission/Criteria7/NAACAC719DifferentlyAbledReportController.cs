...
namespace IVRMUX.Controllers.NAAC.Admission.Criteria7
{
    ...
    public class NAACAC719DifferentlyAbledReportController : Controller
    {
        NAACAC719DifferentlyAbledReportDelegate del = new NAACAC719DifferentlyAbledReportDelegate();
