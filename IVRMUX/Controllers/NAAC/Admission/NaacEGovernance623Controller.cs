...
namespace IVRMUX.Controllers.NAAC.Admission
{
    ...
    public class NaacEGovernance623Controller : Controller
    {

        NaacEGovernance623Delegate _delobj = new NaacEGovernance623Delegate();
        [Route("loaddata/{id:int}")]
        public NAAC_AC_623_EGovernance_DTO loaddata(int id)
        {
            NAAC_AC_623_EGovernance_DTO data = new NAAC_AC_623_EGovernance_DTO();
            data.MI_Id = id;
