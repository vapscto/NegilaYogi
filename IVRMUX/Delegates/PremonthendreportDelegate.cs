...
{
    public class PremonthendreportDelegate 
    {
            ...
            MonthEndReportDTO enqdto = null;
                ...
                try
                {
                    ...
                    var response = client.PostAsync("api/PremonthendreportFacade/getalldetails123/", byteContent).Result;
            ...
            MonthEndReportDTO enqdto = null;
                ...
                try
                {
                    ...
                    var byteContent = new ByteArrayContent(buffer);
                    byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                    var response = client.PostAsync("api/PremonthendreportFacade/getreport/", byteContent).Result;
