...
{
    public class ReportProspectusDelegates
    {
        ...
        {
            return COMMM.POSTData(WrittenTestMarksBindDataDTO, "ReportProspectusFacade/Getdetails/");
        }


        public WrittenTestMarksBindDataDTO get_intial_data(WrittenTestMarksBindDataDTO WrittenTestMarksBindDataDTO)
        {
            return COMMM.POSTData(WrittenTestMarksBindDataDTO, "ReportProspectusFacade/Get_Intial_data/");
        }
        ...
        public string SendSms(WrittenTestMarksBindDataDTO WrittenTestMarksBindDataDTO)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/ReportProspectusFacade/SendSms/", byteContent).Result;
        ...
        public string SendMail(WrittenTestMarksBindDataDTO WrittenTestMarksBindDataDTO)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/ReportProspectusFacade/SendMail/", byteContent).Result;
        ...
        public string ExportToExcle(WrittenTestMarksBindDataDTO WrittenTestMarksBindDataDTO)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/ReportProspectusFacade/ExportToExcle/", byteContent).Result;
        ...
        public WrittenTestMarksBindDataDTO searchprospectus(WrittenTestMarksBindDataDTO WrittenTestMarksBindDataDTO)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/ReportProspectusFacade/searchprospectus/", byteContent).Result;
