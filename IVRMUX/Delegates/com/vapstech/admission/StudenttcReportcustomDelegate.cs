...
{
    public class StudenttcReportcustomDelegate
    {
        ...
        public StudentAttendanceReportDTO getinitialdata(int id)
        {
            ...
            try
            {
                ...
                var response = client.GetAsync("api/StudenttcReportcustomFacade/getinitialdata/" + id).Result;
        ...
        public StudentAttendanceReportDTO getstuddetails(StudentAttendanceReportDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudenttcReportcustomFacade/getstuddetails/", byteContent).Result;
        ...
        public StudentAttendanceReportDTO getStudentlist(int id)
        {
            StudentAttendanceReportDTO stuDTO = null;
            string product;
            HttpClient client = new HttpClient();
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.GetAsync("api/StudenttcReportcustomFacade/getstudlist/" + id).Result;
        ...
        public StudentAttendanceReportDTO getTCdata(StudentAttendanceReportDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudenttcReportcustomFacade/", byteContent).Result;
        ...
        public StudentAttendanceReportDTO getTcdetailsbwmc(StudentAttendanceReportDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudenttcReportcustomFacade/getTcdetailsbwmc", byteContent).Result;
