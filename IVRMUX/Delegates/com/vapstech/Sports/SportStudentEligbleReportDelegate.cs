...
namespace corewebapi18072016.Delegates.com.vapstech.Sports
{
    ...
    public class SportStudentEligbleReportDelegate : Controller
    {
        ...
        {
            return COMMM.POSTDataSports(data, "SportStudentEligbleReportFacade/Getdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportStudentEligbleReportFacade/showdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportStudentEligbleReportFacade/get_class/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportStudentEligbleReportFacade/get_section/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportStudentEligbleReportFacade/get_student/");
        }
    }
}
