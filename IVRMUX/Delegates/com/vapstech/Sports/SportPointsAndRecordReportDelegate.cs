...
namespace corewebapi18072016.Delegates.com.vapstech.Sports
{
    ...
    public class SportPointsAndRecordReportDelegate : Controller
    {
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointsAndRecordReportFacade/Getdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointsAndRecordReportFacade/showdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointsAndRecordReportFacade/get_class/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointsAndRecordReportFacade/get_section/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointsAndRecordReportFacade/get_student/");
        }
