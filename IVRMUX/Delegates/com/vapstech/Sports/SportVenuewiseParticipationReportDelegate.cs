...
namespace corewebapi18072016.Delegates.com.vapstech.Sports
{
    ...
    public class SportVenuewiseParticipationReportDelegate : Controller
    {
        ...
        {
            return COMMM.POSTDataSports(data, "SportVenuewiseParticipationReportFacade/Getdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportVenuewiseParticipationReportFacade/showdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportVenuewiseParticipationReportFacade/get_class/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportVenuewiseParticipationReportFacade/get_section/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportVenuewiseParticipationReportFacade/get_student/");
        }
    }
}
