...
namespace corewebapi18072016.Delegates.com.vapstech.Sports
{
    ...
    public class SportPointAndRecordReportDelegate : Controller
    {
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointAndRecordReportFacade/Getdetails/");
        ...
        {
            return COMMM.POSTDataSports(data, "SportPointAndRecordReportFacade/showdetails/");
