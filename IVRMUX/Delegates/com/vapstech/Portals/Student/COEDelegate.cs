...
namespace corewebapi18072016.Delegates.com.vapstech.Portals.Student
{
    public class COEDelegate
    {
        ...
        {     
            return COMMM.POSTPORTALData(data, "COEFacade/getloaddata/");
        }
        public StudentDashboardDTO getcoedata(StudentDashboardDTO sddto)
        {
            return COMMM.POSTPORTALData(sddto, "COEFacade/getcoedata/");
        }
