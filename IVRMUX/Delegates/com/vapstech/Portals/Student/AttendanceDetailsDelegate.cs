...
{
    public class AttendanceDetailsDelegate
    {
        ...
        {     
            return COMMM.POSTPORTALData(data, "AttendanceDetailsFacade/getloaddata/");
        }
        public StudentDashboardDTO getAttdata(StudentDashboardDTO sddto)
        {
            return COMMM.POSTPORTALData(sddto, "AttendanceDetailsFacade/getAttdata/");
        }
    }
}
