...
{
    public class ChairmanDashboardDelegates
    {
        private readonly object resource;
        private readonly string serviceBaseUrl;
        private const String JsonContentType = "application/json; charset=utf-8";
        CommonDelegate<ChairmanDashboardDTO, ChairmanDashboardDTO> COMMM = new CommonDelegate<ChairmanDashboardDTO, ChairmanDashboardDTO>();
        public ChairmanDashboardDTO Getdetails(ChairmanDashboardDTO data)
        {
            return COMMM.POSTPORTALData(data, "ChairmanDashboardFacade/Getdetails/");
        }
