...
{
    public class JobPostingListVMSDelegate
    {
        ...
        {
            return COMMM.POSTVMS(dto, "JobPostingListVMSFacade/onloadgetdetails");
        }
        ...
        {
            return COMMM.GetVMS(id, "JobPostingListVMSFacade/getRecordById/");
        }
        public HR_MRFRequisitionDTO deleterec(HR_MRFRequisitionDTO maspage)
        {
            return COMMM.POSTVMS(maspage, "JobPostingListVMSFacade/deactivateRecordById/");
        }
    }
}
