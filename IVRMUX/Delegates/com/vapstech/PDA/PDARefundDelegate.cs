...
namespace corewebapi18072016.Delegates.com.vapstech.PDA
{
    ...
    public class PDARefundDelegate
    {
        public PDATransactionDTO getdetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/PDARefundfacade/getdetails/", byteContent).Result;
        ...
        public FeeStudentTransactionDTO getsearchfilter(FeeStudentTransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/getsearchfilter/", byteContent).Result;
        ...
        public PDATransactionDTO getstuddetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/getstuddetails/", byteContent).Result;
        ...
        public PDATransactionDTO Savedata(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/Savedata/", byteContent).Result;
        ...
        public PDATransactionDTO searching(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/searching/", byteContent).Result;
        ...
        public PDATransactionDTO Deletedetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/Deletedetails/", byteContent).Result;
        ...
        public PDATransactionDTO getdatastuacad(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundfacade/getacademicyear/", byteContent).Result;
