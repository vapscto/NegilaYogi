...
{
    public class PDAReportDelegate
    {
        ...
        public PDATransactionDTO getalldetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/PDAReportFacade/getalldetails/", byteContent).Result;
        ...
        public PDATransactionDTO radiobtndata(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDAReportFacade/radiobtndata/", byteContent).Result;
        ...
        public PDATransactionDTO getstudent(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDAReportFacade/getstudent/", byteContent).Result;
        ...
        public PDATransactionDTO getsection(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDAReportFacade/getsection/", byteContent).Result;
