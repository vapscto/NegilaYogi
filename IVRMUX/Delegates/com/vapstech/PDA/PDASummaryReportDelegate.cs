...
{
    public class PDASummaryReportDelegate
    {
        public PDATransactionDTO getalldetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/PDASummaryReportFacade/getalldetails/", byteContent).Result;
        ...
        public PDATransactionDTO getsection(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDASummaryReportFacade/getsection/", byteContent).Result;
        ...
        public PDATransactionDTO getstudent(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDASummaryReportFacade/getstudent/", byteContent).Result;
        ...
        public PDATransactionDTO radiobtndata(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDASummaryReportFacade/radiobtndata/", byteContent).Result;
