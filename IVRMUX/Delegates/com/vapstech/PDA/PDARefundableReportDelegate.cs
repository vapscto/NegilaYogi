...
{
    public class PDARefundableReportDelegate
    {
        ...
        public PDATransactionDTO getalldetails(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/PDARefundableReportFacade/getalldetails/", byteContent).Result;
        ...
        public PDATransactionDTO radiobtndata(PDATransactionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/PDARefundableReportFacade/radiobtndata/", byteContent).Result;
