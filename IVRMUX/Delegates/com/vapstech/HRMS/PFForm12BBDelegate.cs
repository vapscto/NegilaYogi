...
{
    public class PFForm12BBDelegate
    {
    ...
    {
      return COMMM.POSTDataHRMS(dto, "PFForm12BBFacadeController/onloadgetdetails");
    }
    ...
    {
      return COMMM.POSTDataHRMS(maspage, "PFForm12BBFacadeController/getEmployeedetailsBySelection/");
    }

    public PFReportsDTO FilterEmployeeData(PFReportsDTO maspage)
    {
      return COMMM.POSTDataHRMS(maspage, "PFForm12BBFacadeController/FilterEmployeeData/");
    }
