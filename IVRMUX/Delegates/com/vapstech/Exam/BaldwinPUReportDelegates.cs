...
{
    public class BaldwinPUReportDelegates
    {
        ...
        public string getData(long resource)
        {
            ...
            try
            {
                HttpResponseMessage response = client.GetAsync("api/BaldwinPUReportFacade/" + resource).Result;
        ...
        public BaldwinAllReportDTO Getdetails(BaldwinAllReportDTO data)
        {
           ...
           client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json; charset=utf-8");
            ...
            {             
                ...
                var response = client.PostAsync("api/BaldwinPUReportFacade/Getdetails", byteContent).Result;
        ...
        public BaldwinAllReportDTO savedetails(BaldwinAllReportDTO data)//Int32 IVRMM_Id
        {
           ...
           client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json; charset=utf-8");
            ...
            {         
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");            
                var response = client.PostAsync("api/BaldwinPUReportFacade/savedetails", byteContent).Result;
