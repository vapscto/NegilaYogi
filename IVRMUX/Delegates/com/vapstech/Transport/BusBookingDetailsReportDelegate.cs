...
{
    public class BusBookingDetailsReportDelegate
    {
        ...
        {
            return comml.POSTDataTransport(data, "BusBookingDetailsReportFacade/Getreportdetails/");
        }
        public TripReportDTO getdata(int id)
        {
            return comml.GetDataByIdTransport(id, "BusBookingDetailsReportFacade/getdata/");
        }
    }
}
