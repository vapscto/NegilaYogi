...
{
    public class TRGroupConsoleReportDelegate
    {
        ...
        {
            return comml.POSTDataTransport(data, "TRGroupConsoleReportFacade/Getreportdetails/");
        }
        public TripReportDTO getdata(int id)
        {
            return comml.GetDataByIdTransport(id, "TRGroupConsoleReportFacade/getdata/");
        }
    }
}
