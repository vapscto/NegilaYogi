...
{
    public class CLGRouteStatusReportDelgate
    {
        ...
        {
            return comml.POSTDataTransport(data, "CLGRouteStatusReportFacade/Getreportdetails/");
        }
        public RouteStatusReportDTO getdata(int id)
        {
            return comml.GetDataByIdTransport(id, "CLGRouteStatusReportFacade/getdata/");
        }
    }
}
