...
{
    public class ScheduleWiseBusRouteDelegate
    {
        ...
        {
            return comml.POSTDataTransport(data, "ScheduleWiseBusRouteFacade/Getreportdetails/");
        }
        public ConsolidatedBusRouteDTO getdata(int id)
        {
            return comml.GetDataByIdTransport(id, "ScheduleWiseBusRouteFacade/getdata/");
        }
    }
}
