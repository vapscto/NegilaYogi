...
{
    public class TRPartyBillReceiptReportDelegate
    {
        ...
        {
            return comml.POSTDataTransport(data, "TRPartyBillReceiptReportFacade/Getreportdetails/");
        }
        public TripReportDTO getdata(int id)
        {
            return comml.GetDataByIdTransport(id, "TRPartyBillReceiptReportFacade/getdata/");
        }
    }
}
