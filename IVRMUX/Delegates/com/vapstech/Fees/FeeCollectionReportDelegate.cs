...
{
    public class FeeCollectionReportDelegate
    {
        ...
        public FeeTransactionPaymentDTO getdetails(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/FeeCollectionReportFacade/getdetails/" , byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getgrpterms(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeCollectionReportFacade/getgrpterms", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getradiofiltereddata(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeCollectionReportFacade/radiobtndata", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO get_groups(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeCollectionReportFacade/get_groups", byteContent).Result;
