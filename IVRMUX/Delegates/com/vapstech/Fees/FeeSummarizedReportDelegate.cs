...
{
    public class FeeSummarizedReportDelegate
    {
        public FeeTransactionPaymentDTO details(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/FeeSummarizedReportFacade/getdetails/" , byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getsection(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeSummarizedReportFacade/getsection/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getstudent(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeSummarizedReportFacade/getstudent/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO get_groups(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeSummarizedReportFacade/get_groups", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getradiofiltereddata(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeSummarizedReportFacade/radiobtndata", byteContent).Result;
