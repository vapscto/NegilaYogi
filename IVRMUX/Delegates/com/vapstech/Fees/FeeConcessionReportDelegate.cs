...
{
    public class FeeConcessionReportDelegate
    {
        public FeeTransactionPaymentDTO getdetails(FeeTransactionPaymentDTO dt)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/FeeConcessionReportFacade/getdetails/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getradiofiltereddata(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeConcessionReportFacade/radiobtndata/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO get_groups(FeeTransactionPaymentDTO value)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeConcessionReportFacade/get_groups", byteContent).Result;
