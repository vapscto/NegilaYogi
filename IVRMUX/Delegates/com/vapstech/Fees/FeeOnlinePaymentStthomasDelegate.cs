...
{
    public class FeeOnlinePaymentStthomasDelegate
    {
        ...
        public FeeOnlinePaymentStthomasDelegate() { }

        public FeeOnlinePaymentStthomasDelegate(FacadeUrl config)
        {
            _config = config;
            fdu = config;
        }
        ...
        public FeeStudentTransactionDTO getInitailData(FeeStudentTransactionDTO rtnData)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getpagedetails/", byteContent).Result;
        ...
        public FeeStudentTransactionDTO getamountdet(FeeStudentTransactionDTO rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getamountdetails/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
                    rtnData = JsonConvert.DeserializeObject<FeeStudentTransactionDTO>(product, new JsonSerializerSettings
        ...
        public PaymentDetails getpaymentresponse(PaymentDetails rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getpaymentresponse/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
        ...
        public PaymentDetails.BillDeskPayment getBillDeskpaymentresponse(PaymentDetails.BillDeskPayment rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/billdeskPayment/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
        ...
        public FeeStudentTransactionDTO getgrouportermdeta(FeeStudentTransactionDTO rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getgrouportermdetails/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
                    rtnData = JsonConvert.DeserializeObject<FeeStudentTransactionDTO>(product, new JsonSerializerSettings
        ...
        public FeeStudentTransactionDTO generatehashseq(FeeStudentTransactionDTO rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/generatehashsequence/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
                    rtnData = JsonConvert.DeserializeObject<FeeStudentTransactionDTO>(product, new JsonSerializerSettings
        ...
        public FeeStudentTransactionDTO getcusgrps(FeeStudentTransactionDTO rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getcustomgroups/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
                    rtnData = JsonConvert.DeserializeObject<FeeStudentTransactionDTO>(product, new JsonSerializerSettings
        ...
        public PaymentDetails.PAYTM getpaymentresponse(PaymentDetails.PAYTM rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getpaymentresponsePAYTM/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
        ...
        public PaymentDetails razorgetpaymentresponse(PaymentDetails rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/Razorpaypaymentresponse/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
                    rtnData = JsonConvert.DeserializeObject<PaymentDetails>(product, new JsonSerializerSettings
        ...
        public PaymentDetails.easybuzz getpaymentresponseeasybuzz(PaymentDetails.easybuzz rtnData)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeOnlinePaymentStthomasFacade/getpaymentresponseeasybuzz/", byteContent).Result;
                if (response.IsSuccessStatusCode)
                {
                    product = response.Content.ReadAsStringAsync().Result;
