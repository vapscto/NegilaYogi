...
{
    public class StudentFeeGroupMappingDelegate
    {
        ...
        public FeeStudentGroupMappingDTO getdata(FeeStudentGroupMappingDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/getalldetails/",byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO getstucls(FeeStudentGroupMappingDTO enqdto)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/getgroupmappedheads/" ,byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO fillstudentsroute(FeeStudentGroupMappingDTO enqdto)
        {
            //FeeStudentGroupMappingDTO enqdto = null;
            string product;
            Array[] dropDownArray = new Array[2];
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/fillstudentsroute/", byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO savedetails(FeeStudentGroupMappingDTO pgmod)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/", byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO deleterec_s(FeeStudentGroupMappingDTO enqdto)
        {
            //FeeStudentGroupMappingDTO enqdto = null;
            string product;
            Array[] dropDownArray = new Array[2];
        ...
        public FeeStudentGroupMappingDTO deleterec_o(FeeStudentGroupMappingDTO enqdto)
        {
            //FeeStudentGroupMappingDTO enqdto = null;
            string product;
            Array[] dropDownArray = new Array[2];
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/deletemodpages_o/", byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO searching_s(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO searching_o(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO searchingstaff(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO searchingothers(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO getacademicye(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO geteditdatastaffothers(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
        ...
        public FeeStudentGroupMappingDTO saveeditdatastaff(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentFeeGroupMappingFacade/saveeditdatastaff", byteContent).Result;
        ...
        public FeeStudentGroupMappingDTO saveeditdataothers(FeeStudentGroupMappingDTO enqdto)
        {
            string product;
            Array[] dropDownArray = new Array[2];
            HttpClient client = new HttpClient();
