...
{
    public class DateWiseFeeCollectionDelegate
    {
        public CategoryWiseFeeCollectionDTO getdetails(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/DateWiseFeeCollectionFacade/getdetails/", byteContent).Result;
        ...
        public CategoryWiseFeeCollectionDTO radiobtndata(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/DateWiseFeeCollectionFacade/radiobtndata", byteContent).Result;
        ...
        public CategoryWiseFeeCollectionDTO onchangeacademic(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/DateWiseFeeCollectionFacade/onchangeacademic", byteContent).Result;
