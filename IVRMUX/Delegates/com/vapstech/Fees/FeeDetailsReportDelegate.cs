...
{
    public class FeeDetailsReportDelegate
    {
        ...
        public FeeTransactionPaymentDTO getdetails(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/FeeDetailsReportFacade/getdetails/" , byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getheadisbygrpid(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeDetailsReportFacade/getheadisbygrpid/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO getsection(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeDetailsReportFacade/getsection/", byteContent).Result;
        ...
        public FeeTransactionPaymentDTO radiobtndata(FeeTransactionPaymentDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/FeeDetailsReportFacade/radiobtndata", byteContent).Result;
