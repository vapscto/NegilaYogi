...
{
    public class StudentWiseFeeCollectionDelegate
    {
        public CategoryWiseFeeCollectionDTO getdetails(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var response = client.PostAsync("api/StudentWiseFeeCollectionFacade/getdetails/", byteContent).Result;
        ...
        public CategoryWiseFeeCollectionDTO radiobtndata(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentWiseFeeCollectionFacade/radiobtndata", byteContent).Result;
             ...
             public CategoryWiseFeeCollectionDTO onchangeacademic(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentWiseFeeCollectionFacade/onchangeacademic", byteContent).Result;
        ...
        public CategoryWiseFeeCollectionDTO onselectclass(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentWiseFeeCollectionFacade/onselectclass", byteContent).Result;
        ...
        public CategoryWiseFeeCollectionDTO onselectsection(CategoryWiseFeeCollectionDTO data)
        {
            ...
            try
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var response = client.PostAsync("api/StudentWiseFeeCollectionFacade/onselectsection", byteContent).Result;
