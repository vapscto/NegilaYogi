...
{
    public class DCS_R_StockDelegate
    {
        ...
        {
            return COMINV.POSTDataInventory(data, "DCS_R_StockFacade/getloaddata/");
        }
        public INV_StockDTO onreport(INV_StockDTO data)
        {
            return COMINV.POSTDataInventory(data, "DCS_R_StockFacade/onreport/");
        }
