...
{
    public class EmployeePunchLateInEarlyOutReportDelegate
    {
        ...
        {
            return COMFRNT.POSTDataHolidayReport(data, "EmployeePunchLateInEarlyOutReportFacade/getalldetails/");
        }
        public EmployeeInOutReportDTO get_departments(EmployeeInOutReportDTO student)
        {
            return COMFRNT.POSTDataHolidayReport(student, "EmployeePunchLateInEarlyOutReportFacade/get_departments/");
        }
        public EmployeeInOutReportDTO get_designation(EmployeeInOutReportDTO student)
        {
            return COMFRNT.POSTDataHolidayReport(student, "EmployeePunchLateInEarlyOutReportFacade/get_designation/");

        }
        public EmployeeInOutReportDTO get_employee(EmployeeInOutReportDTO student)
        {

            return COMFRNT.POSTDataHolidayReport(student, "EmployeePunchLateInEarlyOutReportFacade/get_employee/");
        }
        public EmployeeInOutReportDTO getrpt(EmployeeInOutReportDTO student)
        {
            return COMFRNT.POSTDataHolidayReport(student, "EmployeePunchLateInEarlyOutReportFacade/getrpt/");
        }
    }
}
