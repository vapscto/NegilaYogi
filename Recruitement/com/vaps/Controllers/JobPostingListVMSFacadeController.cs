...
namespace Recruitment.com.vaps.Controllers
{
    ...
    public class JobPostingListVMSFacadeController : Controller
    {

        public JobPostingListVMSInterface _ads;

        public JobPostingListVMSFacadeController(JobPostingListVMSInterface adstu)
        {
            _ads = adstu;
        }
