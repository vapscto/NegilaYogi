...
namespace Recruitment.com.vaps.Controllers
{
    ...
    public class staffwisereportFacadeController : Controller
    {
        public staffwisereportInterface _interface;

        public staffwisereportFacadeController(staffwisereportInterface _inter)
        {
            _interface = _inter;
        }
        [Route("onloaddata")]
        public staffwisereportDTO onloaddata([FromBody] staffwisereportDTO data)
        {
