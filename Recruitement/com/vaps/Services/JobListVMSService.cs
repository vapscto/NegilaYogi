...
{
    public class JobListVMSService : Interfaces.JobListVMSInterface
    {
        public VMSContext _VMSContext;
        public DomainModelMsSqlServerContext _Context;

        public JobListVMSService(VMSContext VMSContext, DomainModelMsSqlServerContext OrganisationContext)
        {
        ...
        public HR_MRFRequisitionDTO editData(HR_MRFRequisitionDTO dto)
        {
            dto.retrunMsg = "";
            try
            {
                ...
                dto.VMSEditValue = (from a in _VMSContext.HR_MRFRequisitionDMO
                                  ...
                                  where (a.HRMRFR_Id.Equals(dto.HRMRFR_Id) && a.HRMP_Id == b.HRMP_Id && a.MI_Id == b.MI_Id && a.HRMD_Id == c.HRMD_Id && a.MI_Id == c.MI_Id && a.HRMPR_Id == d.HRMPR_Id && a.MI_Id == d.MI_Id && a.HRMPT_Id == e.HRMPT_Id && a.MI_Id == e.MI_Id && a.HRMC_Id == g.HRMC_Id && a.MI_Id == g.MI_Id && a.IVRMMG_Id == h.IVRMMG_Id && a.MI_Id == h.MI_Id)
                                  select new HR_MRFRequisitionDTO
                                  {
        ...
        public HR_MRFRequisitionDTO GetAllDropdownAndDatatableDetails(HR_MRFRequisitionDTO dto)
        {
            ...
            try
            {
                var mrfdatalist = from a in _VMSContext.HR_MRFRequisitionDMO
                                  from b in _VMSContext.HR_Master_PositionDMO
                                  from d in _VMSContext.HR_Master_PriorityDMO
                                  where (a.HRMP_Id == b.HRMP_Id && a.HRMPR_Id == d.HRMPR_Id && a.MI_Id == dto.MI_Id && a.HRMRFR_CreatedBy == dto.userid && a.HRMRFR_HRFlag == false)
                                  select new HR_MRFRequisitionDTO
                                  {
                                      HRMRFR_Id = a.HRMRFR_Id,
                                      HRMP_Id = a.HRMP_Id,
