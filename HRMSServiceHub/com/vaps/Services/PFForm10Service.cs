...
{
    public class PFForm10Service : Interfaces.PFForm10Interface
  {
    public HRMSContext _HRMSContext;
    public DomainModelMsSqlServerContext _Context;
    public PFForm10Service(HRMSContext HRMSContext, DomainModelMsSqlServerContext MsSqlServerContext)
    {
      ...
      return dto;
        ...
        public PFReportsDTO getEmployeedetailsBySelectionStjames(PFReportsDTO dto)
        {
            ...
            try
            {
                ...
                employeeDetails = _HRMSContext.MasterEmployee.Where(u => Convert.ToDateTime(u.HRME_DOL).Month + 1 == IVRM_Month_Id && Convert.ToDateTime(u.HRME_DOL).Year == Convert.ToInt32(dto.HRES_Year) && Convert.ToBoolean(u.HRME_LeftFlag) == true && u.HRME_ActiveFlag == true && (u.HRME_LeavingReason == "Retired" || u.HRME_LeavingReason == "Resigned" || u.HRME_LeavingReason == "Others")).ToList();
               ...
               // employeeDetails = _HRMSContext.MasterEmployee.Where(u => Convert.ToDateTime(u.HRME_PensionStoppedDate).Month + 1 == IVRM_Month_Id && Convert.ToDateTime(u.HRME_PensionStoppedDate).Year == Convert.ToInt32(dto.HRES_Year) && u.HRME_ActiveFlag == true && u.HRME_LeftFlag == false && u.HRME_RetiredFlg == true).ToList();
                ...
                List<long> empids = _HRMSContext.MasterEmployee.Where(u => Convert.ToDateTime(u.HRME_DOL).Month + 1 == IVRM_Month_Id && Convert.ToDateTime(u.HRME_DOL).Year == Convert.ToInt32(dto.HRES_Year) && Convert.ToBoolean(u.HRME_LeftFlag) == true && u.HRME_ActiveFlag == true).Select(t=>t.HRME_Id).ToList();
