...
{
    public class FORMNO19Service:Interfaces.FORMNO19Interface
    {

    public HRMSContext _HRMSContext;
    public DomainModelMsSqlServerContext _Context;
    public FORMNO19Service(HRMSContext HRMSContext, DomainModelMsSqlServerContext MsSqlServerContext)
    {
      _HRMSContext = HRMSContext;
      _Context = MsSqlServerContext;

    }
    public FORMNO19DTO getBasicData(FORMNO19DTO dto)
    {
      dto = GetAllDropdownAndDatatableDetails(dto);
      return dto;
    }

    public FORMNO19DTO GetAllDropdownAndDatatableDetails(FORMNO19DTO dto)
    {
      try
      {
    ...
    public FORMNO19DTO FilterEmployeeData(FORMNO19DTO dto)
    {
      return dto;
    }

    public FORMNO19DTO getEmployeedetailsBySelection(FORMNO19DTO dto)
    {
      ...
      //List<FORMNO19DTO> alldata = new List<FORMNO19DTO>();
      ////List<FORMNO19DTO> cumDTOList = new List<FORMNO19DTO>();
      //try
      //{
      ...
      //  {
      //    FORMNO19DTO ss = new FORMNO19DTO();
      //    List<FORMNO19DTO> alldataInner = new List<FORMNO19DTO>();
      ...
      //      FORMNO19DTO ssInner = new FORMNO19DTO();
