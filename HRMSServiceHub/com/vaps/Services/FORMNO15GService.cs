...
{
    public class FORMNO15GService : Interfaces.FORMNO15GInterface
    {
    public HRMSContext _HRMSContext;
    public DomainModelMsSqlServerContext _Context;
    public FORMNO15GService(HRMSContext HRMSContext, DomainModelMsSqlServerContext MsSqlServerContext)
    {
      _HRMSContext = HRMSContext;
      _Context = MsSqlServerContext;

    }
    public FORMNO15GDTO getBasicData(FORMNO15GDTO dto)
    {
      dto = GetAllDropdownAndDatatableDetails(dto);
      return dto;
    }

    public FORMNO15GDTO GetAllDropdownAndDatatableDetails(FORMNO15GDTO dto)
    {
      try
      {
    ...
    public FORMNO15GDTO FilterEmployeeData(FORMNO15GDTO dto)
    {
      return dto;
    }

    public FORMNO15GDTO getEmployeedetailsBySelection(FORMNO15GDTO dto)
    {
      ...
      //List<FORMNO15GDTO> alldata = new List<FORMNO15GDTO>();
      ////List<FORMNO15GDTO> cumDTOList = new List<FORMNO15GDTO>();
      //try
      //{
      ...
      //  {
      //    FORMNO15GDTO ss = new FORMNO15GDTO();
      //    List<FORMNO15GDTO> alldataInner = new List<FORMNO15GDTO>();
      ...
      //      FORMNO15GDTO ssInner = new FORMNO15GDTO();
