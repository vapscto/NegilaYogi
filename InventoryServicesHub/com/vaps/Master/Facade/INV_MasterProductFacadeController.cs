...
namespace InventoryServicesHub.com.vaps.Controllers
{
    ...
    public class INV_MasterProductFacadeController : Controller
    {
        // GET: api/values
        INV_MasterProductInterface _Inv;
        public INV_MasterProductFacadeController(INV_MasterProductInterface Inv)
        {
            _Inv = Inv;
        }
        [Route("getloaddata")]
