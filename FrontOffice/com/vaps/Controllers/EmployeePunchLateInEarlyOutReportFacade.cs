...
namespace FrontOfficeHub.com.vaps.Controllers
{
    ...
    public class EmployeePunchLateInEarlyOutReportFacade : Controller
    {
        public EmployeePunchLateInEarlyOutReportInterface _org;
        public EmployeePunchLateInEarlyOutReportFacade(EmployeePunchLateInEarlyOutReportInterface maspag)
        {
            _org = maspag;
        }
        [HttpPost]
        ...
        [Route("getrpt")]
        public Task<EmployeeInOutReportDTO> getrpt([FromBody] EmployeeInOutReportDTO org)
        {
