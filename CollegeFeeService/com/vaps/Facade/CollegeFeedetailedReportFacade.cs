...
namespace CollegeFeeService.com.vaps.Facade
{
    ...
    public class CollegeFeedetailedReportFacade : Controller
    {


        public CollegeFeedetailedReportInterface objInterface;

        public CollegeFeedetailedReportFacade(CollegeFeedetailedReportInterface bdInterface)
        {
