...
namespace CollegeFeeService.com.vaps.Facade
{
    ...
    public class CollegeGroupWiseStudentReportFacade : Controller
    {
        public CollegeGroupWiseStudentReportInterface _feegrouppagee;

        public CollegeGroupWiseStudentReportFacade(CollegeGroupWiseStudentReportInterface maspag)
        {
