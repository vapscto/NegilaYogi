...
namespace CollegeFeeService.com.vaps.Facade
{
    ...
    public class CollegeDailyCollectionReportFacade : Controller
    {

        public CollegeDailyCollectionReportInterface _feegrouppagee;

        public CollegeDailyCollectionReportFacade(CollegeDailyCollectionReportInterface maspag)
        {
