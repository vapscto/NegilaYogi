...
{
    public class SpecialFeeHeadClgImpl:Interfaces.SpecialFeeHeadClgInterface
    {

        private static ConcurrentDictionary<string, SpecialFeeHeadClgDTO> _login =
        new ConcurrentDictionary<string, SpecialFeeHeadClgDTO>();
        public CollFeeGroupContext _FeeGroupContext;
        public SpecialFeeHeadClgImpl(CollFeeGroupContext frgContext)
        {
            _FeeGroupContext = frgContext;
        }

        public SpecialFeeHeadClgDTO SaveYearlyGroupDataY(SpecialFeeHeadClgDTO FGpage)
        {
            string dupl = "";
            string retval = "";
            ...
            try
            {
                ...
                FGpage.RetrivefeeHeadData = (from a in _FeeGroupContext.FeeHeadClgDMO
                                             ...
                                             select new SpecialFeeHeadClgDTO
                                             {
        ...
        {
            SpecialFeeHeadClgDTO FGRDT = new SpecialFeeHeadClgDTO();
            try
            {
                List<FeeHeadClgDMO> feeheads = new List<FeeHeadClgDMO>();
                feeheads = _FeeGroupContext.FeeHeadClgDMO.Where(t => t.MI_Id == id && t.FMH_SpecialFeeFlag == true && t.FMH_ActiveFlag == true).OrderBy(t => t.FMH_Order).ToList();
                ...
                FGRDT.newarydatah = (from a in _FeeGroupContext.FeeHeadClgDMO
                                     from b in _FeeGroupContext.feeSGGG
                                     from c in _FeeGroupContext.feespecialHead
        ...
        public SpecialFeeHeadClgDTO deactivateY(SpecialFeeHeadClgDTO acd)
        {
            try
            {
                ...
                if (acd.FMSFHFH_Id > 0)
                {
                    ...
                    var feestutrans = _FeeGroupContext.Fee_College_Student_StatusDMO.Where(t => t.FMH_Id == result.FMH_Id).ToList();
        ...
        public SpecialFeeHeadClgDTO getpageeditY(int id)
        {
            SpecialFeeHeadClgDTO page = new SpecialFeeHeadClgDTO();
            try
            {
        ...
        public SpecialFeeHeadClgDTO deleterecY(SpecialFeeHeadClgDTO data)
        {
            ...
            else
            {
                try
                {
                    ...
                    page.RetrivefeeHeadData = (from a in _FeeGroupContext.FeeHeadClgDMO
                                               from b in _FeeGroupContext.feeSGGG
                                               from c in _FeeGroupContext.feespecialHead
        ...
        public SpecialFeeHeadClgGroupsGroupDTO saveyeardata(long grpid, long ggrpid)
        {
            SpecialFeeHeadClgGroupsGroupDTO te = new SpecialFeeHeadClgGroupsGroupDTO();
            ...
            te.FeeSpecialgroupgrping = (from a in _FeeGroupContext.FeeHeadClgDMO
                                        from b in _FeeGroupContext.feeSGGG
                                        from c in _FeeGroupContext.feespecialHead
        ...
        public SpecialFeeHeadClgDTO[] getdata()
        {
            List<SpecialFeeHeadClgDTO> AllInOne = new List<SpecialFeeHeadClgDTO>();
            List<FeeSpecialFeeGroupDMO> Allrows = new List<FeeSpecialFeeGroupDMO>();
            Allrows = _FeeGroupContext.feespecialHead.ToList();
            for (int i = 0; i < Allrows.Count; i++)
            {
                SpecialFeeHeadClgDTO temp = new SpecialFeeHeadClgDTO();
                ...
                List<FeeHeadClgDMO> Allname101 = new List<FeeHeadClgDMO>();
                Allname101 = _FeeGroupContext.FeeHeadClgDMO.Where(t => t.FMH_Id.Equals(Allname1011[0].FMH_Id)).ToList().ToList();  // head id                 
        ...
        public string deleterec(long grpid)
        {
            ...
            SpecialFeeHeadClgGroupsGroupDTO page1 = new SpecialFeeHeadClgGroupsGroupDTO();
