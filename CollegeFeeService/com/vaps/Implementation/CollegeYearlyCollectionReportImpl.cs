...
{
    public class CollegeYearlyCollectionReportImpl: CollegeYearlyCollectionReportInterface
    {
        public CollFeeGroupContext _ClgAdmissionContext;
        readonly ILogger<CollegemasterstudentconcessionImpl> _logger;
        public CollegeYearlyCollectionReportImpl(CollFeeGroupContext _ClgAdmissionCon, ILogger<CollegemasterstudentconcessionImpl> log)
        {
            _logger = log;
        ...
        public async Task<CollegeConcessionDTO> Getreportdetails(CollegeConcessionDTO data)
        {
            ...
            try
            {
                using (var cmd1 = _ClgAdmissionContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd1.CommandText = "College_Yearly_Collection_Report";
                    cmd1.CommandType = CommandType.StoredProcedure;
        ...
        //Fee Student Wise Report
        public async Task<CollegeConcessionDTO> headwisedetails(CollegeConcessionDTO data)
        {
            long fmgg_id = 0;
            var amco_ids = "";
            ...
            {                             
                using (var cmd1 = _ClgAdmissionContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd1.CommandText = "College_Yearly_Collection_FeeHeadWise_Report";
                    cmd1.CommandType = CommandType.StoredProcedure;
                    ...
                    try
                    {
                        ...
                        data.studentrecord = retObject1.ToArray();
                    }
