...
{
    public class CollegeOverallFeeStatusImpl : CollegeOverallFeeStatusInterface
    {
        ...
        public CollegeOverallFeeStatusImpl(CollFeeGroupContext objDbcontext)
        {
        ...
        public CollegeOverallFeeStatusDTO get_courses(CollegeOverallFeeStatusDTO data)
        {
            ...
            try
            {
                ...
                data.fillmastergroup = (from a in CollFeeGroupContext.CLG_Fee_Yearly_Group_Head_Mapping
                                        ...
                                        where (a.FMG_Id == b.FMG_Id && a.FMH_Id == f.FMH_Id && a.FMG_Id == f.FMG_ID && a.MI_Id == data.MI_Id && b.FMG_ActiceFlag == true && a.FYGHM_ActiveFlag == "1" && g.FMH_Id == a.FMH_Id && a.FMG_Id == g.FMG_Id  && g.MI_Id == data.MI_Id && g.ASMAY_Id == data.ASMAY_Id)
        ...
        public CollegeOverallFeeStatusDTO savedata(CollegeOverallFeeStatusDTO data)
        {
            ...
            try
            {
                ...
                {
                    cmd.CommandText = "Clg_Overallfeestatus";
