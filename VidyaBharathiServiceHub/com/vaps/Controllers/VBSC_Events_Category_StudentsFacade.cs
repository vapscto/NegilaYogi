...
namespace VidyaBharathiServiceHub.com.vaps.Controllers
{
    ...
    public class VBSC_Events_Category_StudentsFacade : Controller
    {
        //IVRM_User_Login_StateFacade
        public VBSC_Events_Category_StudentsInterface _cms;

        public VBSC_Events_Category_StudentsFacade(VBSC_Events_Category_StudentsInterface cmsdept)
        {
            _cms = cmsdept;
        }
    
        [Route("loaddata")]
        public VBSC_Events_Category_StudentsDTO loaddata([FromBody]VBSC_Events_Category_StudentsDTO data)
        {
