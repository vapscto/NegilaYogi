...
{
    public class BookTransactionChikkttiIMPL : Interfaces.BookTransactionChikkttiInterface
    {
        public LibraryContext _LibraryContext;

        DomainModelMsSqlServerContext _db;
        public BookTransactionChikkttiIMPL(LibraryContext para, DomainModelMsSqlServerContext db)
        {
        ...
        public BookTransactionDTO getdetails_smartcard(BookTransactionDTO data)
        {
            try
            {
                var LC_CommonLibraryFlg = _LibraryContext.LIB_ConfigurationDMO.Where(R => R.MI_Id == data.MI_Id).FirstOrDefault().LC_CommonLibraryFlg;
                if (LC_CommonLibraryFlg == true)
                {


                    data.msterliblist1 = (from a in _LibraryContext.LIB_Master_Library_DMO
                                          from b in _LibraryContext.LIB_User_Library_DMO
                                          from c in _LibraryContext.Institute
                                          where (a.MI_Id == b.MI_Id && a.MI_Id == c.MI_Id && a.LMAL_Id == b.LMAL_Id && a.LMAL_ActiveFlag == true && b.LUL_ActiveFlg == true && b.IVRMUL_Id == data.IVRMUL_Id)
                                          select new BookTransactionDTO
                                          {
                                              MI_Id = c.MI_Id,
                                              MI_Name = c.MI_Name,
                                              LMAL_Id = a.LMAL_Id,
                                              LMAL_LibraryName = a.LMAL_LibraryName
                                          }).Distinct().ToArray();
                }
                else
                {
                    ...
                    data.msterliblist1 = (from a in _LibraryContext.LIB_Master_Library_DMO
                                          from b in _LibraryContext.LIB_User_Library_DMO
                                          from c in _LibraryContext.Institute
                                          where (a.MI_Id == b.MI_Id && a.MI_Id == c.MI_Id && a.MI_Id == data.MI_Id && a.LMAL_Id == b.LMAL_Id && a.LMAL_ActiveFlag == true && b.LUL_ActiveFlg == true && b.IVRMUL_Id == data.IVRMUL_Id)
                                          select new BookTransactionDTO
                                          {
                                              MI_Id = c.MI_Id,
                                              MI_Name = c.MI_Name,
        ...
        public BookTransactionDTO getdetails(BookTransactionDTO data)
        {
            try
            {
                ...
                if (data.LMAL_Id == 0)
                {
                    if (LC_CommonLibraryFlg == true)
                    {
                        liblist = _LibraryContext.LIB_Master_Library_DMO.Where(R => R.LMAL_ActiveFlag == true).OrderByDescending(R => R.LMAL_Id).Distinct().ToList();
                    }
                    else
                    {
                ...
                if (LC_CommonLibraryFlg == true)
                {
                    data.msterliblist1 = _LibraryContext.LIB_Master_Library_DMO.Where(R => R.LMAL_ActiveFlag == true).OrderByDescending(R => R.LMAL_Id).Distinct().ToArray();
                }
                else
                {
                    data.msterliblist1 = (from a in _LibraryContext.LIB_Master_Library_DMO
                ...
                if (liblist.Count > 0)
                {
                    List<long> LMAL_Id = new List<long>();
                    if (LC_CommonLibraryFlg == true)
                    {
                        foreach (var d in liblist)
                        {
                            LMAL_Id.Add(d.LMAL_Id);
                        }
                        //data.LMAL_Id = liblist.FirstOrDefault().LMAL_Id;
                    }
                    else
                    {
                        LMAL_Id.Add(liblist.FirstOrDefault().LMAL_Id);
                        // data.LMAL_Id = liblist.FirstOrDefault().LMAL_Id;
                    }
                    ...
                    {
                        if(LC_CommonLibraryFlg==false)
                        {
                            var libclasslist = (from a in _LibraryContext.LIB_Master_Library_DMO
                                                from b in _LibraryContext.LIB_User_Library_DMO
                                                from c in _LibraryContext.LIB_Library_Class_DMO
                                                where a.MI_Id == b.MI_Id && a.MI_Id == c.MI_Id && a.MI_Id == data.MI_Id && a.LMAL_Id == c.LMAL_Id && a.LMAL_Id == b.LMAL_Id && a.LMAL_ActiveFlag == true && b.LUL_ActiveFlg == true && c.LLC_ActiveFlg == true && b.IVRMUL_Id == data.IVRMUL_Id && LMAL_Id.Contains(a.LMAL_Id)
                                                select c).ToList();
                    ...
                    if (data.issuertype == "std")
                    {
                        ...
                        if (LC_CommonLibraryFlg == true)
                        {
                            var classlist = _LibraryContext.School_M_Class.Where(t => t.MI_Id == data.MI_Id && t.ASMCL_ActiveFlag == true).Distinct().OrderBy(e => e.ASMCL_Order).ToList();
                        ...
                        else
                        {
                            var classlist = (from t in _LibraryContext.School_M_Class
                                             from c in _LibraryContext.LIB_Library_Class_DMO
                                             where (t.MI_Id == data.MI_Id && t.ASMCL_ActiveFlag == true && t.ASMCL_Id == c.ASMCL_Id && c.LLC_ActiveFlg == true && LMAL_Id.Contains(c.LMAL_Id))
                        ...
                        {
                            cmd.CommandText = "LIB_GET_STUDENT_BOOK_TRANSACTION_SCHOOL_CHIKKATTI";
                        ...
                        if (data.bookcat_type == "book")
                        {
                            if (data.booktype == "nonbook")
                            {
                                if (LC_CommonLibraryFlg == true)
                                {
                                    using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                                    {
                                        cmd.CommandText = "LIB_GET_STAFF_TRANSACTION_CHIKKATTI";
                                        cmd.CommandType = CommandType.StoredProcedure;
                                        cmd.CommandTimeout = 8000000;
                                        ...
                                        cmd.Parameters.Add(new SqlParameter("@LMC_BNBFlg",
                                            SqlDbType.VarChar)
                                        {
                                            Value = "Book"
                                        });
                        ...
                        if (data.bookcat_type == "book")
                        {
                            if (data.booktype == "nonbook")
                            {
                                if (LC_CommonLibraryFlg == true)
                                {
                                    using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                                    {
                                        cmd.CommandText = "LIB_GET_DEPARTMENT_TRANSACTION_CHIKKATTI";
                                        cmd.CommandType = CommandType.StoredProcedure;
                                        cmd.CommandTimeout = 8000000;
                        ...
                        if (data.bookcat_type == "book")
                        {
                            if (data.booktype == "nonbook")
                            {
                                if (LC_CommonLibraryFlg == true)
                                {
                                    using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                                    {
                                        cmd.CommandText = "LIB_GET_SGDSO_TRANSACTION_CHIKKATTI";
                                        cmd.CommandType = CommandType.StoredProcedure;
                                        cmd.CommandTimeout = 8000000;
                    ...
                    using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "LIB_GET_BOOKS_FOR_TRANSACTION_CHIKKATTI";
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.CommandTimeout = 8000000;
        ...
        public BookTransactionDTO stdSearch_Grid(BookTransactionDTO data)
        {
            ...
            try
            {
                ...
                if (LC_CommonLibraryFlg == true)
                {
                    using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "LIB_GET_STUDENT_BOOK_TRANSACTION_SCHOOL_SEARCH_GRID_CHIKKATTI";
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.CommandTimeout = 8000000;
        ...
        public BookTransactionDTO get_bookdetails(BookTransactionDTO data)
        {
            try
            {
                ...
                using (var cmd = _LibraryContext.Database.GetDbConnection().CreateCommand())
                {
                    cmd.CommandText = "LIB_GET_BOOKDETAILS_TRANS_CHIKKATTI";
                    cmd.CommandType = CommandType.StoredProcedure;
