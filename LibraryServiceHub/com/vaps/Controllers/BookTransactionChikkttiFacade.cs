...
namespace LibraryServiceHub.com.vaps.Controllers
{
    ...
    public class BookTransactionChikkttiFacade : Controller
    {

        public BookTransactionChikkttiInterface _objInter;
        public BookTransactionChikkttiFacade(BookTransactionChikkttiInterface data)
        {
            _objInter = data;
        }
