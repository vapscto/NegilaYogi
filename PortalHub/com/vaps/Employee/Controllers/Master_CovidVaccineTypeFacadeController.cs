...
namespace PortalHub.com.vaps.Employee.Controllers
{
    ...
    public class Master_CovidVaccineTypeFacadeController : Controller
    {
        public Master_CovidVaccineTypeInterface _interface;

        public Master_CovidVaccineTypeFacadeController(Master_CovidVaccineTypeInterface _inter)
        {
            _interface = _inter;
        }
        [Route("onloaddata")]
