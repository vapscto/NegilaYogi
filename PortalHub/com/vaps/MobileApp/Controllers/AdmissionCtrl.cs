...
namespace PortalHub.com.vaps.MobileApp.Controllers
{
    ...
    public class AdmissionCtrl : Controller
    {
        public AdmissionInterface _admissionInterface;
        private readonly PortalContext _PortalContext;
        public AdmissionCtrl(PortalContext cpContext, AdmissionInterface admissionInterface)
        {
        ...
        //onclick_LIBstaff
        [Route("onclick_LIBstaff")]
        public AdmissionDTO.onclick_LIB onclick_LIBstaff([FromBody] AdmissionDTO.onclick_LIB obj)
        {
            return _admissionInterface.onclick_LIBstaff(obj);
        }
        //getCoedata
