...
namespace PortalHub.com.vaps.Chairman.Controllers
{
    ...
    public class HomeSchoolAdmFacadeController : Controller
    {
        public HomeSchoolAdmInterface _ChairmanDashboardReport;

        public HomeSchoolAdmFacadeController(HomeSchoolAdmInterface data)
        {
        ...
        [HttpPost]
        [Route("Getdetails")]
        public HomeSchoolAdmDTO Getdetails([FromBody] HomeSchoolAdmDTO data)//int IVRMM_Id
        {
