...
namespace PortalHub.com.vaps.Chairman.Controllers
{
    ...
    public class Ch_LopFacadeController : Controller
    {
        public Ch_LopInterface _ChairmanDashboardReport;

        public Ch_LopFacadeController(Ch_LopInterface data)
        {
        ...
        [Route("getdata")]
        public Ch_LopDTO getdata([FromBody] Ch_LopDTO obj)
        {
