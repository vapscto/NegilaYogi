...
namespace PortalHub.com.vaps.Chairman.Controllers
{
    ...
    public class ExamToppersListFacadeController : Controller
    {
        public ExamToppersListInterface _ChairmanDashboardReport;

        public ExamToppersListFacadeController(ExamToppersListInterface data)
        {
        ...
        [HttpPost]
        [Route("Getdetails")]
        public ExamToppersListDTO Getdetails([FromBody] ExamToppersListDTO data)
        {
        ...
        [HttpPost]
        [Route("getcategory")]
        public ExamToppersListDTO getclass([FromBody] ExamToppersListDTO data)
        {
