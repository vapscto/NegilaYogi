...
namespace ClgCOEServiceHub.com.vaps.Services
{
    public class ClgCOEMailSMSImpl:Interfaces.ClgCOEMailSMSInterface
    {
        int MI_ID = 0;
        public ClgCOEContext _coe;
        public DomainModelMsSqlServerContext _db;
        private readonly IHostingEnvironment _hostingEnvironment;
        public ClgCOEMailSMSImpl(ClgCOEContext coe, DomainModelMsSqlServerContext db, IHostingEnvironment hostingEnvironment)
        {
            _coe = coe;
            _db = db;
