...
{
    public class ClgMasterCOEImpl : Interfaces.ClgMasterCOEInterface
    {
       ...
       new ConcurrentDictionary<string, ClgMasterCOEDTO>();
        ...
        public ClgMasterCOEImpl(ClgCOEContext coe)
        {
            _ClgCOEContext = coe;
        }
        ...
        public ClgMasterCOEDTO delete_event_classes(int id)
        {
            ...
            try
            {
                ...
                lorg = _ClgCOEContext.COE_Events_ClassesDMO.Where(t => t.COEE_Id == id).ToList();
                if (lorg.Any())
                {
