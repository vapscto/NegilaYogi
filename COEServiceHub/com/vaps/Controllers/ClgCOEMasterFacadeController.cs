...
namespace COEServiceHub.com.vaps.Controllers
{
    ...
    public class ClgCOEMasterFacadeController : Controller
    {
        public ClgCOEMasterInterface _ttcategory;

        public ClgCOEMasterFacadeController(ClgCOEMasterInterface maspag)
        {
            _ttcategory = maspag;
        }
