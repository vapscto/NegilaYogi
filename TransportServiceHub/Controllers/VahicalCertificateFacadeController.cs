...
namespace TransportServiceHub.Controllers
{
    ...
    public class VahicalCertificateFacadeController : Controller
    {
        public VahicalCertificateInterface driverint;

        public VahicalCertificateFacadeController(VahicalCertificateInterface driv)
        {
            driverint = driv;
        }
        // GET: api/values
        ...
        [Route("deleterecord")]
        public VahicalCertificateDTO deleterecord([FromBody] VahicalCertificateDTO data)
        {
