...
namespace TransportServiceHub.Controllers
{
    ...
    public class RouteStatusReportFacade : Controller
    {
        public RouteStatusReportInterface _feegrouppagee;
        // GET: api/values

        public RouteStatusReportFacade(RouteStatusReportInterface maspag)
        {
