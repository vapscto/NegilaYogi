...
namespace TransportServiceHub.Controllers
{
    ...
    public class BusBookingDetailsReportFacade : Controller
    {
        public BusBookingDetailsReportInterface _feegrouppagee;
        // GET: api/values
        public BusBookingDetailsReportFacade(BusBookingDetailsReportInterface maspag)
        {
