...
namespace TransportServiceHub.Controllers
{
    ...
    public class TRGroupConsoleReportFacade : Controller
    {
        public TRGroupConsoleReportInterface _feegrouppagee;
        // GET: api/values
        public TRGroupConsoleReportFacade(TRGroupConsoleReportInterface maspag)
        {
