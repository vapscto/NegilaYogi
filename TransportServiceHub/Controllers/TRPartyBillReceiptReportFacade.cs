...
namespace TransportServiceHub.Controllers
{
    ...
    public class TRPartyBillReceiptReportFacade : Controller
    {
        public TRPartyBillReceiptReportInterface _feegrouppagee;
        // GET: api/values
        public TRPartyBillReceiptReportFacade(TRPartyBillReceiptReportInterface maspag)
        {
