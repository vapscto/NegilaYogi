...
namespace TransportServiceHub.Controllers
{
    ...
    public class ConsolidatedBusRouteListFacade : Controller
    {
        public ConsolidatedBusRouteListInterface _feegrouppagee;
        // GET: api/values

        public ConsolidatedBusRouteListFacade(ConsolidatedBusRouteListInterface maspag)
        {
