...
namespace TransportServiceHub.Controllers
{
    ...
    public class ScheduleWiseBusRouteFacade : Controller
    {
        public ScheduleWiseBusRouteInterface _feegrouppagee;
        // GET: api/values

        public ScheduleWiseBusRouteFacade(ScheduleWiseBusRouteInterface maspag)
        {
