...
namespace TransportServiceHub.Controllers
{
    ...
    public class BusRoutesDetailsFacade : Controller
    {
        public BusRoutesDetailsInterface _feegrouppagee;
        // GET: api/values

        public BusRoutesDetailsFacade(BusRoutesDetailsInterface maspag)
        {
