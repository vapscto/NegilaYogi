...
{
    public class CLGConsolidatedBusRouteImpl : Interfaces.CLGConsolidatedBusRouteInterface
    {
        public TransportContext _context;
        ILogger<CLGConsolidatedBusRouteImpl> _areaimpl;
        public CLGConsolidatedBusRouteImpl(ILogger<CLGConsolidatedBusRouteImpl> areaimpl, TransportContext context)
        {
...

        {
            try
            {
                ...
                {
                    cmd.CommandText = "ConsolidatedListForBusRoute_new_collage";
