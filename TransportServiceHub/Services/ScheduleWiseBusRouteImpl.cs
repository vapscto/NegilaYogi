...
{
    public class ScheduleWiseBusRouteImpl : Interfaces.ScheduleWiseBusRouteInterface
    {
        public TransportContext _context;
        ILogger<ScheduleWiseBusRouteImpl> _areaimpl;
        public ScheduleWiseBusRouteImpl(ILogger<ScheduleWiseBusRouteImpl> areaimpl, TransportContext context)
        {
...

        {
            try
            {
                ...
                {
                    cmd.CommandText = "ScheduleWiseBusRouteCount";
