...
{
    public class TRPartyBillReceiptReportImpl : Interfaces.TRPartyBillReceiptReportInterface
    {
        ...
        ILogger<TRPartyBillReceiptReportImpl> _areaimpl;
        public TRPartyBillReceiptReportImpl(ILogger<TRPartyBillReceiptReportImpl> areaimpl, TransportContext context, DomainModelMsSqlServerContext db)
        {
