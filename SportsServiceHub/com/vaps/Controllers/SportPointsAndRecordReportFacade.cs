...
namespace SportsServiceHub.com.vaps.Controllers
{
    ...
    public class SportPointsAndRecordReportFacade : Controller
    {
        public SportPointsAndRecordReportInterface _ReportContext;

        public SportPointsAndRecordReportFacade(SportPointsAndRecordReportInterface dt)
        {
            _ReportContext = dt;
        }
