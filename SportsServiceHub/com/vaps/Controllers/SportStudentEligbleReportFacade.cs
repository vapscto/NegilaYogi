...
namespace SportsServiceHub.com.vaps.Controllers
{
    ...
    public class SportStudentEligbleReportFacade : Controller
    {
        public SportStudentEligbleReportInterface _ReportContext;

        public SportStudentEligbleReportFacade(SportStudentEligbleReportInterface dt)
        {
            _ReportContext = dt;
        }
