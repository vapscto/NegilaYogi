...
namespace SportsServiceHub.com.vaps.Controllers
{
    ...
    public class SportTopperListReportFacade : Controller
    {
        public SportTopperListReportInterface _ReportContext;

        public SportTopperListReportFacade(SportTopperListReportInterface dt)
        {
            _ReportContext = dt;
        }
        ...
        [Route("Kiosk_Sports_Details")]
        public Task<SportStudentParticipationReportDTO> Kiosk_Sports_Details([FromBody] SportStudentParticipationReportDTO data)
        {
            return _ReportContext.Kiosk_Sports_Details(data);
        }
