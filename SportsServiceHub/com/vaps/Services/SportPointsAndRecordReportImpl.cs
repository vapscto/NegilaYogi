...
{
    public class SportPointsAndRecordReportImpl : Interfaces.SportPointsAndRecordReportInterface
    {
   ...
   new ConcurrentDictionary<string, SportStudentParticipationReportDTO>();
        ...
        ILogger<SportPointsAndRecordReportImpl> _acdimpl;
        public SportPointsAndRecordReportImpl(SportsContext sportcontext, StudentAttendanceReportContext db)
        {
        ...
        public SportStudentParticipationReportDTO Getdetails(SportStudentParticipationReportDTO data)//int IVRMM_Id
        {
            ...
            try
            {
                ...
                data.venueList = (from a in _sportcontext.MasterEventVenueDMO
                                  ...
                                  select new MasterEventVenueDTO
                                  {
                ...
                data.eventList = (from a in _sportcontext.MasterEventsDMO
                                  ...
                                  select new SportStudentParticipationReportDTO { SPCCME_Id = a.SPCCME_Id, SPCCME_EventName = a.SPCCME_EventName }).Distinct().OrderBy(t => t.SPCCME_EventName).ToArray();
                ...
                data.categoryList = _sportcontext.MasterCompitionCategoryDMO.Where(t => t.MI_Id == data.MI_Id && t.SPCCMCC_ActiveFlag == true).Distinct().ToArray();
        ...
        public async Task<SportStudentParticipationReportDTO> showdetails(SportStudentParticipationReportDTO data)
        {
            try
            {
                ...
                else if (data.Type == "CC")
                {
                    ...
                    foreach (var item in data.placListData)
                    {
                        placees = placees + ',' + item.SPCCESTR_Rank;
                    }
                }
                else
                {
                ...
                if (data.Type == "CC")
                {
                    ...
                    {
                        cmd.CommandText = "SPCC_SportPointsAndRecordReportCCWise";
                    ...
                    SqlDbType.VarChar)
                        ...
                        cmd.Parameters.Add(new SqlParameter("@SPCCESTR_Rank",
                    SqlDbType.VarChar)
                        {
                            Value = placees
                        });
                        ...
                        try
                        {
                            ...
                            data.viewlistCCwise = retObject.ToArray();
                        }
                        catch (Exception ex)
                        {
                ...
                else
                {
                    using (var cmd = _sportcontext.Database.GetDbConnection().CreateCommand())
                    {
                        cmd.CommandText = "SPCC_SportPointsAndRecordReport";
                        cmd.CommandType = CommandType.StoredProcedure;
