...
namespace PDAServiceHub.com.vaps.controllers
{
    ...
    public class PDAClassSectionReportFacade : Controller
    {
        public PDAClassSectionReportInterface _pdamasterhead;

        public PDAClassSectionReportFacade(PDAClassSectionReportInterface maspag)
        {
