...
namespace PDAServiceHub.com.vaps.controllers
{
    ...
    public class PDASummaryReportFacade : Controller
    {
        public PDASummaryReportInterface _pdamasterhead;

        public PDASummaryReportFacade(PDASummaryReportInterface maspag)
        {
