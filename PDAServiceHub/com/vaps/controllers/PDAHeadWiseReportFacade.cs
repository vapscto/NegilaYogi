...
namespace PDAServiceHub.com.vaps.controllers
{
    ...
    public class PDAHeadWiseReportFacade : Controller
    {
        public PDAHeadWiseReportInterface _pdamasterhead;

        public PDAHeadWiseReportFacade(PDAHeadWiseReportInterface maspag)
        {
