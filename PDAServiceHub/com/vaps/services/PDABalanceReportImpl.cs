...
{
    public class PDABalanceReportImpl: PDABalanceReportInterface
    {
       ...
       new ConcurrentDictionary<string, PDATransactionDTO>();
        ...
        readonly ILogger<PDABalanceReportImpl> _logger;
        public PDABalanceReportImpl(PDAContext frgContext, ILogger<PDABalanceReportImpl> log)
        {
            _logger = log;
