...
{
    public class PDAHeadWiseReportImpl:PDAHeadWiseReportInterface
    {
  ...
  new ConcurrentDictionary<string, PDATransactionDTO>();
        ...
        readonly ILogger<PDAHeadWiseReportImpl> _logger;
        public PDAHeadWiseReportImpl(PDAContext frgContext, ILogger<PDAHeadWiseReportImpl> log)
        {
            _logger = log;
